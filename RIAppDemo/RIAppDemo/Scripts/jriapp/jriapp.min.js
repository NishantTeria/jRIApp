...
if(b=this._dataSource)b=this._fn_itemsProvider?this._fn_itemsProvider(b):b.items,this._fn_filter&&(b=b.filter(this._fn_filter)),this._fn_sort&&(b=b.sort(this._fn_sort)),this._fillItems({items:b,isPageChanged:!!a,clear:!0,isAppend:!1}),this._onViewRefreshed({})},_fillItems:function(a){a=g.extend(!1,{items:[],isPageChanged:!1,clear:!0,isAppend:!1},a);var b,c=[],d=[],f=[];this._onFillStart({isBegin:!0,rowCount:a.items.length,time:new Date,isPageChanged:a.isPageChanged});try{a.clear&&this.clear(),b=this.isPagingEnabled&&
!a.isAppend?this._filterForPaging(a.items):a.items,b.forEach(function(a){var b=this._itemsByKey[a._key];b?f.push(b):(this._itemsByKey[a._key]=a,c.push(a),d.push(this._items.length-1),this._items.push(a),f.push(a))},this),0<c.length&&(this._onItemsChanged({change_type:e.COLL_CHANGE_TYPE.ADDED,items:c,pos:d}),this.raisePropertyChanged("count"))}finally{this._onFillEnd({isBegin:!1,rowCount:f.length,time:new Date,resetUI:!!a.clear,fetchedItems:f,newItems:c,isPageChanged:a.isPageChanged})}this.totalCount=
a.clear?a.items.length:this.totalCount+c.length;this.moveFirst();return c},_onDSCollectionChanged:function(a){var b=this,c;c=e.COLL_CHANGE_TYPE;var d=a.items;switch(a.change_type){case c.RESET:this._isDSFilling||this._refresh(!1);break;case c.ADDED:!this._isAddingNew&&!this._isDSFilling&&(b._fn_filter&&(d=d.filter(b._fn_filter)),b.appendItems([d]));break;case c.REMOVE:d.forEach(function(a){(a=b._itemsByKey[a._key])&&b.removeItem(a)});break;case c.REMAP_KEY:if(c=b._itemsByKey[a.old_key])delete b._itemsByKey[a.old_key],
b._itemsByKey[a.new_key]=c,this._onItemsChanged(a);break;default:throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_COLLECTION_CHANGETYPE_INVALID,a.change_type));}},_onDSFill:function(a){var b=a.fetchedItems;a.isBegin?this._isDSFilling=!0:(this._isDSFilling=!1,a.resetUI?this._refresh(!1):(this._fn_filter&&(b=b.filter(this._fn_filter)),this.appendItems(b)))},_onDSStatusChanged:function(a){var b=a.item,e=a.oldChangeType,c=!!this._fn_filter;this._itemsByKey[a.key]?(this._onItemStatusChanged(b,e),c&&((a=this._fn_filter(b))||
this.removeItem(b))):c&&(a=this._fn_filter(b))&&this.appendItems([b])},_bindDS:function(){var a=this,b=this._dataSource;b&&(b.addHandler("coll_changed",function(e,c){b===e&&a._onDSCollectionChanged(c)},a._objId),b.addHandler("fill",function(e,c){b===e&&a._onDSFill(c)},a._objId),b.addHandler("begin_edit",function(e,c){b===e&&a._itemsByKey[c.item._key]&&a._onEditing(c.item,!0,!1)},a._objId),b.addHandler("end_edit",function(e,c){if(b===e){var d,g=c.item;d=!!a._fn_filter;a._itemsByKey[g._key]?(a._onEditing(g,
!1,c.isCanceled),!c.isCanceled&&d&&((d=a._fn_filter(g))||a.removeItem(g))):!c.isCanceled&&d&&(d=a._fn_filter(g))&&a._appendItems([g])}},a._objId),b.addHandler("errors_changed",function(e,c){b===e&&a._itemsByKey[c.item._key]&&a._onErrorsChanged(c.item)},a._objId),b.addHandler("status_changed",function(e,c){b===e&&a._onDSStatusChanged(c)},a._objId),b.addHandler("item_deleting",function(e,c){b===e&&a._itemsByKey[c.item._key]&&a._onItemDeleting(c)},a._objId),b.addHandler("item_added",function(e,c){b===
e&&a._isAddingNew&&(a._itemsByKey[c.item._key]||a._attach(c.item),a.currentItem=c.item,a._onEditing(c.item,!0,!1),a._onItemAdded(c.item))},a._objId),b.addHandler("item_adding",function(e,c){b===e&&a._isAddingNew&&a._onItemAdding(c.item)},a._objId))},_unbindDS:function(){var a=this._dataSource;a&&a.removeNSHandlers(this._objId)},appendItems:function(a){return this._isDestroyed?[]:this._fillItems({items:a,isPageChanged:!1,clear:!1,isAppend:!0})},_getStrValue:function(a,b){return this._dataSource._getStrValue(a,
b)},_onCurrentChanging:function(a){var b=this._dataSource;try{b._EditingItem&&a!==b._EditingItem&&b.endEdit()}catch(e){b.cancelEdit(),f.reThrow(e,this._onError(e,this))}},_getErrors:function(a){return this._dataSource._getErrors(a)},_onPageChanged:function(){this._refresh(!0)},getItemsWithErrors:function(){return this._dataSource.getItemsWithErrors()},addNew:function(){var a=this._dataSource,b;this._isAddingNew=!0;try{b=a.addNew()}finally{this._isAddingNew=!1}return b},removeItem:function(a){if(null===
a._key)throw Error(RIAPP.ERRS.ERR_ITEM_IS_DETACHED);if(this._itemsByKey[a._key]){var b=this._items.indexOf(a);if(0>b)throw Error(RIAPP.ERRS.ERR_ITEM_IS_NOTFOUND);this._items.splice(b,1);delete this._itemsByKey[a._key];delete this._errors[a._key];this.totalCount-=1;this._onRemoved(a,b);a=this.getItemByPos(b);var e=this._currentPos;e===b&&(a||(this._currentPos=e-1),this._onCurrentChanged());e>b&&(this._currentPos=e-1,this._onCurrentChanged())}},sortLocal:function(a,b){var e=1,c=this._app.parser;b&&
"DESC"===b.toUpperCase()&&(e=-1);this.fn_sort=function(b,d){var g=0,f,p,l;f=0;for(p=a.length;f<p&&!(l=a[f],g=c.resolvePath(b,l),l=c.resolvePath(d,l),g=g<l?-1*e:g>l?e:0,0!==g);f+=1);return g}},getIsHasErrors:function(){return this._dataSource.getIsHasErrors()},clear:function(){this.cancelEdit();this._EditingItem=null;this._newKey=0;this.currentItem=null;this._items=[];this._itemsByKey={};this._errors={};this._onItemsChanged({change_type:e.COLL_CHANGE_TYPE.RESET,items:[]});this.pageIndex=0;this.raisePropertyChanged("count")},
refresh:function(){this._refresh(!1)},destroy:function(){this._isDestroyed||(this._unbindDS(),this._fn_sort=this._fn_filter=this._dataSource=null,this._super())}},{isPagingEnabled:{set:function(a){this._options.enablePaging!==a&&(this._options.enablePaging=a,this.raisePropertyChanged("isPagingEnabled"),this._refresh())},get:function(){return this._options.enablePaging}},permissions:{get:function(){return this._dataSource.permissions}},fn_filter:{set:function(a){this._fn_filter!==a&&(this._fn_filter=
a,this._refresh())},get:function(){return this._fn_filter}},fn_sort:{set:function(a){this._fn_sort!==a&&(this._fn_sort=a,this._refresh())},get:function(){return this._fn_sort}},fn_itemsProvider:{set:function(a){this._fn_itemsProvider!==a&&(this._fn_itemsProvider=a,this._refresh())},get:function(){return this._fn_itemsProvider}}},function(a){d.registerType("DataView",a)});RIAPP.BaseObject.extend({_app:d,_create:function(a){this._super();var b=this;this._objId="assoc:"+g.getNewID();a=g.extend(!1,{dbContext:null,
parentName:"",childName:"",parentKeyFields:[],childKeyFields:[],parentToChildrenName:null,childToParentName:null,name:this._objId,onDeleteAction:e.DELETE_ACTION.NoAction},a);this._name=a.name;this._dbContext=a.dbContext;this._onDeleteAction=a.onDeleteAction;this._parentDS=a.dbContext.dbSets[a.parentName];this._childDS=a.dbContext.dbSets[a.childName];this._parentFldInfos=a.parentKeyFields.map(function(a){return b._parentDS.getFieldInfo(a)});this._childFldInfos=a.childKeyFields.map(function(a){return b._childDS.getFieldInfo(a)});
this._parentToChildrenName=a.parentToChildrenName;this._childToParentName=a.childToParentName;this._parentMap={};this._childMap={};this._isChildFilling=this._isParentFilling=!1;this._bindParentDS();a=this._mapParentItems(this._parentDS.items);this._bindChildDS();var c=this._mapChildren(this._childDS.items);this._changedTimeout=this._saveChildFKey=this._saveParentFKey=null;this._changed={};b._notifyParentChanged(a);b._notifyChildrenChanged(c)},_onError:function(a,b){var e=this._super(a,b);return!e?
this.app._onError(a,b):e},_bindParentDS:function(){var a=this,b=this._parentDS;b&&(b._addHandler("coll_changed",function(e,c){b===e&&a._onParentCollChanged(c)},a._objId,!0),b._addHandler("fill",function(e,c){b===e&&a._onParentFill(c)},a._objId,!0),b._addHandler("begin_edit",function(e,c){b===e&&a._onParentEdit(c.item,!0,void 0)},a._objId,!0),b._addHandler("end_edit",function(e,c){b===e&&a._onParentEdit(c.item,!1,c.isCanceled)},a._objId,!0),b._addHandler("item_deleting",function(c,d){if(b===c){var g=
e.DELETE_ACTION,f=a.getChildItems(d.item);switch(a.onDeleteAction){case g.NoAction:0<f.length&&(d.isCancel=!0,a._onError(Error(RIAPP.ERRS.ERR_ASSOC_HAS_CHILDREN),a))}}},a._objId,!0),b._addHandler("status_changed",function(e,c){b===e&&a._onParentStatusChanged(c.item,c.oldChangeType)},a._objId,!0),b._addHandler("commit_changes",function(e,c){b===e&&a._onParentCommitChanges(c.item,c.isBegin,c.isRejected,c.changeType)},a._objId,!0))},_bindChildDS:function(){var a=this,b=this._childDS;b&&(b._addHandler("coll_changed",
function(e,c){b===e&&a._onChildCollChanged(c)},a._objId,!0),b._addHandler("fill",function(e,c){b===e&&a._onChildFill(c)},a._objId,!0),b._addHandler("begin_edit",function(e,c){b===e&&a._onChildEdit(c.item,!0,void 0)},a._objId,!0),b._addHandler("end_edit",function(e,c){b===e&&a._onChildEdit(c.item,!1,c.isCanceled)},a._objId,!0),b._addHandler("status_changed",function(e,c){b===e&&a._onChildStatusChanged(c.item,c.oldChangeType)},a._objId,!0),b._addHandler("commit_changes",function(e,c){b===e&&a._onChildCommitChanges(c.item,
c.isBegin,c.isRejected,c.changeType)},a._objId,!0))},_onParentCollChanged:function(a){var b=this,c=e.COLL_CHANGE_TYPE,d=a.items,g=[],f={};switch(a.change_type){case c.RESET:b._isParentFilling||(g=b.refreshParentMap());break;case c.ADDED:this._isParentFilling||(g=b._mapParentItems(d));break;case c.REMOVE:d.forEach(function(a){(a=b._unMapParentItem(a))&&(f[a]=null)});g=Object.keys(f);break;case c.REMAP_KEY:if(a.old_key&&(c=this._parentMap[a.old_key]))delete this._parentMap[a.old_key],g=this._mapParentItems([c]);
break;default:throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_COLLECTION_CHANGETYPE_INVALID,a.change_type));}b._notifyParentChanged(g)},_onParentFill:function(a){a.isBegin?this._isParentFilling=!0:(this._isParentFilling=!1,a=a.resetUI?this.refreshParentMap():this._mapParentItems(a.newItems),this._notifyParentChanged(a))},_onParentEdit:function(a,b,e){b?this._storeParentFKey(a):e?this._saveParentFKey=null:this._checkParentFKey(a)},_onParentCommitChanges:function(a,b,c,d){var g=e.CHANGE_TYPE;b?c&&d===
g.ADDED?(a=this._unMapParentItem(a))&&this._notifyParentChanged([a]):!c&&d===g.DELETED?(a=this._unMapParentItem(a))&&this._notifyParentChanged([a]):this._storeParentFKey(a):this._checkParentFKey(a)},_storeParentFKey:function(a){a=this.getParentFKey(a);null!==a&&this._parentMap[a]&&(this._saveParentFKey=a)},_checkParentFKey:function(a){var b,e=this._saveParentFKey;this._saveParentFKey=null;b=this.getParentFKey(a);b!==e&&(e&&(delete this._parentMap[e],this._notifyChildrenChanged([e]),this._notifyParentChanged([e])),
b&&(this._mapParentItems([a]),this._notifyChildrenChanged([b]),this._notifyParentChanged([b])))},_onParentStatusChanged:function(a,b){var c=this,d,g,f=e.DELETE_ACTION;if(a._changeType===e.CHANGE_TYPE.DELETED){g=c.getChildItems(a);d=this._unMapParentItem(a);switch(c.onDeleteAction){case f.Cascade:g.forEach(function(a){a.deleteItem()});break;case f.SetNulls:g.forEach(function(a){var b=a.isEditing;b||a.beginEdit();try{c._childFldInfos.forEach(function(b){a[b.fieldName]=null}),b||a.endEdit()}finally{b||
a.cancelEdit()}})}d&&c._notifyParentChanged([d])}},_onChildCollChanged:function(a){var b=this,c=e.COLL_CHANGE_TYPE,d=a.items,g=[],f={};switch(a.change_type){case c.RESET:b._isChildFilling||(g=b.refreshChildMap());break;case c.ADDED:this._isChildFilling||(g=b._mapChildren(d));break;case c.REMOVE:d.forEach(function(a){(a=b._unMapChildItem(a))&&(f[a]=null)});g=Object.keys(f);break;case c.REMAP_KEY:if(a.old_key&&(a=d[0])){if(g=a._getFieldVal(this._childToParentName))delete this._childMap[g],a._clearFieldVal(this._childToParentName);
g=this._mapChildren([a])}break;default:throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_COLLECTION_CHANGETYPE_INVALID,a.change_type));}b._notifyChildrenChanged(g)},_notifyChildrenChanged:function(a){this._notifyChanged([],a)},_notifyParentChanged:function(a){this._notifyChanged(a,[])},_notifyChanged:function(a,b){var e=this;if(0<a.length||0<b.length)a.forEach(function(a){var b=e._changed[a];e._changed[a]=b?b|1:1}),b.forEach(function(a){var b=e._changed[a];e._changed[a]=b?b|2:2}),this._changedTimeout||
(this._changedTimeout=setTimeout(function(){e._changedTimeout=null;var a=e._changed;e._changed={};Object.keys(a).forEach(function(b){var c=a[b];1==(c&1)&&e._onParentChanged(b);2==(c&2)&&e._onChildrenChanged(b)})},100))},_onChildFill:function(a){a.isBegin?this._isChildFilling=!0:(this._isChildFilling=!1,a=a.resetUI?this.refreshChildMap():this._mapChildren(a.newItems),this._notifyChildrenChanged(a))},_onChildEdit:function(a,b,e){b?this._storeChildFKey(a):e?this._saveChildFKey=null:this._checkChildFKey(a)},
_onChildCommitChanges:function(a,b,c,d){var g=e.CHANGE_TYPE;b?c&&d===g.ADDED?(a=this._unMapChildItem(a))&&this._notifyChildrenChanged([a]):!c&&d===g.DELETED?(a=this._unMapChildItem(a))&&this._notifyChildrenChanged([a]):this._storeChildFKey(a):this._checkChildFKey(a)},_storeChildFKey:function(a){var b=this.getChildFKey(a),e;if(b&&(e=this._childMap[b])&&-1<e.indexOf(a))this._saveChildFKey=b},_checkChildFKey:function(a){var b=this._saveChildFKey,e,c,d;this._saveChildFKey=null;e=this.getChildFKey(a);
e!==b&&(b&&(c=this._childMap[b],d=c.indexOf(a),-1<d&&c.splice(d,1),0==c.length&&delete this._childMap[b],this._notifyParentChanged([b]),this._notifyChildrenChanged([b])),e&&(this._mapChildren([a]),this._notifyParentChanged([e]),this._notifyChildrenChanged([e])))},_onChildStatusChanged:function(a,b){var c=e.CHANGE_TYPE.DELETED,d=a._changeType,g=this.getChildFKey(a);g&&d===c&&(g=this._unMapChildItem(a))&&this._notifyChildrenChanged([g])},_getItemKey:function(a,b,e){for(var c=[],d,g=0,f=a.length;g<f;g+=
1){d=e[a[g].fieldName];d=b._getStrValue(d,a[g]);if(null===d)return null;c.push(d)}return c.join(";")},_resetChildMap:function(){var a=Object.keys(this._childMap);this._childMap={};this._notifyChildrenChanged(a)},_resetParentMap:function(){var a=Object.keys(this._parentMap);this._parentMap={};this._notifyParentChanged(a)},_unMapChildItem:function(a){var b,e,c=null;if(b=this.getChildFKey(a))if(e=this._childMap[b])a=e.indexOf(a),-1<a&&(e.splice(a,1),0==e.length&&delete this._childMap[b],c=b);return c},
_unMapParentItem:function(a){var b=null;if((a=this.getParentFKey(a))&&this._parentMap[a])delete this._parentMap[a],b=a;return b},_mapParentItems:function(a){for(var b,c,d=e.CHANGE_TYPE.DELETED,g,f={},l=0,h=a.length;l<h;l+=1)if(b=a[l],c=b._changeType,c!==d&&(c=this.getParentFKey(b)))g=this._parentMap[c],g!==b&&(this._parentMap[c]=b,f[c]=null);return Object.keys(f)},_onChildrenChanged:function(a){a&&this._parentToChildrenName&&(a=this._parentMap[a])&&a.raisePropertyChanged(this._parentToChildrenName)},
_onParentChanged:function(a){var b=this;a&&this._childToParentName&&(a=this._childMap[a])&&a.forEach(function(a){a.raisePropertyChanged(b._childToParentName)})},_mapChildren:function(a){for(var b,c,d,g=e.CHANGE_TYPE.DELETED,f={},l=0,h=a.length;l<h;l+=1)if(b=a[l],c=b._changeType,c!==g&&(c=this.getChildFKey(b)))d=this._childMap[c],d||(d=[],this._childMap[c]=d),0>d.indexOf(b)&&(d.push(b),f[c]||(f[c]=null));return Object.keys(f)},_unbindParentDS:function(){var a=this.parentDS;a&&a.removeNSHandlers(this._objId)},
_unbindChildDS:function(){var a=this.childDS;a&&a.removeNSHandlers(this._objId)},getParentFKey:function(a){return a&&a._isNew?a._key:this._getItemKey(this._parentFldInfos,this._parentDS,a)},getChildFKey:function(a){if(a&&this._childToParentName){var b=a._getFieldVal(this._childToParentName);if(b)return b}return this._getItemKey(this._childFldInfos,this._childDS,a)},getChildItems:function(a){if(!a)return[];a=this.getParentFKey(a);a=this._childMap[a];return!a?[]:a},getParentItem:function(a){if(!a)return null;
a=this.getChildFKey(a);return(a=this._parentMap[a])?a:null},refreshParentMap:function(){this._resetParentMap();return this._mapParentItems(this._parentDS.items)},refreshChildMap:function(){this._resetChildMap();return this._mapChildren(this._childDS.items)},destroy:function(){this._isDestroying=!0;clearTimeout(this._changedTimeout);this._changedTimeout=null;this._changed={};this._unbindParentDS();this._unbindChildDS();this._childFldInfos=this._parentFldInfos=this._childMap=this._parentMap=null;this._super()}},
{app:{get:function(){return this._app}},name:{get:function(){return this._name}},parentToChildrenName:{get:function(){return this._parentToChildrenName}},childToParentName:{get:function(){return this._childToParentName}},parentDS:{get:function(){return this._parentDS}},childDS:{get:function(){return this._childDS}},parentFldInfos:{get:function(){return this._parentFldInfos}},childFldInfos:{get:function(){return this._childFldInfos}},onDeleteAction:{get:function(){return this._onDeleteAction}}},function(a){d.registerType("Association",
a)});k.extend({_create:function(a){this._refreshTimeout=this._parentItem=null;this._association=a.association;a.dataSource=this._association.childDS;var b=this,e=this._association,c=a.fn_filter;a.fn_filter=function(a){if(!b._parentItem)return!1;var d=e.getParentFKey(b._parentItem);if(!d)return!1;var g=e.getChildFKey(a);return!g||d!==g?!1:c?c(a):!0};this._super(a)},_refresh:function(){var a=this;this._dataSource&&(clearTimeout(a._refreshTimeout),a._refreshTimeout=setTimeout(function(){var b=a._association.getChildItems(a._parentItem);
a._fn_filter&&(b=b.filter(a._fn_filter));a._fn_sort&&(b=b.sort(a._fn_sort));a._fillItems({items:b,isPageChanged:!1,clear:!0,isAppend:!1});a._onViewRefreshed({})},250))},destroy:function(){clearTimeout(this._refreshTimeout);this._association=null;this._super()}},{parentItem:{set:function(a){this._parentItem!==a&&(this._parentItem=a,this.raisePropertyChanged("parentItem"),0<this.items.length&&(this.clear(),this._onViewRefreshed({})),this._refresh())},get:function(){return this._parentItem}},association:{get:function(){return this._association}}},
function(a){d.registerType("ChildDataView",a)})};
