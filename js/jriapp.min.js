...
(d||"\\s")+"]+","g"),"")},rtrim:function(a,d){return a.replace(RegExp("["+(d||"\\s")+"]+$","g"),"")},isArray:function(a){return!a?!1:Array.isArray(a)},format:function(){for(var f="",d=arguments,h=d[0],k=0;;){var n=h.indexOf("{",k),p=h.indexOf("}",k);if(0>n&&0>p){f+=h.slice(k);break}if(0<p&&(p<n||0>n)){if("}"!==h.charAt(p+1))throw Error(a.format(RIAPP.ERRS.ERR_STRING_FORMAT_INVALID,h));f+=h.slice(k,p+1);k=p+2}else if(f+=h.slice(k,n),k=n+1,"{"===h.charAt(k))f+="{",k++;else{if(0>p)throw Error(a.format(RIAPP.ERRS.ERR_STRING_FORMAT_INVALID,
h));var n=h.substring(k,p),g=n.indexOf(":"),k=parseInt(0>g?n:n.substring(0,g),10)+1;if(isNaN(k))throw Error(a.format(RIAPP.ERRS.ERR_STRING_FORMAT_INVALID,h));n=0>g?"":n.substring(g+1);k=d[k];if(void 0===k||null===k)k="";f=k.format?f+k.format(n):f+k.toString();k=p+1}}return f}};String.format||(String.format=function(){var f=Array.prototype.slice.call(arguments);return a.format.apply(a,f)});return a}();
RIAPP.BaseObject={_create:function(){this.__events=this._super=null;this._isDestroyCalled=this._isDestroyed=!1},create:function(){var a=Object.create(this);a._create.apply(a,arguments);Object.seal(a);return a},extend:function(a,f,d){var h=f||{},k,n=0,p,g,b=/\._super\s*\(/;Object.getOwnPropertyNames(h).forEach(function(b){b=h[b];void 0===b.enumerable&&(b.enumerable=!0);void 0===b.configurable&&(b.configurable=!1)});h._typeName=Object.getOwnPropertyDescriptor({_typeName:""},"_typeName");h.__eventNames=
Object.getOwnPropertyDescriptor({__eventNames:[]},"__eventNames");if(a){k=Object.getOwnPropertyNames(a);n=0;for(p=k.length;n<p;n+=1)f=k[n],h.hasOwnProperty(f)||(h[f]=Object.getOwnPropertyDescriptor(a,f))}g=Object.create(this,h);Object.getOwnPropertyNames(g).forEach(function(c){var e=Object.getOwnPropertyDescriptor(g,c),l,m,a;e.value&&RIAPP.utils.isFunc(e.value)&&(m=e.value.toString(),l=g[c],b.test(m)?(a=Object.getPrototypeOf(g),e.value="destroy"==c?function(){var b=this._super;this._super=a[c];try{return this._isDestroyCalled=
...
a));null===this.__events&&(this.__events={});var k=this.__events,n="*";d&&(n=""+d);k[a]||(k[a]=[]);a=k[a];a.some(function(a){return a.fn===f&&a.ns==n})||(h?a.unshift({fn:f,ns:n}):a.push({fn:f,ns:n}))}},_removeHandler:function(a,f){var d=this.__events,h="*";if(d){f&&(h=""+f);var k,n,p;if(a){if(d[a])if("*"==h)delete d[a];else{k=d[a];n=k.filter(function(g){return g.ns==h});for(p=k.length;0<p;)p-=1,-1<n.indexOf(k[p])&&k.splice(p,1);0==k.length&&delete d[a]}}else"*"!=h?Object.keys(d).forEach(function(g){var b=
d[g],c=b.filter(function(b){return b.ns==h});for(p=b.length;0<p;)p-=1,-1<c.indexOf(b[p])&&b.splice(p,1);0==b.length&&delete d[g]}):this.__events=null}},_raiseEvent:function(a,f){var d=this,h=d.__events;null!==h&&a&&("0*"!=a&&RIAPP.utils.startsWith(a,"0")&&this._raiseEvent("0*",f),h[a]&&Array.clone(h[a]).forEach(function(a){a.fn.apply(d,[d,f])}))},_onError:function(a,f){if(RIAPP.global&&RIAPP.global._checkIsDummy(a))return!0;a.message||(a=Error(""+a));var d={error:a,source:f,isHandled:!1};this._raiseEvent("error",
...
f.split("."),n;for(n=0;n<k.length-1;n+=1)a[k[n]]||(a[k[n]]={}),a=a[k[n]];k=k[k.length-1];if(h&&a[k])throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_OBJ_ALREADY_REGISTERED,f));a[k]=d;return a},_getObjectCore:function(a,f){var d=f.split("."),h=a,k;for(k=0;k<d.length;k+=1){if(!h[d[k]])return null;h=h[d[k]]}return h},_registerType:function(a,f,d){return this._registerObjectCore(a._exports,f,d,!0)},_getType:function(a,f){return this._getObjectCore(a._exports,f)},_processTemplateSections:function(a){var f=
this;Array.fromList(a.querySelectorAll(f._TEMPLATES_SELECTOR)).forEach(function(a){f._processTemplateSection(a,null);f.utils.removeNode(a)})},_processTemplateSection:function(a,f){var d=this;Array.fromList(a.querySelectorAll(d._TEMPLATE_SELECTOR)).forEach(function(a){var k=d.document.createElement("div"),n=a.getAttribute("id"),p=d.utils.createDeferred();a.removeAttribute("id");k.appendChild(a);p.resolve(k.innerHTML);f&&(n=f.appName+"."+n);d._registerTemplateLoader(n,{fn_loader:function(){return p.promise()}})})},
_loadTemplatesAsync:function(a,f){var d=this,h=a(),k=d.isLoading;d._promises.push(h);d.isLoading!==k&&d.raisePropertyChanged("isLoading");var n=d.utils.createDeferred();h.done(function(a){d.utils.removeFromArray(d._promises,h);try{var g=d.document.createElement("div");g.innerHTML=a;d._processTemplateSection(g,f);n.resolve()}catch(b){d._onError(b,d),n.reject()}d.isLoading||d.raisePropertyChanged("isLoading")});h.fail(function(a){d.utils.removeFromArray(d._promises,h);d.isLoading||d.raisePropertyChanged("isLoading");
n.reject();a&&a.message?d._onError(a,d):a&&a.responseText?d._onError(Error(a.responseText),d):d._onError(Error("Failed to load templates"),d)});return n.promise()},_registerTemplateLoaderCore:function(a,f){return this._registerObjectCore(this._templateLoaders,a,f,!1)},_getTemplateLoaderCore:function(a){return this._getObjectCore(this._templateLoaders,a)},_registerTemplateLoader:function(a,f){f=this.utils.extend(!1,{fn_loader:null,groupName:null},f);if(!f.groupName&&!this.utils.check_is.Function(f.fn_loader))throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_ASSERTION_FAILED,
...
d.groupName));return function(){h.promise||(h.promise=f._loadTemplatesAsync(h.fn_loader,h.app));var d=f.utils.createDeferred();h.promise.done(function(){try{h.promise=null;h.names.forEach(function(g){h.app&&(g=h.app.appName+"."+g);var b=f._getTemplateLoaderCore(g);if(!b||!b.fn_loader)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_TEMPLATE_NOTREGISTERED,g));});var n=f._getTemplateLoaderCore(a);if(!n||!n.fn_loader)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_TEMPLATE_NOTREGISTERED,a));delete f._templateGroups[n.groupName];
n.fn_loader().done(function(g){d.resolve(g)}).fail(function(g){d.reject(g)})}catch(p){d.reject(p)}});h.promise.fail(function(a){h.promise=null;d.reject(a)});return d.promise()}}return d.fn_loader},_registerTemplateGroup:function(a,f){var d=this;f=d.utils.extend(!1,{fn_loader:null,url:null,names:null,app:null,promise:null},f);f.url&&!f.fn_loader&&(f.fn_loader=function(){return d.utils.performAjaxGet(f.url)});var h=this._registerObjectCore(d._templateGroups,a,f,!0);f.names.forEach(function(k){f.app&&
...
RIAPP.Global._coreModules.array_ext=function(a){Array.prototype.distinct=function(){var a={},d,h=this.length,k=[];for(d=0;d<h;d+=1)a[this[d]]=this[d];var n=Object.keys(a);d=0;for(h=n.length;d<h;d+=1)k.push(a[n[d]]);return k};Array.prototype.intersect=function(a){return this.filter(function(d){return-1<a.indexOf(d)})};Array.fromList=function(a){for(var d=Array(a.length),h=0,k=a.length;h<k;h++)d[h]=a[h];return d}};
...
c,e,a){b=(b+"").replace(/[^0-9+-Ee.]/g,"");var m=!isFinite(+b)?0:+b;b=!isFinite(+c)?0:Math.abs(c);a=void 0===a?",":a;e=void 0===e?".":e;var g="",g=function(b,c){var m=Math.pow(10,c);return""+Math.round(b*m)/m};p.check_is.nt(c)?(g=(""+m).split("."),b=2):g=(b?g(m,b):""+Math.round(m)).split(".");var m="",d=g[0].length;if(3<d){for(c=0;c<d;c+=1)m+=g[0].charAt(c),c<d-1&&0===(d-c-1)%3&&(m+=a);g[0]=m}if((g[1]||"").length<b)g[1]=g[1]||"",g[1]+=Array(b-g[1].length+1).join("0");return g.join(e)},stripNonNumeric:function(b){b+=
"";for(var c=/^\d|\.|-$/,e="",a=0;a<b.length;a++)c.test(b.charAt(a))&&("."==b.charAt(a)&&-1!=e.indexOf(".")||"-"==b.charAt(a)&&0!=e.length||(e+=b.charAt(a)));return e}},check_is:k,validation:n,getNewID:function(){var b=h;h+=1;return b},isContained:function(b,c){if(!b)return!1;for(;b=b.parentNode;)if(b===c)return!0;return!1},slice:Array.prototype.slice,get_timeZoneOffset:function(){var b=(new Date).getTimezoneOffset();return function(){return b}}(),parseBool:function(b){var c=d.trim(b).toLowerCase();
if("false"===c)return!1;if("true"===c)return!0;throw Error(p.format(RIAPP.ERRS.ERR_PARAM_INVALID,"bool_value",b));},round:function(b,c){return parseFloat(b.toFixed(c))},performAjaxCall:function(b,c,e,g,m,t){var d=new XMLHttpRequest;d.open("POST",b,e);var f=p.createDeferred();d.responseType="text";d.onload=function(b){200==this.status&&f.resolve(this.response)};d.onerror=function(b){f.reject(Error(b.target.status))};d.ontimeout=function(){f.reject(Error("The request for "+b+" timed out."))};d.timeout=
1E3*a.defaults.ajaxTimeOut;d.setRequestHeader("Content-Type","application/json; charset=utf-8");d.send(c);c=f.promise();g&&c.done(function(b){g.call(t,b)});m&&c.fail(function(b){m.call(t,b)});return c},performAjaxGet:function(b){var c=new XMLHttpRequest;c.open("GET",b,!0);var e=p.createDeferred();c.responseType="text";c.onload=function(b){200==this.status&&e.resolve(this.response)};c.onerror=function(b){e.reject(Error(b.target.status))};c.ontimeout=function(){e.reject(Error("The request for "+b+" timed out."))};
...
style:{classes:e?e:null},position:{my:"top left",at:"bottom right",target:b,viewport:$(a.window),adjust:{method:"flip none",x:0,y:0}},hide:{fixed:!0,delay:250}};b.data("qtip")?c?b.qtip("option","content.text",c):b.qtip("destroy"):c&&b.qtip(e)},hasProp:function(b,c){if(!b)return!1;if(b.hasOwnProperty(c))return!0;if(Object===b)return!1;var e=Object.getPrototypeOf(b);return p.hasProp(e,c)},createDeferred:function(){return a.$.Deferred()},cloneObj:function(b,c){var e,a,m;if(!b)return b;if(k.Array(b)){m=
b.length;e=Array(m);for(a=0;a<m;a+=1)e[a]=p.cloneObj(b[a],null)}else if(k.SimpleObject(b)){e=c||{};var g,d=Object.getOwnPropertyNames(b);m=d.length;for(a=0;a<m;a+=1)g=d[a],e[g]=p.cloneObj(b[g],null)}else return b;return e},shallowCopy:function(b){return p.mergeObj(b,{})},mergeObj:function(b,c){c||(c={});if(!b)return c;for(var e=Object.getOwnPropertyNames(b),a,m=0,g=e.length;m<g;m+=1)a=e[m],c[a]=b[a];return c},removeFromArray:function(b,c){var e=b.indexOf(c);-1<e&&b.splice(e,1);return e},insertIntoArray:function(b,
c,e){b.splice(e,0,c)},destroyJQueryPlugin:function(b,c){if(b.data(c))b[c]("destroy")},uuid:function(){var b="0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz".split("");return function(c,e){var a,m=[],g=Math.random;e=e||b.length;if(c)for(a=0;a<c;a+=1)m[a]=b[0|g()*e];else{var d;m[8]=m[13]=m[18]=m[23]="-";m[14]="4";for(a=0;36>a;a+=1)m[a]||(d=0|16*g(),m[a]=b[19==a?d&3|8:d&15])}return m.join("")}}()},g=RIAPP.BaseObject.extend({_cnt:0,_create:function(){this._super();this._objs=[];g._cnt+=
...
{uniqueID:{get:function(){return this._objId}}},function(b){a.registerType("PropWatcher",b)});f.WaitQueue=RIAPP.BaseObject.extend({_create:function(b){this._super();this._objId="wq"+p.getNewID();this._owner=b;this._queue={}},_checkQueue:function(b,c){if(this._owner&&!this._owner._isDestroyCalled){var e=this,a=this._queue[b],m;if(a&&0!=a.length){var g,d,f=null,k=[],p=[],n=[];for(g=0;g<a.length;g+=1)if(m=a[g],m.predicate(c))if(!m.group&&0==k.length){d=m;break}else m.group&&(f||(f=m.group),f===m.group&&
k.push(m));if(d)p.push(d),n.push(d);else for(;0<k.length;)m=k.pop(),d||(d=m),d.lastWins?0==p.length&&p.push(m):p.push(m),n.push(m);try{if(0<p.length){for(g=a.length;0<g;)g-=1,-1<n.indexOf(a[g])&&a.splice(g,1);p.forEach(function(b){try{b.action.apply(e._owner,b.args)}catch(c){e._owner._onError(c,e)}})}}finally{0==a.length&&(delete this._queue[b],this._owner.removeOnPropertyChange(b,this.uniqueID))}}}},enQueue:function(b){b=p.extend(!1,{prop:"",groupName:null,predicate:null,action:null,actionArgs:[],
...
RIAPP.Global._coreModules.riapp=function(a){var f=this,d=a.utils,h=a.consts,k={},n={},p=RIAPP.BaseObject.extend({_DATA_BIND_SELECTOR:["*[",h.DATA_ATTR.DATA_BIND,"]"].join(""),_TEMPLATES_DATA_BIND_SELECTOR:["section.",RIAPP.css_riaTemplate," *[",h.DATA_ATTR.DATA_BIND,"]"].join(""),registerModule:function(a,b){if(n[a])throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_MODULE_ALREDY_REGISTERED,a));n[a]=b},_create:function(g){this._super();g=d.extend(!1,{app_name:"default",service_url:"",metadata:null,createDbContext:!0,
...
a)},_getBindingOption:function(a,b,c){var e={mode:this.modules.binding.BINDING_MODE[1],converterParam:null,converter:null,targetPath:null,sourcePath:null,target:null,source:null,isSourceFixed:!1},l=a.source,m=a.target;!a.sourcePath&&a.to?e.sourcePath=a.to:a.sourcePath&&(e.sourcePath=a.sourcePath);a.targetPath&&(e.targetPath=a.targetPath);a.converterParam&&(e.converterParam=a.converterParam);a.mode&&(e.mode=a.mode);a.converter&&(d.check_is.String(a.converter)?e.converter=this.getConverter(a.converter):
e.converter=a.converter);m?d.check_is.String(m)?e.target="this"==m?b:this.parser.resolveBindingSource(this,this.parser._getPathParts(m)):e.target=m:e.target=b;l?(e.isSourceFixed=!0,d.check_is.String(l)?e.source="this"==l?b:this.parser.resolveBindingSource(this,this.parser._getPathParts(l)):e.source=l):e.source=c;return e},_getElViewType:function(a){return this._elViews[a]},_getElView:function(a){return(a=a.getAttribute(this._ELV_STORE_KEY))?this._elViewStore[a]:null},_setElView:function(a,b){var c=
...
c.thousandSep;switch(g){case 1:return h.formatNumber(a,0,b,e);case 2:return g=c.decPrecision,h.formatNumber(a,g,b,e);case 4:return h.formatNumber(a,0,b,"");case 3:return h.formatNumber(a,null,b,e);default:return h.formatNumber(a,null,b,e)}},toString:function(){return"NumberConverter"}},null,function(d){a.registerConverter("numberConverter",d)});k.extend({convertToSource:function(a,g,b){return n.convertToSource(a,1,b)},convertToTarget:function(a,g,b){return n.convertToTarget(a,1,b)},toString:function(){return"IntegerConverter"}},
null,function(d){a.registerConverter("integerConverter",d)});k.extend({convertToSource:function(a,g,b){return n.convertToSource(a,4,b)},convertToTarget:function(a,g,b){return n.convertToTarget(a,4,b)},toString:function(){return"SmallIntConverter"}},null,function(d){a.registerConverter("smallIntConverter",d)});k.extend({convertToSource:function(a,g,b){return n.convertToSource(a,2,b)},convertToTarget:function(a,g,b){return n.convertToTarget(a,2,b)},toString:function(){return"DecimalConverter"}},null,
function(d){a.registerConverter("decimalConverter",d)});k.extend({convertToSource:function(a,g,b){return n.convertToSource(a,3,b)},convertToTarget:function(a,g,b){return n.convertToTarget(a,3,b)},toString:function(){return"FloatConverter"}},null,function(d){a.registerConverter("floatConverter",d)})};
...
b+"]")):f.push(a)});return f},_resolveProp:function(f,n){var h;return!n?f:d.startsWith(n,"[")?(h=a.modules.collection,n=this.trimQuotes(this.trimBrackets(n)),h.Dictionary.isPrototypeOf(f)?f.getItemByKey(n):h.Collection.isPrototypeOf(f)?f.getItemByPos(parseInt(n,10)):RIAPP.utils.isArray(f)?f[parseInt(n,10)]:f[n]):f[n]},_resolvePath:function(a,d){return!a?void 0:0===d.length?a:1===d.length?this._resolveProp(a,d[0]):this._resolvePath(this._resolveProp(a,d[0]),d.slice(1))},_setPropertyValue:function(a,
d,f){RIAPP.utils.startsWith(d,"[")?(d=this.trimQuotes(this.trimBrackets(d)),RIAPP.utils.isArray(a)?a[parseInt(d,10)]=f:a[d]=f):a[d]=f},_getKeyVals:function(a){var n,h,g,b=[],c={key:"",val:""},e=!0,l=this.__valueDelimeter1,m=this.__valueDelimeter2,t=this.__keyValDelimeter,u=function(a){a.val&&(f.check_is.Numeric(a.val)?a.val=Number(a.val):f.check_is.BoolString(a.val)&&(a.val=f.parseBool(a.val)));b.push(a)};for(n=0;n<a.length;n+=1){h=a.charAt(n);if("'"===h||'"'===h)g?g===h&&(g=null):g=h;!g&&"{"===h&&
!e?(h=a.substr(n),h=this.getBraceParts(h,!0)[0],c.val+=h,n+=h.length-1):!g&&h===t?c.key&&(u(c),c={key:"",val:""},e=!0):!g&&(h===l||h===m)?e=!1:e?c.key+=h:c.val+=h}c.key&&u(c);b.forEach(function(b){b.key=d.trim(b.key);f.check_is.String(b.val)&&(b.val=d.trim(b.val));""===b.val&&d.startsWith(b.key,"this.")&&(b.val=b.key.substr(5),b.key="targetPath")});return b=b.filter(function(b){return""!==b.val})},resolveBindingSource:function(a,d){if(a){if(0===d.length)return a;if(0<d.length)return this.resolveBindingSource(this._resolveProp(a,
...
""))},trimBrackets:function(a){return d.trim(a.replace(this.__trimBracketsRX,""))},isWithOuterBraces:function(a){return d.startsWith(a,"{")&&d.endsWith(a,"}")},parseOption:function(a){var n={},h=this;a=d.trim(a);h.isWithOuterBraces(a)&&(a=h.trimOuterBraces(a));h._getKeyVals(a).forEach(function(a){var b=f.check_is.String(a.val);b&&h.isWithOuterBraces(a.val)?n[a.key]=h.parseOption(a.val):n[a.key]=b?h.trimQuotes(a.val):a.val});return n},parseOptions:function(a){var f=[],h=this;a=d.trim(a);var g=[a];
...
a.removeClass(p.fieldError)},_updateErrorUI:function(b,a){if(b){var e=this.$el;a&&0<a.length?(h.addToolTip(e,this._getErrorTipInfo(a),p.errorTip),this._setFieldError(!0)):(this._setToolTip(e,this.toolTip),this._setFieldError(!1))}},_onError:function(b,a){var e=this._super(b,a);return!e?this._app._onError(b,a):e},_setToolTip:function(b,a,e){h.addToolTip(b,a,e)},toString:function(){return"BaseElView"}},{app:{get:function(){return this._app}},$el:{get:function(){this._el&&!this._$el&&(this._$el=d.$(this._el));
...
b;a.registerType("TemplateElView",b);a.registerElView("template",b)});g.extend({_init:function(b){this._super(b);var a;a=b.img?b.img:k.LOADER_GIF.NORMAL;this._delay=400;this._timeOut=null;h.check_is.nt(b.delay)||(this._delay=parseInt(b.delay));this._loaderPath=d.getImagePath(a);this._$loader=d.$(new Image);this._$loader.css({position:"absolute",display:"none",zIndex:"10000"});this._$loader.prop("src",this._loaderPath);this._$loader.appendTo(this.el);this._isBusy=!1},destroy:function(){this._isDestroyed||
(this._timeOut&&(clearTimeout(this._timeOut),this._timeOut=null),this._$loader.remove(),this._$loader=null,this._super())},toString:function(){return"BusyElView"}},{isBusy:{set:function(b){var a=this,e=function(){a._timeOut=null;a._$loader.show();a._$loader.position({of:d.$(a.el)})};b!==a._isBusy&&(a._isBusy=b,a._isBusy?(a._timeOut&&(clearTimeout(a._timeOut),a._timeOut=null),0<a._delay?a._timeOut=setTimeout(e,a._delay):e()):a._timeOut?(clearTimeout(a._timeOut),a._timeOut=null):a._$loader.hide(),a.raisePropertyChanged("isBusy"))},
get:function(){return this._isBusy}},delay:{set:function(a){a!==this._delay&&(this._delay=a,this.raisePropertyChanged("delay"))},get:function(){return this._delay}}},function(b){f.BusyElView=b;a.registerType("BusyElView",b);a.registerElView("busy_indicator",b)});g.extend({_init:function(a){this._super(a);this._template=this._dataContext=null},_templateChanged:function(){this.raisePropertyChanged("templateID");this._template&&this.$el.empty().append(this._template.el)},updateTemplate:function(a){var c=
this;try{if(!a&&this._template){this._template.destroy();this._template=null;c._templateChanged();return}}catch(e){this._onError(e,this),d._throwDummy(e)}try{this._template?this._template.templateID=a:(this._template=this._app.getType("Template").create(a),this._template.dataContext=this._dataContext,this._template.addOnPropertyChange("templateID",function(a,b){c._templateChanged()},this._objId),c._templateChanged())}catch(l){this._onError(l,this),d._throwDummy(l)}},destroy:function(){this._template&&
...
RIAPP.Application._coreModules.binding=function(a){var f=this,d=a.global,h=d.utils,k=d.modules.errors,n=a.modules.baseElView.BaseElView,p=["OneTime","OneWay","TwoWay"];f.BINDING_MODE=p;f.ValidationError=k.BaseError.extend({_create:function(a,b){var c=RIAPP.ERRS.ERR_VALIDATION+"\r\n",e=0;a.forEach(function(a){0<e&&(c+="\r\n");c=a.fieldName?c+" "+RIAPP.localizable.TEXT.txtField+": "+a.fieldName+" -> "+a.errors.join(", "):c+a.errors.join(", ");e+=1});this._super(c);this._errors=a;this._item=b}},{item:{get:function(){return this._item}},
...
b):c},_getTgtChangedFn:function(a,b,c,e,d){return function(m,t){var f=a._app.parser._resolveProp(b,c);0<e.length&&a._checkBounded(null,"target",d,e);a._parseTgtPath(f,e,d)}},_getSrcChangedFn:function(a,b,c,e,d){return function(m,t){var f=a._app.parser._resolveProp(b,c);0<e.length&&a._checkBounded(null,"source",d,e);a._parseSrcPath(f,e,d)}},_parseSrcPath:function(a,b,c){this._sourceObj=null;0===b.length?this._sourceObj=a:this._parseSrcPath2(a,b,c);this._targetObj&&this._updateTarget()},_parseSrcPath2:function(a,
...
RIAPP.Application._coreModules.template=function(a){var f=a.global,d=f.utils,h=f.consts,k=a.modules.binding.Binding,n=a.modules.baseElView,p=n.BaseElView,g=n.BusyElView,b=n.TemplateElView,c=this.css={templateContainer:"ria-template-container"};Object.freeze(c);this.Template=RIAPP.BaseObject.extend({_app:a,_create:function(a){this._super();this._el=this._dctxt=null;this._isDisabled=!1;this._lfTime=null;this._templateID=a;this._templElView=void 0;this._busyTimeOut=this._promise=null;this._templateID&&
this._loadTemplate()},_getBindings:function(){if(!this._lfTime)return[];for(var a=this._lfTime.getObjs(),b=[],m=0,c=a.length;m<c;m+=1)k.isPrototypeOf(a[m])&&b.push(a[m]);return b},_getElViews:function(){if(!this._lfTime)return[];for(var a=this._lfTime.getObjs(),b=[],m=0,c=a.length;m<c;m+=1)p.isPrototypeOf(a[m])&&b.push(a[m]);return b},_getTemplateElView:function(){if(!this._lfTime||null===this._templElView)return null;if(this._templElView)return this._templElView;for(var a=null,c=this._getElViews(),
m=0,d=c.length;m<d;m+=1)if(b.isPrototypeOf(c[m])){a=c[m];break}return this._templElView=a},_loadTemplateElAsync:function(a){if(a=this._app.getTemplateLoader(a))return a().then(function(a){var b=f.document.createElement("div");b.innerHTML=a;return b.firstElementChild});a=d.createDeferred();a.reject(Error(String.format(RIAPP.ERRS.ERR_TEMPLATE_ID_INVALID,this._templateID)));return a.promise()},_appendIsBusy:function(a){var b=this;this._busyTimeOut=setTimeout(function(){b._busyTimeOut&&!b._isDestroyCalled&&
(b._busyTimeOut=null,g.create(a,{img:h.LOADER_GIF.SMALL,delay:0}).isBusy=!0)},400)},_removeIsBusy:function(a){this._busyTimeOut&&(clearTimeout(this._busyTimeOut),this._busyTimeOut=null);(a=this._app._getElView(a))&&g.isPrototypeOf(a)&&a.destroy()},_loadTemplate:function(){var a=this,b=a._templateID,m,t,g=!1;a._promise&&(a._promise.reject("cancel"),a._promise=null);a._unloadTemplate();b&&(b=a._loadTemplateElAsync(b),g="pending"==b.state(),a._promise=m=d.createDeferred(),b.done(function(a){"pending"==
m.state()&&m.resolve(a)}),b.fail(function(a){"pending"==m.state()&&m.reject(a)}),a._el=t=f.document.createElement("div"),t.className=c.templateContainer,g&&(a._appendIsBusy(t),m.done(function(){a._removeIsBusy(t)}),m.fail(function(b){"cancel"==b&&a._removeIsBusy(t)})),m.then(function(b){a._isDestroyCalled||(a._promise=null,b?(a._el.appendChild(b),a._lfTime=a._app._bindTemplateElements(b),(b=a._getTemplateElView())&&b.templateLoaded(a),a._updateBindingSource()):a._unloadTemplate())},function(b){if(!a._isDestroyCalled&&
(a._promise=null,"cancel"!=b)){var m;b&&(b.message?m=b:b.statusText?m=Error(b.statusText):d.check_is.String(b)&&(m=Error(b)));m||(m=Error(String.format(RIAPP.ERRS.ERR_TEMPLATE_ID_INVALID,a._templateID)));a._app._onError(m,a)}}))},_updateBindingSource:function(){var a,b,m,c=this._getBindings();a=0;for(b=c.length;a<b;a+=1)m=c[a],m.isDisabled=this._isDisabled,m.isSourceFixed||(m.source=this._dctxt)},_updateIsDisabled:function(){var a,b,m,c=this._getBindings(),d=this._getElViews(),f=this._app._getElViewType(h.ELVIEW_NM.DATAFORM);
a=0;for(b=c.length;a<b;a+=1)m=c[a],m.isDisabled=this._isDisabled;a=0;for(b=d.length;a<b;a+=1)m=d[a],f.isPrototypeOf(m)&&m.form&&(m.form.isDisabled=this._isDisabled)},_unloadTemplate:function(){try{if(this._el){var a=this._templElView;this._templElView=void 0;a&&a.templateUnloading(this)}}finally{this._lfTime&&(this._lfTime.destroy(),this._lfTime=null),this._el&&f.$(this._el).remove(),this._el=null}},destroy:function(){this._isDestroyed||(this._busyTimeOut&&(clearTimeout(this._busyTimeOut),this._busyTimeOut=
null),this._promise&&(this._promise.reject("cancel"),this._promise=null),this._dctxt=null,this._unloadTemplate(),this._templateID=null,this._templElView=void 0,this._super())},findElByDataName:function(a){return f.$(this._el).find(["*[",h.DATA_ATTR.DATA_NAME,'="',a,'"]'].join("")).toArray()},findElViewsByDataName:function(a){var b=this,m=[];this.findElByDataName(a).forEach(function(a){(a=b._app._getElView(a))&&m.push(a)});return m},toString:function(){return"Template"}},{dataContext:{set:function(a){this._dctxt!==
a&&(this._dctxt=a,this.raisePropertyChanged("dataContext"),this._updateBindingSource())},get:function(){return this._dctxt}},templateID:{set:function(a){this._templateID!==a&&(this._templateID=a,this._loadTemplate(),this.raisePropertyChanged("templateID"))},get:function(){return this._templateID}},el:{get:function(){return this._el}},isDisabled:{set:function(a){this._isDisabled!==a&&(this._isDisabled=!!a,this._updateIsDisabled(),this.raisePropertyChanged("isDisabled"))},get:function(){return this._isDisabled}}},
...
RIAPP.Application._coreModules.collection=function(a){var f=this,d=a.global,h=d.utils,k,n,p,g=d.consts.DATA_TYPE,b={REMOVE:"0",ADDED:"1",RESET:"2",REMAP_KEY:"3"},c={};c.DATA_TYPE=g;c.SORT_ORDER={ASC:0,DESC:1};c.COLL_CHANGE_TYPE=b;c.DATE_CONVERSION={None:0,ServerLocalToClientLocal:1,UtcToClientLocal:2};f.consts=c;Object.freeze(c);var e=a.modules.binding.ValidationError,l={valueToDate:function(a,b,e){if(!a)return null;a=""+a;var d=a.split("&");if(7!=d.length)throw Error(base_utils.format(RIAPP.ERRS.ERR_PARAM_INVALID,
...
isRowTimeStamp:!1,dataType:g.NONE,isNullable:!0,maxLength:-1,isReadOnly:!1,isAutoGenerated:!1,allowClientDefault:!1,dateConversion:c.DATE_CONVERSION.NONE,isClientOnly:!0,isCalculated:!1,isNeedOriginal:!1,dependentOn:null,range:null,regex:null,isNavigation:!1,fieldName:a}};p=n.extend({_create:function(a){this._super();this.__isNew=!a;a&&(this._vals=a);a||this._collection.getFieldNames().forEach(function(a){this._vals[a]=null},this)},_setProp:function(a,b){var c,d=this._collection;if(this._vals[a]!==
...
_setFieldVal:function(a,b){var c,e=this._dbSetName,d=this._collection,q=RIAPP.ERRS,l=this._vals[a],f=b,m=this.getFieldInfo(a);if(!m)throw Error(String.format(q.ERR_DBSET_INVALID_FIELDNAME,e,a));!this._isEditing&&!this._isUpdating&&this.beginEdit();try{if(f=this._checkVal(m,f),l!=f&&this._fldChanging(m,l,f)&&(this._vals[a]=f,this._fldChanged(m,l,f)),d._removeError(this,a),c=this._validateField(a))throw u.create([c],this);}catch(g){throw c=u.isPrototypeOf(g)?g:u.create([{fieldName:a,errors:[g.message]}],
...
this.dbContext.getDbSet(b.parentDbSetName),a=c.slice(1).join("."),b.getFieldInfo(a);throw Error(String.format(RIAPP.ERRS.ERR_DBSET_INVALID_FIELDNAME,this.dbSetName,a));},_onError:function(a,b){return this.dbContext._onError(a,b)},_mapAssocFields:function(){for(var a=this._trackAssoc,b,c=Object.keys(a),e,d=this._trackAssocMap,q=0,l=c.length;q<l;q+=1){b=a[c[q]];for(var f=0,m=b.fieldRels.length;f<m;f+=1)e=b.fieldRels[f],d[e.childField]?d[e.childField].push(b.childToParentName):d[e.childField]=[b.childToParentName]}},
...
b));if(a.fieldName===b)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_CALC_FIELD_SELF_DEPEND,b));0>c.dependents.indexOf(a.fieldName)&&c.dependents.push(a.fieldName)})},f=function(a){var b=d._fieldMap[a.fieldName],r=!0,l=c.filter(function(b){return b.childToParentName==a.fieldName});0===l.length&&(l=e.filter(function(b){return b.parentToChildrenName==a.fieldName}),r=!1);if(1!=l.length)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_PARAM_INVALID_TYPE,"assocs","Array"));b.isClientOnly=!0;b.isReadOnly=
!0;var f=function(){throw Error("getFunc is not emplemented!");},m,A=l[0].name;r?(b.isReadOnly=!1,d._childAssocMap[l[0].childToParentName]=l[0],l[0].fieldRels.forEach(function(a){a=d._fieldMap[a.childField];!b.isReadOnly&&a.isReadOnly&&(b.isReadOnly=!0)}),f=function(){return d.dbContext.getAssociation(A).getParentItem(this)},b.isReadOnly||(d._trackAssoc[A]=l[0],m=function(b){var c,e,r=d.dbContext.getAssociation(A);if(b&&!r.parentDS.entityType.isPrototypeOf(b))throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_PARAM_INVALID_TYPE,
"value",r.parentDS.entityType._typeName));if(b&&b._isNew)this._setFieldVal(a.fieldName,b._key);else if(b){c=0;for(e=r.childFldInfos.length;c<e;c+=1)this[r.childFldInfos[c].fieldName]=b[r.parentFldInfos[c].fieldName]}else{this._getFieldVal(a.fieldName)&&this._setFieldVal(a.fieldName,null);c=0;for(e=r.childFldInfos.length;c<e;c+=1)this[r.childFldInfos[c].fieldName]=null}})):(d._parentAssocMap[l[0].parentToChildrenName]=l[0],f=function(){return d.dbContext.getAssociation(A).getChildItems(this)});q[a.fieldName]=
{set:m,get:f}},m=function(a){q[a.fieldName]={set:function(b){this._setFieldVal(a.fieldName,b)},get:function(){return this._getFieldVal(a.fieldName)}}};b.forEach(function(b){if(k.hasProp(n,b.fieldName))throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_ITEM_NAME_COLLISION,a,b.fieldName));if(b.isCalculated){var c=d.getFieldInfo(b.fieldName);c.isClientOnly=!0;c.isReadOnly=!0;c={dbSetName:a,fieldName:b.fieldName,getFunc:null};d.dbContext._onGetCalcField(c);k.check_is.Function(c.getFunc)&&(b.dependentOn&&l(b),
q[b.fieldName]={get:c.getFunc})}else b.isNavigation?f(b):m(b)});q._dbSet={get:function(){return this.__dbSet}};this._entityType=n.extend({__dbSet:d},q,function(b){b._typeName=a+"Entity"});this._mapAssocFields()},_fillFromService:function(a){a=k.extend(!1,{res:{names:[],rows:[],pageIndex:null,pageCount:null,dbSetName:this.dbSetName,totalCount:null},isPageChanged:!1,fn_beforeFillEnd:null},a);var b=this,c=a.res,e=c.names,d=c.rows||[],q=this._entityType,f=[],m=[],g=[],h=[],t=this.isPagingEnabled,n=this.query,
v=!0,p;this._onFillStart({isBegin:!0,rowCount:d.length,time:new Date,isPageChanged:a.isPageChanged});try{n&&(v=n.isClearPrevData,n.isClearCacheOnEveryLoad&&n._clearCache(),v&&this.clear(),n._reindexCache(),1<n.loadPageCount&&t&&(p=n._getCache(),n.isIncludeTotalCount&&!k.check_is.nt(c.totalCount)&&(p.totalCount=c.totalCount)));g=d.map(function(a){var c=a.key;if(!c)throw Error(RIAPP.ERRS.ERR_KEY_IS_EMPTY);var r=b._itemsByKey[c];r?a.values.forEach(function(a,b){r._refreshValue(a,e[b],1)}):(p&&(r=p.getItemByKey(c)),
r?a.values.forEach(function(a,b){r._refreshValue(a,e[b],1)}):r=q.create(a,e));return r});if(n&&(n.isIncludeTotalCount&&!k.check_is.nt(c.totalCount)&&(this.totalCount=c.totalCount),1<n.loadPageCount&&t)){p.fillCache(c.pageIndex,g);var u=p.getCachedPage(n.pageIndex),g=u?u.items:[]}g.forEach(function(a){var b=this._itemsByKey[a._key];b?h.push(b):(this._items.push(a),this._itemsByKey[a._key]=a,f.push(a),m.push(this._items.length-1),h.push(a))},this);0<f.length&&(this._onItemsChanged({change_type:l.ADDED,
items:f,pos:m}),this.raisePropertyChanged("count"));a.fn_beforeFillEnd&&a.fn_beforeFillEnd()}finally{this._onFillEnd({isBegin:!1,rowCount:h.length,time:new Date,resetUI:v,fetchedItems:h,newItems:f,isPageChanged:a.isPageChanged})}this.moveFirst();return{fetchedItems:h,newItems:f,isPageChanged:a.isPageChanged}},_fillFromCache:function(a){a=k.extend(!1,{isPageChanged:!1,fn_beforeFillEnd:null},a);var b=this,c=[],e=[],d=this.query;if(!d)throw Error(String.format(RIAPP.ERRS.ERR_ASSERTION_FAILED,"query is not null"));
...
l,f=a.parameters,q=f.length,m,g,h;c||(c={});for(l=0;l<q;l+=1){m=f[l];g=c[m.name];if(!m.isNullable&&!m.isArray&&m.dataType!==b.String&&k.check_is.nt(g))throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_SVC_METH_PARAM_INVALID,m.name,g,a.methodName));if(k.check_is.Function(g))throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_SVC_METH_PARAM_INVALID,m.name,g,a.methodName));m.isArray&&(!k.check_is.nt(g)&&!k.check_is.Array(g))&&(g=[g]);h=null;k.check_is.Array(g)?(h=[],g.forEach(function(a){h.push(e.stringifyValue(a,
m.dateConversion,self._serverTimezone))}),h=JSON.stringify(h)):h=e.stringifyValue(g,m.dateConversion,self._serverTimezone);d.paramInfo.parameters.push({name:m.name,value:h})}return d},_invokeMethod:function(a,b,c){var e=this,l,q;this.isBusy=!0;var m=function(a){try{if(!a)throw Error(k.format(RIAPP.ERRS.ERR_UNEXPECTED_SVC_ERROR,"operation result is undefined"));f.checkError(a.error,"invoke");c({result:a.result,error:null})}catch(b){d._checkIsDummy(b)||(e._onDataOperError(b,"invoke"),c({result:null,
error:b}))}};try{l=JSON.stringify(b),q=this._getUrl("InvokeMethod"),k.performAjaxCall(q,l,!0,function(a){m(JSON.parse(a));e.isBusy=!1},function(a){m({result:null,error:a});e.isBusy=!1},null)}catch(g){d._checkIsDummy(g)&&d._throwDummy(g),this.isBusy=!1,this._onDataOperError(g,"invoke"),c({result:null,error:g}),d._throwDummy(g)}},_getEventNames:function(){var a=this._super();return["submit_error","define_calc"].concat(a)},_loadFromCache:function(a,b){var c=a._dbSet,e;try{e=c._fillFromCache({isPageChanged:b,
...
e=this._getUrl("RefreshItem"),d=a._dbSet;this.waitForNotSubmiting(function(){var b=this;d.waitForNotLoading(function(){var l,f=function(){b.isBusy=!1;d.isLoading=!1;a._isRefreshing=!1},m=function(a){f();b._onDataOperError(a,"refresh")};a._isRefreshing=!0;b.isBusy=!0;d.isLoading=!0;try{var g={dbSetName:a._dbSetName,rowInfo:a._getRowInfo(),error:null};a._checkCanRefresh();l=JSON.stringify(g);k.performAjaxCall(e,l,!0,function(e){try{var d=JSON.parse(e);b._onItemRefreshed(d,a);f();c(!0)}catch(l){m(l),
c(!1)}},function(a){f();b._onDataOperError(a,"refresh");c(!1)},null)}catch(y){m(y),c(!1)}},[],!0,null)},[],null);return b.promise()},_onError:function(a,b){var c=this._super(a,b);return!c?this.app?this.app._onError(a,b):d._onError(a,b):c},_onDataOperError:function(a,b){if(d._checkIsDummy(a))return!0;var c;c=t.isPrototypeOf(a)?a:t.create(a,b);return this._onError(c,this)},_onSubmitError:function(a){var b={error:a,isHandled:!1};this.raiseEvent("submit_error",b);b.isHandled||(this.rejectChanges(),this._onDataOperError(a,
...
f=a.isPagingEnabled,m=a.dbSetName,g=this.getDbSet(m);this.waitForNotSubmiting(function(){g.waitForNotLoading(function(){var h=g.query,n=c._getUrl("GetItems"),t,v,p=function(){g.isLoading=!1;c.isBusy=!1},u=function(a){p();e.resolve(a)},z=function(a){p();c._onDataOperError(a,"load");e.reject()},x;g.isLoading=!0;c.isBusy=!0;try{a.pageIndex=q;c._beforeLoad(a,h,g);var w,h=1;if(1<l&&f){if(a._isPageCached(q)){x=c._loadFromCache(a,b);x.outOfBandData=null;u(x);return}w=a._getCache().getNextRange(q);q=w.start;
h=w.cnt}t={dbSetName:m,pageIndex:q,pageSize:a.pageSize,pageCount:h,isIncludeTotalCount:a.isIncludeTotalCount,filterInfo:a.filterInfo,sortInfo:a.sortInfo,paramInfo:c._getMethodParams(a._queryInfo,a.params).paramInfo,queryName:a.queryName};v=JSON.stringify(t);k.performAjaxCall(n,v,!0,function(a){var e=[],q;try{q=a.indexOf(d.modules.consts.CHUNK_SEP),-1<q?(e.push(a.substr(0,q)),e.push(a.substr(q+d.modules.consts.CHUNK_SEP.length))):e.push(a),e=e.map(function(a){return JSON.parse(a)}),setTimeout(function(){var d,
q=e[0],l=!!q.included&&0<q.included.length;try{if(1<e.length&&(d=e[1])&&0<d.length)if(l&&q.included.forEach(function(a){a.rows=d.splice(0,a.rowCount);if(a.rowCount!=a.rows.length)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_ASSERTION_FAILED,"subset.rowCount == subset.rows.length"));}),q.rows=d,q.rowCount!=q.rows.length)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_ASSERTION_FAILED,"getDataResult.rowCount == getDataResult.rows.length"));x=c._onLoaded(q,b);x.outOfBandData=a.extraInfo;u(x)}catch(r){z(r)}},
0)}catch(l){z(l)}},function(a){p();c._onDataOperError(a,"load");e.reject()},null)}catch(D){z(D)}},[],!0,b?"paging":null)},[],b?"paging":null);return e.promise()},getDbSet:function(a){if(!this.isInitialized)throw Error(RIAPP.ERRS.ERR_DOMAIN_CONTEXT_NOT_INITIALIZED);var b=this._dbSets[a];if(!b)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_DBSET_NAME_INVALID,a));return b},getAssociation:function(a){var b=this._assoc[a];if(!b)throw Error(RIAPP.utils.format(RIAPP.ERR_ASSOC_NAME_INVALID,a));return b()},
...
return}}catch(m){f(m);return}try{e=JSON.stringify(d),k.performAjaxCall(b,e,!0,function(b){try{a._dataSaved(JSON.parse(b)),l(),c(!0)}catch(e){f(e)}},function(b){l();a._onSubmitError(b);c(!1)},null)}catch(g){f(g)}},[]);return b.deferred.promise()},load:function(a){return this._load(a,!1)},acceptChanges:function(){this._arrDbSets.forEach(function(a){a.acceptChanges()})},rejectChanges:function(){this._arrDbSets.forEach(function(a){a.rejectChanges()})},initialize:function(a){if(!this._isInitialized){var b=
...
c>b&&(this._currentPos=c-1,this._onCurrentChanged())}},sortLocal:function(a,b){var c=1,e=this._app.parser;b&&"DESC"===b.toUpperCase()&&(c=-1);this.fn_sort=function(b,d){var l=0,f,m,g;f=0;for(m=a.length;f<m&&!(g=a[f],l=e.resolvePath(b,g),g=e.resolvePath(d,g),l=l<g?-1*c:l>g?c:0,0!==l);f+=1);return l}},getIsHasErrors:function(){return this._dataSource.getIsHasErrors()},clear:function(){this.cancelEdit();this._EditingItem=null;this._newKey=0;this.currentItem=null;this._items=[];this._itemsByKey={};this._errors=
...
this._parentMap={};this._notifyParentChanged(a)},_unMapChildItem:function(a){var b,c,e=null;if(b=this.getChildFKey(a))if(c=this._childMap[b])a=k.removeFromArray(c,a),-1<a&&(0==c.length&&delete this._childMap[b],e=b);return e},_unMapParentItem:function(a){var b=null;if((a=this.getParentFKey(a))&&this._parentMap[a])delete this._parentMap[a],b=a;return b},_mapParentItems:function(a){for(var b,e,d=c.DELETED,l,q={},f=0,m=a.length;f<m;f+=1)if(b=a[f],e=b._changeType,e!==d&&(e=this.getParentFKey(b)))l=this._parentMap[e],
l!==b&&(this._parentMap[e]=b,q[e]=null);return Object.keys(q)},_onChildrenChanged:function(a){a&&this._parentToChildrenName&&(a=this._parentMap[a])&&a.raisePropertyChanged(this._parentToChildrenName)},_onParentChanged:function(a){var b=this;a&&this._childToParentName&&(a=this._childMap[a])&&a.forEach(function(a){a.raisePropertyChanged(b._childToParentName)})},_mapChildren:function(a){for(var b,e,d,l=c.DELETED,q={},f=0,m=a.length;f<m;f+=1)if(b=a[f],e=b._changeType,e!==l&&(e=this.getChildFKey(b)))d=
...
this._$template=this._template=null;this._fn_submitOnOK=function(){var a=c._dbContext;if(!a)return h.createDeferred().resolve();a.addHandler("submit_error",function(a,b){n.SubmitError.isPrototypeOf(b.error)&&0<b.error.notValidated.length&&(b.isHandled=!0)},c._objId);var b=a.submitChanges();b.always(function(){a.removeHandler("submit_error",c._objId)});return b};this._updateIsEditable();this._options={width:a.width,height:a.height,title:a.title,autoOpen:!1,modal:!0,close:function(a,b){c._onClose()},
...
a});l=n.extend({_init:function(){var a=d.$(this.el);a.addClass(s.rowCollapsed);a.addClass(s.rowExpander)},_onCellClicked:function(){this._row&&(this._super(),this._row.isExpanded=!this._row.isExpanded)},_toggleImage:function(){var a=d.$(this.el);this._row.isExpanded?(a.removeClass(s.rowCollapsed),a.addClass(s.rowExpanded)):(a.removeClass(s.rowExpanded),a.addClass(s.rowCollapsed))},toString:function(){return"ExpanderCell"}},null,function(a){f.ExpanderCell=a});m=n.extend({_create:function(a,b){this._isEditing=
...
actionsCell:{get:function(){return this._actionsCell}},isDeleted:{set:function(a){this._el&&this._isDeleted!==a&&((this._isDeleted=a)?(this.isExpanded=!1,d.$(this._el).addClass(s.rowDeleted)):d.$(this._el).removeClass(s.rowDeleted))},get:function(){return!this._el?!0:this._isDeleted}},isEditing:{get:function(){return this._item._isEditing}}},function(a){f.Row=a});p=RIAPP.BaseObject.extend({_app:a,_create:function(a,b){this._super();this._grid=a;this._el=b.tr;this._parentRow=this._cell=this._item=
...
c.th;this._options=c.colinfo;this._isSelected=!1;this._objId="col"+this.app.getNewObjectID();var l=d.$("<div></div>");l.addClass(s.column);this._grid._headerDiv.append(l);this._extcol=l;var f=d.$("<div></div>");f.addClass(s.cellDiv).click(function(b){b.stopPropagation();d.currentSelectable=a;a._setCurrentColumn(e);e._onColumnClicked()});l.append(f);f.get(0).cell=this;this._div=f;d.$(this.grid._tableEl).on("click","div["+k.DATA_ATTR.DATA_EVENT_SCOPE+'="'+this.uniqueID+'"]',function(c){c.stopPropagation();
...
this.$div;b.removeClass(s.colSortable).removeClass(s.colSortAsc).removeClass(s.colSortDesc);switch(a){case "ASC":b.addClass(s.colSortAsc);break;case "DESC":b.addClass(s.colSortDesc);break;default:this.isSortable&&b.addClass(s.colSortable)}this._sortOrder=a},get:function(){return this._sortOrder}}},function(a){f.DataColumn=a});w=n.extend({_init:function(){this._super();this.$div.addClass(s.rowExpander)},toString:function(){return"ExpanderColumn"}},null,function(a){f.ExpanderColumn=a});v=n.extend({_init:function(){this._super();
...
c){if(this._isDestroyCalled)return null;var e,f="",g,h;a&&(f=a._key);if(this._keyMap[f])return null;h=this._getText(a);g=this._getValue(a);e=d.document.createElement("option");e.text=h;e.value=f;h={item:a,op:e};this._keyMap[f]=h;""!==g&&(this._valMap[g]=h);c?2>this._el.options.length?this._el.add(e,null):this._el.add(e,this._el.options[1]):this._el.add(e,null);return e},_removeOption:function(a){if(!this._isDestroyCalled){var c="",d;if(a&&(c=a._key,d=this._keyMap[c]))this._el.remove(d.op.index),d=
this._getValue(a),delete this._keyMap[c],""!==d&&delete this._valMap[d],this._saveSelected===a&&(this._saveSelected=null),this.selectedItem===a&&(this.selectedItem=this._saveSelected)}},_clear:function(a){this._el.options.length=0;this._keyMap={};this._valMap={};this._saveSelected=null;a?this._selectedItem=null:(this._addOption(null,!1),this.selectedItem=null)},clear:function(){this._clear(!1)},_refresh:function(){var a=this,c=this._dataSource,d=this._selectedItem;this._isRefreshing=!0;try{this.clear(),
c&&c.forEach(function(c){a._addOption(c,!1)}),this._el.selectedIndex=this._findItemIndex(d)}finally{this._isRefreshing=!1}this._onChanged()},_findItemIndex:function(a){if(!a)return 0;a=this._keyMap[a._key];return!a?0:a.op.index},findItemByValue:function(a){a=this._valMap[a];return!a?null:a.item},getTextByValue:function(a){return(a=this._valMap[a])?a.op.text:""},_setIsEnabled:function(a,c){a.disabled=!c},_getIsEnabled:function(a){return!a.disabled},toString:function(){return"ListBox"}},{dataSource:{set:function(a){this._dataSource!==
...
RIAPP.Application._coreModules.dataform=function(a){var f=this,d=a.global,h=d.utils,k=d.consts,n=a.modules.binding.Binding,p=a.modules.baseElView,g=p.BaseElView,b={dataform:"ria-dataform"},c=RIAPP.localizable.VALIDATE;Object.freeze(b);f.css=b;var e=RIAPP.BaseObject.extend({_DATA_CONTENT_SELECTOR:"*["+k.DATA_ATTR.DATA_CONTENT+"]:not(["+k.DATA_ATTR.DATA_COLUMN+"])",_app:a,_create:function(c,e){var f=this,g;this._super();this._el=c;this._$el=d.$(this._el);this._objId="frm"+this._app.getNewObjectID();
this._css=e.css;this._dataContext=null;this._$el.addClass(b.dataform);this._css&&this._$el.addClass(this._css);this._isDisabled=this._isEditing=!1;this._content=[];this._lfTime=null;this._supportEdit=this._contentCreated=!1;this._errors=this._parentDataForm=this._collection=null;if(g=this._getParentDataForm(this._el))f._parentDataForm=a.getElementView(g),f._parentDataForm.addOnDestroyed(function(a,b){f.destroy()},f._objId)},_getBindings:function(){if(!this._lfTime)return[];for(var a=this._lfTime.getObjs(),
b=[],c=0,d=a.length;c<d;c+=1)n.isPrototypeOf(a[c])&&b.push(a[c]);return b},_getElViews:function(){if(!this._lfTime)return[];for(var a=this._lfTime.getObjs(),b=[],c=0,d=a.length;c<d;c+=1)g.isPrototypeOf(a[c])&&b.push(a[c]);return b},_updateIsDisabled:function(){var a,b,c,d=this._getBindings(),e=this._getElViews(),f=this._app._getElViewType(k.ELVIEW_NM.DATAFORM);a=0;for(b=d.length;a<b;a+=1)c=d[a],c.isDisabled=this._isDisabled;a=0;for(b=e.length;a<b;a+=1)c=e[a],f.isPrototypeOf(c)&&c.form&&(c.form.isDisabled=
...
this._onDSErrorsChanged(b))}}catch(c){d.reThrow(c,this._onError(c,this))}},get:function(){return this._dataContext}},isEditing:{set:function(a){var b=this._dataContext,c=this._isEditing;if(b)if(!this._supportEdit&&a!==c)this._isEditing=a,this._updateContent(),this.raisePropertyChanged("isEditing");else{if(a!==c)try{a?b.beginEdit():b.endEdit()}catch(e){d.reThrow(e,this._onError(e,b))}b.isEditing!==c&&(this._isEditing=b.isEditing,this._updateContent(),this.raisePropertyChanged("isEditing"))}},get:function(){return this._isEditing}},
validationErrors:{set:function(a){a!==this._errors&&(this._errors=a,this.raisePropertyChanged("validationErrors"))},get:function(){return this._errors}},isDisabled:{set:function(a){this._isDisabled!==a&&(this._isDisabled=!!a,this._updateIsDisabled(),this.raisePropertyChanged("isDisabled"))},get:function(){return this._isDisabled}}},function(a){f.DataForm=a});g.extend({_init:function(a){this._super(a);this._form=this._dataContext=null;this._options=a},_getErrorTipInfo:function(a){var b=["<b>",c.errorInfo,
"</b>","<ul>"];a.forEach(function(a){var d=a.fieldName,e="";d&&(e=c.errorField+" "+d);a.errors.forEach(function(a){e=e?e+" -> "+a:a});b.push("<li>"+e+"</li>");e=""});b.push("</ul>");return b.join("")},_updateErrorUI:function(a,b){if(a){var c=this.$el;if(b&&0<b.length){var e,f=d.getImagePath("warning.png");e=d.$('<img name="error_info" alt="error_info" class="error-info" />');c.prepend(e);e.get(0).src=f;h.addToolTip(e,this._getErrorTipInfo(b),p.css.errorTip);this._setFieldError(!0)}else c.children('img[name="error_info"]').remove(),
this._setFieldError(!1)}},destroy:function(){this._form&&!this._form._isDestroyCalled&&this._form.destroy();this._dataContext=this._form=null;this._super()},toString:function(){return"DataFormElView"}},{dataContext:{set:function(a){var b=this;this._dataContext!==a&&(this._dataContext=a,this._form||(this._form=e.create(this._el,this._options)),this._form.dataContext=this._dataContext,this._form.addOnDestroyed(function(){b._form=null}),this.form.addOnPropertyChange("validationErrors",function(a,c){b.validationErrors=
a.validationErrors},this._objId),b.invokePropChanged("form"))},get:function(){return this._dataContext}},form:{get:function(){return this._form}}},function(b){f.DataFormElView=b;a.registerType("DataFormElView",b);a.registerElView(d.consts.ELVIEW_NM.DATAFORM,b)})};
RIAPP.Application._coreModules.elview=function(a){var f=this,d=a.global,h=d.utils,k=a.modules.baseElView,n=k.BaseElView,p=k.EditableElView,g=k.CommandElView,b=k.css;f.BaseElView=n;f.EditableElView=p;f.CommandElView=g;n.extend({_init:function(a){this._super(a);this._someProp=null}},{someProp:{set:function(a){if(a!==this._someProp){debugger;this._someProp=a;this.raisePropertyChanged("someProp");this.$el.html(""+this._someProp)}},get:function(){return this._someProp}}},function(b){f.DebuggerElView=b;
...
c,e,f){b=this._super(b,c,e,f);b.converter=a.getConverter("dateTimeConverter");c=this.getFieldInfo();e=d.defaults;switch(c.dataType){case p.DateTime:b.converterParam=e.dateTimeFormat;break;case p.Time:b.converterParam=e.timeFormat;break;default:b.converterParam=e.dateTimeFormat}return b},toString:function(){return"DateTimeContent"}},null,function(a){f.DateTimeContent=a}),m=b.extend({_allowedKeys:[0,g.backspace,g.del,g.left,g.right,g.end,g.home,g.tab,g.esc,g.enter],_getBindingOption:function(b,c,d,
...
get:function(){return this._value}}},function(a){f.LookupContent=a});f.BindingContentFactory=RIAPP.BaseObject.extend({_app:a,getContentType:function(a){var d=a.fieldInfo;if(a.lookup)return w;switch(d.dataType){case p.None:a=b;break;case p.String:a=a.multyline?u:t;break;case p.Bool:a=e;break;case p.Integer:a=m;break;case p.Decimal:case p.Float:a=m;break;case p.DateTime:case p.Time:a=l;break;case p.Date:a=c;break;case p.Guid:case p.Binary:a=b;break;default:throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_FIELD_DATATYPE,
