...
(d||"\\s")+"]+","g"),"")},rtrim:function(a,d){return a.replace(RegExp("["+(d||"\\s")+"]+$","g"),"")},isArray:function(a){return!a?!1:"[object Array]"===Object.prototype.toString.call(a)},format:function(){for(var f="",d=arguments,l=d[0],h=0;;){var p=l.indexOf("{",h),m=l.indexOf("}",h);if(0>p&&0>m){f+=l.slice(h);break}if(0<m&&(m<p||0>p)){if("}"!==l.charAt(m+1))throw Error(a.format(RIAPP.ERRS.ERR_STRING_FORMAT_INVALID,l));f+=l.slice(h,m+1);h=m+2}else if(f+=l.slice(h,p),h=p+1,"{"===l.charAt(h))f+="{",
h++;else{if(0>m)throw Error(a.format(RIAPP.ERRS.ERR_STRING_FORMAT_INVALID,l));var p=l.substring(h,m),g=p.indexOf(":"),h=parseInt(0>g?p:p.substring(0,g),10)+1;if(isNaN(h))throw Error(a.format(RIAPP.ERRS.ERR_STRING_FORMAT_INVALID,l));p=0>g?"":p.substring(g+1);h=d[h];if(void 0===h||null===h)h="";f=h.format?f+h.format(p):f+h.toString();h=m+1}}return f}};String.format||(String.format=function(){var f=Array.prototype.slice.call(arguments);return a.format.apply(a,f)});return a}();
RIAPP.BaseObject={_create:function(){this.__events=this._super=null;this._isDestroyCalled=this._isDestroyed=!1},create:function(){var a=Object.create(this);a._create.apply(a,arguments);Object.seal(a);return a},extend:function(a,f,d){var l=f||{},h,p=0,m,g,b=/\._super\s*\(/;Object.getOwnPropertyNames(l).forEach(function(b){b=l[b];void 0===b.enumerable&&(b.enumerable=!0);void 0===b.configurable&&(b.configurable=!1)});l._typeName=Object.getOwnPropertyDescriptor({_typeName:""},"_typeName");l.__eventNames=
Object.getOwnPropertyDescriptor({__eventNames:[]},"__eventNames");if(a){h=Object.getOwnPropertyNames(a);p=0;for(m=h.length;p<m;p+=1)f=h[p],l.hasOwnProperty(f)||(l[f]=Object.getOwnPropertyDescriptor(a,f))}g=Object.create(this,l);Object.getOwnPropertyNames(g).forEach(function(c){var e=Object.getOwnPropertyDescriptor(g,c),k,n,a;e.value&&RIAPP.utils.isFunc(e.value)&&(n=e.value.toString(),k=g[c],b.test(n)?(a=Object.getPrototypeOf(g),e.value="destroy"==c?function(){var b=this._super;this._super=a[c];try{return this._isDestroyCalled=
...
a));null===this.__events&&(this.__events={});var h=this.__events,p="*";d&&(p=""+d);h[a]||(h[a]=[]);a=h[a];a.some(function(a){return a.fn===f&&a.ns==p})||(l?a.unshift({fn:f,ns:p}):a.push({fn:f,ns:p}))}},_removeHandler:function(a,f){var d=this.__events,l="*";if(d){f&&(l=""+f);var h,p,m;if(a){if(d[a])if("*"==l)delete d[a];else{h=d[a];p=h.filter(function(g){return g.ns==l});for(m=h.length;0<m;)m-=1,-1<p.indexOf(h[m])&&h.splice(m,1);0==h.length&&delete d[a]}}else"*"!=l?Object.keys(d).forEach(function(g){var b=
...
RIAPP.Global._coreModules.array_ext=function(a){Array.prototype.distinct=function(){var a={},d,l=this.length,h=[];for(d=0;d<l;d+=1)a[this[d]]=this[d];var p=Object.keys(a);d=0;for(l=p.length;d<l;d+=1)h.push(a[p[d]]);return h};Array.prototype.intersect=function(a){return this.filter(function(d){return-1<a.indexOf(d)})};Array.fromList=function(a){for(var d=Array(a.length),l=0,h=a.length;l<h;l++)d[l]=a[l];return d}};
RIAPP.Global._coreModules.consts=function(a){var f={DATA_ATTR:{EL_VIEW_KEY:"data-elvwkey",DATA_BIND:"data-bind",DATA_VIEW:"data-view",DATA_APP:"data-app",DATA_EVENT_SCOPE:"data-scope",DATA_ITEM_KEY:"data-key",DATA_CONTENT:"data-content",DATA_COLUMN:"data-column",DATA_NAME:"data-name"},DATA_TYPE:{None:0,String:1,Bool:2,Integer:3,Decimal:4,Float:5,DateTime:6,Date:7,Time:8,Guid:9,Binary:10},CHANGE_TYPE:{NONE:0,ADDED:1,UPDATED:2,DELETED:3},KEYS:{backspace:8,tab:9,enter:13,esc:27,space:32,pageUp:33,pageDown:34,
end:35,home:36,left:37,up:38,right:39,down:40,del:127},ELVIEW_NM:{DATAFORM:"dataform",DYNACONT:"dynacontent"}};Object.getOwnPropertyNames(f).forEach(function(a){Object.freeze(f[a])});Object.freeze(f);this.consts=f;a.consts=this.consts};
...
c,e,g){b=(b+"").replace(/[^0-9+-Ee.]/g,"");var n=!isFinite(+b)?0:+b;b=!isFinite(+c)?0:Math.abs(c);g=void 0===g?",":g;e=void 0===e?".":e;var a="",a=function(b,c){var e=Math.pow(10,c);return""+Math.round(b*e)/e};m.check_is.nt(c)?(a=(""+n).split("."),b=2):a=(b?a(n,b):""+Math.round(n)).split(".");var n="",d=a[0].length;if(3<d){for(c=0;c<d;c+=1)n+=a[0].charAt(c),c<d-1&&0===(d-c-1)%3&&(n+=g);a[0]=n}if((a[1]||"").length<b)a[1]=a[1]||"",a[1]+=Array(b-a[1].length+1).join("0");return a.join(e)},stripNonNumeric:function(b){b+=
"";for(var c=/^\d|\.|-$/,e="",a=0;a<b.length;a++)c.test(b.charAt(a))&&("."==b.charAt(a)&&-1!=e.indexOf(".")||"-"==b.charAt(a)&&0!=e.length||(e+=b.charAt(a)));return e}},check_is:h,validation:p,getNewID:function(){var b=l;l+=1;return b},isContained:function(b,c){if(!b)return!1;for(;b=b.parentNode;)if(b===c)return!0;return!1},slice:Array.prototype.slice,get_timeZoneOffset:function(){var b=(new Date).getTimezoneOffset();return function(){return b}}(),parseBool:function(b){var c=d.trim(b).toLowerCase();
if("false"===c)return!1;if("true"===c)return!0;throw Error(m.format(RIAPP.ERRS.ERR_PARAM_INVALID,"bool_value",b));},round:function(b,c){return parseFloat(b.toFixed(c))},performAjaxCall:function(b,c,e,g,n,u){b=a.$.ajax({url:b,type:"POST",dataType:"json",data:c,async:e,timeout:1E3*a.defaults.ajaxTimeOut,contentType:"application/json; charset=utf-8"});g&&b.done(function(b){g.call(u,b)});n&&b.fail(function(b){var c="Load Failed!";b&&b.message?c=b.message:b&&b.responseText&&(c=b.responseText);n.call(u,
c)});return b},performAjaxGet:function(b){return a.$.get(b)},format:d.format,extend:function(b,c,e){return b?m.cloneObj(e,c):m.mergeObj(e,c)},removeNode:function(b){if(b){var c=b.parentNode;c&&c.removeChild(b)}},insertAfter:function(b,c){var e=b.parentNode;e.lastChild===b?e.appendChild(c):e.insertBefore(c,b.nextSibling)},getProps:function(b){return Object.getOwnPropertyNames(b)},forEachProp:function(b,c){Object.getOwnPropertyNames(b).forEach(c)},addToolTip:function(b,c,e){e={content:{text:c},style:{classes:e?
e:null},position:{my:"top left",at:"bottom right",target:b,viewport:$(a.window),adjust:{method:"flip none",x:0,y:0}},hide:{fixed:!0,delay:250}};b.data("qtip")?c?b.qtip("option","content.text",c):b.qtip("destroy"):c&&b.qtip(e)},hasProp:function(b,c){if(!b)return!1;if(b.hasOwnProperty(c))return!0;if(Object===b)return!1;var e=Object.getPrototypeOf(b);return m.hasProp(e,c)},createDeferred:function(){return a.$.Deferred()},cloneObj:function(b,c){var e,a,n;if(!b)return b;if(h.Array(b)){n=b.length;e=Array(n);
for(a=0;a<n;a+=1)e[a]=m.cloneObj(b[a],null)}else if(h.SimpleObject(b)){e=c||{};var g,d=Object.getOwnPropertyNames(b);n=d.length;for(a=0;a<n;a+=1)g=d[a],e[g]=m.cloneObj(b[g],null)}else return b;return e},shallowCopy:function(b){return m.mergeObj(b,{})},mergeObj:function(b,c){c||(c={});if(!b)return c;for(var e=Object.getOwnPropertyNames(b),a,n=0,g=e.length;n<g;n+=1)a=e[n],c[a]=b[a];return c},removeFromArray:function(b,c){var e=b.indexOf(c);-1<e&&b.splice(e,1);return e},insertIntoArray:function(b,c,
e){b.splice(e,0,c)},destroyJQueryPlugin:function(b,c){if(b.data(c))b[c]("destroy")},uuid:function(){var b="0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz".split("");return function(c,e){var a,n=[],g=Math.random;e=e||b.length;if(c)for(a=0;a<c;a+=1)n[a]=b[0|g()*e];else{var d;n[8]=n[13]=n[18]=n[23]="-";n[14]="4";for(a=0;36>a;a+=1)n[a]||(d=0|16*g(),n[a]=b[19==a?d&3|8:d&15])}return n.join("")}}()},g=RIAPP.BaseObject.extend({_cnt:0,_create:function(){this._super();this._objs=[];g._cnt+=
...
{uniqueID:{get:function(){return this._objId}}},function(b){a.registerType("PropWatcher",b)});f.WaitQueue=RIAPP.BaseObject.extend({_create:function(b){this._super();this._objId="wq"+m.getNewID();this._owner=b;this._queue={}},_checkQueue:function(b,c){if(this._owner&&!this._owner._isDestroyCalled){var e=this,a=this._queue[b],n;if(a&&0!=a.length){var g,d,m=null,h=[],f=[],p=[];for(g=0;g<a.length;g+=1)if(n=a[g],n.predicate(c))if(!n.group&&0==h.length){d=n;break}else n.group&&(m||(m=n.group),m===n.group&&
h.push(n));if(d)f.push(d),p.push(d);else for(;0<h.length;)n=h.pop(),d||(d=n),d.lastWins?0==f.length&&f.push(n):f.push(n),p.push(n);try{if(0<f.length){for(g=a.length;0<g;)g-=1,-1<p.indexOf(a[g])&&a.splice(g,1);f.forEach(function(t){try{t.action.apply(e._owner,t.args)}catch(b){e._owner._onError(b,e)}})}}finally{0==a.length&&(delete this._queue[b],this._owner.removeOnPropertyChange(b,this.uniqueID))}}}},enQueue:function(b){b=m.extend(!1,{prop:"",groupName:null,predicate:null,action:null,actionArgs:[],
...
RIAPP.Global._coreModules.riapp=function(a){var f=this,d=a.utils,l=a.consts,h={},p={},m=RIAPP.BaseObject.extend({_DATA_BIND_SELECTOR:["*[",l.DATA_ATTR.DATA_BIND,"]"].join(""),_TEMPLATES_DATA_BIND_SELECTOR:["section.",RIAPP.css_riaTemplate," *[",l.DATA_ATTR.DATA_BIND,"]"].join(""),registerModule:function(a,b){if(p[a])throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_MODULE_ALREDY_REGISTERED,a));p[a]=b},_create:function(g){this._super();g=d.extend(!1,{app_name:"default",service_url:"",metadata:null,createDbContext:!0,
...
a)},_getBindingOption:function(a,b,c){var e={mode:this.modules.binding.BINDING_MODE[1],converterParam:null,converter:null,targetPath:null,sourcePath:null,target:null,source:null,isSourceFixed:!1},k=a.source,n=a.target;!a.sourcePath&&a.to?e.sourcePath=a.to:a.sourcePath&&(e.sourcePath=a.sourcePath);a.targetPath&&(e.targetPath=a.targetPath);a.converterParam&&(e.converterParam=a.converterParam);a.mode&&(e.mode=a.mode);a.converter&&(d.check_is.String(a.converter)?e.converter=this.getConverter(a.converter):
e.converter=a.converter);n?d.check_is.String(n)?e.target="this"==n?b:this.parser.resolveBindingSource(this,this.parser._getPathParts(n)):e.target=n:e.target=b;k?(e.isSourceFixed=!0,d.check_is.String(k)?e.source="this"==k?b:this.parser.resolveBindingSource(this,this.parser._getPathParts(k)):e.source=k):e.source=c;return e},_getElViewType:function(a){return this._elViews[a]},_getElView:function(a){return(a=a.getAttribute(this._ELV_STORE_KEY))?this._elViewStore[a]:null},_setElView:function(a,b){var c=
...
c.thousandSep;switch(g){case 1:return l.formatNumber(a,0,b,e);case 2:return g=c.decPrecision,l.formatNumber(a,g,b,e);case 4:return l.formatNumber(a,0,b,"");case 3:return l.formatNumber(a,null,b,e);default:return l.formatNumber(a,null,b,e)}},toString:function(){return"NumberConverter"}},null,function(d){a.registerConverter("numberConverter",d)});h.extend({convertToSource:function(a,g,b){return p.convertToSource(a,1,b)},convertToTarget:function(a,g,b){return p.convertToTarget(a,1,b)},toString:function(){return"IntegerConverter"}},
null,function(d){a.registerConverter("integerConverter",d)});h.extend({convertToSource:function(a,g,b){return p.convertToSource(a,4,b)},convertToTarget:function(a,g,b){return p.convertToTarget(a,4,b)},toString:function(){return"SmallIntConverter"}},null,function(d){a.registerConverter("smallIntConverter",d)});h.extend({convertToSource:function(a,g,b){return p.convertToSource(a,2,b)},convertToTarget:function(a,g,b){return p.convertToTarget(a,2,b)},toString:function(){return"DecimalConverter"}},null,
function(d){a.registerConverter("decimalConverter",d)});h.extend({convertToSource:function(a,g,b){return p.convertToSource(a,3,b)},convertToTarget:function(a,g,b){return p.convertToTarget(a,3,b)},toString:function(){return"FloatConverter"}},null,function(d){a.registerConverter("floatConverter",d)})};
...
d,f){RIAPP.utils.startsWith(d,"[")?(d=this.trimQuotes(this.trimBrackets(d)),RIAPP.utils.isArray(a)?a[parseInt(d,10)]=f:a[d]=f):a[d]=f},_getKeyVals:function(a){var p,m,g,b=[],c={key:"",val:""},e=!0,k=this.__valueDelimeter1,n=this.__valueDelimeter2,u=this.__keyValDelimeter,v=function(c){c.val&&(f.check_is.Numeric(c.val)?c.val=Number(c.val):f.check_is.BoolString(c.val)&&(c.val=f.parseBool(c.val)));b.push(c)};for(p=0;p<a.length;p+=1){m=a.charAt(p);if("'"===m||'"'===m)g?g===m&&(g=null):g=m;!g&&"{"===m&&
!e?(m=a.substr(p),m=this.getBraceParts(m,!0)[0],c.val+=m,p+=m.length-1):!g&&m===u?c.key&&(v(c),c={key:"",val:""},e=!0):!g&&(m===k||m===n)?e=!1:e?c.key+=m:c.val+=m}c.key&&v(c);b.forEach(function(b){b.key=d.trim(b.key);f.check_is.String(b.val)&&(b.val=d.trim(b.val));""===b.val&&d.startsWith(b.key,"this.")&&(b.val=b.key.substr(5),b.key="targetPath")});return b=b.filter(function(b){return""!==b.val})},resolveBindingSource:function(a,d){if(a){if(0===d.length)return a;if(0<d.length)return this.resolveBindingSource(this._resolveProp(a,
...
""))},trimBrackets:function(a){return d.trim(a.replace(this.__trimBracketsRX,""))},isWithOuterBraces:function(a){return d.startsWith(a,"{")&&d.endsWith(a,"}")},parseOption:function(a){var p={},m=this;a=d.trim(a);m.isWithOuterBraces(a)&&(a=m.trimOuterBraces(a));m._getKeyVals(a).forEach(function(a){var b=f.check_is.String(a.val);b&&m.isWithOuterBraces(a.val)?p[a.key]=m.parseOption(a.val):p[a.key]=b?m.trimQuotes(a.val):a.val});return p},parseOptions:function(a){var f=[],m=this;a=d.trim(a);var g=[a];
...
try{this._$el=this._el=this.toolTip=this.validationErrors=this._propChangedCommand=null}finally{this._app._setElView(a,null)}this._super()}},invokePropChanged:function(b){b={property:b};this._propChangedCommand&&this._propChangedCommand.execute(this,b)},_getErrorTipInfo:function(b){var a=["<b>",p.errorInfo,"</b>","<br/>"];b.forEach(function(b){var g="";b.errors.forEach(function(b){g=g+" "+b});a.push(g);g=""});return a.join("")},_setFieldError:function(b){var a=this.$el;b?a.addClass(m.fieldError):
...
b):c},_getTgtChangedFn:function(a,b,c,e,d){return function(n,u){var f=a._app.parser._resolveProp(b,c);0<e.length&&a._checkBounded(null,"target",d,e);a._parseTgtPath(f,e,d)}},_getSrcChangedFn:function(a,b,c,e,d){return function(n,u){var f=a._app.parser._resolveProp(b,c);0<e.length&&a._checkBounded(null,"source",d,e);a._parseSrcPath(f,e,d)}},_parseSrcPath:function(a,b,c){this._sourceObj=null;0===b.length?this._sourceObj=a:this._parseSrcPath2(a,b,c);this._targetObj&&this._updateTarget()},_parseSrcPath2:function(a,
...
this._converterParam,this._sourceObj);void 0!==a&&(this.targetValue=a)}catch(b){d.reThrow(b,this._onError(b,this))}finally{this._ignoreTgtChange=!1}}},_updateSource:function(){if(!this._ignoreTgtChange){this._ignoreSrcChange=!0;try{var a=this._converter.convertToSource(this.targetValue,this._converterParam,this._sourceObj);void 0!==a&&(this.sourceValue=a)}catch(b){if(!f.ValidationError.isPrototypeOf(b)||!p.isPrototypeOf(this._targetObj))if(this._updateTarget(),!this._onError(b,this))throw b;}finally{this._ignoreSrcChange=
...
RIAPP.Application._coreModules.template=function(a){var f=a.global,d=f.utils,l=f.consts,h=a.modules.binding.Binding,p=a.modules.baseElView.BaseElView;this.Template=RIAPP.BaseObject.extend({_app:a,_create:function(a){this._super();this._el=this._dctxt=null;this._isDisabled=!1;this._lfTime=null;this._templateID=a;this._templElView=void 0;this._promise=null;this._templateID&&this._loadTemplate()},_getBindings:function(){if(!this._lfTime)return[];for(var a=this._lfTime.getObjs(),d=[],b=0,c=a.length;b<
c;b+=1)h.isPrototypeOf(a[b])&&d.push(a[b]);return d},_getElViews:function(){if(!this._lfTime)return[];for(var a=this._lfTime.getObjs(),d=[],b=0,c=a.length;b<c;b+=1)p.isPrototypeOf(a[b])&&d.push(a[b]);return d},_getTemplateElView:function(){if(!this._lfTime||null===this._templElView)return null;if(this._templElView)return this._templElView;for(var a=null,d=this._app.modules.elview.TemplateElView,b=this._getElViews(),c=0,e=b.length;c<e;c+=1)if(d.isPrototypeOf(b[c])){a=b[c];break}return this._templElView=
...
RIAPP.Application._coreModules.collection=function(a){var f=this,d=a.global,l=d.utils,h,p,m,g=d.consts.DATA_TYPE,b={REMOVE:"0",ADDED:"1",RESET:"2",REMAP_KEY:"3"},c={};c.DATA_TYPE=g;c.SORT_ORDER={ASC:0,DESC:1};c.COLL_CHANGE_TYPE=b;c.DATE_CONVERSION={None:0,ServerLocalToClientLocal:1,UtcToClientLocal:2};f.consts=c;Object.freeze(c);var e=a.modules.binding.ValidationError,k={valueToDate:function(a,b,e){if(!a)return null;a=""+a;var d=a.split("&");if(7!=d.length)throw Error(base_utils.format(RIAPP.ERRS.ERR_PARAM_INVALID,
...
isRowTimeStamp:!1,dataType:g.NONE,isNullable:!0,maxLength:-1,isReadOnly:!1,isAutoGenerated:!1,allowClientDefault:!1,dateConversion:c.DATE_CONVERSION.NONE,isClientOnly:!0,isCalculated:!1,isNeedOriginal:!1,dependentOn:null,range:null,regex:null,isNavigation:!1,fieldName:a}};m=p.extend({_create:function(a){this._super();this.__isNew=!a;a&&(this._vals=a);a||this._collection.getFieldNames().forEach(function(a){this._vals[a]=null},this)},_setProp:function(a,b){var c,d=this._collection;if(this._vals[a]!==
...
getFieldNames:function(){return h.getProps(this._dbSet._fieldMap)},_addSort:function(a,b){var c=n.ASC,e=this._sortInfo;b&&"d"===b.toLowerCase().substr(0,1)&&(c=n.DESC);e.sortItems.push({fieldName:a,sortOrder:c});this._cacheInvalidated=!0},_addFilterItem:function(a,b,c){var d=0,d=this.getFieldInfo(a);if(!d)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_DBSET_INVALID_FIELDNAME,this.dbSetName,a));var k=this._serverTimezone,q=d.dateConversion,s=c;h.check_is.Array(s)||(s=[c]);s=Array.clone(s).map(function(a){return e.stringifyValue(a,
...
function(a){f.DataQuery=a});p=l.CollectionItem.extend({_create:function(a,b){this._super();this.__changeType=c.NONE;this._saveChangeType=this._origVals=this._srvRowKey=null;this.__isCached=this.__isRefreshing=!1;this.getFieldNames().forEach(function(a){this._vals[a]=null},this);this._initRowInfo(a,b)},_initRowInfo:function(a,b){if(a){var c=this,d=c._serverTimezone;this._key=this._srvRowKey=a.key;a.values.forEach(function(a,t){var k=b[t],f=c.getFieldInfo(k);if(!f)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_DBSET_INVALID_FIELDNAME,
c._dbSetName,k));k=e.parseValue(a,f.dataType,f.dateConversion,d);c._vals[f.fieldName]=k})}},_checkCanRefresh:function(){if(null===this._key||this._changeType===c.ADDED)throw Error(RIAPP.ERRS.ERR_OPER_REFRESH_INVALID);},_refreshValue:function(a,b,c){var d=this.getFieldInfo(b);if(!d)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_DBSET_INVALID_FIELDNAME,this._dbSetName,b));var k,q,s=d.dataType;a=e.parseValue(a,s,d.dateConversion,this._serverTimezone);k=this._vals[b];switch(c){case 3:e.compareVals(a,k,
s)||(this._vals[b]=a,this._onFieldChanged(d));break;case 1:this._origVals&&(this._origVals[b]=a);this._saveVals&&(this._saveVals[b]=a);e.compareVals(a,k,s)||(this._vals[b]=a,this._onFieldChanged(d));break;case 2:this._origVals&&(q=this._origVals[b],this._origVals[b]=a);if((void 0===q||e.compareVals(q,k,s))&&!e.compareVals(a,k,s))this._vals[b]=a,this._onFieldChanged(d);break;default:throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_PARAM_INVALID,"refreshMode",c));}},_refreshValues:function(a,b){var e=
...
b));if(a.fieldName===b)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_CALC_FIELD_SELF_DEPEND,b));0>c.dependents.indexOf(a.fieldName)&&c.dependents.push(a.fieldName)})},f=function(a){var b=d._fieldMap[a.fieldName],t=!0,k=c.filter(function(b){return b.childToParentName==a.fieldName});0===k.length&&(k=e.filter(function(b){return b.parentToChildrenName==a.fieldName}),t=!1);if(1!=k.length)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_PARAM_INVALID_TYPE,"assocs","Array"));b.isClientOnly=!0;b.isReadOnly=
!0;var s=function(){throw Error("getFunc is not emplemented!");},f,w=k[0].name;t?(b.isReadOnly=!1,d._childAssocMap[k[0].childToParentName]=k[0],k[0].fieldRels.forEach(function(a){a=d._fieldMap[a.childField];!b.isReadOnly&&a.isReadOnly&&(b.isReadOnly=!0)}),s=function(){return d.dbContext.getAssociation(w).getParentItem(this)},b.isReadOnly||(d._trackAssoc[w]=k[0],f=function(b){var c,e,t=d.dbContext.getAssociation(w);if(b&&!t.parentDS.entityType.isPrototypeOf(b))throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_PARAM_INVALID_TYPE,
"value",t.parentDS.entityType._typeName));if(b&&b._isNew)this._setFieldVal(a.fieldName,b._key);else if(b){c=0;for(e=t.childFldInfos.length;c<e;c+=1)this[t.childFldInfos[c].fieldName]=b[t.parentFldInfos[c].fieldName]}else{this._getFieldVal(a.fieldName)&&this._setFieldVal(a.fieldName,null);c=0;for(e=t.childFldInfos.length;c<e;c+=1)this[t.childFldInfos[c].fieldName]=null}})):(d._parentAssocMap[k[0].parentToChildrenName]=k[0],s=function(){return d.dbContext.getAssociation(w).getChildItems(this)});q[a.fieldName]=
{set:f,get:s}},g=function(a){q[a.fieldName]={set:function(b){this._setFieldVal(a.fieldName,b)},get:function(){return this._getFieldVal(a.fieldName)}}};b.forEach(function(b){if(h.hasProp(p,b.fieldName))throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_ITEM_NAME_COLLISION,a,b.fieldName));if(b.isCalculated){var c=d.getFieldInfo(b.fieldName);c.isClientOnly=!0;c.isReadOnly=!0;c={dbSetName:a,fieldName:b.fieldName,getFunc:null};d.dbContext._onGetCalcField(c);h.check_is.Function(c.getFunc)&&(b.dependentOn&&k(b),
q[b.fieldName]={get:c.getFunc})}else b.isNavigation?f(b):g(b)});q._dbSet={get:function(){return this.__dbSet}};this._entityType=p.extend({__dbSet:d},q,function(b){b._typeName=a+"Entity"});this._mapAssocFields()},_fillFromService:function(a){a=h.extend(!1,{res:{names:[],rows:[],pageIndex:null,pageCount:null,dbSetName:this.dbSetName,totalCount:null},isPageChanged:!1,fn_beforeFillEnd:null},a);var b=a.res,c=b.names,e=b.rows,d=this._entityType,q=[],s=[],f=[],g=[],n=this.isPagingEnabled,l=this.query,m=
!0,u;this._onFillStart({isBegin:!0,rowCount:e.length,time:new Date,isPageChanged:a.isPageChanged});try{l&&(m=l.isClearPrevData,l.isClearCacheOnEveryLoad&&l._clearCache(),m&&this.clear(),l._reindexCache(),1<l.loadPageCount&&n&&(u=l._getCache(),l.isIncludeTotalCount&&!h.check_is.nt(b.totalCount)&&(u.totalCount=b.totalCount)));f=e.map(function(a){var b=a.key;if(!b)throw Error(RIAPP.ERRS.ERR_KEY_IS_EMPTY);var e=this._itemsByKey[b];e?a.values.forEach(function(a,b){e._refreshValue(a,c[b],1)}):(u&&(e=u.getItemByKey(b)),
e?a.values.forEach(function(a,b){e._refreshValue(a,c[b],1)}):e=d.create(a,c));return e},this);if(l&&(l.isIncludeTotalCount&&!h.check_is.nt(b.totalCount)&&(this.totalCount=b.totalCount),1<l.loadPageCount&&n)){u.fillCache(b.pageIndex,f);var x=u.getCachedPage(l.pageIndex),f=x?x.items:[]}f.forEach(function(a){var b=this._itemsByKey[a._key];b?g.push(b):(this._items.push(a),this._itemsByKey[a._key]=a,q.push(a),s.push(this._items.length-1),g.push(a))},this);0<q.length&&(this._onItemsChanged({change_type:k.ADDED,
items:q,pos:s}),this.raisePropertyChanged("count"));a.fn_beforeFillEnd&&a.fn_beforeFillEnd()}finally{this._onFillEnd({isBegin:!1,rowCount:g.length,time:new Date,resetUI:m,fetchedItems:g,newItems:q,isPageChanged:a.isPageChanged})}this.moveFirst();return{fetchedItems:g,newItems:q,isPageChanged:a.isPageChanged}},_fillFromCache:function(a){a=h.extend(!1,{isPageChanged:!1,fn_beforeFillEnd:null},a);var b=[],c=[],e=this.query;if(!e)throw Error(String.format(RIAPP.ERRS.ERR_ASSERTION_FAILED,"query is not null"));
e=e._getCache().getCachedPage(e.pageIndex);e=!e?[]:e.items;this._onFillStart({isBegin:!0,rowCount:e.length,time:new Date,isPageChanged:a.isPageChanged});try{this.clear(),this._items=e,e.forEach(function(a,e){this._itemsByKey[a._key]=a;b.push(e);c.push(a)},this),a.fn_beforeFillEnd&&a.fn_beforeFillEnd(),0<c.length&&(this._onItemsChanged({change_type:k.ADDED,items:c,pos:b}),this.raisePropertyChanged("count"))}finally{this._onFillEnd({isBegin:!1,rowCount:c.length,time:new Date,resetUI:!0,fetchedItems:c,
newItems:c,isPageChanged:a.isPageChanged})}this.moveFirst();return{fetchedItems:c,newItems:c,isPageChanged:a.isPageChanged}},_commitChanges:function(a){var b=this;a.forEach(function(a){var e=a.clientKey,t=b._itemsByKey[e];if(!t)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_KEY_IS_NOTFOUND,e));var d=t._changeType;t.acceptChanges(a);d===c.ADDED&&(delete b._itemsByKey[e],t._srvRowKey=a.serverKey,t._key=t._srvRowKey,b._itemsByKey[t._key]=t,b._onItemsChanged({change_type:k.REMAP_KEY,items:[t],old_key:e,
...
this._assoc[a.name]=function(){var e=B.create(c);b._arrAssoc.push(e);b._assoc[a.name]=function(){return e};return e}},_initMethod:function(a){var b=this;this._svcMethods[a.methodName]=function(c){var e=h.createDeferred(),k=function(a){a.error?e.reject():e.resolve(a.result)};try{var q=b._getMethodParams(a,c);b._invokeMethod(a,q,k)}catch(f){d._checkIsDummy(f)||(b._onError(f,b),k({result:null,error:f}))}return e.promise()}},_getMethodParams:function(a,c){var d={methodName:a.methodName,paramInfo:{parameters:[]}},
k,f=a.parameters,q=f.length,s,g,n;c||(c={});for(k=0;k<q;k+=1){s=f[k];g=c[s.name];if(!s.isNullable&&!s.isArray&&s.dataType!==b.String&&h.check_is.nt(g))throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_SVC_METH_PARAM_INVALID,s.name,g,a.methodName));if(h.check_is.Function(g))throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_SVC_METH_PARAM_INVALID,s.name,g,a.methodName));s.isArray&&(!h.check_is.nt(g)&&!h.check_is.Array(g))&&(g=[g]);n=null;h.check_is.Array(g)?(n=[],g.forEach(function(a){n.push(e.stringifyValue(a,
s.dateConversion,self._serverTimezone))}),n=JSON.stringify(n)):n=e.stringifyValue(g,s.dateConversion,self._serverTimezone);d.paramInfo.parameters.push({name:s.name,value:n})}return d},_invokeMethod:function(a,b,c){var e=this,k,q;this.isBusy=!0;var s=function(a){try{if(!a)throw Error(h.format(RIAPP.ERRS.ERR_UNEXPECTED_SVC_ERROR,"operation result is undefined"));f.checkError(a.error,"invoke");c({result:a.result,error:null})}catch(b){d._checkIsDummy(b)||(e._onDataOperError(b,"invoke"),c({result:null,
error:b}))}};try{k=JSON.stringify(b),q=this._getUrl("InvokeMethod"),h.performAjaxCall(q,k,!0,function(a){s(a);e.isBusy=!1},function(a){s({result:null,error:a});e.isBusy=!1},null)}catch(g){d._checkIsDummy(g)&&d._throwDummy(g),this.isBusy=!1,this._onDataOperError(g,"invoke"),c({result:null,error:g}),d._throwDummy(g)}},_getEventNames:function(){var a=this._super();return["submit_error","define_calc"].concat(a)},_loadFromCache:function(a,b){var c=a._dbSet,e;try{e=c._fillFromCache({isPageChanged:b,fn_beforeFillEnd:null})}catch(k){d._checkIsDummy(k)&&
d._throwDummy(k),this._onDataOperError(k,"load"),d._throwDummy(k)}return e},_loadIncluded:function(a){var b=this;a.included&&0<a.included.length&&a.included.forEach(function(a){b.getDbSet(a.dbSetName).fillItems(a,!0)})},_onLoaded:function(a,b){var c=this,e,k,q;try{if(!a)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_UNEXPECTED_SVC_ERROR,"null result"));e=a.dbSetName;k=this.getDbSet(e);if(!k)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_DBSET_NAME_INVALID,e));f.checkError(a.error,"load");q=k._fillFromService({res:a,
isPageChanged:b,fn_beforeFillEnd:function(){c._loadIncluded(a)}})}catch(s){d._checkIsDummy(s)&&d._throwDummy(s),this._onDataOperError(s,"load"),d._throwDummy(s)}return q},_dataSaved:function(a){var b=this,c=[],e=[];try{try{f.checkError(a.error,"submit")}catch(k){throw a.dbSets.forEach(function(a){var d=b._dbSets[a.dbSetName];a.rows.forEach(function(a){var b=d.getItemByKey(a.clientKey);if(!b)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_KEY_IS_NOTFOUND,a.clientKey));c.push(b);a.invalid&&(d._setItemInvalid(a),
e.push(b))})}),z.create(k,c,e);}a.dbSets.forEach(function(a){b._dbSets[a.dbSetName]._commitChanges(a.rows)})}catch(q){d._checkIsDummy(q)&&d._throwDummy(q),this._onSubmitError(q),d._throwDummy(q)}},_getChanges:function(){var a={dbSets:[],error:null,trackAssocs:[]};this._arrDbSets.forEach(function(b){b.endEdit();var c=b._getChanges();if(0!==c.length){var e=b._getTrackAssocInfo();a.dbSets.push({dbSetName:b.dbSetName,rows:c});a.trackAssocs=a.trackAssocs.concat(e)}});return a},_getUrl:function(a){var b=
this.service_url;h.str.endsWith(b,"/")||(b+="/");return b+=[a,""].join("/")},_onItemRefreshed:function(a,b){try{if(f.checkError(a.error,"refresh"),a.rowInfo)b._refreshValues(a.rowInfo,2);else throw b._dbSet.removeItem(b),b.destroy(),Error(RIAPP.ERRS.ERR_ITEM_DELETED_BY_ANOTHER_USER);}catch(c){d._checkIsDummy(c)&&d._throwDummy(c),this._onDataOperError(c,"refresh"),d._throwDummy(c)}},_refreshItem:function(a){var b=h.createDeferred(),c=function(c){c?b.resolve(a):b.reject()},e=this._getUrl("RefreshItem"),
d=a._dbSet;this.waitForNotSubmiting(function(){var b=this;d.waitForNotLoading(function(){var k,f=function(){b.isBusy=!1;d.isLoading=!1;a._isRefreshing=!1},g=function(a){f();b._onDataOperError(a,"refresh")};a._isRefreshing=!0;b.isBusy=!0;d.isLoading=!0;try{var n={dbSetName:a._dbSetName,rowInfo:a._getRowInfo(),error:null};a._checkCanRefresh();k=JSON.stringify(n);h.performAjaxCall(e,k,!0,function(e){try{b._onItemRefreshed(e,a),f(),c(!0)}catch(d){g(d),c(!1)}},function(a){f();b._onDataOperError(a,"refresh");
c(!1)},null)}catch(w){g(w),c(!1)}},[],!0,null)},[],null);return b.promise()},_onError:function(a,b){var c=this._super(a,b);return!c?this.app?this.app._onError(a,b):d._onError(a,b):c},_onDataOperError:function(a,b){if(d._checkIsDummy(a))return!0;var c;c=u.isPrototypeOf(a)?a:u.create(a,b);return this._onError(c,this)},_onSubmitError:function(a){var b={error:a,isHandled:!1};this.raiseEvent("submit_error",b);b.isHandled||(this.rejectChanges(),this._onDataOperError(a,"submit"))},_loadChunks:function(a,
b,c,e){var d=this;h.performAjaxCall(a,b,!0,function(q){try{f.checkError(q.error,"load");var k=q.chunksID&&0<q.chunksLeft;c.rows=c.rows.concat(q.rows);q.rows=[];c.included&&0<c.included.length&&c.included.forEach(function(a){var b=q.included.filter(function(b){return b.dbSetName==a.dbSetName});1==b.length&&(a.rows=a.rows.concat(b[0].rows))});k?d._loadChunks(a,b,c,e):e(c,null)}catch(g){e(null,g)}},function(a){e(null,a)},null)},_beforeLoad:function(a,b,c){a&&b!==a&&(c._query=a,c.pageIndex=0);b&&b!==
a&&b.destroy();if(a.pageSize!==c.pageSize){c._ignorePageChanged=!0;try{c.pageIndex=0,c.pageSize=a.pageSize}finally{c._ignorePageChanged=!1}}if(a.pageIndex!==c.pageIndex){c._ignorePageChanged=!0;try{c.pageIndex=a.pageIndex}finally{c._ignorePageChanged=!1}}a.isCacheValid||a._clearCache()},_load:function(a,b){if(!a)throw Error(RIAPP.ERRS.ERR_DB_LOAD_NO_QUERY);var c=this,e=h.createDeferred(),d=function(a,b){a?e.resolve(b):e.reject()},q=a.loadPageCount,k=a.pageIndex,f=a.isPagingEnabled,g=a.dbSetName,n=
this.getDbSet(g);this.waitForNotSubmiting(function(){n.waitForNotLoading(function(){var e=n.query,l=c._getUrl("GetItems"),m,A,u=function(){n.isLoading=!1;c.isBusy=!1},x=function(a){u();d(!0,a)},p=function(a){u();c._onDataOperError(a,"load");d(!1,null)},v;n.isLoading=!0;c.isBusy=!0;try{a.pageIndex=k;c._beforeLoad(a,e,n);var y,e=1;if(1<q&&f){if(a._isPageCached(k)){v=c._loadFromCache(a,b);v.outOfBandData=null;x(v);return}y=a._getCache().getNextRange(k);k=y.start;e=y.cnt}m={dbSetName:g,pageIndex:k,pageSize:a.pageSize,
pageCount:e,isIncludeTotalCount:a.isIncludeTotalCount,filterInfo:a.filterInfo,sortInfo:a.sortInfo,paramInfo:c._getMethodParams(a._queryInfo,a.params).paramInfo,queryName:a.queryName,chunksID:null};A=JSON.stringify(m);h.performAjaxCall(l,A,!0,function(a){try{a.chunksID&&0<a.chunksLeft?(m.chunksID=a.chunksID,m.filterInfo=null,m.sortInfo=null,m.paramInfo=null,A=JSON.stringify(m),c._loadChunks(l,A,a,function(a,e){e?(u(),c._onDataOperError(e,"load"),d(!1,null)):(v=c._onLoaded(a,b),v.outOfBandData=a.extraInfo,
x(v))})):(v=c._onLoaded(a,b),v.outOfBandData=a.extraInfo,x(v))}catch(e){p(e)}},function(a){u();c._onDataOperError(a,"load");d(!1,null)},null)}catch(B){p(B)}},[],!0,b?"paging":null)},[],b?"paging":null);return e.promise()},getDbSet:function(a){if(!this.isInitialized)throw Error(RIAPP.ERRS.ERR_DOMAIN_CONTEXT_NOT_INITIALIZED);var b=this._dbSets[a];if(!b)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_DBSET_NAME_INVALID,a));return b},getAssociation:function(a){var b=this._assoc[a];if(!b)throw Error(RIAPP.utils.format(RIAPP.ERR_ASSOC_NAME_INVALID,
...
c>b&&(this._currentPos=c-1,this._onCurrentChanged())}},sortLocal:function(a,b){var c=1,e=this._app.parser;b&&"DESC"===b.toUpperCase()&&(c=-1);this.fn_sort=function(b,d){var k=0,f,g,n;f=0;for(g=a.length;f<g&&!(n=a[f],k=e.resolvePath(b,n),n=e.resolvePath(d,n),k=k<n?-1*c:k>n?c:0,0!==k);f+=1);return k}},getIsHasErrors:function(){return this._dataSource.getIsHasErrors()},clear:function(){this.cancelEdit();this._EditingItem=null;this._newKey=0;this.currentItem=null;this._items=[];this._itemsByKey={};this._errors=
...
this._$template=this._template=null;this._fn_submitOnOK=function(){var a=c._dbContext;if(!a)return l.createDeferred().resolve();a.addHandler("submit_error",function(a,b){p.SubmitError.isPrototypeOf(b.error)&&0<b.error.notValidated.length&&(b.isHandled=!0)},c._objId);var b=a.submitChanges();b.always(function(){a.removeHandler("submit_error",c._objId)});return b};this._updateIsEditable();this._options={width:a.width,height:a.height,title:a.title,autoOpen:!1,modal:!0,close:function(a,b){c._onClose()},
...
RIAPP.Application._coreModules.datagrid=function(a){var f=this,d=a.global,l=d.utils,h=d.consts,p,m,g,b,c,e,k,n,u,v,z,x,y,B=a.modules.baseElView.BaseElView,t=a.modules.collection,w=a.modules.datadialog.DataEditDialog,C=a.modules.template.Template,A=RIAPP.localizable.TEXT,r={container:"ria-table-container",dataTable:"ria-data-table",columnInfo:"ria-col-info",column:"ria-ex-column",cellDiv:"cell-div",headerDiv:"ria-table-header",wrapDiv:"ria-table-wrap",dataColumn:"data-column",rowCollapsed:"row-collapsed",
rowExpanded:"row-expanded",rowExpander:"row-expander",columnSelected:"selected",rowSelected:"selected",rowActions:"row-actions",rowDetails:"row-details",rowSelector:"row-selector",rowHighlight:"row-highlight",rowDeleted:"row-deleted",rowError:"row-error",nobr:"ria-nobr",colSortable:"sortable",colSortAsc:"sort-asc",colSortDesc:"sort-desc"};Object.freeze(r);f.css=r;p=RIAPP.BaseObject.extend({_app:a,_create:function(a,b){this._super();this._row=a;this._el=b.td;this._column=b.column;this._div=d.document.createElement("div");
var c=d.$(this._div);this._clickTimeOut=null;c.addClass(r.cellDiv).attr(h.DATA_ATTR.DATA_EVENT_SCOPE,this._column.uniqueID);this._div.cell=this;this._column.options.width&&(this._el.style.width=this._column.options.width);this._init();this._column.options.rowCellCss&&c.addClass(this._column.options.rowCellCss);this._el.appendChild(this._div);this._row.el.appendChild(this._el)},_init:function(){},_onCellClicked:function(){this.grid.currentRow=this._row},_onDblClicked:function(){this.grid.currentRow=
...
a});k=p.extend({_init:function(){var a=d.$(this.el);a.addClass(r.rowCollapsed);a.addClass(r.rowExpander)},_onCellClicked:function(){this._row&&(this._super(),this._row.isExpanded=!this._row.isExpanded)},_toggleImage:function(){var a=d.$(this.el);this._row.isExpanded?(a.removeClass(r.rowCollapsed),a.addClass(r.rowExpanded)):(a.removeClass(r.rowExpanded),a.addClass(r.rowCollapsed))},toString:function(){return"ExpanderCell"}},null,function(a){f.ExpanderCell=a});n=p.extend({_create:function(a,b){this._isEditing=
...
c.th;this._options=c.colinfo;this._isSelected=!1;this._objId="col"+this.app.getNewObjectID();var k=d.$("<div></div>");k.addClass(r.column);this._grid._headerDiv.append(k);this._extcol=k;var f=d.$("<div></div>");f.addClass(r.cellDiv).click(function(b){b.stopPropagation();d.currentSelectable=a;a._setCurrentColumn(e);e._onColumnClicked()});k.append(f);f.get(0).cell=this;this._div=f;d.$(this.grid._tableEl).on("click","div["+h.DATA_ATTR.DATA_EVENT_SCOPE+'="'+this.uniqueID+'"]',function(c){c.stopPropagation();
...
this.$div;b.removeClass(r.colSortable).removeClass(r.colSortAsc).removeClass(r.colSortDesc);switch(a){case "ASC":b.addClass(r.colSortAsc);break;case "DESC":b.addClass(r.colSortDesc);break;default:this.isSortable&&b.addClass(r.colSortable)}this._sortOrder=a},get:function(){return this._sortOrder}}},function(a){f.DataColumn=a});z=p.extend({_init:function(){this._super();this.$div.addClass(r.rowExpander)},toString:function(){return"ExpanderColumn"}},null,function(a){f.ExpanderColumn=a});x=p.extend({_init:function(){this._super();
...
null)},_createColumns:function(){for(var a=this,b=this._tHeadCells,c=b.length,e=[],d,k,f=0;f<c;f+=1)d=b[f],k=this._parseColumnAttr(d.getAttribute(h.DATA_ATTR.DATA_COLUMN),d.getAttribute(h.DATA_ATTR.DATA_CONTENT)),e.push({th:d,colinfo:k});e.forEach(function(b){(b=a._createColumn(b))&&a._columns.push(b)})},_createColumn:function(a){var b;switch(a.colinfo.type){case "row_expander":this._expanderCol||(this._expanderCol=b=z.create(this,a));break;case "row_actions":this._actionsCol||(this._actionsCol=b=
...
RIAPP.Application._coreModules.dataform=function(a){var f=this,d=a.global,l=d.utils,h=d.consts,p=a.modules.binding.Binding,m=a.modules.baseElView.BaseElView,g={dataform:"ria-dataform"},b=RIAPP.localizable.VALIDATE;Object.freeze(g);f.css=g;var c=RIAPP.BaseObject.extend({_DATA_CONTENT_SELECTOR:"*["+h.DATA_ATTR.DATA_CONTENT+"]:not(["+h.DATA_ATTR.DATA_COLUMN+"])",_app:a,_create:function(b,c){var f=this,h;this._super();this._el=b;this._$el=d.$(this._el);this._objId="frm"+this._app.getNewObjectID();this._css=
...
RIAPP.Application._coreModules.elview=function(a){var f=this,d=a.global,l=d.utils,h=a.modules.baseElView,p=h.BaseElView,m=h.EditableElView,g=h.CommandElView,b=h.css;f.BaseElView=p;f.EditableElView=m;f.CommandElView=g;p.extend({_init:function(a){this._super(a);this._someProp=null}},{someProp:{set:function(a){if(a!==this._someProp){debugger;this._someProp=a;this.raisePropertyChanged("someProp");this.$el.html(""+this._someProp)}},get:function(){return this._someProp}}},function(b){f.DebuggerElView=b;
...
_getEventNames:function(){var a=this._super();return["keypress"].concat(a)},toString:function(){return"TextBoxElView"}},{value:{set:function(a){if(this._el){var b=this._el,d=b.value;a=null===a?"":""+a;d!==a&&(b.value=a,this.raisePropertyChanged("value"))}},get:function(){var a=this._el;return!a?"":a.value}}},function(b){f.TextBoxElView=b;a.registerType("TextBoxElView",b);a.registerElView("input:text",b)});p.extend({toString:function(){return"HiddenElView"}},{value:{set:function(a){if(this._el){var b=
...
this._isExpanded?this._expandedsrc:this._collapsedsrc;this._super()},toString:function(){return"ExpanderElView"}},{isExpanded:{set:function(a){this._isExpanded!==a&&(this._isExpanded=a,this.invokeCommand(),this.raisePropertyChanged("isExpanded"))},get:function(){return this._isExpanded}}},function(b){f.ExpanderElView=b;a.registerType("ExpanderElView",b);a.registerElView("expander",b)});p.extend({toString:function(){return"SpanElView"}},{value:{set:function(a){this.text=a},get:function(){return this.text}},
...
c,e,f){b=this._super(b,c,e,f);b.converter=a.getConverter("dateTimeConverter");c=this.getFieldInfo();e=d.defaults;switch(c.dataType){case m.DateTime:b.converterParam=e.dateTimeFormat;break;case m.Time:b.converterParam=e.timeFormat;break;default:b.converterParam=e.dateTimeFormat}return b},toString:function(){return"DateTimeContent"}},null,function(a){f.DateTimeContent=a}),n=b.extend({_allowedKeys:[0,g.backspace,g.del,g.left,g.right,g.end,g.home,g.tab,g.esc,g.enter],_getBindingOption:function(b,c,d,
...
get:function(){return this._value}}},function(a){f.LookupContent=a});f.BindingContentFactory=RIAPP.BaseObject.extend({_app:a,getContentType:function(a){var d=a.fieldInfo;if(a.lookup)return z;switch(d.dataType){case m.None:a=b;break;case m.String:a=a.multyline?v:u;break;case m.Bool:a=e;break;case m.Integer:a=n;break;case m.Decimal:case m.Float:a=n;break;case m.DateTime:case m.Time:a=k;break;case m.Date:a=c;break;case m.Guid:case m.Binary:a=b;break;default:throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_FIELD_DATATYPE,
