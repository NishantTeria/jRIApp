...
{})});a.window.onerror=function(a,d,h){if(a&&-1<a.indexOf("DUMMY_ERROR"))return!0;alert("Error message: "+a+"\nURL: "+d+"\nLine Number: "+h);return!1}},_getEventNames:function(){var a=this._super();return["load","unload"].concat(a)},_addHandler:function(a,g,d,h){var k=this;"load"==a&&k._isReady?setTimeout(function(){g(k,{})},0):this._super(a,g,d,h)},_onGridAdded:function(a){var g=this,d=g.utils,h=a.$container;h.on("click."+a.uniqueID,function(k){k.stopPropagation();d.isContained(k.target,h.get(0))&&
(g.currentSelectable=a)})},_onGridRemoved:function(a){a.$container.off("click."+a.uniqueID);this.currentSelectable===a&&(this.currentSelectable=null)},_onStackPanelAdded:function(a){var g=this,d=g.utils,h=a._$el;h.on("click."+a.uniqueID,function(k){k.stopPropagation();d.isContained(k.target,h.get(0))&&(g.currentSelectable=a)})},_onStackPanelRemoved:function(a){a._$el.off("click."+a.uniqueID);this.currentSelectable===a&&(this.currentSelectable=null)},_registerApp:function(a){this._appInst[a.appName]||
