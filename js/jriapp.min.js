...
(d||"\\s")+"]+","g"),"")},rtrim:function(a,d){return a.replace(RegExp("["+(d||"\\s")+"]+$","g"),"")},isArray:function(a){return!a?!1:Array.isArray(a)},format:function(){for(var f="",d=arguments,h=d[0],k=0;;){var m=h.indexOf("{",k),p=h.indexOf("}",k);if(0>m&&0>p){f+=h.slice(k);break}if(0<p&&(p<m||0>m)){if("}"!==h.charAt(p+1))throw Error(a.format(RIAPP.ERRS.ERR_STRING_FORMAT_INVALID,h));f+=h.slice(k,p+1);k=p+2}else if(f+=h.slice(k,m),k=m+1,"{"===h.charAt(k))f+="{",k++;else{if(0>p)throw Error(a.format(RIAPP.ERRS.ERR_STRING_FORMAT_INVALID,
h));var m=h.substring(k,p),g=m.indexOf(":"),k=parseInt(0>g?m:m.substring(0,g),10)+1;if(isNaN(k))throw Error(a.format(RIAPP.ERRS.ERR_STRING_FORMAT_INVALID,h));m=0>g?"":m.substring(g+1);k=d[k];if(void 0===k||null===k)k="";f=k.format?f+k.format(m):f+k.toString();k=p+1}}return f}};String.format||(String.format=function(){var f=Array.prototype.slice.call(arguments);return a.format.apply(a,f)});return a}();
RIAPP.BaseObject={_create:function(){this.__events=this._super=null;this._isDestroyCalled=this._isDestroyed=!1},create:function(){var a=Object.create(this);a._create.apply(a,arguments);Object.seal(a);return a},extend:function(a,f,d){var h=f||{},k,m=0,p,g,b=/\._super\s*\(/;Object.getOwnPropertyNames(h).forEach(function(c){c=h[c];void 0===c.enumerable&&(c.enumerable=!0);void 0===c.configurable&&(c.configurable=!1)});h._typeName=Object.getOwnPropertyDescriptor({_typeName:""},"_typeName");h.__eventNames=
Object.getOwnPropertyDescriptor({__eventNames:[]},"__eventNames");if(a){k=Object.getOwnPropertyNames(a);m=0;for(p=k.length;m<p;m+=1)f=k[m],h.hasOwnProperty(f)||(h[f]=Object.getOwnPropertyDescriptor(a,f))}g=Object.create(this,h);Object.getOwnPropertyNames(g).forEach(function(c){var e=Object.getOwnPropertyDescriptor(g,c),l,n,a;e.value&&RIAPP.utils.isFunc(e.value)&&(n=e.value.toString(),l=g[c],b.test(n)?(a=Object.getPrototypeOf(g),e.value="destroy"==c?function(){var b=this._super;this._super=a[c];try{return this._isDestroyCalled=
!0,l.apply(this,arguments)}finally{this._super=b}}:function(){var b=this._super;this._super=a[c];try{return l.apply(this,arguments)}finally{this._super=b}},Object.defineProperty(g,c,e)):"destroy"==c&&(e.value=function(){this._isDestroyCalled=!0;return l.apply(this,arguments)},Object.defineProperty(g,c,e)))});g.__eventNames=g._getEventNames();d&&d(g);return g},_addHandler:function(a,f,d,h){if(!this._isDestroyed){if(!RIAPP.utils.isFunc(f))throw Error(RIAPP.ERRS.ERR_EVENT_INVALID_FUNC);if(!a)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_EVENT_INVALID,
a));null===this.__events&&(this.__events={});var k=this.__events,m="*";d&&(m=""+d);k[a]||(k[a]=[]);a=k[a];a.some(function(a){return a.fn===f&&a.ns==m})||(h?a.unshift({fn:f,ns:m}):a.push({fn:f,ns:m}))}},_removeHandler:function(a,f){var d=this.__events,h="*";if(d){f&&(h=""+f);var k,m,p;if(a){if(d[a])if("*"==h)delete d[a];else{k=d[a];m=k.filter(function(g){return g.ns==h});for(p=k.length;0<p;)p-=1,-1<m.indexOf(k[p])&&k.splice(p,1);0==k.length&&delete d[a]}}else"*"!=h?Object.keys(d).forEach(function(g){var b=
d[g],c=b.filter(function(c){return c.ns==h});for(p=b.length;0<p;)p-=1,-1<c.indexOf(b[p])&&b.splice(p,1);0==b.length&&delete d[g]}):this.__events=null}},_raiseEvent:function(a,f){var d=this,h=d.__events;null!==h&&a&&("0*"!=a&&RIAPP.utils.startsWith(a,"0")&&this._raiseEvent("0*",f),h[a]&&Array.clone(h[a]).forEach(function(a){a.fn.apply(d,[d,f])}))},_onError:function(a,f){if(RIAPP.global&&RIAPP.global._checkIsDummy(a))return!0;a.message||(a=Error(""+a));var d={error:a,source:f,isHandled:!1};this._raiseEvent("error",
...
{})});a.window.onerror=function(a,d,h){if(a&&-1<a.indexOf("DUMMY_ERROR"))return!0;alert("Error message: "+a+"\nURL: "+d+"\nLine Number: "+h);return!1}},_getEventNames:function(){var a=this._super();return["load","unload"].concat(a)},_addHandler:function(a,f,d,h){var k=this;"load"==a&&k._isReady?setTimeout(function(){f.apply(k,[k,{}])},0):this._super(a,f,d,h)},_onGridAdded:function(a){var f=this,d=f.utils,h=a.$container;h.on("click."+a.uniqueID,function(k){k.stopPropagation();d.isContained(k.target,
h.get(0))&&(f.currentSelectable=a)})},_onGridRemoved:function(a){a.$container.off("click."+a.uniqueID);this.currentSelectable===a&&(this.currentSelectable=null)},_onStackPanelAdded:function(a){var f=this,d=f.utils,h=a._$el;h.on("click."+a.uniqueID,function(k){k.stopPropagation();d.isContained(k.target,h.get(0))&&(f.currentSelectable=a)})},_onStackPanelRemoved:function(a){a._$el.off("click."+a.uniqueID);this.currentSelectable===a&&(this.currentSelectable=null)},_registerApp:function(a){this._appInst[a.appName]||
(this._appInst[a.appName]=a)},_unregisterApp:function(a){this._appInst[a.appName]&&(delete this._appInst[a.appName],delete this._templateLoaders[a.appName],delete this._templateGroups[a.appName])},_destroyApps:function(){var a=this;this.utils.forEachProp(this._appInst,function(f){a._appInst[f].destroy()})},_throwDummy:function(a){var f=this.modules.errors;if(f&&a&&!a.isDummy)throw f.DummyError.create(a);throw a;},_checkIsDummy:function(a){return!!a.isDummy},_registerObjectCore:function(a,f,d,h){var k=
f.split("."),m;for(m=0;m<k.length-1;m+=1)a[k[m]]||(a[k[m]]={}),a=a[k[m]];k=k[k.length-1];if(h&&a[k])throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_OBJ_ALREADY_REGISTERED,f));a[k]=d;return a},_getObjectCore:function(a,f){var d=f.split("."),h=a,k;for(k=0;k<d.length;k+=1){if(!h[d[k]])return null;h=h[d[k]]}return h},_registerType:function(a,f,d){return this._registerObjectCore(a._exports,f,d,!0)},_getType:function(a,f){return this._getObjectCore(a._exports,f)},_processTemplateSections:function(a){var f=
this;Array.fromList(a.querySelectorAll(f._TEMPLATES_SELECTOR)).forEach(function(a){f._processTemplateSection(a,null);f.utils.removeNode(a)})},_processTemplateSection:function(a,f){var d=this;Array.fromList(a.querySelectorAll(d._TEMPLATE_SELECTOR)).forEach(function(a){var k=d.document.createElement("div"),m=a.getAttribute("id"),p=d.utils.createDeferred();a.removeAttribute("id");k.appendChild(a);p.resolve(k.innerHTML);f&&(m=f.appName+"."+m);d._registerTemplateLoader(m,{fn_loader:function(){return p.promise()}})})},
_loadTemplatesAsync:function(a,f){var d=this,h=a(),k=d.isLoading;d._promises.push(h);d.isLoading!==k&&d.raisePropertyChanged("isLoading");var m=d.utils.createDeferred();h.done(function(a){d.utils.removeFromArray(d._promises,h);try{var g=d.document.createElement("div");g.innerHTML=a;d._processTemplateSection(g,f);m.resolve()}catch(b){d._onError(b,d),m.reject()}d.isLoading||d.raisePropertyChanged("isLoading")});h.fail(function(a){d.utils.removeFromArray(d._promises,h);d.isLoading||d.raisePropertyChanged("isLoading");
m.reject();a&&a.message?d._onError(a,d):a&&a.responseText?d._onError(Error(a.responseText),d):d._onError(Error("Failed to load templates"),d)});return m.promise()},_registerTemplateLoaderCore:function(a,f){return this._registerObjectCore(this._templateLoaders,a,f,!1)},_getTemplateLoaderCore:function(a){return this._getObjectCore(this._templateLoaders,a)},_registerTemplateLoader:function(a,f){f=this.utils.extend(!1,{fn_loader:null,groupName:null},f);if(!f.groupName&&!this.utils.check_is.Function(f.fn_loader))throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_ASSERTION_FAILED,
"fn_loader is Function"));var d=this._getTemplateLoaderCore(a);if(d){if(!d.fn_loader&&d.groupName&&!f.groupName&&f.fn_loader)return this._registerTemplateLoaderCore(a,f);throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_TEMPLATE_ALREADY_REGISTERED,a));}return this._registerTemplateLoaderCore(a,f)},_getTemplateLoader:function(a){var f=this,d=f._getTemplateLoaderCore(a);if(!d)return null;if(!d.fn_loader&&d.groupName){var h=f._getTemplateGroup(d.groupName);if(!h)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_TEMPLATE_GROUP_NOTREGISTERED,
d.groupName));return function(){h.promise||(h.promise=f._loadTemplatesAsync(h.fn_loader,h.app));var d=f.utils.createDeferred();h.promise.done(function(){try{h.promise=null;h.names.forEach(function(g){h.app&&(g=h.app.appName+"."+g);var b=f._getTemplateLoaderCore(g);if(!b||!b.fn_loader)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_TEMPLATE_NOTREGISTERED,g));});var m=f._getTemplateLoaderCore(a);if(!m||!m.fn_loader)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_TEMPLATE_NOTREGISTERED,a));delete f._templateGroups[m.groupName];
m.fn_loader().done(function(g){d.resolve(g)}).fail(function(g){d.reject(g)})}catch(p){d.reject(p)}});h.promise.fail(function(a){h.promise=null;d.reject(a)});return d.promise()}}return d.fn_loader},_registerTemplateGroup:function(a,f){var d=this;f=d.utils.extend(!1,{fn_loader:null,url:null,names:null,app:null,promise:null},f);f.url&&!f.fn_loader&&(f.fn_loader=function(){return d.utils.performAjaxGet(f.url)});var h=this._registerObjectCore(d._templateGroups,a,f,!0);f.names.forEach(function(k){f.app&&
(k=f.app.appName+"."+k);d._registerTemplateLoader(k,{groupName:a,fn_loader:null})});return h},_getTemplateGroup:function(a){return this._getObjectCore(this._templateGroups,a)},_waitForNotLoading:function(a,f){this._waitQueue.enQueue({prop:"isLoading",groupName:null,predicate:function(a){return!a},action:a,actionArgs:f})},reThrow:function(a,f){if(f)this._throwDummy(a);else throw a;},findApp:function(a){return this._appInst[a]},destroy:function(){this._isDestroyed||(this._waitQueue&&(this._waitQueue.destroy(),
...
RIAPP.Global._coreModules.array_ext=function(a){Array.prototype.distinct=function(){var a={},d,h=this.length,k=[];for(d=0;d<h;d+=1)a[this[d]]=this[d];var m=Object.keys(a);d=0;for(h=m.length;d<h;d+=1)k.push(a[m[d]]);return k};Array.prototype.intersect=function(a){return this.filter(function(d){return-1<a.indexOf(d)})};Array.fromList=function(a){for(var d=Array(a.length),h=0,k=a.length;h<k;h++)d[h]=a[h];return d}};
...
esc:27,space:32,pageUp:33,pageDown:34,end:35,home:36,left:37,up:38,right:39,down:40,del:127};f.ELVIEW_NM={DATAFORM:"dataform",DYNACONT:"dynacontent"};f.LOADER_GIF={SMALL:"loader2.gif",NORMAL:"loader.gif"};Object.getOwnPropertyNames(f).forEach(function(a){Object.freeze(f[a])});Object.freeze(f);this.consts=f;a.consts=this.consts};
...
RIAPP.Global._coreModules.utils=function(a){var f=this,d=RIAPP.utils,h=0,k={Null:function(b){return null===b},Undefined:function(b){return void 0===b},nt:function(b){return null===b||void 0===b},Function:d.isFunc,String:function(b){if(k.nt(b))return!1;var c=/string/i;return"string"===typeof b?!0:"object"===typeof b?c.test(b.constructor.toString()):!1},Array:d.isArray,Boolean:function(b){if(k.nt(b))return!1;var c=/boolean/i;return"boolean"===typeof b?!0:"object"===typeof b?c.test(b.constructor.toString()):
...
!1},SimpleObject:function(b){return k.nt(b)?!1:k.Object(b)&&Object.prototype===Object.getPrototypeOf(b)},RegExp:function(b){if(k.nt(b))return!1;var c=/regexp/i;return"function"===typeof b?c.test(b.constructor.toString()):!1},Numeric:function(b){return k.Number(b)||k.String(b)&&!isNaN(Number(b))},BoolString:function(b){return k.nt(b)?!1:"true"==b||"false"==b}},m={checkNumRange:function(b,c){var e=c.split(",");if(e[0]&&b<parseFloat(e[0]))throw Error(String.format(RIAPP.ERRS.ERR_FIELD_RANGE,b,c));if(e[1]&&
b>parseFloat(e[1]))throw Error(String.format(RIAPP.ERRS.ERR_FIELD_RANGE,b,c));},_dtRangeToDate:function(b){b=b.split("-");return new Date(parseInt(b[0],10),parseInt(b[1],10)-1,b[2])},checkDateRange:function(b,c){var e=c.split(",");if(e[0]&&b<m._dtRangeToDate(e[0]))throw Error(String.format(RIAPP.ERRS.ERR_FIELD_RANGE,b,c));if(e[1]&&b>m._dtRangeToDate(e[1]))throw Error(String.format(RIAPP.ERRS.ERR_FIELD_RANGE,b,c));}},p={str:{endsWith:d.endsWith,startsWith:d.startsWith,trim:d.trim,formatNumber:function(b,
c,e,a){b=(b+"").replace(/[^0-9+-Ee.]/g,"");var n=!isFinite(+b)?0:+b;b=!isFinite(+c)?0:Math.abs(c);a=void 0===a?",":a;e=void 0===e?".":e;var g="",g=function(c,b){var e=Math.pow(10,b);return""+Math.round(c*e)/e};p.check_is.nt(c)?(g=(""+n).split("."),b=2):g=(b?g(n,b):""+Math.round(n)).split(".");var n="",d=g[0].length;if(3<d){for(c=0;c<d;c+=1)n+=g[0].charAt(c),c<d-1&&0===(d-c-1)%3&&(n+=a);g[0]=n}if((g[1]||"").length<b)g[1]=g[1]||"",g[1]+=Array(b-g[1].length+1).join("0");return g.join(e)},stripNonNumeric:function(b){b+=
"";for(var c=/^\d|\.|-$/,e="",a=0;a<b.length;a++)c.test(b.charAt(a))&&("."==b.charAt(a)&&-1!=e.indexOf(".")||"-"==b.charAt(a)&&0!=e.length||(e+=b.charAt(a)));return e}},check_is:k,validation:m,getNewID:function(){var b=h;h+=1;return b},isContained:function(b,c){if(!b)return!1;for(;b=b.parentNode;)if(b===c)return!0;return!1},slice:Array.prototype.slice,get_timeZoneOffset:function(){var b=(new Date).getTimezoneOffset();return function(){return b}}(),parseBool:function(b){var c=d.trim(b).toLowerCase();
if("false"===c)return!1;if("true"===c)return!0;throw Error(p.format(RIAPP.ERRS.ERR_PARAM_INVALID,"bool_value",b));},round:function(b,c){return parseFloat(b.toFixed(c))},performAjaxCall:function(b,c,e,g,n,s){var d=new XMLHttpRequest;d.open("POST",b,e);var f=p.createDeferred();d.responseType="text";d.onload=function(c){200==this.status&&f.resolve(this.response)};d.onerror=function(c){f.reject(Error(c.target.status))};d.ontimeout=function(){f.reject(Error("The request for "+b+" timed out."))};d.timeout=
1E3*a.defaults.ajaxTimeOut;d.setRequestHeader("Content-Type","application/json; charset=utf-8");d.send(c);c=f.promise();g&&c.done(function(c){g.call(s,c)});n&&c.fail(function(c){n.call(s,c)});return c},performAjaxGet:function(b){var c=new XMLHttpRequest;c.open("GET",b,!0);var e=p.createDeferred();c.responseType="text";c.onload=function(c){200==this.status&&e.resolve(this.response)};c.onerror=function(c){e.reject(Error(c.target.status))};c.ontimeout=function(){e.reject(Error("The request for "+b+" timed out."))};
...
style:{classes:e?e:null},position:{my:"top left",at:"bottom right",target:b,viewport:$(a.window),adjust:{method:"flip none",x:0,y:0}},hide:{fixed:!0,delay:250}};b.data("qtip")?c?b.qtip("option","content.text",c):b.qtip("destroy"):c&&b.qtip(e)},hasProp:function(b,c){if(!b)return!1;if(b.hasOwnProperty(c))return!0;if(Object===b)return!1;var e=Object.getPrototypeOf(b);return p.hasProp(e,c)},createDeferred:function(){return a.$.Deferred()},cloneObj:function(b,c){var e,a,n;if(!b)return b;if(k.Array(b)){n=
b.length;e=Array(n);for(a=0;a<n;a+=1)e[a]=p.cloneObj(b[a],null)}else if(k.SimpleObject(b)){e=c||{};var g,d=Object.getOwnPropertyNames(b);n=d.length;for(a=0;a<n;a+=1)g=d[a],e[g]=p.cloneObj(b[g],null)}else return b;return e},shallowCopy:function(b){return p.mergeObj(b,{})},mergeObj:function(b,c){c||(c={});if(!b)return c;for(var e=Object.getOwnPropertyNames(b),a,n=0,g=e.length;n<g;n+=1)a=e[n],c[a]=b[a];return c},removeFromArray:function(b,c){var e=b.indexOf(c);-1<e&&b.splice(e,1);return e},insertIntoArray:function(b,
c,e){b.splice(e,0,c)},destroyJQueryPlugin:function(b,c){if(b.data(c))b[c]("destroy")},uuid:function(){var b="0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz".split("");return function(c,e){var a,n=[],g=Math.random;e=e||b.length;if(c)for(a=0;a<c;a+=1)n[a]=b[0|g()*e];else{var d;n[8]=n[13]=n[18]=n[23]="-";n[14]="4";for(a=0;36>a;a+=1)n[a]||(d=0|16*g(),n[a]=b[19==a?d&3|8:d&15])}return n.join("")}}()},g=RIAPP.BaseObject.extend({_cnt:0,_create:function(){this._super();this._objs=[];g._cnt+=
...
RIAPP.Global._coreModules.riapp=function(a){var f=this,d=a.utils,h=a.consts,k={},m={},p=RIAPP.BaseObject.extend({_DATA_BIND_SELECTOR:["*[",h.DATA_ATTR.DATA_BIND,"]"].join(""),_TEMPLATES_DATA_BIND_SELECTOR:["section.",RIAPP.css_riaTemplate," *[",h.DATA_ATTR.DATA_BIND,"]"].join(""),registerModule:function(a,b){if(m[a])throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_MODULE_ALREDY_REGISTERED,a));m[a]=b},_create:function(g){this._super();g=d.extend(!1,{app_name:"default",service_url:"",metadata:null,createDbContext:!0,
moduleNames:[]},g);var b=g.app_name;if(a.findApp(b))throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_APP_NAME_NOT_UNIQUE,b));Object.freeze(g);this._options=g;this._parser=null;this._converters={};this._lftmBind=this._dbContext=null;this._instanceNum=a._getNextAppNum();this._ELV_STORE_KEY=h.DATA_ATTR.EL_VIEW_KEY+this._instanceNum;this._bindingContentFactory=null;this._modInst={};this._exports={};this._elViews={};this._elViewStore={};this._global=a;this._nextElViewStoreKey=0;this._userCode={};this._viewModels=
{};var c,e;c=0;for(e=RIAPP._app_modules.length;c<e;c+=1)b={},k[RIAPP._app_modules[c]].apply(b,[this]),Object.freeze(b),this._modInst[RIAPP._app_modules[c]]=b;g=d.check_is.Array(g.moduleNames)&&0<g.moduleNames.length?g.moduleNames:[];c=0;for(e=g.length;c<e;c+=1){if(!m[g[c]])throw Error(String.format(RIAPP.ERRS.ERR_MODULE_UNDEFINED,g[c]));b={};m[g[c]].apply(b,[this]);Object.freeze(b);this._modInst[g[c]]=b}a._registerApp(this)},destroy:function(){this._isDestroyed||(a._unregisterApp(this),this._destroyBindings(),
...
a)},_getBindingOption:function(a,b,c){var e={mode:this.modules.binding.BINDING_MODE[1],converterParam:null,converter:null,targetPath:null,sourcePath:null,target:null,source:null,isSourceFixed:!1},l=a.source,n=a.target;!a.sourcePath&&a.to?e.sourcePath=a.to:a.sourcePath&&(e.sourcePath=a.sourcePath);a.targetPath&&(e.targetPath=a.targetPath);a.converterParam&&(e.converterParam=a.converterParam);a.mode&&(e.mode=a.mode);a.converter&&(d.check_is.String(a.converter)?e.converter=this.getConverter(a.converter):
e.converter=a.converter);n?d.check_is.String(n)?e.target="this"==n?b:this.parser.resolveBindingSource(this,this.parser._getPathParts(n)):e.target=n:e.target=b;l?(e.isSourceFixed=!0,d.check_is.String(l)?e.source="this"==l?b:this.parser.resolveBindingSource(this,this.parser._getPathParts(l)):e.source=l):e.source=c;return e},_getElViewType:function(a){return this._elViews[a]},_getElView:function(a){return(a=a.getAttribute(this._ELV_STORE_KEY))?this._elViewStore[a]:null},_setElView:function(a,b){var c=
a.getAttribute(this._ELV_STORE_KEY);c?b?this._elViewStore[c]=b:(a.removeAttribute(this._ELV_STORE_KEY),delete this._elViewStore[c]):b&&(c="s_"+this._nextElViewStoreKey,this._nextElViewStoreKey+=1,a.setAttribute(this._ELV_STORE_KEY,c),this._elViewStore[c]=b)},_isDataForm:function(a){if(!a)return!1;a=a.getAttribute(h.DATA_ATTR.DATA_VIEW);if(!a)return!1;a=this.parser.parseOptions(a);return 0<a.length&&a[0].name===h.ELVIEW_NM.DATAFORM},_isInsideDataForm:function(a){return!a?!1:(a=a.parentElement)?this._isDataForm(a)?
!0:this._isInsideDataForm(a):!1},_bindTemplateElements:function(a){var b=this,c=Array.fromList(a.querySelectorAll(b._DATA_BIND_SELECTOR)),e=d.LifeTimeScope.create();a.hasAttribute(h.DATA_ATTR.DATA_BIND)&&c.push(a);c.forEach(function(c){var n,a,g,d,f;if(!b._isInsideDataForm(c)){d=c.getAttribute(h.DATA_ATTR.DATA_BIND);c.removeAttribute(h.DATA_ATTR.DATA_BIND);d=b.parser.parseOptions(d);f=b.getElementView(c);e.addObj(f);n=0;for(a=d.length;n<a;n+=1)c=b._getBindingOption(d[n],f,null),g=b.bind(c),c.target=
null,e.addObj(g)}});return e},_bindElements:function(g,b,c){var e=this;g=g||a.document;g=Array.fromList(g.querySelectorAll(e._DATA_BIND_SELECTOR));var l=d.LifeTimeScope.create();g.forEach(function(n){var a,g;if(c||!e._isInsideDataForm(n)){if(!c&&(n.hasAttribute(h.DATA_ATTR.DATA_APP)&&(a=n.getAttribute(h.DATA_ATTR.DATA_APP)),a&&e.appName!==a||!a&&"default"!==e.appName))return;a=n.getAttribute(h.DATA_ATTR.DATA_BIND);n=e.getElementView(n);l.addObj(n);a=e.parser.parseOptions(a);for(var d=0,f=a.length;d<
f;d+=1)g=e._getBindingOption(a[d],n,b),g=e.bind(g),l.addObj(g)}});return l},_getContent:function(a,b,c,e,l){if(b.templateInfo)a=a.create(c,b.templateInfo,e,l);else if(b.bindingInfo)a=a.create(c,b,e,l);else throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_PARAM_INVALID,"options","bindingInfo"));return a},_getContentType:function(a){if(a.templateInfo)a=this.modules.baseContent.TemplateContent;else if(a.bindingInfo)a=this.bindingContentFactory.getContentType(a);else throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_PARAM_INVALID,
...
this)},registerTemplateLoader:function(g,b){a._registerTemplateLoader(this.appName+"."+g,{fn_loader:b})},getTemplateLoader:function(g){var b=a._getTemplateLoader(this.appName+"."+g);b||(b=a._getTemplateLoader(g));return b},registerTemplateGroup:function(g,b){b=a.utils.extend(!1,{fn_loader:null,url:null,names:null,app:this},b);a._registerTemplateGroup(this.appName+"."+g,b)},toString:function(){return"Application"+this._instanceNum}},{_coreModules:{get:function(){return k}},bindingContentFactory:{get:function(){return this._bindingContentFactory},
set:function(a){this._bindingContentFactory=a}},options:{get:function(){return this._options}},modules:{get:function(){return this._modInst}},parser:{get:function(){return this._parser}},instanceNum:{get:function(){return this._instanceNum}},appName:{get:function(){return this.options.app_name}},global:{get:function(){return this._global}},dbContext:{get:function(){return this._dbContext}},UC:{get:function(){return this._userCode}},VM:{get:function(){return this._viewModels}},app:{get:function(){return this}},
localizable:{get:function(){return RIAPP.localizable}}},function(g){f.Application=g;a.registerType("Application",g)});RIAPP.Application=p};RIAPP.global=RIAPP.Global.create(window,jQuery,[]);
RIAPP.Application._coreModules.converter=function(a){var f=a.global,d=f.utils,h=d.str,k=RIAPP.BaseObject.extend({convertToSource:function(a,g,b){return a},convertToTarget:function(a,g,b){return d.check_is.nt(a)?null:a}},null,function(d){a.registerType("BaseConverter",d);a.registerConverter("BaseConverter",d)});k.extend({convertToSource:function(a,g,b){return!a?null:f.$.datepicker.parseDate(g,a)},convertToTarget:function(a,g,b){return d.check_is.nt(a)?"":f.$.datepicker.formatDate(g,a)},toString:function(){return"DateConverter"}},
null,function(d){a.registerConverter("dateConverter",d)});k.extend({convertToSource:function(a,g,b){if(!a)return null;g=Date.parseExact(a,g);if(!g)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_CONV_INVALID_DATE,a));return g},convertToTarget:function(a,g,b){return d.check_is.nt(a)?"":a.toString(g)},toString:function(){return"DateTimeConverter"}},null,function(d){a.registerConverter("dateTimeConverter",d)});var m=k.extend({convertToSource:function(a,g,b){if(d.check_is.nt(a))return null;b=f.defaults;
var c=b.decimalPoint,e=4,l=a.replace(b.thousandSep,""),l=l.replace(c,"."),l=h.stripNonNumeric(l);if(""===l)return null;c=null;switch(g){case 4:c=parseInt(l,10);break;case 1:c=parseInt(l,10);break;case 2:e=b.decPrecision;c=d.round(parseFloat(l),e);break;case 3:c=parseFloat(l);break;default:c=Number(l)}if(!d.check_is.Number(c))throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_CONV_INVALID_NUM,a));return c},convertToTarget:function(a,g,b){if(d.check_is.nt(a))return"";var c=f.defaults;b=c.decimalPoint;var e=
c.thousandSep;switch(g){case 1:return h.formatNumber(a,0,b,e);case 2:return g=c.decPrecision,h.formatNumber(a,g,b,e);case 4:return h.formatNumber(a,0,b,"");case 3:return h.formatNumber(a,null,b,e);default:return h.formatNumber(a,null,b,e)}},toString:function(){return"NumberConverter"}},null,function(d){a.registerConverter("numberConverter",d)});k.extend({convertToSource:function(a,g,b){return m.convertToSource(a,1,b)},convertToTarget:function(a,g,b){return m.convertToTarget(a,1,b)},toString:function(){return"IntegerConverter"}},
null,function(d){a.registerConverter("integerConverter",d)});k.extend({convertToSource:function(a,g,b){return m.convertToSource(a,4,b)},convertToTarget:function(a,g,b){return m.convertToTarget(a,4,b)},toString:function(){return"SmallIntConverter"}},null,function(d){a.registerConverter("smallIntConverter",d)});k.extend({convertToSource:function(a,g,b){return m.convertToSource(a,2,b)},convertToTarget:function(a,g,b){return m.convertToTarget(a,2,b)},toString:function(){return"DecimalConverter"}},null,
function(d){a.registerConverter("decimalConverter",d)});k.extend({convertToSource:function(a,g,b){return m.convertToSource(a,3,b)},convertToTarget:function(a,g,b){return m.convertToTarget(a,3,b)},toString:function(){return"FloatConverter"}},null,function(d){a.registerConverter("floatConverter",d)})};
RIAPP.Application._coreModules.parser=function(a){var f=a.global.utils,d=f.str,h=RIAPP.BaseObject.extend({__trimOuterBracesRX:/^([{]){0,1}|([}]){0,1}$/g,__trimQuotsRX:/^(['"])+|(['"])+$/g,__trimBracketsRX:/^(\[)+|(\])+$/g,__indexedPropRX:/(^\w+)\s*\[\s*['"]?\s*([^'"]+)\s*['",]?\s*\]/i,__valueDelimeter1:":",__valueDelimeter2:"=",__keyValDelimeter:",",_getPathParts:function(a){var d=this,f=[];(!a?[]:a.split(".")).forEach(function(a){var b;(b=a.match(d.__indexedPropRX))?(a=b[1],b=b[2],f.push(a),f.push("["+
b+"]")):f.push(a)});return f},_resolveProp:function(f,m){var h;return!m?f:d.startsWith(m,"[")?(h=a.modules.collection,m=this.trimQuotes(this.trimBrackets(m)),h.Dictionary.isPrototypeOf(f)?f.getItemByKey(m):h.Collection.isPrototypeOf(f)?f.getItemByPos(parseInt(m,10)):RIAPP.utils.isArray(f)?f[parseInt(m,10)]:f[m]):f[m]},_resolvePath:function(a,d){return!a?void 0:0===d.length?a:1===d.length?this._resolveProp(a,d[0]):this._resolvePath(this._resolveProp(a,d[0]),d.slice(1))},_setPropertyValue:function(a,
d,f){RIAPP.utils.startsWith(d,"[")?(d=this.trimQuotes(this.trimBrackets(d)),RIAPP.utils.isArray(a)?a[parseInt(d,10)]=f:a[d]=f):a[d]=f},_getKeyVals:function(a){var m,h,g,b=[],c={key:"",val:""},e=!0,l=this.__valueDelimeter1,n=this.__valueDelimeter2,s=this.__keyValDelimeter,u=function(c){c.val&&(f.check_is.Numeric(c.val)?c.val=Number(c.val):f.check_is.BoolString(c.val)&&(c.val=f.parseBool(c.val)));b.push(c)};for(m=0;m<a.length;m+=1){h=a.charAt(m);if("'"===h||'"'===h)g?g===h&&(g=null):g=h;!g&&"{"===h&&
!e?(h=a.substr(m),h=this.getBraceParts(h,!0)[0],c.val+=h,m+=h.length-1):!g&&h===s?c.key&&(u(c),c={key:"",val:""},e=!0):!g&&(h===l||h===n)?e=!1:e?c.key+=h:c.val+=h}c.key&&u(c);b.forEach(function(c){c.key=d.trim(c.key);f.check_is.String(c.val)&&(c.val=d.trim(c.val));""===c.val&&d.startsWith(c.key,"this.")&&(c.val=c.key.substr(5),c.key="targetPath")});return b=b.filter(function(c){return""!==c.val})},resolveBindingSource:function(a,d){if(a){if(0===d.length)return a;if(0<d.length)return this.resolveBindingSource(this._resolveProp(a,
d[0]),d.slice(1));throw Error("Invalid operation");}},resolvePath:function(a,d){if(!d)return a;var f=this._getPathParts(d);return this._resolvePath(a,f)},getBraceParts:function(a,d){var f,g="",b,c,e=0,l=[];for(f=0;f<a.length;f+=1){b=a.charAt(f);if("'"===b||'"'===b)c?c===b&&(c=null):c=b;if(!c&&"{"===b)e+=1,g+=b;else if(!c&&"}"===b){if(e-=1,g+=b,0===e&&(l.push(g),g="",d))break}else 0<e&&(g+=b)}return l},trimOuterBraces:function(a){return d.trim(a.replace(this.__trimOuterBracesRX,""))},trimQuotes:function(a){return d.trim(a.replace(this.__trimQuotsRX,
""))},trimBrackets:function(a){return d.trim(a.replace(this.__trimBracketsRX,""))},isWithOuterBraces:function(a){return d.startsWith(a,"{")&&d.endsWith(a,"}")},parseOption:function(a){var m={},h=this;a=d.trim(a);h.isWithOuterBraces(a)&&(a=h.trimOuterBraces(a));h._getKeyVals(a).forEach(function(a){var b=f.check_is.String(a.val);b&&h.isWithOuterBraces(a.val)?m[a.key]=h.parseOption(a.val):m[a.key]=b?h.trimQuotes(a.val):a.val});return m},parseOptions:function(a){var f=[],h=this;a=d.trim(a);var g=[a];
h.isWithOuterBraces(a)&&(g=h.getBraceParts(a,!1));g.forEach(function(b){f.push(h.parseOption(b))});return f},toString:function(){return"Parser"}},null);a._parser=h.create()};
RIAPP.Application._coreModules.baseElView=function(a){var f=this,d=a.global,h=d.utils,k=d.consts,m=RIAPP.localizable.VALIDATE,p=f.css={fieldError:"ria-field-error",errorTip:"ui-tooltip-red",commandLink:"ria-command-link"};Object.freeze(p);var g=RIAPP.BaseObject.extend({_app:a,_create:function(b,c){this._super();this._el=b;this._oldDisplay=this._$el=null;this._objId="elv"+this._app.getNewObjectID();this._propChangedCommand=null;this._app._setElView(this._el,this);this._errors=null;this._toolTip=c.tip;
...
try{this._$el=this._el=this.toolTip=this.validationErrors=this._propChangedCommand=null}finally{this._app._setElView(c,null)}this._super()}},invokePropChanged:function(b){b={property:b};this._propChangedCommand&&this._propChangedCommand.execute(this,b)},_getErrorTipInfo:function(b){var c=["<b>",m.errorInfo,"</b>","<br/>"];b.forEach(function(b){var a="";b.errors.forEach(function(c){a=a+" "+c});c.push(a);a=""});return c.join("")},_setFieldError:function(b){var c=this.$el;b?c.addClass(p.fieldError):
c.removeClass(p.fieldError)},_updateErrorUI:function(b,c){if(b){var a=this.$el;c&&0<c.length?(h.addToolTip(a,this._getErrorTipInfo(c),p.errorTip),this._setFieldError(!0)):(this._setToolTip(a,this.toolTip),this._setFieldError(!1))}},_onError:function(b,c){var a=this._super(b,c);return!a?this._app._onError(b,c):a},_setToolTip:function(b,c,a){h.addToolTip(b,c,a)},toString:function(){return"BaseElView"}},{app:{get:function(){return this._app}},$el:{get:function(){this._el&&!this._$el&&(this._$el=d.$(this._el));
...
this.$el;this._css!=b&&(this._css&&c.removeClass(this._css),(this._css=b)&&c.addClass(this._css),this.raisePropertyChanged("css"))},get:function(){return this._css}}},function(b){f.BaseElView=b;a.registerType("BaseElView",b)});g.extend(null,{isEnabled:{set:function(b){b=!!b;b!==this.isEnabled&&(this._setIsEnabled(this.$el,b),this.raisePropertyChanged("isEnabled"))},get:function(){return this._getIsEnabled(this.$el)}}},function(b){f.EditableElView=b;a.registerType("EditableElView",b)});g.extend({_init:function(b){this._super(b);
...
_getUpdTgtProxy:function(){var a=this;return function(){a._updateTarget()}},_getUpdSrcProxy:function(){var a=this;return function(){a._updateSource()}},_getSrcErrChangedProxy:function(){var a=this;return function(b,c){a._onSrcErrorsChanged()}},_onSrcErrorsChanged:function(){var a=[],b=this._targetObj,c=this._sourceObj,e=this._srcPath;b&&m.isPrototypeOf(b)&&(c&&0<e.length&&(a=c.getFieldErrors(e[e.length-1])),b.validationErrors=a)},_onError:function(a,b){var c=this._super(a,b);return!c?this._app._onError(a,
b):c},_getTgtChangedFn:function(a,b,c,e,d){return function(n,f){var k=a._app.parser._resolveProp(b,c);0<e.length&&a._checkBounded(null,"target",d,e);a._parseTgtPath(k,e,d)}},_getSrcChangedFn:function(a,b,c,e,d){return function(n,f){var k=a._app.parser._resolveProp(b,c);0<e.length&&a._checkBounded(null,"source",d,e);a._parseSrcPath(k,e,d)}},_parseSrcPath:function(a,b,c){this._sourceObj=null;0===b.length?this._sourceObj=a:this._parseSrcPath2(a,b,c);this._targetObj&&this._updateTarget()},_parseSrcPath2:function(a,
...
this._converterParam,this._sourceObj);void 0!==a&&(this.targetValue=a)}catch(b){d.reThrow(b,this._onError(b,this))}finally{this._ignoreTgtChange=!1}}},_updateSource:function(){if(!this._ignoreTgtChange){this._ignoreSrcChange=!0;try{var a=this._converter.convertToSource(this.targetValue,this._converterParam,this._sourceObj);void 0!==a&&(this.sourceValue=a)}catch(b){if(!f.ValidationError.isPrototypeOf(b)||!m.isPrototypeOf(this._targetObj))if(this._updateTarget(),!this._onError(b,this))throw b;}finally{this._ignoreSrcChange=
...
RIAPP.Application._coreModules.template=function(a){var f=a.global,d=f.utils,h=f.consts,k=a.modules.binding.Binding,m=a.modules.baseElView,p=m.BaseElView,g=m.BusyElView,b=m.TemplateElView;this.Template=RIAPP.BaseObject.extend({_app:a,_create:function(a){this._super();this._el=this._dctxt=null;this._isDisabled=!1;this._lfTime=null;this._templateID=a;this._templElView=void 0;this._busyTimeOut=this._promise=null;this._templateID&&this._loadTemplate()},_getBindings:function(){if(!this._lfTime)return[];
for(var a=this._lfTime.getObjs(),b=[],d=0,n=a.length;d<n;d+=1)k.isPrototypeOf(a[d])&&b.push(a[d]);return b},_getElViews:function(){if(!this._lfTime)return[];for(var a=this._lfTime.getObjs(),b=[],d=0,n=a.length;d<n;d+=1)p.isPrototypeOf(a[d])&&b.push(a[d]);return b},_getTemplateElView:function(){if(!this._lfTime||null===this._templElView)return null;if(this._templElView)return this._templElView;for(var a=null,e=this._getElViews(),d=0,n=e.length;d<n;d+=1)if(b.isPrototypeOf(e[d])){a=e[d];break}return this._templElView=
a},_loadTemplateElAsync:function(a){if(a=this._app.getTemplateLoader(a))return a().then(function(a){var c=f.document.createElement("div");c.innerHTML=a;return c.firstElementChild});a=d.createDeferred();a.reject(Error(String.format(RIAPP.ERRS.ERR_TEMPLATE_ID_INVALID,this._templateID)));return a.promise()},_appendIsBusy:function(a){var b=this;this._busyTimeOut=setTimeout(function(){b._busyTimeOut&&!b._isDestroyCalled&&(b._busyTimeOut=null,g.create(a,{img:h.LOADER_GIF.SMALL,delay:0}).isBusy=!0)},400)},
_removeIsBusy:function(a){this._busyTimeOut&&(clearTimeout(this._busyTimeOut),this._busyTimeOut=null);(a=this._app._getElView(a))&&g.isPrototypeOf(a)&&a.destroy()},_loadTemplate:function(){var a=this,b=a._templateID,l,n,s=!1;a._promise&&(a._promise.reject("cancel"),a._promise=null);a._unloadTemplate();b&&(b=a._loadTemplateElAsync(b),s="pending"==b.state(),a._promise=l=d.createDeferred(),b.done(function(a){"pending"==l.state()&&l.resolve(a)}),b.fail(function(a){"pending"==l.state()&&l.reject(a)}),
s&&(a._el=n=f.document.createElement("div"),a._appendIsBusy(n),l.done(function(){a._removeIsBusy(n)}),l.fail(function(b){"cancel"==b&&a._removeIsBusy(n)})),l.then(function(b){a._isDestroyCalled||(a._promise=null,b?(s&&a._el.appendChild(b),a._el=b,a._lfTime=a._app._bindTemplateElements(a._el),(b=a._getTemplateElView())&&b.templateLoaded(a),a._updateBindingSource()):a._unloadTemplate())},function(b){if(!a._isDestroyCalled&&(a._promise=null,"cancel"!=b)){var e;b&&(b.message?e=b:b.statusText?e=Error(b.statusText):
d.check_is.String(b)&&(e=Error(b)));e||(e=Error(String.format(RIAPP.ERRS.ERR_TEMPLATE_ID_INVALID,a._templateID)));a._app._onError(e,a)}}))},_updateBindingSource:function(){var a,b,d,n=this._getBindings();a=0;for(b=n.length;a<b;a+=1)d=n[a],d.isDisabled=this._isDisabled,d.isSourceFixed||(d.source=this._dctxt)},_updateIsDisabled:function(){var a,b,d,n=this._getBindings(),f=this._getElViews(),g=this._app._getElViewType(h.ELVIEW_NM.DATAFORM);a=0;for(b=n.length;a<b;a+=1)d=n[a],d.isDisabled=this._isDisabled;
a=0;for(b=f.length;a<b;a+=1)d=f[a],g.isPrototypeOf(d)&&d.form&&(d.form.isDisabled=this._isDisabled)},_unloadTemplate:function(){try{if(this._el){var a=this._templElView;this._templElView=void 0;a&&a.templateUnloading(this)}}finally{this._lfTime&&(this._lfTime.destroy(),this._lfTime=null),this._el&&f.$(this._el).remove(),this._el=null}},destroy:function(){this._isDestroyed||(this._busyTimeOut&&(clearTimeout(this._busyTimeOut),this._busyTimeOut=null),this._promise&&(this._promise.reject("cancel"),this._promise=
null),this._dctxt=null,this._unloadTemplate(),this._templateID=null,this._templElView=void 0,this._super())},findElByDataName:function(a){return f.$(this._el).find(["*[",h.DATA_ATTR.DATA_NAME,'="',a,'"]'].join("")).toArray()},findElViewsByDataName:function(a){var b=this,d=[];this.findElByDataName(a).forEach(function(a){(a=b._app._getElView(a))&&d.push(a)});return d},toString:function(){return"Template"}},{dataContext:{set:function(a){this._dctxt!==a&&(this._dctxt=a,this.raisePropertyChanged("dataContext"),
this._updateBindingSource())},get:function(){return this._dctxt}},templateID:{set:function(a){this._templateID!==a&&(this._templateID=a,this._loadTemplate(),this.raisePropertyChanged("templateID"))},get:function(){return this._templateID}},el:{get:function(){return this._el}},isDisabled:{set:function(a){this._isDisabled!==a&&(this._isDisabled=!!a,this._updateIsDisabled(),this.raisePropertyChanged("isDisabled"))},get:function(){return this._isDisabled}}},function(b){a.registerType("Template",b)})};
...
d):h},toString:function(){return this._typeName?this._super():"BaseViewModel"}},{uniqueID:{get:function(){return this._objId}},app:{get:function(){return this._app}},$:{get:function(){return this._app.global.$}}},function(f){a.registerType("BaseViewModel",f)})};
RIAPP.Application._coreModules.baseContent=function(a){var f=a.global,d=a.modules.template.Template,h=a.modules.binding.Binding,k=this.css={content:"ria-content-field",required:"ria-required-field"};Object.freeze(k);this.BindingContent=RIAPP.BaseObject.extend({_app:a,_create:function(a,d,g,b){this._super();this._parentEl=a;this._el=null;this._options=d;this._isReadOnly=!!this._options.readOnly;this._isEditing=!!b;this._dctx=g;this._tgt=this._lfScope=null;f.$(this._parentEl).addClass(k.content);d.initContentFn&&
d.initContentFn(this);this._init();this.update()},_init:function(){},_updateCss:function(){var a=this._getDisplayInfo(),d=f.$(this._parentEl),g=this.getFieldInfo();this._isEditing&&this._canBeEdited()?(a&&(a.editCss&&d.addClass(a.editCss),a.displayCss&&d.removeClass(a.displayCss)),g&&!g.isNullable&&d.addClass(k.required)):a&&(a.displayCss&&d.addClass(a.displayCss),a.editCss&&d.removeClass(a.editCss),g&&!g.isNullable&&d.removeClass(k.required))},_canBeEdited:function(){if(this._isReadOnly)return!1;
...
RIAPP.Application._coreModules.collection=function(a){var f=this,d=a.global,h=d.utils,k,m,p,g=d.consts.DATA_TYPE,b={REMOVE:"0",ADDED:"1",RESET:"2",REMAP_KEY:"3"},c={};c.DATA_TYPE=g;c.SORT_ORDER={ASC:0,DESC:1};c.COLL_CHANGE_TYPE=b;c.DATE_CONVERSION={None:0,ServerLocalToClientLocal:1,UtcToClientLocal:2};f.consts=c;Object.freeze(c);var e=a.modules.binding.ValidationError,l={valueToDate:function(a,b,e){if(!a)return null;a=""+a;var d=a.split("&");if(7!=d.length)throw Error(base_utils.format(RIAPP.ERRS.ERR_PARAM_INVALID,
"val",a));a=new Date(parseInt(d[0],10),parseInt(d[1],10)-1,parseInt(d[2],10),parseInt(d[3],10),parseInt(d[4],10),parseInt(d[5],10),parseInt(d[6],10));var d=c.DATE_CONVERSION,l=h.get_timeZoneOffset();switch(b){case d.None:break;case d.ServerLocalToClientLocal:a.setMinutes(a.getMinutes()+e);a.setMinutes(a.getMinutes()-l);break;case d.UtcToClientLocal:a.setMinutes(a.getMinutes()-l);break;default:throw Error(base_utils.format(RIAPP.ERRS.ERR_PARAM_INVALID,"dtcnv",b));}return a},dateToValue:function(a,
b,e){if(null===a)return null;if(!h.check_is.Date(a))throw Error(base_utils.format(RIAPP.ERRS.ERR_PARAM_INVALID,"dt",a));var d=c.DATE_CONVERSION,l=h.get_timeZoneOffset();switch(b){case d.None:break;case d.ServerLocalToClientLocal:a.setMinutes(a.getMinutes()+l);a.setMinutes(a.getMinutes()-e);break;case d.UtcToClientLocal:a.setMinutes(a.getMinutes()+l);break;default:throw Error(h.format(RIAPP.ERRS.ERR_PARAM_INVALID,"dtcnv",b));}return""+a.getFullYear()+"&"+(a.getMonth()+1)+"&"+a.getDate()+"&"+a.getHours()+
"&"+a.getMinutes()+"&"+a.getSeconds()+"&"+a.getMilliseconds()},compareVals:function(a,b,c){if(null===a&&null!==b||null!==a&&null===b)return!1;switch(c){case g.DateTime:case g.Date:case g.Time:return h.check_is.Date(a)&&h.check_is.Date(b)?a.getTime()===b.getTime():!1;default:return a===b}},stringifyValue:function(a,b,c){return h.check_is.nt(a)?null:h.check_is.Date(a)?l.dateToValue(a,b,c):""+a},parseValue:function(a,b,c,e){var d=null;if(void 0===a||null===a)return d;switch(b){case g.None:d=a;break;
case g.String:d=a;break;case g.Bool:d=h.parseBool(a);break;case g.Integer:d=parseInt(a,10);break;case g.Decimal:case g.Float:d=parseFloat(a);break;case g.DateTime:case g.Date:case g.Time:d=l.valueToDate(a,c,e);break;case g.Guid:case g.Binary:d=a;break;default:throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_PARAM_INVALID,"dataType",b));}return d}};f.valueUtils=l;m=RIAPP.BaseObject.extend({_app:a,_create:function(){this._super();this._fkey=null;this._isEditing=!1;this._saveVals=null;this._vals={};this._notEdited=
...
c&&b.push(c);return b},_checkVal:function(a,b){var c=b,e=RIAPP.ERRS;if(this._skipValidate(a,b))return c;if(a.isReadOnly&&(!a.allowClientDefault||!this._isNew))throw Error(e.ERR_FIELD_READONLY);if((null===b||h.check_is.String(b)&&!b)&&!a.isNullable)throw Error(e.ERR_FIELD_ISNOT_NULLABLE);if(null===b)return b;switch(a.dataType){case g.None:break;case g.Guid:case g.Binary:case g.String:if(!h.check_is.String(b))throw Error(String.format(e.ERR_FIELD_WRONG_TYPE,b,"String"));if(0<a.maxLength&&b.length>a.maxLength)throw Error(String.format(e.ERR_FIELD_MAXLEN,
a.maxLength));a.isNullable&&""===b&&(c=null);if(a.regex&&!RegExp(a.regex,"i").test(b))throw Error(String.format(e.ERR_FIELD_REGEX,b));break;case g.Bool:if(!h.check_is.Boolean(b))throw Error(String.format(e.ERR_FIELD_WRONG_TYPE,b,"Boolean"));break;case g.Integer:case g.Decimal:case g.Float:if(!h.check_is.Number(b))throw Error(String.format(e.ERR_FIELD_WRONG_TYPE,b,"Number"));a.range&&h.validation.checkNumRange(Number(b),a.range);break;case g.DateTime:case g.Date:if(!h.check_is.Date(b))throw Error(String.format(e.ERR_FIELD_WRONG_TYPE,
b,"Date"));a.range&&h.validation.checkDateRange(b,a.range);break;case g.Time:if(!h.check_is.Date(b))throw Error(String.format(e.ERR_FIELD_WRONG_TYPE,b,"Time"));break;default:throw Error(String.format(e.ERR_PARAM_INVALID,"dataType",a.dataType));}return c},_onErrorsChanged:function(a){this.raiseEvent("errors_changed",a)},_resetIsNew:function(){},getFieldInfo:function(a){return this._collection.getFieldInfo(a)},getFieldNames:function(){return this._collection.getFieldNames()},addOnItemErrorsChanged:function(a,
...
_onItemAdded:function(a){this.raiseEvent("item_added",{item:a,isAddNewHandled:!1})},_createNew:function(){throw Error("Not implemented");},_attach:function(a,c){if(this._itemsByKey[a._key])throw Error(RIAPP.ERRS.ERR_ITEM_IS_ATTACHED);try{this.endEdit()}catch(e){d.reThrow(e,this._onError(e,this))}var l;a._onAttaching();h.check_is.nt(c)?(l=this._items.length,this._items.push(a)):(l=c,h.insertIntoArray(this._items,a,l));this._itemsByKey[a._key]=a;this._onItemsChanged({change_type:b.ADDED,items:[a],pos:[l]});
a._onAttach();this.raisePropertyChanged("count");this._onCurrentChanging(a);this._currentPos=l;this._onCurrentChanged();return l},_onRemoved:function(a,c){try{this._onItemsChanged({change_type:b.REMOVE,items:[a],pos:[c]})}finally{this.raisePropertyChanged("count")}},_onPageSizeChanged:function(){},_onPageChanging:function(){var a={page:this.pageIndex,isCancel:!1};this._raiseEvent("page_changing",a);if(!a.isCancel)try{this.endEdit()}catch(b){d.reThrow(b,this._onError(b,this))}return!a.isCancel},_onPageChanged:function(){},
...
isLoading:{set:function(a){this._isLoading!==a&&(this._isLoading=a,this.raisePropertyChanged("isLoading"))},get:function(){return this._isLoading}},isUpdating:{set:function(a){this._isUpdating!==a&&(this._isUpdating=a,this.raisePropertyChanged("isUpdating"))},get:function(){return this._isUpdating}},pageCount:{get:function(){var a=this.totalCount,b=this.pageSize;return 0===a||0===b?0:0===a%b?a/b:a=Math.floor(a/b)+1}}},function(a){f.Collection=a});k.getEmptyFieldInfo=function(a){return{isPrimaryKey:0,
isRowTimeStamp:!1,dataType:g.NONE,isNullable:!0,maxLength:-1,isReadOnly:!1,isAutoGenerated:!1,allowClientDefault:!1,dateConversion:c.DATE_CONVERSION.NONE,isClientOnly:!0,isCalculated:!1,isNeedOriginal:!1,dependentOn:null,range:null,regex:null,isNavigation:!1,fieldName:a}};p=m.extend({_create:function(a){this._super();this.__isNew=!a;a&&(this._vals=a);a||this._collection.getFieldNames().forEach(function(a){this._vals[a]=null},this)},_setProp:function(a,b){var c,d=this._collection;if(this._vals[a]!==
b)try{if(this._vals[a]=b,this.raisePropertyChanged(a),d._removeError(this,a),c=this._validateField(a))throw e.create([c],this);}catch(l){throw c=e.isPrototypeOf(l)?l:e.create([{fieldName:a,errors:[l.message]}],this),d._addError(this,a,c.errors[0].errors),c;}},_getProp:function(a){return this._vals[a]},_resetIsNew:function(){this.__isNew=!1},toString:function(){return"ListItem"}},{_isNew:{get:function(){return this.__isNew}},_collection:{get:function(){return this.__coll}}},function(a){f.ListItem=
...
a)},get:function(){return this._getProp(b)}}},this);a._collection={get:function(){return this.__coll}};var b=this._type_name;this._itemType=p.extend({__coll:this},a,function(a){a._typeName=b+"Item"})},_getNewKey:function(a){a="clkey_"+this._newKey;this._newKey+=1;return a},fillItems:function(a,c){var e=[],d=[],l=[];this._onFillStart({isBegin:!0,rowCount:a.length,time:new Date,isPageChanged:!1});try{c&&this.clear(),a.forEach(function(a){a=this._itemType.create(a);a._key=this._getNewKey(a);var b=this._itemsByKey[a._key];
b?l.push(b):(this._items.push(a),this._itemsByKey[a._key]=a,e.push(a),d.push(this._items.length-1),l.push(a))},this),0<e.length&&(this._onItemsChanged({change_type:b.ADDED,items:e,pos:d}),this.raisePropertyChanged("count"))}finally{this._onFillEnd({isBegin:!1,rowCount:l.length,time:new Date,resetUI:!!c,fetchedItems:l,newItems:e,isPageChanged:!1})}this.moveFirst()},getNewObjects:function(){return this._items.filter(function(a){return a._isNew})},resetNewObjects:function(){this._items.forEach(function(a){a._resetIsNew()})},
...
RIAPP.Application._coreModules.db=function(a){var f=this,d=a.global,h=a.modules.collection,k=d.utils,m,p,g,b=d.consts.DATA_TYPE,c=d.consts.CHANGE_TYPE,e=h.valueUtils,l=h.consts.COLL_CHANGE_TYPE,n=h.consts.SORT_ORDER,s=d.modules.errors.BaseError.extend({_create:function(a,b){var c;a&&(c=a.message);c||(c=""+a);this._super(c);this._origError=a;this._operationName=b}},{operationName:{get:function(){return this._operationName}}},function(b){f.DataOperationError=b;a.registerType("DataOperationError",b)}),
u=a.modules.binding.ValidationError;f.AccessDeniedError=s.extend(null,null,function(b){a.registerType("AccessDeniedError",b)});f.ConcurrencyError=s.extend(null,null,function(b){a.registerType("ConcurrencyError",b)});f.SvcValidationError=s.extend(null,null,function(b){a.registerType("SvcValidationError",b)});var y=f.SubmitError=s.extend({_create:function(a,b,c){var e=a.message||""+a;this._super(e,"submit");this._origError=a;this._allSubmitted=b||[];this._notValidated=c||[];if(0<this._notValidated.length){var d=
...
function(a){f.DataQuery=a});m=h.CollectionItem.extend({_create:function(a,b){this._super();this.__changeType=c.NONE;this._saveChangeType=this._origVals=this._srvRowKey=null;this.__isCached=this.__isRefreshing=!1;this.getFieldNames().forEach(function(a){this._vals[a]=null},this);this._initRowInfo(a,b)},_initRowInfo:function(a,b){if(a){var c=this,d=c._serverTimezone;this._key=this._srvRowKey=a.key;a.values.forEach(function(a,t){var l=b[t],f=c.getFieldInfo(l);if(!f)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_DBSET_INVALID_FIELDNAME,
c._dbSetName,l));l=e.parseValue(a,f.dataType,f.dateConversion,d);c._vals[f.fieldName]=l})}},_checkCanRefresh:function(){if(null===this._key||this._changeType===c.ADDED)throw Error(RIAPP.ERRS.ERR_OPER_REFRESH_INVALID);},_refreshValue:function(a,b,c){var d=this.getFieldInfo(b);if(!d)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_DBSET_INVALID_FIELDNAME,this._dbSetName,b));var l,q,f=d.dataType;a=e.parseValue(a,f,d.dateConversion,this._serverTimezone);l=this._vals[b];switch(c){case 3:e.compareVals(a,l,
f)||(this._vals[b]=a,this._onFieldChanged(d));break;case 1:this._origVals&&(this._origVals[b]=a);this._saveVals&&(this._saveVals[b]=a);e.compareVals(a,l,f)||(this._vals[b]=a,this._onFieldChanged(d));break;case 2:this._origVals&&(q=this._origVals[b],this._origVals[b]=a);if((void 0===q||e.compareVals(q,l,f))&&!e.compareVals(a,l,f))this._vals[b]=a,this._onFieldChanged(d);break;default:throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_PARAM_INVALID,"refreshMode",c));}},_refreshValues:function(a,b){var e=
...
this.getFieldInfo(a);if(b.isClientOnly)return null;var e=c._getStrValue(this._vals[a],b),t=null===this._origVals?e:c._getStrValue(this._origVals[a],b);return t!==e?{val:e,orig:t,fieldName:a,flags:3}:0<b.isPrimaryKey||b.isRowTimeStamp||b.isNeedOriginal?{val:e,orig:t,fieldName:a,flags:2}:{val:null,orig:null,fieldName:a,flags:0}},this).filter(function(b){return!b?!1:a?1===(b.flags&1):!0})},_getRowInfo:function(){return{values:this._getStrValues(!1),changeType:this._changeType,serverKey:this._srvKey,
...
_setFieldVal:function(a,b){var c,e=this._dbSetName,d=this._collection,q=RIAPP.ERRS,l=this._vals[a],f=b,g=this.getFieldInfo(a);if(!g)throw Error(String.format(q.ERR_DBSET_INVALID_FIELDNAME,e,a));!this._isEditing&&!this._isUpdating&&this.beginEdit();try{if(f=this._checkVal(g,f),l!=f&&this._fldChanging(g,l,f)&&(this._vals[a]=f,this._fldChanged(g,l,f)),d._removeError(this,a),c=this._validateField(a))throw u.create([c],this);}catch(n){throw c=u.isPrototypeOf(n)?n:u.create([{fieldName:a,errors:[n.message]}],
...
this.dbContext.getDbSet(b.parentDbSetName),a=c.slice(1).join("."),b.getFieldInfo(a);throw Error(String.format(RIAPP.ERRS.ERR_DBSET_INVALID_FIELDNAME,this.dbSetName,a));},_onError:function(a,b){return this.dbContext._onError(a,b)},_mapAssocFields:function(){for(var a=this._trackAssoc,b,c=Object.keys(a),e,d=this._trackAssocMap,q=0,l=c.length;q<l;q+=1){b=a[c[q]];for(var f=0,g=b.fieldRels.length;f<g;f+=1)e=b.fieldRels[f],d[e.childField]?d[e.childField].push(b.childToParentName):d[e.childField]=[b.childToParentName]}},
_getStrValue:function(a,b){return e.stringifyValue(a,b.dateConversion,this.dbContext.serverTimezone)},_createEntityType:function(a,b,c,e){var d=this,q={};if(!k.check_is.Array(b))throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_PARAM_INVALID_TYPE,"fldInfos","Array"));b.forEach(function(a){var b=k.extend(!1,{},a);b.dependents=[];d._fieldMap[a.fieldName]=b},this);var l=function(a){a.dependentOn.split(",").forEach(function(b){var c=d._fieldMap[b];if(!c)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_CALC_FIELD_DEFINE,
b));if(a.fieldName===b)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_CALC_FIELD_SELF_DEPEND,b));0>c.dependents.indexOf(a.fieldName)&&c.dependents.push(a.fieldName)})},f=function(a){var b=d._fieldMap[a.fieldName],t=!0,l=c.filter(function(b){return b.childToParentName==a.fieldName});0===l.length&&(l=e.filter(function(b){return b.parentToChildrenName==a.fieldName}),t=!1);if(1!=l.length)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_PARAM_INVALID_TYPE,"assocs","Array"));b.isClientOnly=!0;b.isReadOnly=
!0;var f=function(){throw Error("getFunc is not emplemented!");},w,v=l[0].name;t?(b.isReadOnly=!1,d._childAssocMap[l[0].childToParentName]=l[0],l[0].fieldRels.forEach(function(a){a=d._fieldMap[a.childField];!b.isReadOnly&&a.isReadOnly&&(b.isReadOnly=!0)}),f=function(){return d.dbContext.getAssociation(v).getParentItem(this)},b.isReadOnly||(d._trackAssoc[v]=l[0],w=function(b){var c,e,t=d.dbContext.getAssociation(v);if(b&&!t.parentDS.entityType.isPrototypeOf(b))throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_PARAM_INVALID_TYPE,
"value",t.parentDS.entityType._typeName));if(b&&b._isNew)this._setFieldVal(a.fieldName,b._key);else if(b){c=0;for(e=t.childFldInfos.length;c<e;c+=1)this[t.childFldInfos[c].fieldName]=b[t.parentFldInfos[c].fieldName]}else{this._getFieldVal(a.fieldName)&&this._setFieldVal(a.fieldName,null);c=0;for(e=t.childFldInfos.length;c<e;c+=1)this[t.childFldInfos[c].fieldName]=null}})):(d._parentAssocMap[l[0].parentToChildrenName]=l[0],f=function(){return d.dbContext.getAssociation(v).getChildItems(this)});q[a.fieldName]=
{set:w,get:f}},g=function(a){q[a.fieldName]={set:function(b){this._setFieldVal(a.fieldName,b)},get:function(){return this._getFieldVal(a.fieldName)}}};b.forEach(function(b){if(k.hasProp(m,b.fieldName))throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_ITEM_NAME_COLLISION,a,b.fieldName));if(b.isCalculated){var c=d.getFieldInfo(b.fieldName);c.isClientOnly=!0;c.isReadOnly=!0;c={dbSetName:a,fieldName:b.fieldName,getFunc:null};d.dbContext._onGetCalcField(c);k.check_is.Function(c.getFunc)&&(b.dependentOn&&l(b),
q[b.fieldName]={get:c.getFunc})}else b.isNavigation?f(b):g(b)});q._dbSet={get:function(){return this.__dbSet}};this._entityType=m.extend({__dbSet:d},q,function(b){b._typeName=a+"Entity"});this._mapAssocFields()},_fillFromService:function(a){a=k.extend(!1,{res:{names:[],rows:[],pageIndex:null,pageCount:null,dbSetName:this.dbSetName,totalCount:null},isPageChanged:!1,fn_beforeFillEnd:null},a);var b=this,c=a.res,e=c.names,d=c.rows||[],q=this._entityType,f=[],g=[],n=[],h=[],m=this.isPagingEnabled,s=this.query,
x=!0,p;this._onFillStart({isBegin:!0,rowCount:d.length,time:new Date,isPageChanged:a.isPageChanged});try{s&&(x=s.isClearPrevData,s.isClearCacheOnEveryLoad&&s._clearCache(),x&&this.clear(),s._reindexCache(),1<s.loadPageCount&&m&&(p=s._getCache(),s.isIncludeTotalCount&&!k.check_is.nt(c.totalCount)&&(p.totalCount=c.totalCount)));n=d.map(function(a){var c=a.key;if(!c)throw Error(RIAPP.ERRS.ERR_KEY_IS_EMPTY);var d=b._itemsByKey[c];d?a.values.forEach(function(a,b){d._refreshValue(a,e[b],1)}):(p&&(d=p.getItemByKey(c)),
d?a.values.forEach(function(a,b){d._refreshValue(a,e[b],1)}):d=q.create(a,e));return d});if(s&&(s.isIncludeTotalCount&&!k.check_is.nt(c.totalCount)&&(this.totalCount=c.totalCount),1<s.loadPageCount&&m)){p.fillCache(c.pageIndex,n);var u=p.getCachedPage(s.pageIndex),n=u?u.items:[]}n.forEach(function(a){var b=this._itemsByKey[a._key];b?h.push(b):(this._items.push(a),this._itemsByKey[a._key]=a,f.push(a),g.push(this._items.length-1),h.push(a))},this);0<f.length&&(this._onItemsChanged({change_type:l.ADDED,
items:f,pos:g}),this.raisePropertyChanged("count"));a.fn_beforeFillEnd&&a.fn_beforeFillEnd()}finally{this._onFillEnd({isBegin:!1,rowCount:h.length,time:new Date,resetUI:x,fetchedItems:h,newItems:f,isPageChanged:a.isPageChanged})}this.moveFirst();return{fetchedItems:h,newItems:f,isPageChanged:a.isPageChanged}},_fillFromCache:function(a){a=k.extend(!1,{isPageChanged:!1,fn_beforeFillEnd:null},a);var b=this,c=[],e=[],d=this.query;if(!d)throw Error(String.format(RIAPP.ERRS.ERR_ASSERTION_FAILED,"query is not null"));
d=d._getCache().getCachedPage(d.pageIndex);d=!d?[]:d.items;this._onFillStart({isBegin:!0,rowCount:d.length,time:new Date,isPageChanged:a.isPageChanged});try{this.clear(),this._items=d,d.forEach(function(a,d){b._itemsByKey[a._key]=a;c.push(d);e.push(a)}),a.fn_beforeFillEnd&&a.fn_beforeFillEnd(),0<e.length&&(this._onItemsChanged({change_type:l.ADDED,items:e,pos:c}),this.raisePropertyChanged("count"))}finally{this._onFillEnd({isBegin:!1,rowCount:e.length,time:new Date,resetUI:!0,fetchedItems:e,newItems:e,
isPageChanged:a.isPageChanged})}this.moveFirst();return{fetchedItems:e,newItems:e,isPageChanged:a.isPageChanged}},_commitChanges:function(a){var b=this;a.forEach(function(a){var e=a.clientKey,d=b._itemsByKey[e];if(!d)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_KEY_IS_NOTFOUND,e));var t=d._changeType;d.acceptChanges(a);t===c.ADDED&&(delete b._itemsByKey[e],d._srvRowKey=a.serverKey,d._key=d._srvRowKey,b._itemsByKey[d._key]=d,b._onItemsChanged({change_type:l.REMAP_KEY,items:[d],old_key:e,new_key:d._key}))})},
...
this._assoc[a.name]=function(){var e=z.create(c);b._arrAssoc.push(e);b._assoc[a.name]=function(){return e};return e}},_initMethod:function(a){var b=this;this._svcMethods[a.methodName]=function(c){var e=k.createDeferred(),l=function(a){a.error?e.reject():e.resolve(a.result)};try{var q=b._getMethodParams(a,c);b._invokeMethod(a,q,l)}catch(f){d._checkIsDummy(f)||(b._onError(f,b),l({result:null,error:f}))}return e.promise()}},_getMethodParams:function(a,c){var d={methodName:a.methodName,paramInfo:{parameters:[]}},
l,f=a.parameters,q=f.length,w,g,n;c||(c={});for(l=0;l<q;l+=1){w=f[l];g=c[w.name];if(!w.isNullable&&!w.isArray&&w.dataType!==b.String&&k.check_is.nt(g))throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_SVC_METH_PARAM_INVALID,w.name,g,a.methodName));if(k.check_is.Function(g))throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_SVC_METH_PARAM_INVALID,w.name,g,a.methodName));w.isArray&&(!k.check_is.nt(g)&&!k.check_is.Array(g))&&(g=[g]);n=null;k.check_is.Array(g)?(n=[],g.forEach(function(a){n.push(e.stringifyValue(a,
w.dateConversion,self._serverTimezone))}),n=JSON.stringify(n)):n=e.stringifyValue(g,w.dateConversion,self._serverTimezone);d.paramInfo.parameters.push({name:w.name,value:n})}return d},_invokeMethod:function(a,b,c){var e=this,l,q;this.isBusy=!0;var g=function(a){try{if(!a)throw Error(k.format(RIAPP.ERRS.ERR_UNEXPECTED_SVC_ERROR,"operation result is undefined"));f.checkError(a.error,"invoke");c({result:a.result,error:null})}catch(b){d._checkIsDummy(b)||(e._onDataOperError(b,"invoke"),c({result:null,
error:b}))}};try{l=JSON.stringify(b),q=this._getUrl("InvokeMethod"),k.performAjaxCall(q,l,!0,function(a){g(JSON.parse(a));e.isBusy=!1},function(a){g({result:null,error:a});e.isBusy=!1},null)}catch(n){d._checkIsDummy(n)&&d._throwDummy(n),this.isBusy=!1,this._onDataOperError(n,"invoke"),c({result:null,error:n}),d._throwDummy(n)}},_getEventNames:function(){var a=this._super();return["submit_error","define_calc"].concat(a)},_loadFromCache:function(a,b){var c=a._dbSet,e;try{e=c._fillFromCache({isPageChanged:b,
fn_beforeFillEnd:null})}catch(l){d._checkIsDummy(l)&&d._throwDummy(l),this._onDataOperError(l,"load"),d._throwDummy(l)}return e},_loadIncluded:function(a){var b=this;a.included&&0<a.included.length&&a.included.forEach(function(a){b.getDbSet(a.dbSetName).fillItems(a,!0)})},_onLoaded:function(a,b){var c=this,e,l,q;try{if(!a)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_UNEXPECTED_SVC_ERROR,"null result"));e=a.dbSetName;l=this.getDbSet(e);if(!l)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_DBSET_NAME_INVALID,
e));f.checkError(a.error,"load");q=l._fillFromService({res:a,isPageChanged:b,fn_beforeFillEnd:function(){c._loadIncluded(a)}})}catch(g){d._checkIsDummy(g)&&d._throwDummy(g),this._onDataOperError(g,"load"),d._throwDummy(g)}return q},_dataSaved:function(a){var b=this,c=[],e=[];try{try{f.checkError(a.error,"submit")}catch(l){throw a.dbSets.forEach(function(a){var d=b._dbSets[a.dbSetName];a.rows.forEach(function(a){var b=d.getItemByKey(a.clientKey);if(!b)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_KEY_IS_NOTFOUND,
a.clientKey));c.push(b);a.invalid&&(d._setItemInvalid(a),e.push(b))})}),y.create(l,c,e);}a.dbSets.forEach(function(a){b._dbSets[a.dbSetName]._commitChanges(a.rows)})}catch(q){d._checkIsDummy(q)&&d._throwDummy(q),this._onSubmitError(q),d._throwDummy(q)}},_getChanges:function(){var a={dbSets:[],error:null,trackAssocs:[]};this._arrDbSets.forEach(function(b){b.endEdit();var c=b._getChanges();if(0!==c.length){var e=b._getTrackAssocInfo();a.dbSets.push({dbSetName:b.dbSetName,rows:c});a.trackAssocs=a.trackAssocs.concat(e)}});
return a},_getUrl:function(a){var b=this.service_url;k.str.endsWith(b,"/")||(b+="/");return b+=[a,""].join("/")},_onItemRefreshed:function(a,b){try{if(f.checkError(a.error,"refresh"),a.rowInfo)b._refreshValues(a.rowInfo,2);else throw b._dbSet.removeItem(b),b.destroy(),Error(RIAPP.ERRS.ERR_ITEM_DELETED_BY_ANOTHER_USER);}catch(c){d._checkIsDummy(c)&&d._throwDummy(c),this._onDataOperError(c,"refresh"),d._throwDummy(c)}},_refreshItem:function(a){var b=k.createDeferred(),c=function(c){c?b.resolve(a):b.reject()},
e=this._getUrl("RefreshItem"),d=a._dbSet;this.waitForNotSubmiting(function(){var b=this;d.waitForNotLoading(function(){var l,f=function(){b.isBusy=!1;d.isLoading=!1;a._isRefreshing=!1},g=function(a){f();b._onDataOperError(a,"refresh")};a._isRefreshing=!0;b.isBusy=!0;d.isLoading=!0;try{var n={dbSetName:a._dbSetName,rowInfo:a._getRowInfo(),error:null};a._checkCanRefresh();l=JSON.stringify(n);k.performAjaxCall(e,l,!0,function(e){try{var d=JSON.parse(e);b._onItemRefreshed(d,a);f();c(!0)}catch(l){g(l),
c(!1)}},function(a){f();b._onDataOperError(a,"refresh");c(!1)},null)}catch(v){g(v),c(!1)}},[],!0,null)},[],null);return b.promise()},_onError:function(a,b){var c=this._super(a,b);return!c?this.app?this.app._onError(a,b):d._onError(a,b):c},_onDataOperError:function(a,b){if(d._checkIsDummy(a))return!0;var c;c=s.isPrototypeOf(a)?a:s.create(a,b);return this._onError(c,this)},_onSubmitError:function(a){var b={error:a,isHandled:!1};this.raiseEvent("submit_error",b);b.isHandled||(this.rejectChanges(),this._onDataOperError(a,
"submit"))},_beforeLoad:function(a,b,c){a&&b!==a&&(c._query=a,c.pageIndex=0);b&&b!==a&&b.destroy();if(a.pageSize!==c.pageSize){c._ignorePageChanged=!0;try{c.pageIndex=0,c.pageSize=a.pageSize}finally{c._ignorePageChanged=!1}}if(a.pageIndex!==c.pageIndex){c._ignorePageChanged=!0;try{c.pageIndex=a.pageIndex}finally{c._ignorePageChanged=!1}}a.isCacheValid||a._clearCache()},_load:function(a,b){if(!a)throw Error(RIAPP.ERRS.ERR_DB_LOAD_NO_QUERY);var c=this,e=k.createDeferred(),l=a.loadPageCount,q=a.pageIndex,
f=a.isPagingEnabled,g=a.dbSetName,n=this.getDbSet(g);this.waitForNotSubmiting(function(){n.waitForNotLoading(function(){var h=n.query,m=c._getUrl("GetItems"),s,x,p=function(){n.isLoading=!1;c.isBusy=!1},u=function(a){p();e.resolve(a)},A=function(a){p();c._onDataOperError(a,"load");e.reject()},z;n.isLoading=!0;c.isBusy=!0;try{a.pageIndex=q;c._beforeLoad(a,h,n);var y,h=1;if(1<l&&f){if(a._isPageCached(q)){z=c._loadFromCache(a,b);z.outOfBandData=null;u(z);return}y=a._getCache().getNextRange(q);q=y.start;
h=y.cnt}s={dbSetName:g,pageIndex:q,pageSize:a.pageSize,pageCount:h,isIncludeTotalCount:a.isIncludeTotalCount,filterInfo:a.filterInfo,sortInfo:a.sortInfo,paramInfo:c._getMethodParams(a._queryInfo,a.params).paramInfo,queryName:a.queryName};x=JSON.stringify(s);k.performAjaxCall(m,x,!0,function(a){var e=[],q;try{q=a.indexOf(d.modules.consts.CHUNK_SEP),-1<q?(e.push(a.substr(0,q)),e.push(a.substr(q+d.modules.consts.CHUNK_SEP.length))):e.push(a),e=e.map(function(a){return JSON.parse(a)}),setTimeout(function(){var d,
q=e[0],l=!!q.included&&0<q.included.length;try{if(1<e.length&&(d=e[1])&&0<d.length)if(l&&q.included.forEach(function(a){a.rows=d.splice(0,a.rowCount);if(a.rowCount!=a.rows.length)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_ASSERTION_FAILED,"subset.rowCount == subset.rows.length"));}),q.rows=d,q.rowCount!=q.rows.length)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_ASSERTION_FAILED,"getDataResult.rowCount == getDataResult.rows.length"));z=c._onLoaded(q,b);z.outOfBandData=a.extraInfo;u(z)}catch(t){A(t)}},
0)}catch(l){A(l)}},function(a){p();c._onDataOperError(a,"load");e.reject()},null)}catch(D){A(D)}},[],!0,b?"paging":null)},[],b?"paging":null);return e.promise()},getDbSet:function(a){if(!this.isInitialized)throw Error(RIAPP.ERRS.ERR_DOMAIN_CONTEXT_NOT_INITIALIZED);var b=this._dbSets[a];if(!b)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_DBSET_NAME_INVALID,a));return b},getAssociation:function(a){var b=this._assoc[a];if(!b)throw Error(RIAPP.utils.format(RIAPP.ERR_ASSOC_NAME_INVALID,a));return b()},
submitChanges:function(){if(this._pendingSubmit)return this._pendingSubmit.deferred.promise();var a=this,b={deferred:k.createDeferred()},c=function(a){a?b.deferred.resolve():b.deferred.reject()};this._pendingSubmit=b;this.waitForNotBusy(function(){var b,e,d,l=function(){a.isBusy=!1;a.isSubmiting=!1},f=function(b){l();a._onDataOperError(b,"submit");c(!1)};try{if(this.isSubmiting=this.isBusy=!0,this._pendingSubmit=null,b=this._getUrl("SaveChanges"),d=this._getChanges(),0===d.dbSets.length){l();c(!0);
return}}catch(g){f(g);return}try{e=JSON.stringify(d),k.performAjaxCall(b,e,!0,function(b){try{a._dataSaved(JSON.parse(b)),l(),c(!0)}catch(e){f(e)}},function(b){l();a._onSubmitError(b);c(!1)},null)}catch(n){f(n)}},[]);return b.deferred.promise()},load:function(a){return this._load(a,!1)},acceptChanges:function(){this._arrDbSets.forEach(function(a){a.acceptChanges()})},rejectChanges:function(){this._arrDbSets.forEach(function(a){a.rejectChanges()})},initialize:function(a){if(!this._isInitialized){var b=
...
c>b&&(this._currentPos=c-1,this._onCurrentChanged())}},sortLocal:function(a,b){var c=1,e=this._app.parser;b&&"DESC"===b.toUpperCase()&&(c=-1);this.fn_sort=function(b,d){var l=0,f,g,n;f=0;for(g=a.length;f<g&&!(n=a[f],l=e.resolvePath(b,n),n=e.resolvePath(d,n),l=l<n?-1*c:l>n?c:0,0!==l);f+=1);return l}},getIsHasErrors:function(){return this._dataSource.getIsHasErrors()},clear:function(){this.cancelEdit();this._EditingItem=null;this._newKey=0;this.currentItem=null;this._items=[];this._itemsByKey={};this._errors=
...
_onChildStatusChanged:function(a,b){var e=c.DELETED,d=a._changeType,l=this.getChildFKey(a);l&&d===e&&(l=this._unMapChildItem(a))&&this._notifyChildrenChanged([l])},_getItemKey:function(a,b,c){for(var e=[],d,q=0,l=a.length;q<l;q+=1){d=c[a[q].fieldName];d=b._getStrValue(d,a[q]);if(null===d)return null;e.push(d)}return e.join(";")},_resetChildMap:function(){var a=Object.keys(this._childMap);this._childMap={};this._notifyChildrenChanged(a)},_resetParentMap:function(){var a=Object.keys(this._parentMap);
this._parentMap={};this._notifyParentChanged(a)},_unMapChildItem:function(a){var b,c,e=null;if(b=this.getChildFKey(a))if(c=this._childMap[b])a=k.removeFromArray(c,a),-1<a&&(0==c.length&&delete this._childMap[b],e=b);return e},_unMapParentItem:function(a){var b=null;if((a=this.getParentFKey(a))&&this._parentMap[a])delete this._parentMap[a],b=a;return b},_mapParentItems:function(a){for(var b,e,d=c.DELETED,l,q={},f=0,g=a.length;f<g;f+=1)if(b=a[f],e=b._changeType,e!==d&&(e=this.getParentFKey(b)))l=this._parentMap[e],
l!==b&&(this._parentMap[e]=b,q[e]=null);return Object.keys(q)},_onChildrenChanged:function(a){a&&this._parentToChildrenName&&(a=this._parentMap[a])&&a.raisePropertyChanged(this._parentToChildrenName)},_onParentChanged:function(a){var b=this;a&&this._childToParentName&&(a=this._childMap[a])&&a.forEach(function(a){a.raisePropertyChanged(b._childToParentName)})},_mapChildren:function(a){for(var b,e,d,l=c.DELETED,q={},f=0,g=a.length;f<g;f+=1)if(b=a[f],e=b._changeType,e!==l&&(e=this.getChildFKey(b)))d=
...
g.DIALOG_ACTION.StayOpen)if(this._dataContext){if(c=this._isEditable?this._dataContext.endEdit():!0)if(this._submitOnOK){this._disableButtons(!0);var e=this.title;this.title=k.txtSubmitting;c=this._fn_submitOnOK();c.always(function(){a._disableButtons(!1);a.title=e});c.done(function(){a._result="ok";a.hide()});c.fail(function(){a._isEditable&&a._dataContext.beginEdit()})}else a._result="ok",a.hide()}else a.hide()},_onCancel:function(){var a=g.DIALOG_ACTION.Default;this._fn_OnCancel&&(a=this._fn_OnCancel(this));
...
a});l=m.extend({_init:function(){var a=d.$(this.el);a.addClass(r.rowCollapsed);a.addClass(r.rowExpander)},_onCellClicked:function(){this._row&&(this._super(),this._row.isExpanded=!this._row.isExpanded)},_toggleImage:function(){var a=d.$(this.el);this._row.isExpanded?(a.removeClass(r.rowCollapsed),a.addClass(r.rowExpanded)):(a.removeClass(r.rowExpanded),a.addClass(r.rowCollapsed))},toString:function(){return"ExpanderCell"}},null,function(a){f.ExpanderCell=a});n=m.extend({_create:function(a,b){this._isEditing=
...
c.th;this._options=c.colinfo;this._isSelected=!1;this._objId="col"+this.app.getNewObjectID();var l=d.$("<div></div>");l.addClass(r.column);this._grid._headerDiv.append(l);this._extcol=l;var f=d.$("<div></div>");f.addClass(r.cellDiv).click(function(b){b.stopPropagation();d.currentSelectable=a;a._setCurrentColumn(e);e._onColumnClicked()});l.append(f);f.get(0).cell=this;this._div=f;d.$(this.grid._tableEl).on("click","div["+k.DATA_ATTR.DATA_EVENT_SCOPE+'="'+this.uniqueID+'"]',function(c){c.stopPropagation();
var l=this.cell;l&&(d.currentSelectable=a,a._setCurrentColumn(e),b.isPrototypeOf(l)?l._clickTimeOut?(clearTimeout(l._clickTimeOut),l._clickTimeOut=null,l._onDblClicked()):(l._onCellClicked(),l._clickTimeOut=setTimeout(function(){l._clickTimeOut=null},350)):l._onCellClicked())});this._options.width&&(this._el.style.width=this._options.width);this._init();this._options.colCellCss&&f.addClass(this._options.colCellCss)},_init:function(){this.title&&this._div.html(this.title)},destroy:function(){this._isDestroyed||
...
this.$div;b.removeClass(r.colSortable).removeClass(r.colSortAsc).removeClass(r.colSortDesc);switch(a){case "ASC":b.addClass(r.colSortAsc);break;case "DESC":b.addClass(r.colSortDesc);break;default:this.isSortable&&b.addClass(r.colSortable)}this._sortOrder=a},get:function(){return this._sortOrder}}},function(a){f.DataColumn=a});y=m.extend({_init:function(){this._super();this.$div.addClass(r.rowExpander)},toString:function(){return"ExpanderColumn"}},null,function(a){f.ExpanderColumn=a});x=m.extend({_init:function(){this._super();
...
this._columns.forEach(function(a){a.$extcol.width(a.el.offsetWidth);a.$extcol.position({my:"left top",at:"left top",of:b,offset:""+a.el.offsetLeft+" 0"})})},_wrapTable:function(){var a=this._$tableEl,b,c,e,l=this;a.wrap(d.$("<div></div>").addClass(r.wrapDiv));c=a.parent();c.wrap(d.$("<div></div>").addClass(r.container));e=c.parent();b=d.$("<div></div>").addClass(r.headerDiv).insertBefore(c);d.$(this._tHeadRow).addClass(r.columnInfo);this._wrapDiv=c;this._headerDiv=b;this._contaner=e;this._options.containerCss&&
e.addClass(this._options.containerCss);this._options.wrapCss&&c.addClass(this._options.wrapCss);this._options.headerCss&&b.addClass(this._options.headerCss);var f=a.width();this._chkWidthInterval=setInterval(function(){var b=a.width();f!==b&&(f=b,l._updateColsDim())},1E3)},_unWrapTable:function(){var a=this._$tableEl;this._headerDiv&&(clearInterval(this._chkWidthInterval),this._chkWidthInterval=null,this._headerDiv.remove(),this._headerDiv=null,a.unwrap(),this._wrapDiv=null,a.unwrap(),this._contaner=
null)},_createColumns:function(){for(var a=this,b=this._tHeadCells,c=b.length,e=[],d,l,f=0;f<c;f+=1)d=b[f],l=this._parseColumnAttr(d.getAttribute(k.DATA_ATTR.DATA_COLUMN),d.getAttribute(k.DATA_ATTR.DATA_CONTENT)),e.push({th:d,colinfo:l});e.forEach(function(b){(b=a._createColumn(b))&&a._columns.push(b)})},_createColumn:function(a){var b;switch(a.colinfo.type){case "row_expander":this._expanderCol||(this._expanderCol=b=y.create(this,a));break;case "row_actions":this._actionsCol||(this._actionsCol=b=
x.create(this,a));break;case "row_selector":this._rowSelectorCol||(this._rowSelectorCol=b=A.create(this,a));break;case "data":b=u.create(this,a);break;default:throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_GRID_COLTYPE_INVALID,a.colinfo.type));}return b},_appendItems:function(a){if(!this._isDestroyCalled)for(var b,c=this._tBodyEl,e=0,d=a.length;e<d;e+=1)b=a[e],this._rowMap[b._key]||this._createRowForItem(c,b)},_onKeyDown:function(a,b){var c=this._dataSource,e=k.KEYS;if(c)switch(a){case e.up:b.preventDefault();
...
RIAPP.Application._coreModules.pager=function(a){var f=this,d=a.global,h=d.utils,k=a.modules.collection,m=a.modules.baseElView.BaseElView,p={pager:"ria-data-pager",info:"pager-info",currentPage:"pager-current-page",otherPage:"pager-other-page"};Object.freeze(p);f.css=p;var g=RIAPP.localizable.PAGER,b=RIAPP.utils.format,c=RIAPP.BaseObject.extend({_app:a,_create:function(a,b,c){this._super();this._el=a;this._$el=d.$(this._el);this._objId="pgr"+this._app.getNewObjectID();if(b&&!k.Collection.isPrototypeOf(b))throw Error(RIAPP.ERRS.ERR_PAGER_DATASRC_INVALID);
...
this._$el,c,d;this._clearContent();if(0!==this.rowPerPage&&(c=this.rowCount,0!=c&&(c=this.currentPage,0!=c)))if(d=this.pageCount,this.hideOnSinglePage&&1==d)a.hide();else{a.show();if(this.showInfo){var f=this._createElement("span"),h=b(g.pageInfo,c,d);f.addClass(p.info).text(h).appendTo(a)}this.showFirstAndLast&&1!=c&&a.append(this._createFirst());this.showPreviousAndNext&&1!=c&&a.append(this._createPrevious());if(this.showNumbers){var f=1,h=d,k=this.sliderSize;this.useSlider&&0<k&&(f=Math.floor((k-
...
(b=g.firstPageTip);b=this._createLink(1,g.firstText,b);a.addClass(p.otherPage).append(b);return a},_createPrevious:function(){var a=this._createElement("span"),c=this.currentPage-1,d;this.showTip&&(d=b(g.prevPageTip,c));c=this._createLink(c,g.previousText,d);a.addClass(p.otherPage).append(c);return a},_createCurrent:function(){var a=this._createElement("span"),b=this.currentPage;a.text(""+b);this.showTip&&h.addToolTip(a,this._buildTip(b));a.addClass(p.currentPage);return a},_createOther:function(a){var b=
this._createElement("span"),c;this.showTip&&(c=this._buildTip(a));a=this._createLink(a,a,c);b.addClass(p.otherPage);b.append(a);return b},_createNext:function(){var a=this._createElement("span"),c=this.currentPage+1,d;this.showTip&&(d=b(g.nextPageTip,c));c=this._createLink(c,g.nextText,d);a.addClass(p.otherPage).append(c);return a},_createLast:function(){var a=this._createElement("span"),b;this.showTip&&(b=g.lastPageTip);b=this._createLink(this.pageCount,g.lastText,b);a.addClass(p.otherPage).append(b);
...
RIAPP.Application._coreModules.dataform=function(a){var f=this,d=a.global,h=d.utils,k=d.consts,m=a.modules.binding.Binding,p=a.modules.baseElView.BaseElView,g={dataform:"ria-dataform"},b=RIAPP.localizable.VALIDATE;Object.freeze(g);f.css=g;var c=RIAPP.BaseObject.extend({_DATA_CONTENT_SELECTOR:"*["+k.DATA_ATTR.DATA_CONTENT+"]:not(["+k.DATA_ATTR.DATA_COLUMN+"])",_app:a,_create:function(b,c){var f=this,h;this._super();this._el=b;this._$el=d.$(this._el);this._objId="frm"+this._app.getNewObjectID();this._css=
...
RIAPP.Application._coreModules.elview=function(a){var f=this,d=a.global,h=d.utils,k=a.modules.baseElView,m=k.BaseElView,p=k.EditableElView,g=k.CommandElView,b=k.css;f.BaseElView=m;f.EditableElView=p;f.CommandElView=g;m.extend({_init:function(a){this._super(a);this._someProp=null}},{someProp:{set:function(a){if(a!==this._someProp){debugger;this._someProp=a;this.raisePropertyChanged("someProp");this.$el.html(""+this._someProp)}},get:function(){return this._someProp}}},function(b){f.DebuggerElView=b;
...
_getEventNames:function(){var a=this._super();return["keypress"].concat(a)},toString:function(){return"TextBoxElView"}},{value:{set:function(a){if(this._el){var b=this._el,d=b.value;a=null===a?"":""+a;d!==a&&(b.value=a,this.raisePropertyChanged("value"))}},get:function(){var a=this._el;return!a?"":a.value}}},function(b){f.TextBoxElView=b;a.registerType("TextBoxElView",b);a.registerElView("input:text",b)});m.extend({toString:function(){return"HiddenElView"}},{value:{set:function(a){if(this._el){var b=
this._el,d=b.value;a=null===a?"":""+a;d!==a&&(b.value=a,this.raisePropertyChanged("value"))}},get:function(){var a=this._el;return!a?"":a.value}}},function(b){f.HiddenElView=b;a.registerType("HiddenElView",b);a.registerElView("input:hidden",b)});k.extend({_init:function(a){this._super(a);a.rows&&(this.rows=a.rows);a.cols&&(this.cols=a.cols);a.wrap&&(this.wrap=a.wrap)},toString:function(){return"TextAreaElView"}},{rows:{set:function(a){var b=this._el;if(b){var d=b.rows;a=!a?1:a;d!==a&&(b.rows=a,this.raisePropertyChanged("rows"))}},
...
"disabled")},destroy:function(){this._isDestroyed||(this._lfScope&&(this._lfScope.destroy(),this._lfScope=null),this._tgt&&(this._tgt.destroy(),this._tgt=null),this._super())},_cleanUp:function(){},update:function(){this._cleanUp();this._updateCss()},toString:function(){return"BoolContent"}},null,function(a){f.BoolContent=a});e.extend({_canBeEdited:function(){return!0},toString:function(){return"RowSelectContent"}},null,function(a){f.RowSelectContent=a});var l=b.extend({_getBindingOption:function(b,
c,e,f){b=this._super(b,c,e,f);b.converter=a.getConverter("dateTimeConverter");c=this.getFieldInfo();e=d.defaults;switch(c.dataType){case p.DateTime:b.converterParam=e.dateTimeFormat;break;case p.Time:b.converterParam=e.timeFormat;break;default:b.converterParam=e.dateTimeFormat}return b},toString:function(){return"DateTimeContent"}},null,function(a){f.DateTimeContent=a}),n=b.extend({_allowedKeys:[0,g.backspace,g.del,g.left,g.right,g.end,g.home,g.tab,g.esc,g.enter],_getBindingOption:function(b,c,d,
...
if(47===a)return!1;var c={32:" ",44:",",46:"."}[a],e=d.defaults;return c===e.decimalPoint?0===b.length?!1:0>b.indexOf(c):c&&c!==e.thousandSep?!1:!(!c&&(45>a||57<a))},toString:function(){return"NumberContent"}},null,function(a){f.NumberContent=a}),s=b.extend({_allowedKeys:[0,g.backspace,g.del,g.left,g.right,g.end,g.home,g.tab,g.esc,g.enter],update:function(){this._super();var a=this,b=a.getFieldInfo();m.TextBoxElView.isPrototypeOf(a._tgt)&&a._tgt.addHandler("keypress",function(c,d){d.isCancel=!a._previewKeyPress(b,
d.keyCode,d.value)})},_previewKeyPress:function(a,b,c){return!(0<a.maxLength&&c.length>=a.maxLength&&-1===this._allowedKeys.indexOf(b))},toString:function(){return"StringContent"}},null,function(a){f.StringContent=a}),u=b.extend({_allowedKeys:[0,g.backspace,g.del,g.left,g.right,g.end,g.home,g.tab,g.esc,g.enter],update:function(){this._super();var a=this,b=a.getFieldInfo();if(m.TextAreaElView.isPrototypeOf(a._tgt)){a._tgt.addHandler("keypress",function(c,d){d.isCancel=!a._previewKeyPress(b,d.keyCode,
