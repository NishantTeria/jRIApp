...
1E3*a.defaults.ajaxTimeOut;d.setRequestHeader("Content-Type","application/json; charset=utf-8");d.send(c);c=h.promise();g&&c.done(function(b){b=b.split(a.modules.consts.CHUNK_SEP);b=b.map(function(b){return JSON.parse(b)});1==b.length?g.call(u,b[0]):g.call(u,b)});p&&c.fail(function(b){p.call(u,b)});return c},performAjaxGet:function(b){var c=new XMLHttpRequest;c.open("GET",b,!0);var e=m.createDeferred();c.responseType="text";c.onload=function(b){200==this.status&&e.resolve(this.response)};c.onerror=
function(b){e.reject(Error(b.target.status))};c.ontimeout=function(){e.reject(Error("The request for "+b+" timed out."))};c.timeout=1E3*a.defaults.ajaxTimeOut;c.send(null);return e.promise()},format:d.format,extend:function(b,c,e){return b?m.cloneObj(e,c):m.mergeObj(e,c)},removeNode:function(b){if(b){var c=b.parentNode;c&&c.removeChild(b)}},insertAfter:function(b,c){var e=b.parentNode;e.lastChild===b?e.appendChild(c):e.insertBefore(c,b.nextSibling)},getProps:function(b){return Object.getOwnPropertyNames(b)},
forEachProp:function(b,c){Object.getOwnPropertyNames(b).forEach(c)},addToolTip:function(b,c,e){e={content:{text:c},style:{classes:e?e:null},position:{my:"top left",at:"bottom right",target:b,viewport:$(a.window),adjust:{method:"flip none",x:0,y:0}},hide:{fixed:!0,delay:250}};b.data("qtip")?c?b.qtip("option","content.text",c):b.qtip("destroy"):c&&b.qtip(e)},hasProp:function(b,c){if(!b)return!1;if(b.hasOwnProperty(c))return!0;if(Object===b)return!1;var e=Object.getPrototypeOf(b);return m.hasProp(e,
c)},createDeferred:function(){return a.$.Deferred()},cloneObj:function(b,c){var e,a,p;if(!b)return b;if(h.Array(b)){p=b.length;e=Array(p);for(a=0;a<p;a+=1)e[a]=m.cloneObj(b[a],null)}else if(h.SimpleObject(b)){e=c||{};var g,d=Object.getOwnPropertyNames(b);p=d.length;for(a=0;a<p;a+=1)g=d[a],e[g]=m.cloneObj(b[g],null)}else return b;return e},shallowCopy:function(b){return m.mergeObj(b,{})},mergeObj:function(b,c){c||(c={});if(!b)return c;for(var e=Object.getOwnPropertyNames(b),a,p=0,g=e.length;p<g;p+=
1)a=e[p],c[a]=b[a];return c},removeFromArray:function(b,c){var e=b.indexOf(c);-1<e&&b.splice(e,1);return e},insertIntoArray:function(b,c,e){b.splice(e,0,c)},destroyJQueryPlugin:function(b,c){if(b.data(c))b[c]("destroy")},uuid:function(){var b="0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz".split("");return function(c,e){var a,p=[],g=Math.random;e=e||b.length;if(c)for(a=0;a<c;a+=1)p[a]=b[0|g()*e];else{var d;p[8]=p[13]=p[18]=p[23]="-";p[14]="4";for(a=0;36>a;a+=1)p[a]||(d=0|16*g(),p[a]=
b[19==a?d&3|8:d&15])}return p.join("")}}()},g=RIAPP.BaseObject.extend({_cnt:0,_create:function(){this._super();this._objs=[];g._cnt+=1;this._cnt=g._cnt},addObj:function(b){0>this._objs.indexOf(b)&&this._objs.push(b)},removeObj:function(b){m.removeFromArray(this._objs,b)},getObjs:function(){return this._objs},destroy:function(){this._objs.forEach(function(b){b._isDestroyCalled||b.destroy()});this._objs=[];this._super()},toString:function(){return"LifeTimeScope "+this._cnt}},null,function(b){f.LifeTimeScope=
b});f.PropWatcher=RIAPP.BaseObject.extend({_create:function(){this._super();this._objId="prw"+m.getNewID();this._objs=[]},addPropWatch:function(b,c,e){b.addOnPropertyChange(c,function(b,c){e(c.property)},this.uniqueID);0>this._objs.indexOf(b)&&this._objs.push(b)},addWatch:function(b,c,e){b.addOnPropertyChange("*",function(b,p){-1<c.indexOf(p.property)&&e(p.property)},this.uniqueID);0>this._objs.indexOf(b)&&this._objs.push(b)},removeWatch:function(b){b.removeNSHandlers(this.uniqueID)},destroy:function(){var b=
this;this._objs.forEach(function(c){b.removeWatch(c)});this._objs=[];this._super()},toString:function(){return"PropWatcher "+this._objId}},{uniqueID:{get:function(){return this._objId}}},function(b){a.registerType("PropWatcher",b)});f.WaitQueue=RIAPP.BaseObject.extend({_create:function(b){this._super();this._objId="wq"+m.getNewID();this._owner=b;this._queue={}},_checkQueue:function(b,c){if(this._owner&&!this._owner._isDestroyCalled){var e=this,a=this._queue[b],p;if(a&&0!=a.length){var g,d,m=null,
h=[],f=[],n=[];for(g=0;g<a.length;g+=1)if(p=a[g],p.predicate(c))if(!p.group&&0==h.length){d=p;break}else p.group&&(m||(m=p.group),m===p.group&&h.push(p));if(d)f.push(d),n.push(d);else for(;0<h.length;)p=h.pop(),d||(d=p),d.lastWins?0==f.length&&f.push(p):f.push(p),n.push(p);try{if(0<f.length){for(g=a.length;0<g;)g-=1,-1<n.indexOf(a[g])&&a.splice(g,1);f.forEach(function(r){try{r.action.apply(e._owner,r.args)}catch(b){e._owner._onError(b,e)}})}}finally{0==a.length&&(delete this._queue[b],this._owner.removeOnPropertyChange(b,
this.uniqueID))}}}},enQueue:function(b){b=m.extend(!1,{prop:"",groupName:null,predicate:null,action:null,actionArgs:[],lastWins:!1,syncCheck:!1},b);var c=this;if(this._owner){var e=b.prop,a=this._queue[e];a||(a=[],this._queue[e]=a,this._owner.addOnPropertyChange(e,function(b,a){setTimeout(function(){c._isDestroyCalled||c._checkQueue(e,c._owner[e])},0)},c.uniqueID));a.push({predicate:b.predicate,action:b.action,group:b.groupName,lastWins:b.lastWins,args:!b.actionArgs?[]:b.actionArgs});b.syncCheck?
c._checkQueue(e,c._owner[e]):setTimeout(function(){c._isDestroyCalled||c._checkQueue(e,c._owner[e])},0)}},destroy:function(){this._owner.removeOnPropertyChange(null,this.uniqueID);this._queue={};this._owner=null;this._super()},toString:function(){return"WaitQueue "+this._objId}},{uniqueID:{get:function(){return this._objId}},owner:{get:function(){return this._owner}}},null);m.mergeObj(m,f);a.utils=f};
...
!0;var f=function(){throw Error("getFunc is not emplemented!");},t,y=k[0].name;r?(b.isReadOnly=!1,d._childAssocMap[k[0].childToParentName]=k[0],k[0].fieldRels.forEach(function(a){a=d._fieldMap[a.childField];!b.isReadOnly&&a.isReadOnly&&(b.isReadOnly=!0)}),f=function(){return d.dbContext.getAssociation(y).getParentItem(this)},b.isReadOnly||(d._trackAssoc[y]=k[0],t=function(b){var c,e,r=d.dbContext.getAssociation(y);if(b&&!r.parentDS.entityType.isPrototypeOf(b))throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_PARAM_INVALID_TYPE,
"value",r.parentDS.entityType._typeName));if(b&&b._isNew)this._setFieldVal(a.fieldName,b._key);else if(b){c=0;for(e=r.childFldInfos.length;c<e;c+=1)this[r.childFldInfos[c].fieldName]=b[r.parentFldInfos[c].fieldName]}else{this._getFieldVal(a.fieldName)&&this._setFieldVal(a.fieldName,null);c=0;for(e=r.childFldInfos.length;c<e;c+=1)this[r.childFldInfos[c].fieldName]=null}})):(d._parentAssocMap[k[0].parentToChildrenName]=k[0],f=function(){return d.dbContext.getAssociation(y).getChildItems(this)});q[a.fieldName]=
...
d=a._dbSet;this.waitForNotSubmiting(function(){var b=this;d.waitForNotLoading(function(){var k,f=function(){b.isBusy=!1;d.isLoading=!1;a._isRefreshing=!1},g=function(a){f();b._onDataOperError(a,"refresh")};a._isRefreshing=!0;b.isBusy=!0;d.isLoading=!0;try{var p={dbSetName:a._dbSetName,rowInfo:a._getRowInfo(),error:null};a._checkCanRefresh();k=JSON.stringify(p);h.performAjaxCall(e,k,!0,function(e){try{b._onItemRefreshed(e,a),f(),c(!0)}catch(d){g(d),c(!1)}},function(a){f();b._onDataOperError(a,"refresh");
c(!1)},null)}catch(y){g(y),c(!1)}},[],!0,null)},[],null);return b.promise()},_onError:function(a,b){var c=this._super(a,b);return!c?this.app?this.app._onError(a,b):d._onError(a,b):c},_onDataOperError:function(a,b){if(d._checkIsDummy(a))return!0;var c;c=u.isPrototypeOf(a)?a:u.create(a,b);return this._onError(c,this)},_onSubmitError:function(a){var b={error:a,isHandled:!1};this.raiseEvent("submit_error",b);b.isHandled||(this.rejectChanges(),this._onDataOperError(a,"submit"))},_beforeLoad:function(a,
b,c){a&&b!==a&&(c._query=a,c.pageIndex=0);b&&b!==a&&b.destroy();if(a.pageSize!==c.pageSize){c._ignorePageChanged=!0;try{c.pageIndex=0,c.pageSize=a.pageSize}finally{c._ignorePageChanged=!1}}if(a.pageIndex!==c.pageIndex){c._ignorePageChanged=!0;try{c.pageIndex=a.pageIndex}finally{c._ignorePageChanged=!1}}a.isCacheValid||a._clearCache()},_load:function(a,b){if(!a)throw Error(RIAPP.ERRS.ERR_DB_LOAD_NO_QUERY);var c=this,e=h.createDeferred(),d=a.loadPageCount,q=a.pageIndex,k=a.isPagingEnabled,f=a.dbSetName,
g=this.getDbSet(f);this.waitForNotSubmiting(function(){g.waitForNotLoading(function(){var p=g.query,l=c._getUrl("GetItems"),m,w,u=function(){g.isLoading=!1;c.isBusy=!1},n=function(a){u();e.resolve(a)},v=function(a){u();c._onDataOperError(a,"load");e.reject()},x;g.isLoading=!0;c.isBusy=!0;try{a.pageIndex=q;c._beforeLoad(a,p,g);var A,p=1;if(1<d&&k){if(a._isPageCached(q)){x=c._loadFromCache(a,b);x.outOfBandData=null;n(x);return}A=a._getCache().getNextRange(q);q=A.start;p=A.cnt}m={dbSetName:f,pageIndex:q,
pageSize:a.pageSize,pageCount:p,isIncludeTotalCount:a.isIncludeTotalCount,filterInfo:a.filterInfo,sortInfo:a.sortInfo,paramInfo:c._getMethodParams(a._queryInfo,a.params).paramInfo,queryName:a.queryName};w=JSON.stringify(m);h.performAjaxCall(l,w,!0,function(a){var e=[],d;try{h.check_is.Array(a)&&(d=a[0],e=a.slice(1),a=d),x=c._onLoaded(a,b,e),x.outOfBandData=a.extraInfo,n(x)}catch(q){v(q)}},function(a){u();c._onDataOperError(a,"load");e.reject()},null)}catch(z){v(z)}},[],!0,b?"paging":null)},[],b?"paging":
null);return e.promise()},getDbSet:function(a){if(!this.isInitialized)throw Error(RIAPP.ERRS.ERR_DOMAIN_CONTEXT_NOT_INITIALIZED);var b=this._dbSets[a];if(!b)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_DBSET_NAME_INVALID,a));return b},getAssociation:function(a){var b=this._assoc[a];if(!b)throw Error(RIAPP.utils.format(RIAPP.ERR_ASSOC_NAME_INVALID,a));return b()},submitChanges:function(){if(this._pendingSubmit)return this._pendingSubmit.deferred.promise();var a=this,b={deferred:h.createDeferred()},
c=function(a){a?b.deferred.resolve():b.deferred.reject()};this._pendingSubmit=b;this.waitForNotBusy(function(){var b,e,d,k=function(){a.isBusy=!1;a.isSubmiting=!1},f=function(b){k();a._onDataOperError(b,"submit");c(!1)};try{if(this.isSubmiting=this.isBusy=!0,this._pendingSubmit=null,b=this._getUrl("SaveChanges"),d=this._getChanges(),0===d.dbSets.length){k();c(!0);return}}catch(g){f(g);return}try{e=JSON.stringify(d),h.performAjaxCall(b,e,!0,function(b){try{a._dataSaved(b),k(),c(!0)}catch(e){f(e)}},
function(b){k();a._onSubmitError(b);c(!1)},null)}catch(p){f(p)}},[]);return b.deferred.promise()},load:function(a){return this._load(a,!1)},acceptChanges:function(){this._arrDbSets.forEach(function(a){a.acceptChanges()})},rejectChanges:function(){this._arrDbSets.forEach(function(a){a.rejectChanges()})},initialize:function(a){if(!this._isInitialized){var b=this;a=h.extend(!1,{serviceUrl:null,metadata:null},a);this._serviceUrl=a.serviceUrl;if(a.metadata)this._initDbSets(a.metadata);else{a=this._getUrl("GetMetadata");
try{this.isBusy=!0,h.performAjaxCall(a,void 0,!0,function(a){try{b._initDbSets(a),b.isBusy=!1}catch(c){b.isBusy=!1,b._onDataOperError(c,"initDbContext"),d._throwDummy(c)}},function(a){b.isBusy=!1;b._onDataOperError(a,"initDbContext")},null)}catch(c){this.isBusy=!1,this._onDataOperError(c,"initDbContext"),d._throwDummy(c)}}}},waitForNotBusy:function(a,b){this._waitQueue.enQueue({prop:"isBusy",groupName:null,predicate:function(a){return!a},action:a,actionArgs:b})},waitForNotSubmiting:function(a,b,c){this._waitQueue.enQueue({prop:"isSubmiting",
...
a&&(this._isSubmiting=a,this.raisePropertyChanged("isSubmiting"))},get:function(){return this._isSubmiting}},serverTimezone:{get:function(){return this._serverTimezone}},dbSets:{get:function(){return this._dbSets}},arrDbSets:{get:function(){return this._arrDbSets}},serviceMethods:{get:function(){return this._svcMethods}},hasChanges:{get:function(){return this._hasChanges}}},function(b){f.DbContext=b;a.registerType("DbContext",b)});var x=l.Collection.extend({_create:function(a){this._super();a=h.extend(!1,
{dataSource:null,fn_filter:null,fn_sort:null,fn_itemsProvider:null},a);if(!a.dataSource||!l.Collection.isPrototypeOf(a.dataSource))throw Error(RIAPP.ERRS.ERR_DATAVIEW_DATASRC_INVALID);if(!a.fn_filter||!h.check_is.Function(a.fn_filter))throw Error(RIAPP.ERRS.ERR_DATAVIEW_FILTER_INVALID);this._dataSource=a.dataSource;this._fn_filter=a.fn_filter;this._fn_sort=a.fn_sort;this._fn_itemsProvider=a.fn_itemsProvider;this._isAddingNew=this._isDSFilling=!1;var b=this,c=this._dataSource;c.getFieldNames().forEach(function(a){b._fieldMap[a]=
h.extend(!1,{},c.getFieldInfo(a))});this._bindDS()},_getEventNames:function(){var a=this._super();return["view_refreshed"].concat(a)},_filterForPaging:function(a){var b=0,c=0,e=-1,d=-1,q=[],b=this.pageSize*this.pageIndex,c=this.pageSize;a.forEach(function(a){d+=1;d<b||(e+=1,e<c&&q.push(a))});return q},_onViewRefreshed:function(a){this.raiseEvent("view_refreshed",a)},_refresh:function(a){var b;if(b=this._dataSource)b=this._fn_itemsProvider?this._fn_itemsProvider(b):b.items,this._fn_filter&&(b=b.filter(this._fn_filter)),
this._fn_sort&&(b=b.sort(this._fn_sort)),this._fillItems({items:b,isPageChanged:!!a,clear:!0,isAppend:!1}),this._onViewRefreshed({})},_fillItems:function(a){a=h.extend(!1,{items:[],isPageChanged:!1,clear:!0,isAppend:!1},a);var b,c=[],e=[],d=[];this._onFillStart({isBegin:!0,rowCount:a.items.length,time:new Date,isPageChanged:a.isPageChanged});try{a.clear&&this.clear(),b=this.isPagingEnabled&&!a.isAppend?this._filterForPaging(a.items):a.items,b.forEach(function(a){var b=this._itemsByKey[a._key];b?d.push(b):
(this._itemsByKey[a._key]=a,c.push(a),e.push(this._items.length-1),this._items.push(a),d.push(a))},this),0<c.length&&(this._onItemsChanged({change_type:k.ADDED,items:c,pos:e}),this.raisePropertyChanged("count"))}finally{this._onFillEnd({isBegin:!1,rowCount:d.length,time:new Date,resetUI:!!a.clear,fetchedItems:d,newItems:c,isPageChanged:a.isPageChanged})}this.totalCount=a.clear?a.items.length:this.totalCount+c.length;this.moveFirst();return c},_onDSCollectionChanged:function(a){var b=this,c;c=a.items;
switch(a.change_type){case k.RESET:this._isDSFilling||this._refresh(!1);break;case k.ADDED:!this._isAddingNew&&!this._isDSFilling&&(b._fn_filter&&(c=c.filter(b._fn_filter)),b.appendItems([c]));break;case k.REMOVE:c.forEach(function(a){(a=b._itemsByKey[a._key])&&b.removeItem(a)});break;case k.REMAP_KEY:if(c=b._itemsByKey[a.old_key])delete b._itemsByKey[a.old_key],b._itemsByKey[a.new_key]=c,this._onItemsChanged(a);break;default:throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_COLLECTION_CHANGETYPE_INVALID,
a.change_type));}},_onDSFill:function(a){var b=a.fetchedItems;a.isBegin?this._isDSFilling=!0:(this._isDSFilling=!1,a.resetUI?this._refresh(!1):(this._fn_filter&&(b=b.filter(this._fn_filter)),this.appendItems(b)))},_onDSStatusChanged:function(a){var b=a.item,c=a.oldChangeType,e=!!this._fn_filter;this._itemsByKey[a.key]?(this._onItemStatusChanged(b,c),e&&((a=this._fn_filter(b))||this.removeItem(b))):e&&(a=this._fn_filter(b))&&this.appendItems([b])},_bindDS:function(){var a=this,b=this._dataSource;b&&
(b.addHandler("coll_changed",function(c,e){b===c&&a._onDSCollectionChanged(e)},a._objId),b.addHandler("fill",function(c,e){b===c&&a._onDSFill(e)},a._objId),b.addHandler("begin_edit",function(c,e){b===c&&a._itemsByKey[e.item._key]&&a._onEditing(e.item,!0,!1)},a._objId),b.addHandler("end_edit",function(c,e){if(b===c){var d,q=e.item;d=!!a._fn_filter;a._itemsByKey[q._key]?(a._onEditing(q,!1,e.isCanceled),!e.isCanceled&&d&&((d=a._fn_filter(q))||a.removeItem(q))):!e.isCanceled&&d&&(d=a._fn_filter(q))&&
a.appendItems([q])}},a._objId),b.addHandler("errors_changed",function(c,e){b===c&&a._itemsByKey[e.item._key]&&a._onErrorsChanged(e.item)},a._objId),b.addHandler("status_changed",function(c,e){b===c&&a._onDSStatusChanged(e)},a._objId),b.addHandler("item_deleting",function(c,e){b===c&&a._itemsByKey[e.item._key]&&a._onItemDeleting(e)},a._objId),b.addHandler("item_added",function(c,e){b===c&&a._isAddingNew&&(a._itemsByKey[e.item._key]||a._attach(e.item),a.currentItem=e.item,a._onEditing(e.item,!0,!1),
a._onItemAdded(e.item))},a._objId),b.addHandler("item_adding",function(c,e){b===c&&a._isAddingNew&&a._onItemAdding(e.item)},a._objId))},_unbindDS:function(){var a=this._dataSource;a&&a.removeNSHandlers(this._objId)},appendItems:function(a){return this._isDestroyed?[]:this._fillItems({items:a,isPageChanged:!1,clear:!1,isAppend:!0})},_getStrValue:function(a,b){return this._dataSource._getStrValue(a,b)},_onCurrentChanging:function(a){var b=this._dataSource;try{b._EditingItem&&a!==b._EditingItem&&b.endEdit()}catch(c){b.cancelEdit(),
d.reThrow(c,this._onError(c,this))}},_getErrors:function(a){return this._dataSource._getErrors(a)},_onPageChanged:function(){this._refresh(!0)},getItemsWithErrors:function(){return this._dataSource.getItemsWithErrors()},addNew:function(){var a=this._dataSource,b;this._isAddingNew=!0;try{b=a.addNew()}finally{this._isAddingNew=!1}return b},removeItem:function(a){if(null===a._key)throw Error(RIAPP.ERRS.ERR_ITEM_IS_DETACHED);if(this._itemsByKey[a._key]){var b=h.removeFromArray(this._items,a);if(0>b)throw Error(RIAPP.ERRS.ERR_ITEM_IS_NOTFOUND);
delete this._itemsByKey[a._key];delete this._errors[a._key];this.totalCount-=1;this._onRemoved(a,b);a=this.getItemByPos(b);var c=this._currentPos;c===b&&(a||(this._currentPos=c-1),this._onCurrentChanged());c>b&&(this._currentPos=c-1,this._onCurrentChanged())}},sortLocal:function(a,b){var c=1,e=this._app.parser;b&&"DESC"===b.toUpperCase()&&(c=-1);this.fn_sort=function(b,d){var k=0,f,g,p;f=0;for(g=a.length;f<g&&!(p=a[f],k=e.resolvePath(b,p),p=e.resolvePath(d,p),k=k<p?-1*c:k>p?c:0,0!==k);f+=1);return k}},
getIsHasErrors:function(){return this._dataSource.getIsHasErrors()},clear:function(){this.cancelEdit();this._EditingItem=null;this._newKey=0;this.currentItem=null;this._items=[];this._itemsByKey={};this._errors={};this._onItemsChanged({change_type:k.RESET,items:[]});this.pageIndex=0;this.raisePropertyChanged("count")},refresh:function(){this._refresh(!1)},destroy:function(){this._isDestroyed||(this._unbindDS(),this._fn_sort=this._fn_filter=this._dataSource=null,this._super())}},{isPagingEnabled:{set:function(a){this._options.enablePaging!==
a&&(this._options.enablePaging=a,this.raisePropertyChanged("isPagingEnabled"),this._refresh())},get:function(){return this._options.enablePaging}},permissions:{get:function(){return this._dataSource.permissions}},fn_filter:{set:function(a){this._fn_filter!==a&&(this._fn_filter=a,this._refresh())},get:function(){return this._fn_filter}},fn_sort:{set:function(a){this._fn_sort!==a&&(this._fn_sort=a,this._refresh())},get:function(){return this._fn_sort}},fn_itemsProvider:{set:function(a){this._fn_itemsProvider!==
a&&(this._fn_itemsProvider=a,this._refresh())},get:function(){return this._fn_itemsProvider}}},function(b){f.DataView=b;a.registerType("DataView",b)}),A=RIAPP.BaseObject.extend({_app:a,_create:function(a){this._super();var b=this;this._objId="ass"+this._app.getNewObjectID();a=h.extend(!1,{dbContext:null,parentName:"",childName:"",parentKeyFields:[],childKeyFields:[],parentToChildrenName:null,childToParentName:null,name:this._objId,onDeleteAction:0},a);this._name=a.name;this._dbContext=a.dbContext;
this._onDeleteAction=a.onDeleteAction;this._parentDS=a.dbContext.dbSets[a.parentName];this._childDS=a.dbContext.dbSets[a.childName];this._parentFldInfos=a.parentKeyFields.map(function(a){return b._parentDS.getFieldInfo(a)});this._childFldInfos=a.childKeyFields.map(function(a){return b._childDS.getFieldInfo(a)});this._parentToChildrenName=a.parentToChildrenName;this._childToParentName=a.childToParentName;this._parentMap={};this._childMap={};this._isChildFilling=this._isParentFilling=!1;this._bindParentDS();
a=this._mapParentItems(this._parentDS.items);this._bindChildDS();var c=this._mapChildren(this._childDS.items);this._changedTimeout=this._saveChildFKey=this._saveParentFKey=null;this._changed={};b._notifyParentChanged(a);b._notifyChildrenChanged(c)},_onError:function(a,b){var c=this._super(a,b);return!c?this.app._onError(a,b):c},_bindParentDS:function(){var a=this,b=this._parentDS;b&&(b._addHandler("coll_changed",function(c,e){b===c&&a._onParentCollChanged(e)},a._objId,!0),b._addHandler("fill",function(c,
e){b===c&&a._onParentFill(e)},a._objId,!0),b._addHandler("begin_edit",function(c,e){b===c&&a._onParentEdit(e.item,!0,void 0)},a._objId,!0),b._addHandler("end_edit",function(c,e){b===c&&a._onParentEdit(e.item,!1,e.isCanceled)},a._objId,!0),b._addHandler("item_deleting",function(a,b){},a._objId,!0),b._addHandler("status_changed",function(c,e){b===c&&a._onParentStatusChanged(e.item,e.oldChangeType)},a._objId,!0),b._addHandler("commit_changes",function(c,e){b===c&&a._onParentCommitChanges(e.item,e.isBegin,
e.isRejected,e.changeType)},a._objId,!0))},_bindChildDS:function(){var a=this,b=this._childDS;b&&(b._addHandler("coll_changed",function(c,e){b===c&&a._onChildCollChanged(e)},a._objId,!0),b._addHandler("fill",function(c,e){b===c&&a._onChildFill(e)},a._objId,!0),b._addHandler("begin_edit",function(c,e){b===c&&a._onChildEdit(e.item,!0,void 0)},a._objId,!0),b._addHandler("end_edit",function(c,e){b===c&&a._onChildEdit(e.item,!1,e.isCanceled)},a._objId,!0),b._addHandler("status_changed",function(c,e){b===
c&&a._onChildStatusChanged(e.item,e.oldChangeType)},a._objId,!0),b._addHandler("commit_changes",function(c,e){b===c&&a._onChildCommitChanges(e.item,e.isBegin,e.isRejected,e.changeType)},a._objId,!0))},_onParentCollChanged:function(a){var b=this,c;c=a.items;var e=[],d={};switch(a.change_type){case k.RESET:b._isParentFilling||(e=b.refreshParentMap());break;case k.ADDED:this._isParentFilling||(e=b._mapParentItems(c));break;case k.REMOVE:c.forEach(function(a){(a=b._unMapParentItem(a))&&(d[a]=null)});
e=Object.keys(d);break;case k.REMAP_KEY:if(a.old_key&&(c=this._parentMap[a.old_key]))delete this._parentMap[a.old_key],e=this._mapParentItems([c]);break;default:throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_COLLECTION_CHANGETYPE_INVALID,a.change_type));}b._notifyParentChanged(e)},_onParentFill:function(a){a.isBegin?this._isParentFilling=!0:(this._isParentFilling=!1,a=a.resetUI?this.refreshParentMap():this._mapParentItems(a.newItems),this._notifyParentChanged(a))},_onParentEdit:function(a,b,c){b?this._storeParentFKey(a):
c?this._saveParentFKey=null:this._checkParentFKey(a)},_onParentCommitChanges:function(a,b,e,d){b?e&&d===c.ADDED?(a=this._unMapParentItem(a))&&this._notifyParentChanged([a]):!e&&d===c.DELETED?(a=this._unMapParentItem(a))&&this._notifyParentChanged([a]):this._storeParentFKey(a):this._checkParentFKey(a)},_storeParentFKey:function(a){a=this.getParentFKey(a);null!==a&&this._parentMap[a]&&(this._saveParentFKey=a)},_checkParentFKey:function(a){var b,c=this._saveParentFKey;this._saveParentFKey=null;b=this.getParentFKey(a);
b!==c&&(c&&(delete this._parentMap[c],this._notifyChildrenChanged([c]),this._notifyParentChanged([c])),b&&(this._mapParentItems([a]),this._notifyChildrenChanged([b]),this._notifyParentChanged([b])))},_onParentStatusChanged:function(a,b){var e=this,d,k;if(a._changeType===c.DELETED){k=e.getChildItems(a);d=this._unMapParentItem(a);switch(e.onDeleteAction){case 1:k.forEach(function(a){a.deleteItem()});break;case 2:k.forEach(function(a){var b=a.isEditing;b||a.beginEdit();try{e._childFldInfos.forEach(function(b){a[b.fieldName]=
null}),b||a.endEdit()}finally{b||a.cancelEdit()}})}d&&e._notifyParentChanged([d])}},_onChildCollChanged:function(a){var b=this,c=a.items,e=[],d={};switch(a.change_type){case k.RESET:b._isChildFilling||(e=b.refreshChildMap());break;case k.ADDED:this._isChildFilling||(e=b._mapChildren(c));break;case k.REMOVE:c.forEach(function(a){(a=b._unMapChildItem(a))&&(d[a]=null)});e=Object.keys(d);break;case k.REMAP_KEY:if(a.old_key&&(a=c[0])){if(e=a._getFieldVal(this._childToParentName))delete this._childMap[e],
a._clearFieldVal(this._childToParentName);e=this._mapChildren([a])}break;default:throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_COLLECTION_CHANGETYPE_INVALID,a.change_type));}b._notifyChildrenChanged(e)},_notifyChildrenChanged:function(a){this._notifyChanged([],a)},_notifyParentChanged:function(a){this._notifyChanged(a,[])},_notifyChanged:function(a,b){var c=this;if(0<a.length||0<b.length)a.forEach(function(a){var b=c._changed[a];c._changed[a]=b?b|1:1}),b.forEach(function(a){var b=c._changed[a];c._changed[a]=
b?b|2:2}),this._changedTimeout||(this._changedTimeout=setTimeout(function(){if(!c._isDestroyCalled){c._changedTimeout=null;var a=c._changed;c._changed={};Object.keys(a).forEach(function(b){var e=a[b];1==(e&1)&&c._onParentChanged(b);2==(e&2)&&c._onChildrenChanged(b)})}},50))},_onChildFill:function(a){a.isBegin?this._isChildFilling=!0:(this._isChildFilling=!1,a=a.resetUI?this.refreshChildMap():this._mapChildren(a.newItems),this._notifyChildrenChanged(a))},_onChildEdit:function(a,b,c){b?this._storeChildFKey(a):
c?this._saveChildFKey=null:this._checkChildFKey(a)},_onChildCommitChanges:function(a,b,e,d){b?e&&d===c.ADDED?(a=this._unMapChildItem(a))&&this._notifyChildrenChanged([a]):!e&&d===c.DELETED?(a=this._unMapChildItem(a))&&this._notifyChildrenChanged([a]):this._storeChildFKey(a):this._checkChildFKey(a)},_storeChildFKey:function(a){var b=this.getChildFKey(a),c;if(b&&(c=this._childMap[b])&&-1<c.indexOf(a))this._saveChildFKey=b},_checkChildFKey:function(a){var b=this._saveChildFKey,c,e;this._saveChildFKey=
null;c=this.getChildFKey(a);c!==b&&(b&&(e=this._childMap[b],h.removeFromArray(e,a),0==e.length&&delete this._childMap[b],this._notifyParentChanged([b]),this._notifyChildrenChanged([b])),c&&(this._mapChildren([a]),this._notifyParentChanged([c]),this._notifyChildrenChanged([c])))},_onChildStatusChanged:function(a,b){var e=c.DELETED,d=a._changeType,k=this.getChildFKey(a);k&&d===e&&(k=this._unMapChildItem(a))&&this._notifyChildrenChanged([k])},_getItemKey:function(a,b,c){for(var e=[],d,q=0,k=a.length;q<
k;q+=1){d=c[a[q].fieldName];d=b._getStrValue(d,a[q]);if(null===d)return null;e.push(d)}return e.join(";")},_resetChildMap:function(){var a=Object.keys(this._childMap);this._childMap={};this._notifyChildrenChanged(a)},_resetParentMap:function(){var a=Object.keys(this._parentMap);this._parentMap={};this._notifyParentChanged(a)},_unMapChildItem:function(a){var b,c,e=null;if(b=this.getChildFKey(a))if(c=this._childMap[b])a=h.removeFromArray(c,a),-1<a&&(0==c.length&&delete this._childMap[b],e=b);return e},
_unMapParentItem:function(a){var b=null;if((a=this.getParentFKey(a))&&this._parentMap[a])delete this._parentMap[a],b=a;return b},_mapParentItems:function(a){for(var b,e,d=c.DELETED,k,q={},f=0,g=a.length;f<g;f+=1)if(b=a[f],e=b._changeType,e!==d&&(e=this.getParentFKey(b)))k=this._parentMap[e],k!==b&&(this._parentMap[e]=b,q[e]=null);return Object.keys(q)},_onChildrenChanged:function(a){a&&this._parentToChildrenName&&(a=this._parentMap[a])&&a.raisePropertyChanged(this._parentToChildrenName)},_onParentChanged:function(a){var b=
this;a&&this._childToParentName&&(a=this._childMap[a])&&a.forEach(function(a){a.raisePropertyChanged(b._childToParentName)})},_mapChildren:function(a){for(var b,e,d,k=c.DELETED,q={},f=0,g=a.length;f<g;f+=1)if(b=a[f],e=b._changeType,e!==k&&(e=this.getChildFKey(b)))d=this._childMap[e],d||(d=[],this._childMap[e]=d),0>d.indexOf(b)&&(d.push(b),q[e]||(q[e]=null));return Object.keys(q)},_unbindParentDS:function(){var a=this.parentDS;a&&a.removeNSHandlers(this._objId)},_unbindChildDS:function(){var a=this.childDS;
a&&a.removeNSHandlers(this._objId)},getParentFKey:function(a){return a&&a._isNew?a._key:this._getItemKey(this._parentFldInfos,this._parentDS,a)},getChildFKey:function(a){if(a&&this._childToParentName){var b=a._getFieldVal(this._childToParentName);if(b)return b}return this._getItemKey(this._childFldInfos,this._childDS,a)},getChildItems:function(a){if(!a)return[];a=this.getParentFKey(a);a=this._childMap[a];return!a?[]:a},getParentItem:function(a){if(!a)return null;a=this.getChildFKey(a);return(a=this._parentMap[a])?
a:null},refreshParentMap:function(){this._resetParentMap();return this._mapParentItems(this._parentDS.items)},refreshChildMap:function(){this._resetChildMap();return this._mapChildren(this._childDS.items)},destroy:function(){clearTimeout(this._changedTimeout);this._changedTimeout=null;this._changed={};this._unbindParentDS();this._unbindChildDS();this._childFldInfos=this._parentFldInfos=this._childMap=this._parentMap=null;this._super()},toString:function(){return"Association: "+this._name}},{app:{get:function(){return this._app}},
name:{get:function(){return this._name}},parentToChildrenName:{get:function(){return this._parentToChildrenName}},childToParentName:{get:function(){return this._childToParentName}},parentDS:{get:function(){return this._parentDS}},childDS:{get:function(){return this._childDS}},parentFldInfos:{get:function(){return this._parentFldInfos}},childFldInfos:{get:function(){return this._childFldInfos}},onDeleteAction:{get:function(){return this._onDeleteAction}}},function(a){f.Association=a});x.extend({_create:function(a){this._refreshTimeout=
this._parentItem=null;this._association=a.association;a.dataSource=this._association.childDS;var b=this,c=this._association,e=a.fn_filter;a.fn_filter=function(a){if(!b._parentItem)return!1;var d=c.getParentFKey(b._parentItem);if(!d)return!1;var k=c.getChildFKey(a);return!k||d!==k?!1:e?e(a):!0};this._super(a)},_refresh:function(){var a=this;this._dataSource&&(clearTimeout(a._refreshTimeout),a._refreshTimeout=setTimeout(function(){if(!a._isDestroyCalled){var b=a._association.getChildItems(a._parentItem);
a._fn_filter&&(b=b.filter(a._fn_filter));a._fn_sort&&(b=b.sort(a._fn_sort));a._fillItems({items:b,isPageChanged:!1,clear:!0,isAppend:!1});a._onViewRefreshed({})}},250))},destroy:function(){clearTimeout(this._refreshTimeout);this._association=null;this._super()},toString:function(){return this._association?"ChildDataView for "+this._association.toString():"ChildDataView"}},{parentItem:{set:function(a){this._parentItem!==a&&(this._parentItem=a,this.raisePropertyChanged("parentItem"),0<this.items.length&&
(this.clear(),this._onViewRefreshed({})),this._refresh())},get:function(){return this._parentItem}},association:{get:function(){return this._association}}},function(b){f.ChildDataView=b;a.registerType("ChildDataView",b)})};
...
this.$div;b.removeClass(s.colSortable).removeClass(s.colSortAsc).removeClass(s.colSortDesc);switch(a){case "ASC":b.addClass(s.colSortAsc);break;case "DESC":b.addClass(s.colSortDesc);break;default:this.isSortable&&b.addClass(s.colSortable)}this._sortOrder=a},get:function(){return this._sortOrder}}},function(a){f.DataColumn=a});z=n.extend({_init:function(){this._super();this.$div.addClass(s.rowExpander)},toString:function(){return"ExpanderColumn"}},null,function(a){f.ExpanderColumn=a});w=n.extend({_init:function(){this._super();
