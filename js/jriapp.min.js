...
(d||"\\s")+"]+","g"),"")},rtrim:function(a,d){return a.replace(RegExp("["+(d||"\\s")+"]+$","g"),"")},isArray:function(a){return!a?!1:Array.isArray(a)},format:function(){for(var g="",d=arguments,k=d[0],h=0;;){var p=k.indexOf("{",h),n=k.indexOf("}",h);if(0>p&&0>n){g+=k.slice(h);break}if(0<n&&(n<p||0>p)){if("}"!==k.charAt(n+1))throw Error(a.format(RIAPP.ERRS.ERR_STRING_FORMAT_INVALID,k));g+=k.slice(h,n+1);h=n+2}else if(g+=k.slice(h,p),h=p+1,"{"===k.charAt(h))g+="{",h++;else{if(0>n)throw Error(a.format(RIAPP.ERRS.ERR_STRING_FORMAT_INVALID,
k));var p=k.substring(h,n),f=p.indexOf(":"),h=parseInt(0>f?p:p.substring(0,f),10)+1;if(isNaN(h))throw Error(a.format(RIAPP.ERRS.ERR_STRING_FORMAT_INVALID,k));p=0>f?"":p.substring(f+1);h=d[h];if(void 0===h||null===h)h="";g=h.format?g+h.format(p):g+h.toString();h=n+1}}return g}};String.format||(String.format=function(){var g=Array.prototype.slice.call(arguments);return a.format.apply(a,g)});return a}();
RIAPP.BaseObject={_create:function(){this.__events=this._super=null;this._isDestroyCalled=this._isDestroyed=!1},create:function(){var a=Object.create(this);a._create.apply(a,arguments);Object.seal(a);return a},extend:function(a,g,d){var k=g||{},h,p=0,n,f,b=/\._super\s*\(/;Object.getOwnPropertyNames(k).forEach(function(b){b=k[b];void 0===b.enumerable&&(b.enumerable=!0);void 0===b.configurable&&(b.configurable=!1)});k._typeName=Object.getOwnPropertyDescriptor({_typeName:""},"_typeName");k.__eventNames=
Object.getOwnPropertyDescriptor({__eventNames:[]},"__eventNames");if(a){h=Object.getOwnPropertyNames(a);p=0;for(n=h.length;p<n;p+=1)g=h[p],k.hasOwnProperty(g)||(k[g]=Object.getOwnPropertyDescriptor(a,g))}f=Object.create(this,k);Object.getOwnPropertyNames(f).forEach(function(c){var e=Object.getOwnPropertyDescriptor(f,c),l,m,a;e.value&&RIAPP.utils.isFunc(e.value)&&(m=e.value.toString(),l=f[c],b.test(m)?(a=Object.getPrototypeOf(f),e.value="destroy"==c?function(){var b=this._super;this._super=a[c];try{return this._isDestroyCalled=
!0,l.apply(this,arguments)}finally{this._super=b}}:function(){var b=this._super;this._super=a[c];try{return l.apply(this,arguments)}finally{this._super=b}},Object.defineProperty(f,c,e)):"destroy"==c&&(e.value=function(){this._isDestroyCalled=!0;return l.apply(this,arguments)},Object.defineProperty(f,c,e)))});f.__eventNames=f._getEventNames();d&&d(f);return f},_addHandler:function(a,g,d,k){if(!this._isDestroyed){if(!RIAPP.utils.isFunc(g))throw Error(RIAPP.ERRS.ERR_EVENT_INVALID_FUNC);if(!a)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_EVENT_INVALID,
a));null===this.__events&&(this.__events={});var h=this.__events,p="*";d&&(p=""+d);h[a]||(h[a]=[]);a=h[a];a.some(function(a){return a.fn===g&&a.ns==p})||(k?a.unshift({fn:g,ns:p}):a.push({fn:g,ns:p}))}},_removeHandler:function(a,g){var d=this.__events,k="*";if(d){g&&(k=""+g);var h,p,n;if(a){if(d[a])if("*"==k)delete d[a];else{h=d[a];p=h.filter(function(f){return f.ns==k});for(n=h.length;0<n;)n-=1,-1<p.indexOf(h[n])&&h.splice(n,1);0==h.length&&delete d[a]}}else"*"!=k?Object.keys(d).forEach(function(f){var b=
d[f],c=b.filter(function(b){return b.ns==k});for(n=b.length;0<n;)n-=1,-1<c.indexOf(b[n])&&b.splice(n,1);0==b.length&&delete d[f]}):this.__events=null}},_raiseEvent:function(a,g){var d=this,k=d.__events;null!==k&&a&&("0*"!=a&&RIAPP.utils.startsWith(a,"0")&&this._raiseEvent("0*",g),k[a]&&Array.clone(k[a]).forEach(function(a){a.fn.apply(d,[d,g])}))},_onError:function(a,g){if(RIAPP.global&&RIAPP.global._checkIsDummy(a))return!0;a.message||(a=Error(""+a));var d={error:a,source:g,isHandled:!1};this._raiseEvent("error",
...
RIAPP.Global=RIAPP.BaseObject.extend({version:"1.2.4.1",_TEMPLATES_SELECTOR:["section.",RIAPP.css_riaTemplate].join(""),_TEMPLATE_SELECTOR:'*[data-role="template"]',__coreModules:{},_create:function(a,g){this._super();if(RIAPP.global)throw Error(RIAPP.ERRS.ERR_GLOBAL_SINGLTON);if(!g)throw Error(RIAPP.ERRS.ERR_APP_NEED_JQUERY);var d,k;this._window=a;this._appInst={};this._$=g;this._modInst={};this._defaults=this._currentSelectable=null;this._userCode={};this._exports={};this._consts=this._utils=null;
this._templateLoaders={};this._promises=[];for(var h=this._nextAppInstanceNum=0;h<RIAPP._glob_modules.length;h+=1)d={},k=RIAPP._glob_modules[h],this._coreModules[k].apply(d,[this]),Object.freeze(d),this._modInst[RIAPP._glob_modules[h]]=d;this._init();Object.freeze(this._coreModules);this._waitQueue=this.utils.WaitQueue.create(this)},_getNextAppNum:function(){return this._nextAppInstanceNum+=1},_init:function(){var a=this;a.$(a.document).ready(function(g){a._processTemplateSections(a.document);a.raiseEvent("load",
{})});a.$(a.document).on("click.global",function(g){g.stopPropagation();a.currentSelectable=null});a.$(a.document).on("keydown.global",function(g){g.stopPropagation();a._currentSelectable&&a._currentSelectable._onKeyDown(g.which,g)});a.$(a.document).on("keyup.global",function(g){g.stopPropagation();a._currentSelectable&&a._currentSelectable._onKeyUp(g.which,g)});a.$(a.window).unload(function(){a.raiseEvent("unload",{})});a.window.onerror=function(a,d,k){if(a&&-1<a.indexOf("DUMMY_ERROR"))return!0;
alert("Error message: "+a+"\nURL: "+d+"\nLine Number: "+k);return!1}},_getEventNames:function(){var a=this._super();return["load","unload"].concat(a)},_onGridAdded:function(a){var g=this,d=g.utils,k=a.$container;k.on("click."+a.uniqueID,function(h){h.stopPropagation();d.isContained(h.target,k.get(0))&&(g.currentSelectable=a)})},_onGridRemoved:function(a){a.$container.off("click."+a.uniqueID);this.currentSelectable===a&&(this.currentSelectable=null)},_onStackPanelAdded:function(a){var g=this,d=g.utils,
k=a._$el;k.on("click."+a.uniqueID,function(h){h.stopPropagation();d.isContained(h.target,k.get(0))&&(g.currentSelectable=a)})},_onStackPanelRemoved:function(a){a._$el.off("click."+a.uniqueID);this.currentSelectable===a&&(this.currentSelectable=null)},_registerApp:function(a){this._appInst[a.appName]||(this._appInst[a.appName]=a)},_unregisterApp:function(a){this._appInst[a.appName]&&(delete this._appInst[a.appName],delete this._templateLoaders[a.appName])},_destroyApps:function(){var a=this;this.utils.forEachProp(this._appInst,
function(g){a._appInst[g].destroy()})},_throwDummy:function(a){var g=this.modules.errors;if(g&&a&&!a.isDummy)throw g.DummyError.create(a);throw a;},_checkIsDummy:function(a){return!!a.isDummy},_registerType:function(a,g,d){var k=g.split(".");a=a._exports;var h;for(h=0;h<k.length-1;h+=1)a[k[h]]||(a[k[h]]={}),a=a[k[h]];k=k[k.length-1];if(a[k])throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_TYPE_ALREDY_REGISTERED,g));d._typeName=g;a[k]=d;return a},_getType:function(a,g){var d=g.split("."),k=a._exports,
h;for(h=0;h<d.length;h+=1){if(!k[d[h]])return null;k=k[d[h]]}return k},_processTemplateSections:function(a){var g=this;Array.fromList(a.querySelectorAll(g._TEMPLATES_SELECTOR)).forEach(function(a){g._processTemplateSection(a,null);g.utils.removeNode(a)})},_processTemplateSection:function(a,g){var d=this;Array.fromList(a.querySelectorAll(d._TEMPLATE_SELECTOR)).forEach(function(a){var h=d.document.createElement("div"),p=a.getAttribute("id"),n=d.utils.createDeferred();a.removeAttribute("id");h.appendChild(a);
n.resolve(h.innerHTML);g&&(p=g.appName+"."+p);d._registerTemplateLoader(p,function(){return n.promise()})})},_registerTemplateLoader:function(a,g){if(!this.utils.check_is.Function(g))throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_ASSERTION_FAILED,"fn_loader is Function"));var d=a.split("."),k=this._templateLoaders,h;for(h=0;h<d.length-1;h+=1)k[d[h]]||(k[d[h]]={}),k=k[d[h]];d=d[d.length-1];if(k[d])throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_TEMPLATE_ALREDY_REGISTERED,a));k[d]=g;return k},_getTemplateLoader:function(a){a=
a.split(".");var g=this._templateLoaders,d;for(d=0;d<a.length;d+=1){if(!g[a[d]])return null;g=g[a[d]]}return g},_waitForNotLoading:function(a,g){this._waitQueue.enQueue({prop:"isLoading",groupName:null,predicate:function(a){return!a},action:a,actionArgs:g})},_loadTemplatesAsync:function(a,g){var d=this,k=a(),h=d.isLoading;d._promises.push(k);d.isLoading!==h&&d.raisePropertyChanged("isLoading");k.done(function(a){d.utils.removeFromArray(d._promises,k);try{var h=d.document.createElement("div");h.innerHTML=
a;d._processTemplateSection(h,g)}catch(f){d._onError(f,d)}d.isLoading||d.raisePropertyChanged("isLoading")});k.fail(function(a){d.utils.removeFromArray(d._promises,k);d.isLoading||d.raisePropertyChanged("isLoading");a&&a.message?d._onError(a,d):a&&a.responseText?d._onError(Error(a.responseText),d):d._onError(Error("Failed to load templates"),d)})},reThrow:function(a,g){if(g)this._throwDummy(a);else throw a;},findApp:function(a){return this._appInst[a]},destroy:function(){this._isDestroyed||(this._waitQueue&&
...
RIAPP.Global._coreModules.array_ext=function(a){Array.prototype.distinct=function(){var a={},d,k=this.length,h=[];for(d=0;d<k;d+=1)a[this[d]]=this[d];var p=Object.keys(a);d=0;for(k=p.length;d<k;d+=1)h.push(a[p[d]]);return h};Array.prototype.intersect=function(a){return this.filter(function(d){return-1<a.indexOf(d)})};Array.fromList=function(a){for(var d=Array(a.length),k=0,h=a.length;k<h;k++)d[k]=a[k];return d}};
...
RIAPP.Global._coreModules.utils=function(a){var g=this,d=RIAPP.utils,k=0,h={Null:function(b){return null===b},Undefined:function(b){return void 0===b},nt:function(b){return null===b||void 0===b},Function:d.isFunc,String:function(b){if(h.nt(b))return!1;var c=/string/i;return"string"===typeof b?!0:"object"===typeof b?c.test(b.constructor.toString()):!1},Array:d.isArray,Boolean:function(b){if(h.nt(b))return!1;var c=/boolean/i;return"boolean"===typeof b?!0:"object"===typeof b?c.test(b.constructor.toString()):
...
!1},SimpleObject:function(b){return h.nt(b)?!1:h.Object(b)&&Object.prototype===Object.getPrototypeOf(b)},RegExp:function(b){if(h.nt(b))return!1;var c=/regexp/i;return"function"===typeof b?c.test(b.constructor.toString()):!1},Numeric:function(b){return h.Number(b)||h.String(b)&&!isNaN(Number(b))},BoolString:function(b){return h.nt(b)?!1:"true"==b||"false"==b}},p={checkNumRange:function(b,c){var e=c.split(",");if(e[0]&&b<parseFloat(e[0]))throw Error(String.format(RIAPP.ERRS.ERR_FIELD_RANGE,b,c));if(e[1]&&
b>parseFloat(e[1]))throw Error(String.format(RIAPP.ERRS.ERR_FIELD_RANGE,b,c));},_dtRangeToDate:function(b){b=b.split("-");return new Date(parseInt(b[0],10),parseInt(b[1],10)-1,b[2])},checkDateRange:function(b,c){var e=c.split(",");if(e[0]&&b<p._dtRangeToDate(e[0]))throw Error(String.format(RIAPP.ERRS.ERR_FIELD_RANGE,b,c));if(e[1]&&b>p._dtRangeToDate(e[1]))throw Error(String.format(RIAPP.ERRS.ERR_FIELD_RANGE,b,c));}},n={str:{endsWith:d.endsWith,startsWith:d.startsWith,trim:d.trim,formatNumber:function(b,
c,e,f){b=(b+"").replace(/[^0-9+-Ee.]/g,"");var m=!isFinite(+b)?0:+b;b=!isFinite(+c)?0:Math.abs(c);f=void 0===f?",":f;e=void 0===e?".":e;var a="",a=function(b,c){var e=Math.pow(10,c);return""+Math.round(b*e)/e};n.check_is.nt(c)?(a=(""+m).split("."),b=2):a=(b?a(m,b):""+Math.round(m)).split(".");var m="",d=a[0].length;if(3<d){for(c=0;c<d;c+=1)m+=a[0].charAt(c),c<d-1&&0===(d-c-1)%3&&(m+=f);a[0]=m}if((a[1]||"").length<b)a[1]=a[1]||"",a[1]+=Array(b-a[1].length+1).join("0");return a.join(e)},stripNonNumeric:function(b){b+=
"";for(var c=/^\d|\.|-$/,e="",f=0;f<b.length;f++)c.test(b.charAt(f))&&("."==b.charAt(f)&&-1!=e.indexOf(".")||"-"==b.charAt(f)&&0!=e.length||(e+=b.charAt(f)));return e}},check_is:h,validation:p,getNewID:function(){var b=k;k+=1;return b},isContained:function(b,c){if(!b)return!1;for(;b=b.parentNode;)if(b===c)return!0;return!1},slice:Array.prototype.slice,get_timeZoneOffset:function(){var b=(new Date).getTimezoneOffset();return function(){return b}}(),parseBool:function(b){var c=d.trim(b).toLowerCase();
if("false"===c)return!1;if("true"===c)return!0;throw Error(n.format(RIAPP.ERRS.ERR_PARAM_INVALID,"bool_value",b));},round:function(b,c){return parseFloat(b.toFixed(c))},performAjaxCall:function(b,c,e,f,m,t){var d=new XMLHttpRequest;d.open("POST",b,e);var h=n.createDeferred();d.responseType="text";d.onload=function(b){200==this.status&&h.resolve(this.response)};d.onerror=function(b){h.reject(Error(b.target.status))};d.ontimeout=function(){h.reject(Error("The request for "+b+" timed out."))};d.timeout=
1E3*a.defaults.ajaxTimeOut;d.setRequestHeader("Content-Type","application/json; charset=utf-8");d.send(c);c=h.promise();f&&c.done(function(b){f.call(t,b)});m&&c.fail(function(b){m.call(t,b)});return c},performAjaxGet:function(b){var c=new XMLHttpRequest;c.open("GET",b,!0);var e=n.createDeferred();c.responseType="text";c.onload=function(b){200==this.status&&e.resolve(this.response)};c.onerror=function(b){e.reject(Error(b.target.status))};c.ontimeout=function(){e.reject(Error("The request for "+b+" timed out."))};
c.timeout=1E3*a.defaults.ajaxTimeOut;c.send(null);return e.promise()},format:d.format,extend:function(b,c,e){return b?n.cloneObj(e,c):n.mergeObj(e,c)},removeNode:function(b){if(b){var c=b.parentNode;c&&c.removeChild(b)}},insertAfter:function(b,c){var e=b.parentNode;e.lastChild===b?e.appendChild(c):e.insertBefore(c,b.nextSibling)},getProps:function(b){return Object.getOwnPropertyNames(b)},forEachProp:function(b,c){Object.getOwnPropertyNames(b).forEach(c)},addToolTip:function(b,c,e){e={content:{text:c},
style:{classes:e?e:null},position:{my:"top left",at:"bottom right",target:b,viewport:$(a.window),adjust:{method:"flip none",x:0,y:0}},hide:{fixed:!0,delay:250}};b.data("qtip")?c?b.qtip("option","content.text",c):b.qtip("destroy"):c&&b.qtip(e)},hasProp:function(b,c){if(!b)return!1;if(b.hasOwnProperty(c))return!0;if(Object===b)return!1;var e=Object.getPrototypeOf(b);return n.hasProp(e,c)},createDeferred:function(){return a.$.Deferred()},cloneObj:function(b,c){var e,f,m;if(!b)return b;if(h.Array(b)){m=
b.length;e=Array(m);for(f=0;f<m;f+=1)e[f]=n.cloneObj(b[f],null)}else if(h.SimpleObject(b)){e=c||{};var a,d=Object.getOwnPropertyNames(b);m=d.length;for(f=0;f<m;f+=1)a=d[f],e[a]=n.cloneObj(b[a],null)}else return b;return e},shallowCopy:function(b){return n.mergeObj(b,{})},mergeObj:function(b,c){c||(c={});if(!b)return c;for(var e=Object.getOwnPropertyNames(b),f,m=0,a=e.length;m<a;m+=1)f=e[m],c[f]=b[f];return c},removeFromArray:function(b,c){var e=b.indexOf(c);-1<e&&b.splice(e,1);return e},insertIntoArray:function(b,
c,e){b.splice(e,0,c)},destroyJQueryPlugin:function(b,c){if(b.data(c))b[c]("destroy")},uuid:function(){var b="0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz".split("");return function(c,e){var f,m=[],a=Math.random;e=e||b.length;if(c)for(f=0;f<c;f+=1)m[f]=b[0|a()*e];else{var d;m[8]=m[13]=m[18]=m[23]="-";m[14]="4";for(f=0;36>f;f+=1)m[f]||(d=0|16*a(),m[f]=b[19==f?d&3|8:d&15])}return m.join("")}}()},f=RIAPP.BaseObject.extend({_cnt:0,_create:function(){this._super();this._objs=[];f._cnt+=
1;this._cnt=f._cnt},addObj:function(b){0>this._objs.indexOf(b)&&this._objs.push(b)},removeObj:function(b){n.removeFromArray(this._objs,b)},getObjs:function(){return this._objs},destroy:function(){this._objs.forEach(function(b){b._isDestroyCalled||b.destroy()});this._objs=[];this._super()},toString:function(){return"LifeTimeScope "+this._cnt}},null,function(b){g.LifeTimeScope=b});g.PropWatcher=RIAPP.BaseObject.extend({_create:function(){this._super();this._objId="prw"+n.getNewID();this._objs=[]},addPropWatch:function(b,
c,e){b.addOnPropertyChange(c,function(b,c){e(c.property)},this.uniqueID);0>this._objs.indexOf(b)&&this._objs.push(b)},addWatch:function(b,c,e){b.addOnPropertyChange("*",function(b,m){-1<c.indexOf(m.property)&&e(m.property)},this.uniqueID);0>this._objs.indexOf(b)&&this._objs.push(b)},removeWatch:function(b){b.removeNSHandlers(this.uniqueID)},destroy:function(){var b=this;this._objs.forEach(function(c){b.removeWatch(c)});this._objs=[];this._super()},toString:function(){return"PropWatcher "+this._objId}},
{uniqueID:{get:function(){return this._objId}}},function(b){a.registerType("PropWatcher",b)});g.WaitQueue=RIAPP.BaseObject.extend({_create:function(b){this._super();this._objId="wq"+n.getNewID();this._owner=b;this._queue={}},_checkQueue:function(b,c){if(this._owner&&!this._owner._isDestroyCalled){var e=this,f=this._queue[b],m;if(f&&0!=f.length){var a,d,h=null,g=[],n=[],p=[];for(a=0;a<f.length;a+=1)if(m=f[a],m.predicate(c))if(!m.group&&0==g.length){d=m;break}else m.group&&(h||(h=m.group),h===m.group&&
g.push(m));if(d)n.push(d),p.push(d);else for(;0<g.length;)m=g.pop(),d||(d=m),d.lastWins?0==n.length&&n.push(m):n.push(m),p.push(m);try{if(0<n.length){for(a=f.length;0<a;)a-=1,-1<p.indexOf(f[a])&&f.splice(a,1);n.forEach(function(b){try{b.action.apply(e._owner,b.args)}catch(c){e._owner._onError(c,e)}})}}finally{0==f.length&&(delete this._queue[b],this._owner.removeOnPropertyChange(b,this.uniqueID))}}}},enQueue:function(b){b=n.extend(!1,{prop:"",groupName:null,predicate:null,action:null,actionArgs:[],
...
this.uniqueID);this._queue={};this._owner=null;this._super()},toString:function(){return"WaitQueue "+this._objId}},{uniqueID:{get:function(){return this._objId}},owner:{get:function(){return this._owner}}},null);n.mergeObj(n,g);a.utils=g};
RIAPP.Global._coreModules.riapp=function(a){var g=this,d=a.utils,k=a.consts,h={},p={},n=RIAPP.BaseObject.extend({_DATA_BIND_SELECTOR:["*[",k.DATA_ATTR.DATA_BIND,"]"].join(""),_TEMPLATES_DATA_BIND_SELECTOR:["section.",RIAPP.css_riaTemplate," *[",k.DATA_ATTR.DATA_BIND,"]"].join(""),registerModule:function(f,b){if(p[f])throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_MODULE_ALREDY_REGISTERED,f));p[f]=b},_create:function(f){this._super();f=d.extend(!1,{app_name:"default",service_url:"",metadata:null,createDbContext:!0,
moduleNames:[]},f);var b=f.app_name;if(a.findApp(b))throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_APP_NAME_NOT_UNIQUE,b));Object.freeze(f);this._options=f;this._parser=null;this._converters={};this._lftmBind=this._dbContext=null;this._instanceNum=a._getNextAppNum();this._ELV_STORE_KEY=k.DATA_ATTR.EL_VIEW_KEY+this._instanceNum;this._bindingContentFactory=null;this._modInst={};this._exports={};this._elViews={};this._elViewStore={};this._global=a;this._nextElViewStoreKey=0;this._userCode={};this._viewModels=
...
f)},_getBindingOption:function(f,b,c){var e={mode:this.modules.binding.BINDING_MODE[1],converterParam:null,converter:null,targetPath:null,sourcePath:null,target:null,source:null,isSourceFixed:!1},a=f.source,m=f.target;!f.sourcePath&&f.to?e.sourcePath=f.to:f.sourcePath&&(e.sourcePath=f.sourcePath);f.targetPath&&(e.targetPath=f.targetPath);f.converterParam&&(e.converterParam=f.converterParam);f.mode&&(e.mode=f.mode);f.converter&&(d.check_is.String(f.converter)?e.converter=this.getConverter(f.converter):
e.converter=f.converter);m?d.check_is.String(m)?e.target="this"==m?b:this.parser.resolveBindingSource(this,this.parser._getPathParts(m)):e.target=m:e.target=b;a?(e.isSourceFixed=!0,d.check_is.String(a)?e.source="this"==a?b:this.parser.resolveBindingSource(this,this.parser._getPathParts(a)):e.source=a):e.source=c;return e},_getElViewType:function(f){return this._elViews[f]},_getElView:function(f){return(f=f.getAttribute(this._ELV_STORE_KEY))?this._elViewStore[f]:null},_setElView:function(f,b){var c=
f.getAttribute(this._ELV_STORE_KEY);c?b?this._elViewStore[c]=b:(f.removeAttribute(this._ELV_STORE_KEY),delete this._elViewStore[c]):b&&(c="s_"+this._nextElViewStoreKey,this._nextElViewStoreKey+=1,f.setAttribute(this._ELV_STORE_KEY,c),this._elViewStore[c]=b)},_isDataForm:function(f){if(!f)return!1;f=f.getAttribute(k.DATA_ATTR.DATA_VIEW);if(!f)return!1;f=this.parser.parseOptions(f);return 0<f.length&&f[0].name===k.ELVIEW_NM.DATAFORM},_isInsideDataForm:function(f){return!f?!1:(f=f.parentElement)?this._isDataForm(f)?
!0:this._isInsideDataForm(f):!1},_bindTemplateElements:function(f){var b=this,c=Array.fromList(f.querySelectorAll(b._DATA_BIND_SELECTOR)),e=d.LifeTimeScope.create();f.hasAttribute(k.DATA_ATTR.DATA_BIND)&&c.push(f);c.forEach(function(c){var m,f,a,d,h;if(!b._isInsideDataForm(c)){d=c.getAttribute(k.DATA_ATTR.DATA_BIND);c.removeAttribute(k.DATA_ATTR.DATA_BIND);d=b.parser.parseOptions(d);h=b.getElementView(c);e.addObj(h);m=0;for(f=d.length;m<f;m+=1)c=b._getBindingOption(d[m],h,null),a=b.bind(c),c.target=
null,e.addObj(a)}});return e},_bindElements:function(f,b,c){var e=this;f=f||a.document;f=Array.fromList(f.querySelectorAll(e._DATA_BIND_SELECTOR));var l=d.LifeTimeScope.create();f.forEach(function(m){var f,a;if(c||!e._isInsideDataForm(m)){if(!c&&(m.hasAttribute(k.DATA_ATTR.DATA_APP)&&(f=m.getAttribute(k.DATA_ATTR.DATA_APP)),f&&e.appName!==f||!f&&"default"!==e.appName))return;f=m.getAttribute(k.DATA_ATTR.DATA_BIND);m=e.getElementView(m);l.addObj(m);f=e.parser.parseOptions(f);for(var d=0,h=f.length;d<
h;d+=1)a=e._getBindingOption(f[d],m,b),a=e.bind(a),l.addObj(a)}});return l},_getContent:function(f,b,c,e,a){if(b.templateInfo)f=f.create(c,b.templateInfo,e,a);else if(b.bindingInfo)f=f.create(c,b,e,a);else throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_PARAM_INVALID,"options","bindingInfo"));return f},_getContentType:function(f){if(f.templateInfo)f=this.modules.baseContent.TemplateContent;else if(f.bindingInfo)f=this.bindingContentFactory.getContentType(f);else throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_PARAM_INVALID,
...
this)},registerTemplateLoader:function(f,b){a._registerTemplateLoader(this.appName+"."+f,b)},getTemplateLoader:function(f){var b=a._getTemplateLoader(this.appName+"."+f);b||(b=a._getTemplateLoader(f));return b},toString:function(){return"Application"+this._instanceNum}},{_coreModules:{get:function(){return h}},bindingContentFactory:{get:function(){return this._bindingContentFactory},set:function(f){this._bindingContentFactory=f}},options:{get:function(){return this._options}},modules:{get:function(){return this._modInst}},
parser:{get:function(){return this._parser}},instanceNum:{get:function(){return this._instanceNum}},appName:{get:function(){return this.options.app_name}},global:{get:function(){return this._global}},dbContext:{get:function(){return this._dbContext}},UC:{get:function(){return this._userCode}},VM:{get:function(){return this._viewModels}},app:{get:function(){return this}},localizable:{get:function(){return RIAPP.localizable}}},function(f){g.Application=f;a.registerType("Application",f)});RIAPP.Application=
n};RIAPP.global=RIAPP.Global.create(window,jQuery,[]);
RIAPP.Application._coreModules.converter=function(a){var g=a.global,d=g.utils,k=d.str,h=RIAPP.BaseObject.extend({convertToSource:function(a,f,b){return a},convertToTarget:function(a,f,b){return d.check_is.nt(a)?null:a}},null,function(d){a.registerType("BaseConverter",d);a.registerConverter("BaseConverter",d)});h.extend({convertToSource:function(a,f,b){return!a?null:g.$.datepicker.parseDate(f,a)},convertToTarget:function(a,f,b){return d.check_is.nt(a)?"":g.$.datepicker.formatDate(f,a)},toString:function(){return"DateConverter"}},
null,function(d){a.registerConverter("dateConverter",d)});h.extend({convertToSource:function(a,f,b){if(!a)return null;f=Date.parseExact(a,f);if(!f)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_CONV_INVALID_DATE,a));return f},convertToTarget:function(a,f,b){return d.check_is.nt(a)?"":a.toString(f)},toString:function(){return"DateTimeConverter"}},null,function(d){a.registerConverter("dateTimeConverter",d)});var p=h.extend({convertToSource:function(a,f,b){if(d.check_is.nt(a))return null;b=g.defaults;
var c=b.decimalPoint,e=4,l=a.replace(b.thousandSep,""),l=l.replace(c,"."),l=k.stripNonNumeric(l);if(""===l)return null;c=null;switch(f){case 4:c=parseInt(l,10);break;case 1:c=parseInt(l,10);break;case 2:e=b.decPrecision;c=d.round(parseFloat(l),e);break;case 3:c=parseFloat(l);break;default:c=Number(l)}if(!d.check_is.Number(c))throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_CONV_INVALID_NUM,a));return c},convertToTarget:function(a,f,b){if(d.check_is.nt(a))return"";var c=g.defaults;b=c.decimalPoint;var e=
c.thousandSep;switch(f){case 1:return k.formatNumber(a,0,b,e);case 2:return f=c.decPrecision,k.formatNumber(a,f,b,e);case 4:return k.formatNumber(a,0,b,"");case 3:return k.formatNumber(a,null,b,e);default:return k.formatNumber(a,null,b,e)}},toString:function(){return"NumberConverter"}},null,function(d){a.registerConverter("numberConverter",d)});h.extend({convertToSource:function(a,f,b){return p.convertToSource(a,1,b)},convertToTarget:function(a,f,b){return p.convertToTarget(a,1,b)},toString:function(){return"IntegerConverter"}},
null,function(d){a.registerConverter("integerConverter",d)});h.extend({convertToSource:function(a,f,b){return p.convertToSource(a,4,b)},convertToTarget:function(a,f,b){return p.convertToTarget(a,4,b)},toString:function(){return"SmallIntConverter"}},null,function(d){a.registerConverter("smallIntConverter",d)});h.extend({convertToSource:function(a,f,b){return p.convertToSource(a,2,b)},convertToTarget:function(a,f,b){return p.convertToTarget(a,2,b)},toString:function(){return"DecimalConverter"}},null,
function(d){a.registerConverter("decimalConverter",d)});h.extend({convertToSource:function(a,f,b){return p.convertToSource(a,3,b)},convertToTarget:function(a,f,b){return p.convertToTarget(a,3,b)},toString:function(){return"FloatConverter"}},null,function(d){a.registerConverter("floatConverter",d)})};
RIAPP.Application._coreModules.parser=function(a){var g=a.global.utils,d=g.str,k=RIAPP.BaseObject.extend({__trimOuterBracesRX:/^([{]){0,1}|([}]){0,1}$/g,__trimQuotsRX:/^(['"])+|(['"])+$/g,__trimBracketsRX:/^(\[)+|(\])+$/g,__indexedPropRX:/(^\w+)\s*\[\s*['"]?\s*([^'"]+)\s*['",]?\s*\]/i,__valueDelimeter1:":",__valueDelimeter2:"=",__keyValDelimeter:",",_getPathParts:function(a){var d=this,g=[];(!a?[]:a.split(".")).forEach(function(f){var b;(b=f.match(d.__indexedPropRX))?(f=b[1],b=b[2],g.push(f),g.push("["+
b+"]")):g.push(f)});return g},_resolveProp:function(h,g){var k;return!g?h:d.startsWith(g,"[")?(k=a.modules.collection,g=this.trimQuotes(this.trimBrackets(g)),k.Dictionary.isPrototypeOf(h)?h.getItemByKey(g):k.Collection.isPrototypeOf(h)?h.getItemByPos(parseInt(g,10)):RIAPP.utils.isArray(h)?h[parseInt(g,10)]:h[g]):h[g]},_resolvePath:function(a,d){return!a?void 0:0===d.length?a:1===d.length?this._resolveProp(a,d[0]):this._resolvePath(this._resolveProp(a,d[0]),d.slice(1))},_setPropertyValue:function(a,
d,g){RIAPP.utils.startsWith(d,"[")?(d=this.trimQuotes(this.trimBrackets(d)),RIAPP.utils.isArray(a)?a[parseInt(d,10)]=g:a[d]=g):a[d]=g},_getKeyVals:function(a){var p,k,f,b=[],c={key:"",val:""},e=!0,l=this.__valueDelimeter1,m=this.__valueDelimeter2,t=this.__keyValDelimeter,v=function(c){c.val&&(g.check_is.Numeric(c.val)?c.val=Number(c.val):g.check_is.BoolString(c.val)&&(c.val=g.parseBool(c.val)));b.push(c)};for(p=0;p<a.length;p+=1){k=a.charAt(p);if("'"===k||'"'===k)f?f===k&&(f=null):f=k;!f&&"{"===k&&
!e?(k=a.substr(p),k=this.getBraceParts(k,!0)[0],c.val+=k,p+=k.length-1):!f&&k===t?c.key&&(v(c),c={key:"",val:""},e=!0):!f&&(k===l||k===m)?e=!1:e?c.key+=k:c.val+=k}c.key&&v(c);b.forEach(function(b){b.key=d.trim(b.key);g.check_is.String(b.val)&&(b.val=d.trim(b.val));""===b.val&&d.startsWith(b.key,"this.")&&(b.val=b.key.substr(5),b.key="targetPath")});return b=b.filter(function(b){return""!==b.val})},resolveBindingSource:function(a,d){if(a){if(0===d.length)return a;if(0<d.length)return this.resolveBindingSource(this._resolveProp(a,
d[0]),d.slice(1));throw Error("Invalid operation");}},resolvePath:function(a,d){if(!d)return a;var g=this._getPathParts(d);return this._resolvePath(a,g)},getBraceParts:function(a,d){var g,f="",b,c,e=0,l=[];for(g=0;g<a.length;g+=1){b=a.charAt(g);if("'"===b||'"'===b)c?c===b&&(c=null):c=b;if(!c&&"{"===b)e+=1,f+=b;else if(!c&&"}"===b){if(e-=1,f+=b,0===e&&(l.push(f),f="",d))break}else 0<e&&(f+=b)}return l},trimOuterBraces:function(a){return d.trim(a.replace(this.__trimOuterBracesRX,""))},trimQuotes:function(a){return d.trim(a.replace(this.__trimQuotsRX,
""))},trimBrackets:function(a){return d.trim(a.replace(this.__trimBracketsRX,""))},isWithOuterBraces:function(a){return d.startsWith(a,"{")&&d.endsWith(a,"}")},parseOption:function(a){var k={},n=this;a=d.trim(a);n.isWithOuterBraces(a)&&(a=n.trimOuterBraces(a));n._getKeyVals(a).forEach(function(a){var b=g.check_is.String(a.val);b&&n.isWithOuterBraces(a.val)?k[a.key]=n.parseOption(a.val):k[a.key]=b?n.trimQuotes(a.val):a.val});return k},parseOptions:function(a){var g=[],k=this;a=d.trim(a);var f=[a];
k.isWithOuterBraces(a)&&(f=k.getBraceParts(a,!1));f.forEach(function(b){g.push(k.parseOption(b))});return g},toString:function(){return"Parser"}},null);a._parser=k.create()};
RIAPP.Application._coreModules.baseElView=function(a){var g=this,d=a.global,k=d.utils,h=d.consts,p=RIAPP.localizable.VALIDATE,n=g.css={fieldError:"ria-field-error",errorTip:"ui-tooltip-red",commandLink:"ria-command-link"};Object.freeze(n);var f=RIAPP.BaseObject.extend({_app:a,_create:function(b,c){this._super();this._el=b;this._oldDisplay=this._$el=null;this._objId="elv"+this._app.getNewObjectID();this._propChangedCommand=null;this._app._setElView(this._el,this);this._errors=null;this._toolTip=c.tip;
...
RIAPP.Application._coreModules.binding=function(a){var g=this,d=a.global,k=d.utils,h=d.modules.errors,p=a.modules.baseElView.BaseElView,n=["OneTime","OneWay","TwoWay"];g.BINDING_MODE=n;g.ValidationError=h.BaseError.extend({_create:function(a,b){var c=RIAPP.ERRS.ERR_VALIDATION+"\r\n",e=0;a.forEach(function(b){0<e&&(c+="\r\n");c=b.fieldName?c+" "+RIAPP.localizable.TEXT.txtField+": "+b.fieldName+" -> "+b.errors.join(", "):c+b.errors.join(", ");e+=1});this._super(c);this._errors=a;this._item=b}},{item:{get:function(){return this._item}},
errors:{get:function(){return this._errors}}},function(f){a.registerType("ValidationError",f)});g.Binding=RIAPP.BaseObject.extend({_app:a,_create:function(a){this._super();a=k.extend(!1,{target:null,source:null,targetPath:null,sourcePath:null,mode:n[1],converter:null,converterParam:null,isSourceFixed:!1},a);if(!a.target)throw Error(RIAPP.ERRS.ERR_BIND_TARGET_EMPTY);if(!k.check_is.String(a.targetPath))throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_BIND_TGTPATH_INVALID,a.targetPath));if(0>n.indexOf(a.mode))throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_BIND_MODE_INVALID,
...
_getUpdTgtProxy:function(){var a=this;return function(){a._updateTarget()}},_getUpdSrcProxy:function(){var a=this;return function(){a._updateSource()}},_getSrcErrChangedProxy:function(){var a=this;return function(b,c){a._onSrcErrorsChanged()}},_onSrcErrorsChanged:function(){var a=[],b=this._targetObj,c=this._sourceObj,e=this._srcPath;b&&p.isPrototypeOf(b)&&(c&&0<e.length&&(a=c.getFieldErrors(e[e.length-1])),b.validationErrors=a)},_onError:function(a,b){var c=this._super(a,b);return!c?this._app._onError(a,
b):c},_getTgtChangedFn:function(a,b,c,e,d){return function(m,t){var g=a._app.parser._resolveProp(b,c);0<e.length&&a._checkBounded(null,"target",d,e);a._parseTgtPath(g,e,d)}},_getSrcChangedFn:function(a,b,c,e,d){return function(m,t){var g=a._app.parser._resolveProp(b,c);0<e.length&&a._checkBounded(null,"source",d,e);a._parseSrcPath(g,e,d)}},_parseSrcPath:function(a,b,c){this._sourceObj=null;0===b.length?this._sourceObj=a:this._parseSrcPath2(a,b,c);this._targetObj&&this._updateTarget()},_parseSrcPath2:function(a,
b,c){var e=RIAPP.BaseObject;if(e=!!a&&e.isPrototypeOf(a))a.addOnDestroyed(this._getOnSrcDestroyedProxy(),this._objId),this._checkBounded(a,"source",c,b);1<b.length?(e&&a.addOnPropertyChange(b[0],this._getSrcChangedFn(this,a,b[0],b.slice(1),c+1),this._objId),a&&(a=this._app.parser._resolveProp(a,b[0]))&&this._parseSrcPath2(a,b.slice(1),c+1)):a&&1===b.length&&((this._mode===n[1]||this._mode===n[2])&&e&&a.addOnPropertyChange(b[0],this._getUpdTgtProxy(),this._objId),a&&a.addOnItemErrorsChanged&&a.addOnItemErrorsChanged(this._getSrcErrChangedProxy(),
...
b[0]))&&this._parseTgtPath2(a,b.slice(1),c+1)):a&&1===b.length&&(this._mode===n[2]&&e&&a.addOnPropertyChange(b[0],this._getUpdSrcProxy(),this._objId),this._targetObj=a)},_checkBounded:function(a,b,c,e){var d,m;if("source"===b)m="s"+c;else if("target"===b)m="t"+c;else throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_PARAM_INVALID,"to",b));if(d=this._bounds[m])d.removeNSHandlers(this._objId),delete this._bounds[m];0<e.length&&this._checkBounded(null,b,c+1,e.slice(1));a&&(this._bounds[m]=a)},_onTgtDestroyed:function(a,
...
this._converterParam,this._sourceObj);void 0!==a&&(this.targetValue=a)}catch(b){d.reThrow(b,this._onError(b,this))}finally{this._ignoreTgtChange=!1}}},_updateSource:function(){if(!this._ignoreTgtChange){this._ignoreSrcChange=!0;try{var a=this._converter.convertToSource(this.targetValue,this._converterParam,this._sourceObj);void 0!==a&&(this.sourceValue=a)}catch(b){if(!g.ValidationError.isPrototypeOf(b)||!p.isPrototypeOf(this._targetObj))if(this._updateTarget(),!this._onError(b,this))throw b;}finally{this._ignoreSrcChange=
!1}}},destroy:function(){if(!this._isDestroyed){var a=this;k.forEachProp(this._bounds,function(b){a._bounds[b].removeNSHandlers(a._objId)});this._bounds={};this._target=this._source=this._targetObj=this._sourceObj=this._tgtPath=this._srcPath=this._converterParam=this._converter=this._state=this.target=this.source=null;this._super()}},toString:function(){return"Binding"}},{bindingID:{get:function(){return this._objId}},target:{set:function(a){if(this._state)this._state.target=a;else if(this._target!==
...
RIAPP.Application._coreModules.template=function(a){var g=a.global,d=g.utils,k=g.consts,h=a.modules.binding.Binding,p=a.modules.baseElView.BaseElView,n=a.modules.baseElView.TemplateElView;this.Template=RIAPP.BaseObject.extend({_app:a,_create:function(a){this._super();this._el=this._dctxt=null;this._isDisabled=!1;this._lfTime=null;this._templateID=a;this._templElView=void 0;this._promise=null;this._templateID&&this._loadTemplate()},_getBindings:function(){if(!this._lfTime)return[];for(var a=this._lfTime.getObjs(),
b=[],c=0,e=a.length;c<e;c+=1)h.isPrototypeOf(a[c])&&b.push(a[c]);return b},_getElViews:function(){if(!this._lfTime)return[];for(var a=this._lfTime.getObjs(),b=[],c=0,e=a.length;c<e;c+=1)p.isPrototypeOf(a[c])&&b.push(a[c]);return b},_getTemplateElView:function(){if(!this._lfTime||null===this._templElView)return null;if(this._templElView)return this._templElView;for(var a=null,b=this._getElViews(),c=0,e=b.length;c<e;c+=1)if(n.isPrototypeOf(b[c])){a=b[c];break}return this._templElView=a},_loadTemplateElAsync:function(a){if(a=
this._app.getTemplateLoader(a))return a().then(function(b){return g.$(b).get(0)});a=d.createDeferred();a.reject(Error(String.format(RIAPP.ERRS.ERR_TEMPLATE_ID_INVALID,this._templateID)));return a.promise()},_loadTemplate:function(){var a=this,b=a._templateID;a._unloadTemplate();b&&(b=a._loadTemplateElAsync(b),"pending"==b.state()&&(a._el=g.document.createElement("div"),a._promise=d.createDeferred(),b.then(function(){a._promise.resolve()}),b=g.$.when(b,a._promise)),b.then(function(b){if(!a._isDestroyCalled){var e=
!!a._promise;a._promise=null;b?(e&&a._el.appendChild(b),a._el=b,a._lfTime=a._app._bindTemplateElements(a._el),(b=a._getTemplateElView())&&b.templateLoaded(a),a._updateBindingSource()):a._unloadTemplate()}},function(b){a._isDestroyCalled||(a._promise=null,"cancel"!=b&&(b&&b.message?a._app._onError(b,a):a._app._onError(Error(String.format(RIAPP.ERRS.ERR_TEMPLATE_ID_INVALID,a._templateID)),a)))}))},_updateBindingSource:function(){var a,b,c,e=this._getBindings();a=0;for(b=e.length;a<b;a+=1)c=e[a],c.isDisabled=
this._isDisabled,c.isSourceFixed||(c.source=this._dctxt)},_updateIsDisabled:function(){var a,b,c,e=this._getBindings(),d=this._getElViews(),m=this._app._getElViewType(k.ELVIEW_NM.DATAFORM);a=0;for(b=e.length;a<b;a+=1)c=e[a],c.isDisabled=this._isDisabled;a=0;for(b=d.length;a<b;a+=1)c=d[a],m.isPrototypeOf(c)&&c.form&&(c.form.isDisabled=this._isDisabled)},_unloadTemplate:function(){try{if(this._el){var a=this._templElView;this._templElView=void 0;a&&a.templateUnloading(this)}}finally{this._lfTime&&(this._lfTime.destroy(),
this._lfTime=null),this._el&&g.$(this._el).remove(),this._el=null}},destroy:function(){this._isDestroyed||(this._promise&&(this._promise.reject("cancel"),this._promise=null),this._dctxt=null,this._unloadTemplate(),this._templateID=null,this._templElView=void 0,this._super())},findElByDataName:function(a){return g.$(this._el).find(["*[",k.DATA_ATTR.DATA_NAME,'="',a,'"]'].join("")).toArray()},findElViewsByDataName:function(a){var b=this,c=[];this.findElByDataName(a).forEach(function(a){(a=b._app._getElView(a))&&
...
RIAPP.Application._coreModules.mvvm=function(a){this.Command=RIAPP.BaseObject.extend({_app:a,_create:function(a,d,k){this._super();this._action=a;this._thisObj=d;this._canExecute=k;this._isEnabled=!0;this._objId="cmd"+this._app.getNewObjectID()},_getEventNames:function(){var a=this._super();return["canExecute_changed"].concat(a)},canExecute:function(a,d){return!this._canExecute?!0:this._canExecute.apply(this._thisObj,[a,d])},execute:function(a,d){this._isEnabled&&this._action&&this._action.apply(this._thisObj,
[a,d])},destroy:function(){this._isDestroyed||(this._canExecute=this._thisObj=this._action=null,this._super())},raiseCanExecuteChanged:function(){this.raiseEvent("canExecute_changed",{})},toString:function(){return"Command"}},{app:{get:function(){return this._app}}},function(g){a.registerType("Command",g)});this.BaseViewModel=RIAPP.BaseObject.extend({_app:a,_create:function(){this._super();this._objId="vm"+this._app.getNewObjectID()},_onError:function(a,d){var k=this._super(a,d);return!k?this._app._onError(a,
d):k},toString:function(){return this._typeName?this._super():"BaseViewModel"}},{uniqueID:{get:function(){return this._objId}},app:{get:function(){return this._app}},$:{get:function(){return this._app.global.$}}},function(g){a.registerType("BaseViewModel",g)})};
RIAPP.Application._coreModules.baseContent=function(a){var g=a.global,d=a.modules.template.Template,k=a.modules.binding.Binding,h=this.css={content:"ria-content-field",required:"ria-required-field"};Object.freeze(h);this.BindingContent=RIAPP.BaseObject.extend({_app:a,_create:function(a,d,f,b){this._super();this._parentEl=a;this._el=null;this._options=d;this._isReadOnly=!!this._options.readOnly;this._isEditing=!!b;this._dctx=f;this._tgt=this._lfScope=null;g.$(this._parentEl).addClass(h.content);d.initContentFn&&
d.initContentFn(this);this._init();this.update()},_init:function(){},_updateCss:function(){var a=this._getDisplayInfo(),d=g.$(this._parentEl),f=this.getFieldInfo();this._isEditing&&this._canBeEdited()?(a&&(a.editCss&&d.addClass(a.editCss),a.displayCss&&d.removeClass(a.displayCss)),f&&!f.isNullable&&d.addClass(h.required)):a&&(a.displayCss&&d.addClass(a.displayCss),a.editCss&&d.removeClass(a.editCss),f&&!f.isNullable&&d.removeClass(h.required))},_canBeEdited:function(){if(this._isReadOnly)return!1;
...
RIAPP.Application._coreModules.collection=function(a){var g=this,d=a.global,k=d.utils,h,p,n,f=d.consts.DATA_TYPE,b={REMOVE:"0",ADDED:"1",RESET:"2",REMAP_KEY:"3"},c={};c.DATA_TYPE=f;c.SORT_ORDER={ASC:0,DESC:1};c.COLL_CHANGE_TYPE=b;c.DATE_CONVERSION={None:0,ServerLocalToClientLocal:1,UtcToClientLocal:2};g.consts=c;Object.freeze(c);var e=a.modules.binding.ValidationError,l={valueToDate:function(a,b,e){if(!a)return null;a=""+a;var d=a.split("&");if(7!=d.length)throw Error(base_utils.format(RIAPP.ERRS.ERR_PARAM_INVALID,
"val",a));a=new Date(parseInt(d[0],10),parseInt(d[1],10)-1,parseInt(d[2],10),parseInt(d[3],10),parseInt(d[4],10),parseInt(d[5],10),parseInt(d[6],10));var d=c.DATE_CONVERSION,f=k.get_timeZoneOffset();switch(b){case d.None:break;case d.ServerLocalToClientLocal:a.setMinutes(a.getMinutes()+e);a.setMinutes(a.getMinutes()-f);break;case d.UtcToClientLocal:a.setMinutes(a.getMinutes()-f);break;default:throw Error(base_utils.format(RIAPP.ERRS.ERR_PARAM_INVALID,"dtcnv",b));}return a},dateToValue:function(a,
b,e){if(null===a)return null;if(!k.check_is.Date(a))throw Error(base_utils.format(RIAPP.ERRS.ERR_PARAM_INVALID,"dt",a));var d=c.DATE_CONVERSION,f=k.get_timeZoneOffset();switch(b){case d.None:break;case d.ServerLocalToClientLocal:a.setMinutes(a.getMinutes()+f);a.setMinutes(a.getMinutes()-e);break;case d.UtcToClientLocal:a.setMinutes(a.getMinutes()+f);break;default:throw Error(k.format(RIAPP.ERRS.ERR_PARAM_INVALID,"dtcnv",b));}return""+a.getFullYear()+"&"+(a.getMonth()+1)+"&"+a.getDate()+"&"+a.getHours()+
"&"+a.getMinutes()+"&"+a.getSeconds()+"&"+a.getMilliseconds()},compareVals:function(a,b,c){if(null===a&&null!==b||null!==a&&null===b)return!1;switch(c){case f.DateTime:case f.Date:case f.Time:return k.check_is.Date(a)&&k.check_is.Date(b)?a.getTime()===b.getTime():!1;default:return a===b}},stringifyValue:function(a,b,c){return k.check_is.nt(a)?null:k.check_is.Date(a)?l.dateToValue(a,b,c):""+a},parseValue:function(a,b,c,e){var d=null;if(void 0===a||null===a)return d;switch(b){case f.None:d=a;break;
case f.String:d=a;break;case f.Bool:d=k.parseBool(a);break;case f.Integer:d=parseInt(a,10);break;case f.Decimal:case f.Float:d=parseFloat(a);break;case f.DateTime:case f.Date:case f.Time:d=l.valueToDate(a,c,e);break;case f.Guid:case f.Binary:d=a;break;default:throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_PARAM_INVALID,"dataType",b));}return d}};g.valueUtils=l;p=RIAPP.BaseObject.extend({_app:a,_create:function(){this._super();this._fkey=null;this._isEditing=!1;this._saveVals=null;this._vals={};this._notEdited=
!0},_getEventNames:function(){var a=this._super();return["errors_changed"].concat(a)},_onError:function(a,b){var c=this._super(a,b);return!c?this._collection._onError(a,b):c},_beginEdit:function(){var a=this._collection;if(a.isEditing){var b=a._EditingItem;if(b===this)return!1;try{b.endEdit(),b.getIsHasErrors()&&(this._onError(e.create(b.getAllErrors(),b),b),b.cancelEdit())}catch(c){a=this._onError(c,b),b.cancelEdit(),d.reThrow(c,a)}}this._isEditing=!0;this._saveVals=k.shallowCopy(this._vals);this._collection.currentItem=
...
c&&b.push(c);return b},_checkVal:function(a,b){var c=b,e=RIAPP.ERRS;if(this._skipValidate(a,b))return c;if(a.isReadOnly&&(!a.allowClientDefault||!this._isNew))throw Error(e.ERR_FIELD_READONLY);if((null===b||k.check_is.String(b)&&!b)&&!a.isNullable)throw Error(e.ERR_FIELD_ISNOT_NULLABLE);if(null===b)return b;switch(a.dataType){case f.None:break;case f.Guid:case f.Binary:case f.String:if(!k.check_is.String(b))throw Error(String.format(e.ERR_FIELD_WRONG_TYPE,b,"String"));if(0<a.maxLength&&b.length>a.maxLength)throw Error(String.format(e.ERR_FIELD_MAXLEN,
a.maxLength));a.isNullable&&""===b&&(c=null);if(a.regex&&!RegExp(a.regex,"i").test(b))throw Error(String.format(e.ERR_FIELD_REGEX,b));break;case f.Bool:if(!k.check_is.Boolean(b))throw Error(String.format(e.ERR_FIELD_WRONG_TYPE,b,"Boolean"));break;case f.Integer:case f.Decimal:case f.Float:if(!k.check_is.Number(b))throw Error(String.format(e.ERR_FIELD_WRONG_TYPE,b,"Number"));a.range&&k.validation.checkNumRange(Number(b),a.range);break;case f.DateTime:case f.Date:if(!k.check_is.Date(b))throw Error(String.format(e.ERR_FIELD_WRONG_TYPE,
b,"Date"));a.range&&k.validation.checkDateRange(b,a.range);break;case f.Time:if(!k.check_is.Date(b))throw Error(String.format(e.ERR_FIELD_WRONG_TYPE,b,"Time"));break;default:throw Error(String.format(e.ERR_PARAM_INVALID,"dataType",a.dataType));}return c},_onErrorsChanged:function(a){this.raiseEvent("errors_changed",a)},_resetIsNew:function(){},getFieldInfo:function(a){return this._collection.getFieldInfo(a)},getFieldNames:function(){return this._collection.getFieldNames()},addOnItemErrorsChanged:function(a,
b){this.addHandler("errors_changed",a,b)},getFieldErrors:function(a){var b=this._collection._getErrors(this);if(!b)return[];var c=a;a||(a="*");if(!b[a])return[];"*"===a&&(c=null);return[{fieldName:c,errors:b[a]}]},getAllErrors:function(){var a=this._collection._getErrors(this);if(!a)return[];var b=[];k.forEachProp(a,function(c){var e=null;"*"!==c&&(e=c);b.push({fieldName:e,errors:a[c]})});return b},getErrorString:function(){var a=this._collection._getErrors(this);if(!a)return"";var b=[];k.forEachProp(a,
...
e=k.get_timeZoneOffset();return l.stringifyValue(a,c,e)},_getPKFieldInfos:function(){if(this._pkInfo)return this._pkInfo;var a=this._fieldMap,b=[];k.forEachProp(a,function(c){0<a[c].isPrimaryKey&&b.push(a[c])});b.sort(function(a,b){return a.isPrimaryKey-b.isPrimaryKey});return this._pkInfo=b},_onError:function(a,b){var c=this._super(a,b);return!c?this._app._onError(a,b):c},_onCurrentChanging:function(a){try{this.endEdit()}catch(b){d.reThrow(b,this._onError(b,this))}this.raiseEvent("current_changing",
...
b,c){b||(b="*");k.check_is.Array(c)&&0<c.length?(this._errors[a._key]||(this._errors[a._key]={}),this._errors[a._key][b]=c,this._ignoreChangeErrors||this._onErrorsChanged(a)):this._removeError(a,b)},_removeError:function(a,b){var c=this._errors[a._key];c&&(b||(b="*"),c[b]&&(delete c[b],0===k.getProps(c).length&&delete this._errors[a._key],this._onErrorsChanged(a)))},_removeAllErrors:function(a){this._errors[a._key]&&(delete this._errors[a._key],this._onErrorsChanged(a))},_getErrors:function(a){return this._errors[a._key]},
...
_onItemAdded:function(a){this.raiseEvent("item_added",{item:a,isAddNewHandled:!1})},_createNew:function(){throw Error("Not implemented");},_attach:function(a,c){if(this._itemsByKey[a._key])throw Error(RIAPP.ERRS.ERR_ITEM_IS_ATTACHED);try{this.endEdit()}catch(e){d.reThrow(e,this._onError(e,this))}var f;a._onAttaching();k.check_is.nt(c)?(f=this._items.length,this._items.push(a)):(f=c,k.insertIntoArray(this._items,a,f));this._itemsByKey[a._key]=a;this._onItemsChanged({change_type:b.ADDED,items:[a],pos:[f]});
...
getFieldInfo:function(a){return this._fieldMap[a]},getFieldNames:function(){return k.getProps(this._fieldMap)},cancelEdit:function(){this.isEditing&&this._EditingItem.cancelEdit()},endEdit:function(){var a;this.isEditing&&(a=this._EditingItem,!a.endEdit()&&a.getIsHasErrors()&&(this._onError(e.create(a.getAllErrors(),a),a),this.cancelEdit()))},getItemsWithErrors:function(){var a=this,b=[];k.forEachProp(this._errors,function(c){c=a.getItemByKey(c);b.push(c)});return b},addNew:function(){var a,b;a=this._createNew();
this._onItemAdding(a);this._attach(a,null);try{this.currentItem=a,a.beginEdit(),this._onItemAdded(a)}catch(c){b=this._onError(c,this),a.cancelEdit(),d.reThrow(c,b)}return a},getItemByPos:function(a){return 0>a||a>=this._items.length?null:this._items[a]},getItemByKey:function(a){if(!a)throw Error(RIAPP.ERRS.ERR_KEY_IS_EMPTY);return this._itemsByKey[""+a]},findByPK:function(){if(0===arguments.length)return null;var a=k.slice.call(arguments),b=this._getPKFieldInfos(),c=[];1===a.length&&k.check_is.Array(a[0])&&
...
cacheSize:{get:function(){return this._cache.length}}},function(a){g.DataCache=a});n=RIAPP.BaseObject.extend({_app:a,_create:function(a,b){this._super();this._dbSet=a;this.__queryInfo=b;this._filterInfo={filterItems:[]};this._sortInfo={sortItems:[]};this._isClearPrevData=this._isIncludeTotalCount=!0;this._pageSize=a.pageSize;this._pageIndex=a.pageIndex;this._params={};this._loadPageCount=1;this._isClearCacheOnEveryLoad=!0;this._dataCache=null;this._cacheInvalidated=!1},getFieldInfo:function(a){return this._dbSet.getFieldInfo(a)},
getFieldNames:function(){return h.getProps(this._dbSet._fieldMap)},_addSort:function(a,b){var c=m.ASC,e=this._sortInfo;b&&"d"===b.toLowerCase().substr(0,1)&&(c=m.DESC);e.sortItems.push({fieldName:a,sortOrder:c});this._cacheInvalidated=!0},_addFilterItem:function(a,b,c){var d=0,d=this.getFieldInfo(a);if(!d)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_DBSET_INVALID_FIELDNAME,this.dbSetName,a));var f=this._serverTimezone,q=d.dateConversion,u=c;h.check_is.Array(u)||(u=[c]);u=Array.clone(u).map(function(a){return e.stringifyValue(a,
...
function(a){g.DataQuery=a});p=k.CollectionItem.extend({_create:function(a,b){this._super();this.__changeType=c.NONE;this._saveChangeType=this._origVals=this._srvRowKey=null;this.__isCached=this.__isRefreshing=!1;this.getFieldNames().forEach(function(a){this._vals[a]=null},this);this._initRowInfo(a,b)},_initRowInfo:function(a,b){if(a){var c=this,d=c._serverTimezone;this._key=this._srvRowKey=a.key;a.values.forEach(function(a,r){var f=b[r],l=c.getFieldInfo(f);if(!l)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_DBSET_INVALID_FIELDNAME,
c._dbSetName,f));f=e.parseValue(a,l.dataType,l.dateConversion,d);c._vals[l.fieldName]=f})}},_checkCanRefresh:function(){if(null===this._key||this._changeType===c.ADDED)throw Error(RIAPP.ERRS.ERR_OPER_REFRESH_INVALID);},_refreshValue:function(a,b,c){var d=this.getFieldInfo(b);if(!d)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_DBSET_INVALID_FIELDNAME,this._dbSetName,b));var f,q,l=d.dataType;a=e.parseValue(a,l,d.dateConversion,this._serverTimezone);f=this._vals[b];switch(c){case 3:e.compareVals(a,f,
l)||(this._vals[b]=a,this._onFieldChanged(d));break;case 1:this._origVals&&(this._origVals[b]=a);this._saveVals&&(this._saveVals[b]=a);e.compareVals(a,f,l)||(this._vals[b]=a,this._onFieldChanged(d));break;case 2:this._origVals&&(q=this._origVals[b],this._origVals[b]=a);if((void 0===q||e.compareVals(q,f,l))&&!e.compareVals(a,f,l))this._vals[b]=a,this._onFieldChanged(d);break;default:throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_PARAM_INVALID,"refreshMode",c));}},_refreshValues:function(a,b){var e=
...
_setFieldVal:function(a,b){var c,e=this._dbSetName,d=this._collection,q=RIAPP.ERRS,f=this._vals[a],l=b,g=this.getFieldInfo(a);if(!g)throw Error(String.format(q.ERR_DBSET_INVALID_FIELDNAME,e,a));!this._isEditing&&!this._isUpdating&&this.beginEdit();try{if(l=this._checkVal(g,l),f!=l&&this._fldChanging(g,f,l)&&(this._vals[a]=l,this._fldChanged(g,f,l)),d._removeError(this,a),c=this._validateField(a))throw v.create([c],this);}catch(m){throw c=v.isPrototypeOf(m)?m:v.create([{fieldName:a,errors:[m.message]}],
...
b));if(a.fieldName===b)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_CALC_FIELD_SELF_DEPEND,b));0>c.dependents.indexOf(a.fieldName)&&c.dependents.push(a.fieldName)})},l=function(a){var b=d._fieldMap[a.fieldName],r=!0,f=c.filter(function(b){return b.childToParentName==a.fieldName});0===f.length&&(f=e.filter(function(b){return b.parentToChildrenName==a.fieldName}),r=!1);if(1!=f.length)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_PARAM_INVALID_TYPE,"assocs","Array"));b.isClientOnly=!0;b.isReadOnly=
!0;var l=function(){throw Error("getFunc is not emplemented!");},u,w=f[0].name;r?(b.isReadOnly=!1,d._childAssocMap[f[0].childToParentName]=f[0],f[0].fieldRels.forEach(function(a){a=d._fieldMap[a.childField];!b.isReadOnly&&a.isReadOnly&&(b.isReadOnly=!0)}),l=function(){return d.dbContext.getAssociation(w).getParentItem(this)},b.isReadOnly||(d._trackAssoc[w]=f[0],u=function(b){var c,e,r=d.dbContext.getAssociation(w);if(b&&!r.parentDS.entityType.isPrototypeOf(b))throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_PARAM_INVALID_TYPE,
"value",r.parentDS.entityType._typeName));if(b&&b._isNew)this._setFieldVal(a.fieldName,b._key);else if(b){c=0;for(e=r.childFldInfos.length;c<e;c+=1)this[r.childFldInfos[c].fieldName]=b[r.parentFldInfos[c].fieldName]}else{this._getFieldVal(a.fieldName)&&this._setFieldVal(a.fieldName,null);c=0;for(e=r.childFldInfos.length;c<e;c+=1)this[r.childFldInfos[c].fieldName]=null}})):(d._parentAssocMap[f[0].parentToChildrenName]=f[0],l=function(){return d.dbContext.getAssociation(w).getChildItems(this)});q[a.fieldName]=
{set:u,get:l}},g=function(a){q[a.fieldName]={set:function(b){this._setFieldVal(a.fieldName,b)},get:function(){return this._getFieldVal(a.fieldName)}}};b.forEach(function(b){if(h.hasProp(p,b.fieldName))throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_ITEM_NAME_COLLISION,a,b.fieldName));if(b.isCalculated){var c=d.getFieldInfo(b.fieldName);c.isClientOnly=!0;c.isReadOnly=!0;c={dbSetName:a,fieldName:b.fieldName,getFunc:null};d.dbContext._onGetCalcField(c);h.check_is.Function(c.getFunc)&&(b.dependentOn&&f(b),
q[b.fieldName]={get:c.getFunc})}else b.isNavigation?l(b):g(b)});q._dbSet={get:function(){return this.__dbSet}};this._entityType=p.extend({__dbSet:d},q,function(b){b._typeName=a+"Entity"});this._mapAssocFields()},_fillFromService:function(a){a=h.extend(!1,{res:{names:[],rows:[],pageIndex:null,pageCount:null,dbSetName:this.dbSetName,totalCount:null},isPageChanged:!1,fn_beforeFillEnd:null},a);var b=this,c=a.res,e=c.names,d=c.rows||[],q=this._entityType,f=[],g=[],m=[],k=[],y=this.isPagingEnabled,t=this.query,
n=!0,p;this._onFillStart({isBegin:!0,rowCount:d.length,time:new Date,isPageChanged:a.isPageChanged});try{t&&(n=t.isClearPrevData,t.isClearCacheOnEveryLoad&&t._clearCache(),n&&this.clear(),t._reindexCache(),1<t.loadPageCount&&y&&(p=t._getCache(),t.isIncludeTotalCount&&!h.check_is.nt(c.totalCount)&&(p.totalCount=c.totalCount)));m=d.map(function(a){var c=a.key;if(!c)throw Error(RIAPP.ERRS.ERR_KEY_IS_EMPTY);var r=b._itemsByKey[c];r?a.values.forEach(function(a,b){r._refreshValue(a,e[b],1)}):(p&&(r=p.getItemByKey(c)),
r?a.values.forEach(function(a,b){r._refreshValue(a,e[b],1)}):r=q.create(a,e));return r});if(t&&(t.isIncludeTotalCount&&!h.check_is.nt(c.totalCount)&&(this.totalCount=c.totalCount),1<t.loadPageCount&&y)){p.fillCache(c.pageIndex,m);var v=p.getCachedPage(t.pageIndex),m=v?v.items:[]}m.forEach(function(a){var b=this._itemsByKey[a._key];b?k.push(b):(this._items.push(a),this._itemsByKey[a._key]=a,f.push(a),g.push(this._items.length-1),k.push(a))},this);0<f.length&&(this._onItemsChanged({change_type:l.ADDED,
items:f,pos:g}),this.raisePropertyChanged("count"));a.fn_beforeFillEnd&&a.fn_beforeFillEnd()}finally{this._onFillEnd({isBegin:!1,rowCount:k.length,time:new Date,resetUI:n,fetchedItems:k,newItems:f,isPageChanged:a.isPageChanged})}this.moveFirst();return{fetchedItems:k,newItems:f,isPageChanged:a.isPageChanged}},_fillFromCache:function(a){a=h.extend(!1,{isPageChanged:!1,fn_beforeFillEnd:null},a);var b=this,c=[],e=[],d=this.query;if(!d)throw Error(String.format(RIAPP.ERRS.ERR_ASSERTION_FAILED,"query is not null"));
d=d._getCache().getCachedPage(d.pageIndex);d=!d?[]:d.items;this._onFillStart({isBegin:!0,rowCount:d.length,time:new Date,isPageChanged:a.isPageChanged});try{this.clear(),this._items=d,d.forEach(function(a,r){b._itemsByKey[a._key]=a;c.push(r);e.push(a)}),a.fn_beforeFillEnd&&a.fn_beforeFillEnd(),0<e.length&&(this._onItemsChanged({change_type:l.ADDED,items:e,pos:c}),this.raisePropertyChanged("count"))}finally{this._onFillEnd({isBegin:!1,rowCount:e.length,time:new Date,resetUI:!0,fetchedItems:e,newItems:e,
isPageChanged:a.isPageChanged})}this.moveFirst();return{fetchedItems:e,newItems:e,isPageChanged:a.isPageChanged}},_commitChanges:function(a){var b=this;a.forEach(function(a){var e=a.clientKey,r=b._itemsByKey[e];if(!r)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_KEY_IS_NOTFOUND,e));var d=r._changeType;r.acceptChanges(a);d===c.ADDED&&(delete b._itemsByKey[e],r._srvRowKey=a.serverKey,r._key=r._srvRowKey,b._itemsByKey[r._key]=r,b._onItemsChanged({change_type:l.REMAP_KEY,items:[r],old_key:e,new_key:r._key}))})},
_setItemInvalid:function(a){var b=this._itemsByKey[a.clientKey],c={};a.invalid.forEach(function(a){a.fieldName||(a.fieldName="*");c[a.fieldName]?c[a.fieldName].push(a.message):c[a.fieldName]=[a.message]});var e=[];h.forEachProp(c,function(a){e.push({fieldName:a,errors:c[a]})});this._addErrors(b,e);return b},_getChanges:function(){var a=[],b=this._changeCache;h.forEachProp(b,function(c){a.push(b[c]._getRowInfo())});return a},_getTrackAssocInfo:function(){var a=this,b=[],c=this._changeCache,e=Object.keys(a._trackAssoc);
h.forEachProp(c,function(d){var q=c[d];e.forEach(function(c){var e=q._getFieldVal(a._trackAssoc[c].childToParentName),d=q._key;e&&d&&b.push({assocName:c,parentKey:e,childKey:d})})});return b},_getNewKey:function(a){a="clkey_"+this._newKey;this._newKey+=1;return a},_createNew:function(){var a=this._entityType.create(null,null);a._key=this._getNewKey(a);return a},_addToChanged:function(a){null!==a._key&&!this._changeCache[a._key]&&(this._changeCache[a._key]=a,this._changeCount+=1,1===this._changeCount&&
...
var b=this,c=this._dbSets;if(!h.check_is.Array(a.dbSets))throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_PARAM_INVALID_TYPE,"metadata.dbSets","Array"));this._serverTimezone=a.serverTimezone;a.dbSets.forEach(function(e){var d=e.dbSetName,q;q=a.associations.filter(function(a){return e.dbSetName==a.childDbSetName});var l=a.associations.filter(function(a){return e.dbSetName==a.parentDbSetName});q=f.create({dbContext:b,dbSetInfo:e,childAssoc:q,parentAssoc:l});b._arrDbSets.push(q);q.addOnPropertyChange("hasChanges",
...
this._assoc[a.name]=function(){var e=z.create(c);b._arrAssoc.push(e);b._assoc[a.name]=function(){return e};return e}},_initMethod:function(a){var b=this;this._svcMethods[a.methodName]=function(c){var e=h.createDeferred(),f=function(a){a.error?e.reject():e.resolve(a.result)};try{var q=b._getMethodParams(a,c);b._invokeMethod(a,q,f)}catch(l){d._checkIsDummy(l)||(b._onError(l,b),f({result:null,error:l}))}return e.promise()}},_getMethodParams:function(a,c){var d={methodName:a.methodName,paramInfo:{parameters:[]}},
f,l=a.parameters,q=l.length,u,g,m;c||(c={});for(f=0;f<q;f+=1){u=l[f];g=c[u.name];if(!u.isNullable&&!u.isArray&&u.dataType!==b.String&&h.check_is.nt(g))throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_SVC_METH_PARAM_INVALID,u.name,g,a.methodName));if(h.check_is.Function(g))throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_SVC_METH_PARAM_INVALID,u.name,g,a.methodName));u.isArray&&(!h.check_is.nt(g)&&!h.check_is.Array(g))&&(g=[g]);m=null;h.check_is.Array(g)?(m=[],g.forEach(function(a){m.push(e.stringifyValue(a,
u.dateConversion,self._serverTimezone))}),m=JSON.stringify(m)):m=e.stringifyValue(g,u.dateConversion,self._serverTimezone);d.paramInfo.parameters.push({name:u.name,value:m})}return d},_invokeMethod:function(a,b,c){var e=this,f,q;this.isBusy=!0;var l=function(a){try{if(!a)throw Error(h.format(RIAPP.ERRS.ERR_UNEXPECTED_SVC_ERROR,"operation result is undefined"));g.checkError(a.error,"invoke");c({result:a.result,error:null})}catch(b){d._checkIsDummy(b)||(e._onDataOperError(b,"invoke"),c({result:null,
error:b}))}};try{f=JSON.stringify(b),q=this._getUrl("InvokeMethod"),h.performAjaxCall(q,f,!0,function(a){l(JSON.parse(a));e.isBusy=!1},function(a){l({result:null,error:a});e.isBusy=!1},null)}catch(m){d._checkIsDummy(m)&&d._throwDummy(m),this.isBusy=!1,this._onDataOperError(m,"invoke"),c({result:null,error:m}),d._throwDummy(m)}},_getEventNames:function(){var a=this._super();return["submit_error","define_calc"].concat(a)},_loadFromCache:function(a,b){var c=a._dbSet,e;try{e=c._fillFromCache({isPageChanged:b,
...
e));g.checkError(a.error,"load");q=f._fillFromService({res:a,isPageChanged:b,fn_beforeFillEnd:function(){c._loadIncluded(a)}})}catch(l){d._checkIsDummy(l)&&d._throwDummy(l),this._onDataOperError(l,"load"),d._throwDummy(l)}return q},_dataSaved:function(a){var b=this,c=[],e=[];try{try{g.checkError(a.error,"submit")}catch(f){throw a.dbSets.forEach(function(a){var d=b._dbSets[a.dbSetName];a.rows.forEach(function(a){var b=d.getItemByKey(a.clientKey);if(!b)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_KEY_IS_NOTFOUND,
a.clientKey));c.push(b);a.invalid&&(d._setItemInvalid(a),e.push(b))})}),x.create(f,c,e);}a.dbSets.forEach(function(a){b._dbSets[a.dbSetName]._commitChanges(a.rows)})}catch(q){d._checkIsDummy(q)&&d._throwDummy(q),this._onSubmitError(q),d._throwDummy(q)}},_getChanges:function(){var a={dbSets:[],error:null,trackAssocs:[]};this._arrDbSets.forEach(function(b){b.endEdit();var c=b._getChanges();if(0!==c.length){var e=b._getTrackAssocInfo();a.dbSets.push({dbSetName:b.dbSetName,rows:c});a.trackAssocs=a.trackAssocs.concat(e)}});
return a},_getUrl:function(a){var b=this.service_url;h.str.endsWith(b,"/")||(b+="/");return b+=[a,""].join("/")},_onItemRefreshed:function(a,b){try{if(g.checkError(a.error,"refresh"),a.rowInfo)b._refreshValues(a.rowInfo,2);else throw b._dbSet.removeItem(b),b.destroy(),Error(RIAPP.ERRS.ERR_ITEM_DELETED_BY_ANOTHER_USER);}catch(c){d._checkIsDummy(c)&&d._throwDummy(c),this._onDataOperError(c,"refresh"),d._throwDummy(c)}},_refreshItem:function(a){var b=h.createDeferred(),c=function(c){c?b.resolve(a):b.reject()},
e=this._getUrl("RefreshItem"),d=a._dbSet;this.waitForNotSubmiting(function(){var b=this;d.waitForNotLoading(function(){var f,l=function(){b.isBusy=!1;d.isLoading=!1;a._isRefreshing=!1},g=function(a){l();b._onDataOperError(a,"refresh")};a._isRefreshing=!0;b.isBusy=!0;d.isLoading=!0;try{var m={dbSetName:a._dbSetName,rowInfo:a._getRowInfo(),error:null};a._checkCanRefresh();f=JSON.stringify(m);h.performAjaxCall(e,f,!0,function(e){try{var d=JSON.parse(e);b._onItemRefreshed(d,a);l();c(!0)}catch(f){g(f),
c(!1)}},function(a){l();b._onDataOperError(a,"refresh");c(!1)},null)}catch(w){g(w),c(!1)}},[],!0,null)},[],null);return b.promise()},_onError:function(a,b){var c=this._super(a,b);return!c?this.app?this.app._onError(a,b):d._onError(a,b):c},_onDataOperError:function(a,b){if(d._checkIsDummy(a))return!0;var c;c=t.isPrototypeOf(a)?a:t.create(a,b);return this._onError(c,this)},_onSubmitError:function(a){var b={error:a,isHandled:!1};this.raiseEvent("submit_error",b);b.isHandled||(this.rejectChanges(),this._onDataOperError(a,
"submit"))},_beforeLoad:function(a,b,c){a&&b!==a&&(c._query=a,c.pageIndex=0);b&&b!==a&&b.destroy();if(a.pageSize!==c.pageSize){c._ignorePageChanged=!0;try{c.pageIndex=0,c.pageSize=a.pageSize}finally{c._ignorePageChanged=!1}}if(a.pageIndex!==c.pageIndex){c._ignorePageChanged=!0;try{c.pageIndex=a.pageIndex}finally{c._ignorePageChanged=!1}}a.isCacheValid||a._clearCache()},_load:function(a,b){if(!a)throw Error(RIAPP.ERRS.ERR_DB_LOAD_NO_QUERY);var c=this,e=h.createDeferred(),f=a.loadPageCount,q=a.pageIndex,
l=a.isPagingEnabled,g=a.dbSetName,m=this.getDbSet(g);this.waitForNotSubmiting(function(){m.waitForNotLoading(function(){var k=m.query,t=c._getUrl("GetItems"),y,n,p=function(){m.isLoading=!1;c.isBusy=!1},v=function(a){p();e.resolve(a)},A=function(a){p();c._onDataOperError(a,"load");e.reject()},z;m.isLoading=!0;c.isBusy=!0;try{a.pageIndex=q;c._beforeLoad(a,k,m);var x,k=1;if(1<f&&l){if(a._isPageCached(q)){z=c._loadFromCache(a,b);z.outOfBandData=null;v(z);return}x=a._getCache().getNextRange(q);q=x.start;
k=x.cnt}y={dbSetName:g,pageIndex:q,pageSize:a.pageSize,pageCount:k,isIncludeTotalCount:a.isIncludeTotalCount,filterInfo:a.filterInfo,sortInfo:a.sortInfo,paramInfo:c._getMethodParams(a._queryInfo,a.params).paramInfo,queryName:a.queryName};n=JSON.stringify(y);h.performAjaxCall(t,n,!0,function(a){var e=[],q;try{q=a.indexOf(d.modules.consts.CHUNK_SEP),-1<q?(e.push(a.substr(0,q)),e.push(a.substr(q+d.modules.consts.CHUNK_SEP.length))):e.push(a),e=e.map(function(a){return JSON.parse(a)}),setTimeout(function(){var d,
q=e[0],f=!!q.included&&0<q.included.length;try{if(1<e.length&&(d=e[1])&&0<d.length)if(f&&q.included.forEach(function(a){a.rows=d.splice(0,a.rowCount);if(a.rowCount!=a.rows.length)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_ASSERTION_FAILED,"subset.rowCount == subset.rows.length"));}),q.rows=d,q.rowCount!=q.rows.length)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_ASSERTION_FAILED,"getDataResult.rowCount == getDataResult.rows.length"));z=c._onLoaded(q,b);z.outOfBandData=a.extraInfo;v(z)}catch(r){A(r)}},
0)}catch(f){A(f)}},function(a){p();c._onDataOperError(a,"load");e.reject()},null)}catch(D){A(D)}},[],!0,b?"paging":null)},[],b?"paging":null);return e.promise()},getDbSet:function(a){if(!this.isInitialized)throw Error(RIAPP.ERRS.ERR_DOMAIN_CONTEXT_NOT_INITIALIZED);var b=this._dbSets[a];if(!b)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_DBSET_NAME_INVALID,a));return b},getAssociation:function(a){var b=this._assoc[a];if(!b)throw Error(RIAPP.utils.format(RIAPP.ERR_ASSOC_NAME_INVALID,a));return b()},
submitChanges:function(){if(this._pendingSubmit)return this._pendingSubmit.deferred.promise();var a=this,b={deferred:h.createDeferred()},c=function(a){a?b.deferred.resolve():b.deferred.reject()};this._pendingSubmit=b;this.waitForNotBusy(function(){var b,e,d,f=function(){a.isBusy=!1;a.isSubmiting=!1},l=function(b){f();a._onDataOperError(b,"submit");c(!1)};try{if(this.isSubmiting=this.isBusy=!0,this._pendingSubmit=null,b=this._getUrl("SaveChanges"),d=this._getChanges(),0===d.dbSets.length){f();c(!0);
return}}catch(g){l(g);return}try{e=JSON.stringify(d),h.performAjaxCall(b,e,!0,function(b){try{a._dataSaved(JSON.parse(b)),f(),c(!0)}catch(e){l(e)}},function(b){f();a._onSubmitError(b);c(!1)},null)}catch(m){l(m)}},[]);return b.deferred.promise()},load:function(a){return this._load(a,!1)},acceptChanges:function(){this._arrDbSets.forEach(function(a){a.acceptChanges()})},rejectChanges:function(){this._arrDbSets.forEach(function(a){a.rejectChanges()})},initialize:function(a){if(!this._isInitialized){var b=
...
hasChanges:{get:function(){return this._hasChanges}}},function(b){g.DbContext=b;a.registerType("DbContext",b)});var A=k.Collection.extend({_create:function(a){this._super();a=h.extend(!1,{dataSource:null,fn_filter:null,fn_sort:null,fn_itemsProvider:null},a);if(!a.dataSource||!k.Collection.isPrototypeOf(a.dataSource))throw Error(RIAPP.ERRS.ERR_DATAVIEW_DATASRC_INVALID);if(!a.fn_filter||!h.check_is.Function(a.fn_filter))throw Error(RIAPP.ERRS.ERR_DATAVIEW_FILTER_INVALID);this._dataSource=a.dataSource;
...
rowCount:a.items.length,time:new Date,isPageChanged:a.isPageChanged});try{a.clear&&this.clear(),b=this.isPagingEnabled&&!a.isAppend?this._filterForPaging(a.items):a.items,b.forEach(function(a){var b=this._itemsByKey[a._key];b?d.push(b):(this._itemsByKey[a._key]=a,c.push(a),e.push(this._items.length-1),this._items.push(a),d.push(a))},this),0<c.length&&(this._onItemsChanged({change_type:l.ADDED,items:c,pos:e}),this.raisePropertyChanged("count"))}finally{this._onFillEnd({isBegin:!1,rowCount:d.length,
...
c>b&&(this._currentPos=c-1,this._onCurrentChanged())}},sortLocal:function(a,b){var c=1,e=this._app.parser;b&&"DESC"===b.toUpperCase()&&(c=-1);this.fn_sort=function(b,d){var f=0,l,g,m;l=0;for(g=a.length;l<g&&!(m=a[l],f=e.resolvePath(b,m),m=e.resolvePath(d,m),f=f<m?-1*c:f>m?c:0,0!==f);l+=1);return f}},getIsHasErrors:function(){return this._dataSource.getIsHasErrors()},clear:function(){this.cancelEdit();this._EditingItem=null;this._newKey=0;this.currentItem=null;this._items=[];this._itemsByKey={};this._errors=
...
this,c;c=a.items;var e=[],d={};switch(a.change_type){case l.RESET:b._isParentFilling||(e=b.refreshParentMap());break;case l.ADDED:this._isParentFilling||(e=b._mapParentItems(c));break;case l.REMOVE:c.forEach(function(a){(a=b._unMapParentItem(a))&&(d[a]=null)});e=Object.keys(d);break;case l.REMAP_KEY:if(a.old_key&&(c=this._parentMap[a.old_key]))delete this._parentMap[a.old_key],e=this._mapParentItems([c]);break;default:throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_COLLECTION_CHANGETYPE_INVALID,a.change_type));
...
_onChildStatusChanged:function(a,b){var e=c.DELETED,d=a._changeType,f=this.getChildFKey(a);f&&d===e&&(f=this._unMapChildItem(a))&&this._notifyChildrenChanged([f])},_getItemKey:function(a,b,c){for(var e=[],d,f=0,l=a.length;f<l;f+=1){d=c[a[f].fieldName];d=b._getStrValue(d,a[f]);if(null===d)return null;e.push(d)}return e.join(";")},_resetChildMap:function(){var a=Object.keys(this._childMap);this._childMap={};this._notifyChildrenChanged(a)},_resetParentMap:function(){var a=Object.keys(this._parentMap);
this._parentMap={};this._notifyParentChanged(a)},_unMapChildItem:function(a){var b,c,e=null;if(b=this.getChildFKey(a))if(c=this._childMap[b])a=h.removeFromArray(c,a),-1<a&&(0==c.length&&delete this._childMap[b],e=b);return e},_unMapParentItem:function(a){var b=null;if((a=this.getParentFKey(a))&&this._parentMap[a])delete this._parentMap[a],b=a;return b},_mapParentItems:function(a){for(var b,e,d=c.DELETED,f,q={},l=0,g=a.length;l<g;l+=1)if(b=a[l],e=b._changeType,e!==d&&(e=this.getParentFKey(b)))f=this._parentMap[e],
f!==b&&(this._parentMap[e]=b,q[e]=null);return Object.keys(q)},_onChildrenChanged:function(a){a&&this._parentToChildrenName&&(a=this._parentMap[a])&&a.raisePropertyChanged(this._parentToChildrenName)},_onParentChanged:function(a){var b=this;a&&this._childToParentName&&(a=this._childMap[a])&&a.forEach(function(a){a.raisePropertyChanged(b._childToParentName)})},_mapChildren:function(a){for(var b,e,d,f=c.DELETED,q={},l=0,g=a.length;l<g;l+=1)if(b=a[l],e=b._changeType,e!==f&&(e=this.getChildFKey(b)))d=
...
this._$template=this._template=null;this._fn_submitOnOK=function(){var a=c._dbContext;if(!a)return k.createDeferred().resolve();a.addHandler("submit_error",function(a,b){p.SubmitError.isPrototypeOf(b.error)&&0<b.error.notValidated.length&&(b.isHandled=!0)},c._objId);var b=a.submitChanges();b.always(function(){a.removeHandler("submit_error",c._objId)});return b};this._updateIsEditable();this._options={width:a.width,height:a.height,title:a.title,autoOpen:!1,modal:!0,close:function(a,b){c._onClose()},
...
f.DIALOG_ACTION.StayOpen)if(this._dataContext){if(c=this._isEditable?this._dataContext.endEdit():!0)if(this._submitOnOK){this._disableButtons(!0);var e=this.title;this.title=h.txtSubmitting;c=this._fn_submitOnOK();c.always(function(){a._disableButtons(!1);a.title=e});c.done(function(){a._result="ok";a.hide()});c.fail(function(){a._isEditable&&a._dataContext.beginEdit()})}else a._result="ok",a.hide()}else a.hide()},_onCancel:function(){var a=f.DIALOG_ACTION.Default;this._fn_OnCancel&&(a=this._fn_OnCancel(this));
...
actionsCell:{get:function(){return this._actionsCell}},isDeleted:{set:function(a){this._el&&this._isDeleted!==a&&((this._isDeleted=a)?(this.isExpanded=!1,d.$(this._el).addClass(s.rowDeleted)):d.$(this._el).removeClass(s.rowDeleted))},get:function(){return!this._el?!0:this._isDeleted}},isEditing:{get:function(){return this._item._isEditing}}},function(a){g.Row=a});n=RIAPP.BaseObject.extend({_app:a,_create:function(a,b){this._super();this._grid=a;this._el=b.tr;this._parentRow=this._cell=this._item=
...
!a||a._isDestroyCalled?this._parentRow=null:(this._parentRow=a,this._item=a.item,this._cell.item=this._item,k.insertAfter(a.el,this.el),d.$(this._cell._template.el).slideDown("fast",function(){var a=b._parentRow;a&&!a._isDestroyCalled&&b.grid._options.isUseScrollIntoDetails&&a.scrollIntoView(!0)}))},toString:function(){return"DetailsRow"}},{el:{get:function(){return this._el}},grid:{get:function(){return this._grid}},item:{set:function(a){this._item!==a&&(this._item=a)},get:function(){return this._item}},
cell:{get:function(){return this._cell}},uniqueID:{get:function(){return this._objId}},itemKey:{get:function(){return!this._item?null:this._item._key}},parentRow:{set:function(a){var b=this;if(a!==this._parentRow){var c=d.$(this._cell._template.el);b._parentRow?c.slideUp("fast",function(){b._setParentRow(a)}):b._setParentRow(a)}},get:function(){return this._parentRow}}},function(a){g.DetailsRow=a});p=RIAPP.BaseObject.extend({_app:a,_create:function(a,c){this._super();var e=this;this._grid=a;this._el=
c.th;this._options=c.colinfo;this._isSelected=!1;this._objId="col"+this.app.getNewObjectID();var f=d.$("<div></div>");f.addClass(s.column);this._grid._headerDiv.append(f);this._extcol=f;var l=d.$("<div></div>");l.addClass(s.cellDiv).click(function(b){b.stopPropagation();d.currentSelectable=a;a._setCurrentColumn(e);e._onColumnClicked()});f.append(l);l.get(0).cell=this;this._div=l;d.$(this.grid._tableEl).on("click","div["+h.DATA_ATTR.DATA_EVENT_SCOPE+'="'+this.uniqueID+'"]',function(c){c.stopPropagation();
...
this.$div;b.removeClass(s.colSortable).removeClass(s.colSortAsc).removeClass(s.colSortDesc);switch(a){case "ASC":b.addClass(s.colSortAsc);break;case "DESC":b.addClass(s.colSortDesc);break;default:this.isSortable&&b.addClass(s.colSortable)}this._sortOrder=a},get:function(){return this._sortOrder}}},function(a){g.DataColumn=a});x=p.extend({_init:function(){this._super();this.$div.addClass(s.rowExpander)},toString:function(){return"ExpanderColumn"}},null,function(a){g.ExpanderColumn=a});y=p.extend({_init:function(){this._super();
...
this._super();return["row_expanded","row_selected","page_changed","row_state_changed","cell_dblclicked"].concat(a)},_setCurrentColumn:function(a){this._currentColumn&&(this._currentColumn.isSelected=!1);if(this._currentColumn=a)this._currentColumn.isSelected=!0},_parseColumnAttr:function(a,b){var c={type:"data",title:null,sortable:!1,sortMemberName:null,content:{}},e=this._app.parser.parseOptions(a),c=0<e.length?k.extend(!1,c,e[0]):c;b&&(c.content=this._app._parseContentAttr(b),!c.sortMemberName&&
...
null)},_createColumns:function(){for(var a=this,b=this._tHeadCells,c=b.length,e=[],d,f,l=0;l<c;l+=1)d=b[l],f=this._parseColumnAttr(d.getAttribute(h.DATA_ATTR.DATA_COLUMN),d.getAttribute(h.DATA_ATTR.DATA_CONTENT)),e.push({th:d,colinfo:f});e.forEach(function(b){(b=a._createColumn(b))&&a._columns.push(b)})},_createColumn:function(a){var b;switch(a.colinfo.type){case "row_expander":this._expanderCol||(this._expanderCol=b=x.create(this,a));break;case "row_actions":this._actionsCol||(this._actionsCol=b=
y.create(this,a));break;case "row_selector":this._rowSelectorCol||(this._rowSelectorCol=b=A.create(this,a));break;case "data":b=v.create(this,a);break;default:throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_GRID_COLTYPE_INVALID,a.colinfo.type));}return b},_appendItems:function(a){if(!this._isDestroyCalled)for(var b,c=this._tBodyEl,e=0,d=a.length;e<d;e+=1)b=a[e],this._rowMap[b._key]||this._createRowForItem(c,b)},_onKeyDown:function(a,b){var c=this._dataSource,e=h.KEYS;if(c)switch(a){case e.up:b.preventDefault();
...
RIAPP.Application._coreModules.listbox=function(a){var g=this,d=a.global,k=d.utils,h=d.consts,p=a.modules.collection,n=a.modules.baseElView.EditableElView,f=RIAPP.BaseObject.extend({_app:a,_create:function(a,c,e){var f=this;this._super();this._el=a;this._$el=d.$(this._el);this._objId="lst"+this._app.getNewObjectID();if(c&&!p.Collection.isPrototypeOf(c))throw Error(RIAPP.ERRS.ERR_LISTBOX_DATASRC_INVALID);this._$el.on("change."+this._objId,function(a){a.stopPropagation();f._isRefreshing||f._onChanged()});
...
null,c;0<=this._el.selectedIndex&&(a=this._el.options[this._el.selectedIndex],a=a.value,c=this._keyMap[a]);!c&&this._selectedItem?this.selectedItem=null:c.item!==this._selectedItem&&(this.selectedItem=c.item)},_getValue:function(a){a=this._getRealValue(a);return k.check_is.nt(a)?"":a},_getRealValue:function(a){if(!a)return null;if(this._valuePath)return this._app.parser.resolvePath(a,this._valuePath)},_getText:function(a){return!a?"":this._textPath?(a=this._app.parser.resolvePath(a,this._textPath),
k.check_is.nt(a)?"":""+a):""+this._getValue(a)},_onDSCollectionChanged:function(a){var c=this,e=p.consts.COLL_CHANGE_TYPE;switch(a.change_type){case e.RESET:this._isDSFilling||this._refresh();break;case e.ADDED:this._isDSFilling||a.items.forEach(function(a){c._addOption(a,a._isNew)});break;case e.REMOVE:a.items.forEach(function(a){c._removeOption(a)});break;case e.REMAP_KEY:if(e=c._keyMap[a.old_key])delete c._keyMap[a.old_key],c._keyMap[a.new_key]=e,e.op.value=a.new_key}},_onDSFill:function(a){a.isBegin?
...
RIAPP.Application._coreModules.dataform=function(a){var g=this,d=a.global,k=d.utils,h=d.consts,p=a.modules.binding.Binding,n=a.modules.baseElView.BaseElView,f={dataform:"ria-dataform"},b=RIAPP.localizable.VALIDATE;Object.freeze(f);g.css=f;var c=RIAPP.BaseObject.extend({_DATA_CONTENT_SELECTOR:"*["+h.DATA_ATTR.DATA_CONTENT+"]:not(["+h.DATA_ATTR.DATA_COLUMN+"])",_app:a,_create:function(b,c){var g=this,h;this._super();this._el=b;this._$el=d.$(this._el);this._objId="frm"+this._app.getNewObjectID();this._css=
...
RIAPP.Application._coreModules.elview=function(a){var g=this,d=a.global,k=d.utils,h=a.modules.baseElView,p=h.BaseElView,n=h.EditableElView,f=h.CommandElView,b=h.css;g.BaseElView=p;g.EditableElView=n;g.CommandElView=f;p.extend({_init:function(a){this._super(a);this._someProp=null}},{someProp:{set:function(a){if(a!==this._someProp){debugger;this._someProp=a;this.raisePropertyChanged("someProp");this.$el.html(""+this._someProp)}},get:function(){return this._someProp}}},function(b){g.DebuggerElView=b;
a.registerType("DebuggerElView",b);a.registerElView("debugger",b)});h=n.extend({_init:function(a){var b=this;this._super(a);var d=this.$el;d.on("change."+this._objId,function(a){a.stopPropagation();b.raisePropertyChanged("value")});d.on("keypress."+this._objId,function(a){a.stopPropagation();var c={keyCode:a.which,value:a.target.value,isCancel:!1};b.raiseEvent("keypress",c);c.isCancel&&a.preventDefault()});if(a.updateOnKeyUp)d.on("keyup."+this._objId,function(a){a.stopPropagation();b.raisePropertyChanged("value")})},
_getEventNames:function(){var a=this._super();return["keypress"].concat(a)},toString:function(){return"TextBoxElView"}},{value:{set:function(a){if(this._el){var b=this._el,d=b.value;a=null===a?"":""+a;d!==a&&(b.value=a,this.raisePropertyChanged("value"))}},get:function(){var a=this._el;return!a?"":a.value}}},function(b){g.TextBoxElView=b;a.registerType("TextBoxElView",b);a.registerElView("input:text",b)});p.extend({toString:function(){return"HiddenElView"}},{value:{set:function(a){if(this._el){var b=
this._el,d=b.value;a=null===a?"":""+a;d!==a&&(b.value=a,this.raisePropertyChanged("value"))}},get:function(){var a=this._el;return!a?"":a.value}}},function(b){g.HiddenElView=b;a.registerType("HiddenElView",b);a.registerElView("input:hidden",b)});h.extend({_init:function(a){this._super(a);a.rows&&(this.rows=a.rows);a.cols&&(this.cols=a.cols);a.wrap&&(this.wrap=a.wrap)},toString:function(){return"TextAreaElView"}},{rows:{set:function(a){var b=this._el;if(b){var d=b.rows;a=!a?1:a;d!==a&&(b.rows=a,this.raisePropertyChanged("rows"))}},
...
get:function(){return this._value}}},function(a){g.LookupContent=a});g.BindingContentFactory=RIAPP.BaseObject.extend({_app:a,getContentType:function(a){var d=a.fieldInfo;if(a.lookup)return x;switch(d.dataType){case n.None:a=b;break;case n.String:a=a.multyline?v:t;break;case n.Bool:a=e;break;case n.Integer:a=m;break;case n.Decimal:case n.Float:a=m;break;case n.DateTime:case n.Time:a=l;break;case n.Date:a=c;break;case n.Guid:case n.Binary:a=b;break;default:throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_FIELD_DATATYPE,
