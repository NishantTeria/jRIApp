...
RIAPP.utils=function(){Array.clone||(Array.clone=function(a){return 1===a.length?[a[0]]:Array.apply(null,a)});var a={isFunc:function(a){if(!a)return!1;var d=/Function/;return"function"===typeof a?d.test(a.constructor.toString()):!1},endsWith:function(a,d){return a.substr(a.length-d.length)===d},startsWith:function(a,d){return a.substr(0,d.length)===d},fastTrim:function(a){return a.replace(/^\s+|\s+$/g,"")},trim:function(g,d){return!d?a.fastTrim(g):a.ltrim(a.rtrim(g,d),d)},ltrim:function(a,d){return a.replace(RegExp("^["+
(d||"\\s")+"]+","g"),"")},rtrim:function(a,d){return a.replace(RegExp("["+(d||"\\s")+"]+$","g"),"")},isArray:function(a){return!a?!1:Array.isArray(a)},format:function(){for(var g="",d=arguments,h=d[0],k=0;;){var l=h.indexOf("{",k),p=h.indexOf("}",k);if(0>l&&0>p){g+=h.slice(k);break}if(0<p&&(p<l||0>l)){if("}"!==h.charAt(p+1))throw Error(a.format(RIAPP.ERRS.ERR_STRING_FORMAT_INVALID,h));g+=h.slice(k,p+1);k=p+2}else if(g+=h.slice(k,l),k=l+1,"{"===h.charAt(k))g+="{",k++;else{if(0>p)throw Error(a.format(RIAPP.ERRS.ERR_STRING_FORMAT_INVALID,
h));var l=h.substring(k,p),f=l.indexOf(":"),k=parseInt(0>f?l:l.substring(0,f),10)+1;if(isNaN(k))throw Error(a.format(RIAPP.ERRS.ERR_STRING_FORMAT_INVALID,h));l=0>f?"":l.substring(f+1);k=d[k];if(void 0===k||null===k)k="";g=k.format?g+k.format(l):g+k.toString();k=p+1}}return g}};String.format||(String.format=function(){var g=Array.prototype.slice.call(arguments);return a.format.apply(a,g)});return a}();
RIAPP.BaseObject={_create:function(){this.__events=this._super=null;this._isDestroyCalled=this._isDestroyed=!1},create:function(){var a=Object.create(this);a._create.apply(a,arguments);Object.seal(a);return a},extend:function(a,g,d){var h=g||{},k,l=0,p,f,b=/\._super\s*\(/;Object.getOwnPropertyNames(h).forEach(function(b){b=h[b];void 0===b.enumerable&&(b.enumerable=!0);void 0===b.configurable&&(b.configurable=!1)});h._typeName=Object.getOwnPropertyDescriptor({_typeName:""},"_typeName");h.__eventNames=
Object.getOwnPropertyDescriptor({__eventNames:[]},"__eventNames");if(a){k=Object.getOwnPropertyNames(a);l=0;for(p=k.length;l<p;l+=1)g=k[l],h.hasOwnProperty(g)||(h[g]=Object.getOwnPropertyDescriptor(a,g))}f=Object.create(this,h);Object.getOwnPropertyNames(f).forEach(function(c){var e=Object.getOwnPropertyDescriptor(f,c),m,n,a;e.value&&RIAPP.utils.isFunc(e.value)&&(n=e.value.toString(),m=f[c],b.test(n)?(a=Object.getPrototypeOf(f),e.value="destroy"==c?function(){var b=this._super;this._super=a[c];try{return this._isDestroyCalled=
!0,m.apply(this,arguments)}finally{this._super=b}}:function(){var b=this._super;this._super=a[c];try{return m.apply(this,arguments)}finally{this._super=b}},Object.defineProperty(f,c,e)):"destroy"==c&&(e.value=function(){this._isDestroyCalled=!0;return m.apply(this,arguments)},Object.defineProperty(f,c,e)))});f.__eventNames=f._getEventNames();d&&d(f);return f},_addHandler:function(a,g,d,h){if(!this._isDestroyed){if(!RIAPP.utils.isFunc(g))throw Error(RIAPP.ERRS.ERR_EVENT_INVALID_FUNC);if(!a)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_EVENT_INVALID,
a));null===this.__events&&(this.__events={});var k=this.__events,l="*";d&&(l=""+d);k[a]||(k[a]=[]);a=k[a];a.some(function(a){return a.fn===g&&a.ns==l})||(h?a.unshift({fn:g,ns:l}):a.push({fn:g,ns:l}))}},_removeHandler:function(a,g){var d=this.__events,h="*";if(d){g&&(h=""+g);var k,l,p;if(a){if(d[a])if("*"==h)delete d[a];else{k=d[a];l=k.filter(function(f){return f.ns==h});for(p=k.length;0<p;)p-=1,-1<l.indexOf(k[p])&&k.splice(p,1);0==k.length&&delete d[a]}}else"*"!=h?Object.keys(d).forEach(function(f){var b=
d[f],c=b.filter(function(b){return b.ns==h});for(p=b.length;0<p;)p-=1,-1<c.indexOf(b[p])&&b.splice(p,1);0==b.length&&delete d[f]}):this.__events=null}},_raiseEvent:function(a,g){var d=this,h=d.__events;null!==h&&a&&("0*"!=a&&RIAPP.utils.startsWith(a,"0")&&this._raiseEvent("0*",g),h[a]&&Array.clone(h[a]).forEach(function(a){a.fn.apply(d,[d,g])}))},_onError:function(a,g){if(RIAPP.global&&RIAPP.global._checkIsDummy(a))return!0;a.message||(a=Error(""+a));var d={error:a,source:g,isHandled:!1};this._raiseEvent("error",
d);return d.isHandled},_getEventNames:function(){return["error","destroyed"]},_checkEventName:function(a){if(-1===this.__eventNames.indexOf(a))throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_EVENT_INVALID,a));},raisePropertyChanged:function(a){this._raiseEvent("0"+a,{property:a})},addHandler:function(a,g,d){this._checkEventName(a);this._addHandler(a,g,d,!1)},removeHandler:function(a,g){a&&this._checkEventName(a);this._removeHandler(a,g)},addOnDestroyed:function(a,g){this._addHandler("destroyed",a,g,
!1)},removeOnDestroyed:function(a){this._removeHandler("destroyed",a)},removeNSHandlers:function(a){this._removeHandler(void 0,a)},raiseEvent:function(a,g){this._checkEventName(a);this._raiseEvent(a,g)},getEventNames:function(){return this.__eventNames},addOnPropertyChange:function(a,g,d){if(!a)throw Error(RIAPP.ERRS.ERR_PROP_NAME_EMPTY);this._addHandler("0"+a,g,d,!1)},removeOnPropertyChange:function(a,g){a&&(a="0"+a);this._removeHandler(a,g)},destroy:function(){if(!this._isDestroyed){this._isDestroyed=
...
RIAPP.Global=RIAPP.BaseObject.extend({version:"1.2.5.1",_TEMPLATES_SELECTOR:["section.",RIAPP.css_riaTemplate].join(""),_TEMPLATE_SELECTOR:'*[data-role="template"]',__coreModules:{},_create:function(a,g){this._super();if(RIAPP.global)throw Error(RIAPP.ERRS.ERR_GLOBAL_SINGLTON);if(!g)throw Error(RIAPP.ERRS.ERR_APP_NEED_JQUERY);var d,h;this._window=a;this._appInst={};this._$=g;this._modInst={};this._defaults=this._currentSelectable=null;this._userCode={};this._exports={};this._consts=this._utils=null;
this._templateLoaders={};this._templateGroups={};this._promises=[];this._nextAppInstanceNum=0;this._isReady=!1;for(var k=0;k<RIAPP._glob_modules.length;k+=1)d={},h=RIAPP._glob_modules[k],this._coreModules[h].apply(d,[this]),Object.freeze(d),this._modInst[RIAPP._glob_modules[k]]=d;this._init();Object.freeze(this._coreModules);this._waitQueue=this.utils.WaitQueue.create(this)},_getNextAppNum:function(){return this._nextAppInstanceNum+=1},_init:function(){var a=this;a.$(a.document).ready(function(g){a._isReady=
...
{})});a.window.onerror=function(a,d,h){if(a&&-1<a.indexOf("DUMMY_ERROR"))return!0;alert("Error message: "+a+"\nURL: "+d+"\nLine Number: "+h);return!1}},_getEventNames:function(){var a=this._super();return["load","unload"].concat(a)},_addHandler:function(a,g,d,h){var k=this;"load"==a&&k._isReady?setTimeout(function(){g.apply(k,[k,{}])},0):this._super(a,g,d,h)},_onGridAdded:function(a){var g=this,d=g.utils,h=a.$container;h.on("click."+a.uniqueID,function(k){k.stopPropagation();d.isContained(k.target,
h.get(0))&&(g.currentSelectable=a)})},_onGridRemoved:function(a){a.$container.off("click."+a.uniqueID);this.currentSelectable===a&&(this.currentSelectable=null)},_onStackPanelAdded:function(a){var g=this,d=g.utils,h=a._$el;h.on("click."+a.uniqueID,function(k){k.stopPropagation();d.isContained(k.target,h.get(0))&&(g.currentSelectable=a)})},_onStackPanelRemoved:function(a){a._$el.off("click."+a.uniqueID);this.currentSelectable===a&&(this.currentSelectable=null)},_registerApp:function(a){this._appInst[a.appName]||
(this._appInst[a.appName]=a)},_unregisterApp:function(a){this._appInst[a.appName]&&(delete this._appInst[a.appName],delete this._templateLoaders[a.appName],delete this._templateGroups[a.appName])},_destroyApps:function(){var a=this;this.utils.forEachProp(this._appInst,function(g){a._appInst[g].destroy()})},_throwDummy:function(a){var g=this.modules.errors;if(g&&a&&!a.isDummy)throw g.DummyError.create(a);throw a;},_checkIsDummy:function(a){return!!a.isDummy},_registerObjectCore:function(a,g,d,h){var k=
g.split("."),l;for(l=0;l<k.length-1;l+=1)a[k[l]]||(a[k[l]]={}),a=a[k[l]];k=k[k.length-1];if(h&&a[k])throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_OBJ_ALREADY_REGISTERED,g));a[k]=d;return a},_getObjectCore:function(a,g){var d=g.split("."),h=a,k;for(k=0;k<d.length;k+=1){if(!h[d[k]])return null;h=h[d[k]]}return h},_registerType:function(a,g,d){return this._registerObjectCore(a._exports,g,d,!0)},_getType:function(a,g){return this._getObjectCore(a._exports,g)},_processTemplateSections:function(a){var g=
this;Array.fromList(a.querySelectorAll(g._TEMPLATES_SELECTOR)).forEach(function(a){g._processTemplateSection(a,null);g.utils.removeNode(a)})},_processTemplateSection:function(a,g){var d=this;Array.fromList(a.querySelectorAll(d._TEMPLATE_SELECTOR)).forEach(function(a){var k=d.document.createElement("div"),l=a.getAttribute("id"),p=d.utils.createDeferred();a.removeAttribute("id");k.appendChild(a);p.resolve(k.innerHTML);g&&(l=g.appName+"."+l);d._registerTemplateLoader(l,{fn_loader:function(){return p.promise()}})})},
_loadTemplatesAsync:function(a,g){var d=this,h=a(),k=d.isLoading;d._promises.push(h);d.isLoading!==k&&d.raisePropertyChanged("isLoading");var l=d.utils.createDeferred();h.done(function(a){d.utils.removeFromArray(d._promises,h);try{var f=d.document.createElement("div");f.innerHTML=a;d._processTemplateSection(f,g);l.resolve()}catch(b){d._onError(b,d),l.reject()}d.isLoading||d.raisePropertyChanged("isLoading")});h.fail(function(a){d.utils.removeFromArray(d._promises,h);d.isLoading||d.raisePropertyChanged("isLoading");
l.reject();a&&a.message?d._onError(a,d):a&&a.responseText?d._onError(Error(a.responseText),d):d._onError(Error("Failed to load templates"),d)});return l.promise()},_registerTemplateLoaderCore:function(a,g){return this._registerObjectCore(this._templateLoaders,a,g,!1)},_getTemplateLoaderCore:function(a){return this._getObjectCore(this._templateLoaders,a)},_registerTemplateLoader:function(a,g){g=this.utils.extend(!1,{fn_loader:null,groupName:null},g);if(!g.groupName&&!this.utils.check_is.Function(g.fn_loader))throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_ASSERTION_FAILED,
"fn_loader is Function"));var d=this._getTemplateLoaderCore(a);if(d){if(!d.fn_loader&&d.groupName&&!g.groupName&&g.fn_loader)return this._registerTemplateLoaderCore(a,g);throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_TEMPLATE_ALREADY_REGISTERED,a));}return this._registerTemplateLoaderCore(a,g)},_getTemplateLoader:function(a){var g=this,d=g._getTemplateLoaderCore(a);if(!d)return null;if(!d.fn_loader&&d.groupName){var h=g._getTemplateGroup(d.groupName);if(!h)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_TEMPLATE_GROUP_NOTREGISTERED,
d.groupName));return function(){h.promise||(h.promise=g._loadTemplatesAsync(h.fn_loader,h.app));var d=g.utils.createDeferred();h.promise.done(function(){try{h.promise=null;h.names.forEach(function(f){h.app&&(f=h.app.appName+"."+f);var b=g._getTemplateLoaderCore(f);if(!b||!b.fn_loader)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_TEMPLATE_NOTREGISTERED,f));});var l=g._getTemplateLoaderCore(a);if(!l||!l.fn_loader)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_TEMPLATE_NOTREGISTERED,a));delete g._templateGroups[l.groupName];
l.fn_loader().done(function(f){d.resolve(f)}).fail(function(f){d.reject(f)})}catch(p){d.reject(p)}});h.promise.fail(function(a){h.promise=null;d.reject(a)});return d.promise()}}return d.fn_loader},_registerTemplateGroup:function(a,g){var d=this;g=d.utils.extend(!1,{fn_loader:null,url:null,names:null,app:null,promise:null},g);g.url&&!g.fn_loader&&(g.fn_loader=function(){return d.utils.performAjaxGet(g.url)});var h=this._registerObjectCore(d._templateGroups,a,g,!0);g.names.forEach(function(k){g.app&&
(k=g.app.appName+"."+k);d._registerTemplateLoader(k,{groupName:a,fn_loader:null})});return h},_getTemplateGroup:function(a){return this._getObjectCore(this._templateGroups,a)},_waitForNotLoading:function(a,g){this._waitQueue.enQueue({prop:"isLoading",groupName:null,predicate:function(a){return!a},action:a,actionArgs:g})},reThrow:function(a,g){if(g)this._throwDummy(a);else throw a;},findApp:function(a){return this._appInst[a]},destroy:function(){this._isDestroyed||(this._waitQueue&&(this._waitQueue.destroy(),
...
RIAPP.Global._coreModules.array_ext=function(a){Array.prototype.distinct=function(){var a={},d,h=this.length,k=[];for(d=0;d<h;d+=1)a[this[d]]=this[d];var l=Object.keys(a);d=0;for(h=l.length;d<h;d+=1)k.push(a[l[d]]);return k};Array.prototype.intersect=function(a){return this.filter(function(d){return-1<a.indexOf(d)})};Array.fromList=function(a){for(var d=Array(a.length),h=0,k=a.length;h<k;h++)d[h]=a[h];return d}};
...
esc:27,space:32,pageUp:33,pageDown:34,end:35,home:36,left:37,up:38,right:39,down:40,del:127};g.ELVIEW_NM={DATAFORM:"dataform",DYNACONT:"dynacontent"};Object.getOwnPropertyNames(g).forEach(function(a){Object.freeze(g[a])});Object.freeze(g);this.consts=g;a.consts=this.consts};
...
a,this.raisePropertyChanged("decPrecision"))},get:function(){return this._decPrecision}}},function(a){g.Defaults=a});a.defaults=d.create();a.defaults.dateFormat="dd.mm.yy";a.defaults.imagesPath="/Scripts/jriapp/img/"};
RIAPP.Global._coreModules.utils=function(a){var g=this,d=RIAPP.utils,h=0,k={Null:function(b){return null===b},Undefined:function(b){return void 0===b},nt:function(b){return null===b||void 0===b},Function:d.isFunc,String:function(b){if(k.nt(b))return!1;var c=/string/i;return"string"===typeof b?!0:"object"===typeof b?c.test(b.constructor.toString()):!1},Array:d.isArray,Boolean:function(b){if(k.nt(b))return!1;var c=/boolean/i;return"boolean"===typeof b?!0:"object"===typeof b?c.test(b.constructor.toString()):
...
!1},SimpleObject:function(b){return k.nt(b)?!1:k.Object(b)&&Object.prototype===Object.getPrototypeOf(b)},RegExp:function(b){if(k.nt(b))return!1;var c=/regexp/i;return"function"===typeof b?c.test(b.constructor.toString()):!1},Numeric:function(b){return k.Number(b)||k.String(b)&&!isNaN(Number(b))},BoolString:function(b){return k.nt(b)?!1:"true"==b||"false"==b}},l={checkNumRange:function(b,c){var e=c.split(",");if(e[0]&&b<parseFloat(e[0]))throw Error(String.format(RIAPP.ERRS.ERR_FIELD_RANGE,b,c));if(e[1]&&
b>parseFloat(e[1]))throw Error(String.format(RIAPP.ERRS.ERR_FIELD_RANGE,b,c));},_dtRangeToDate:function(b){b=b.split("-");return new Date(parseInt(b[0],10),parseInt(b[1],10)-1,b[2])},checkDateRange:function(b,c){var e=c.split(",");if(e[0]&&b<l._dtRangeToDate(e[0]))throw Error(String.format(RIAPP.ERRS.ERR_FIELD_RANGE,b,c));if(e[1]&&b>l._dtRangeToDate(e[1]))throw Error(String.format(RIAPP.ERRS.ERR_FIELD_RANGE,b,c));}},p={str:{endsWith:d.endsWith,startsWith:d.startsWith,trim:d.trim,formatNumber:function(b,
c,e,f){b=(b+"").replace(/[^0-9+-Ee.]/g,"");var n=!isFinite(+b)?0:+b;b=!isFinite(+c)?0:Math.abs(c);f=void 0===f?",":f;e=void 0===e?".":e;var a="",a=function(b,c){var e=Math.pow(10,c);return""+Math.round(b*e)/e};p.check_is.nt(c)?(a=(""+n).split("."),b=2):a=(b?a(n,b):""+Math.round(n)).split(".");var n="",d=a[0].length;if(3<d){for(c=0;c<d;c+=1)n+=a[0].charAt(c),c<d-1&&0===(d-c-1)%3&&(n+=f);a[0]=n}if((a[1]||"").length<b)a[1]=a[1]||"",a[1]+=Array(b-a[1].length+1).join("0");return a.join(e)},stripNonNumeric:function(b){b+=
"";for(var c=/^\d|\.|-$/,e="",f=0;f<b.length;f++)c.test(b.charAt(f))&&("."==b.charAt(f)&&-1!=e.indexOf(".")||"-"==b.charAt(f)&&0!=e.length||(e+=b.charAt(f)));return e}},check_is:k,validation:l,getNewID:function(){var b=h;h+=1;return b},isContained:function(b,c){if(!b)return!1;for(;b=b.parentNode;)if(b===c)return!0;return!1},slice:Array.prototype.slice,get_timeZoneOffset:function(){var b=(new Date).getTimezoneOffset();return function(){return b}}(),parseBool:function(b){var c=d.trim(b).toLowerCase();
if("false"===c)return!1;if("true"===c)return!0;throw Error(p.format(RIAPP.ERRS.ERR_PARAM_INVALID,"bool_value",b));},round:function(b,c){return parseFloat(b.toFixed(c))},performAjaxCall:function(b,c,e,f,n,d){var g=new XMLHttpRequest;g.open("POST",b,e);var k=p.createDeferred();g.responseType="text";g.onload=function(b){200==this.status&&k.resolve(this.response)};g.onerror=function(b){k.reject(Error(b.target.status))};g.ontimeout=function(){k.reject(Error("The request for "+b+" timed out."))};g.timeout=
1E3*a.defaults.ajaxTimeOut;g.setRequestHeader("Content-Type","application/json; charset=utf-8");g.send(c);c=k.promise();f&&c.done(function(b){f.call(d,b)});n&&c.fail(function(b){n.call(d,b)});return c},performAjaxGet:function(b){var c=new XMLHttpRequest;c.open("GET",b,!0);var e=p.createDeferred();c.responseType="text";c.onload=function(b){200==this.status&&e.resolve(this.response)};c.onerror=function(b){e.reject(Error(b.target.status))};c.ontimeout=function(){e.reject(Error("The request for "+b+" timed out."))};
c.timeout=1E3*a.defaults.ajaxTimeOut;c.send(null);return e.promise()},format:d.format,extend:function(b,c,e){return b?p.cloneObj(e,c):p.mergeObj(e,c)},removeNode:function(b){if(b){var c=b.parentNode;c&&c.removeChild(b)}},insertAfter:function(b,c){var e=b.parentNode;e.lastChild===b?e.appendChild(c):e.insertBefore(c,b.nextSibling)},getProps:function(b){return Object.getOwnPropertyNames(b)},forEachProp:function(b,c){Object.getOwnPropertyNames(b).forEach(c)},addToolTip:function(b,c,e){e={content:{text:c},
style:{classes:e?e:null},position:{my:"top left",at:"bottom right",target:b,viewport:$(a.window),adjust:{method:"flip none",x:0,y:0}},hide:{fixed:!0,delay:250}};b.data("qtip")?c?b.qtip("option","content.text",c):b.qtip("destroy"):c&&b.qtip(e)},hasProp:function(b,c){if(!b)return!1;if(b.hasOwnProperty(c))return!0;if(Object===b)return!1;var e=Object.getPrototypeOf(b);return p.hasProp(e,c)},createDeferred:function(){return a.$.Deferred()},cloneObj:function(b,c){var e,f,n;if(!b)return b;if(k.Array(b)){n=
b.length;e=Array(n);for(f=0;f<n;f+=1)e[f]=p.cloneObj(b[f],null)}else if(k.SimpleObject(b)){e=c||{};var a,d=Object.getOwnPropertyNames(b);n=d.length;for(f=0;f<n;f+=1)a=d[f],e[a]=p.cloneObj(b[a],null)}else return b;return e},shallowCopy:function(b){return p.mergeObj(b,{})},mergeObj:function(b,c){c||(c={});if(!b)return c;for(var e=Object.getOwnPropertyNames(b),f,n=0,a=e.length;n<a;n+=1)f=e[n],c[f]=b[f];return c},removeFromArray:function(b,c){var e=b.indexOf(c);-1<e&&b.splice(e,1);return e},insertIntoArray:function(b,
c,e){b.splice(e,0,c)},destroyJQueryPlugin:function(b,c){if(b.data(c))b[c]("destroy")},uuid:function(){var b="0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz".split("");return function(c,e){var f,n=[],a=Math.random;e=e||b.length;if(c)for(f=0;f<c;f+=1)n[f]=b[0|a()*e];else{var d;n[8]=n[13]=n[18]=n[23]="-";n[14]="4";for(f=0;36>f;f+=1)n[f]||(d=0|16*a(),n[f]=b[19==f?d&3|8:d&15])}return n.join("")}}()},f=RIAPP.BaseObject.extend({_cnt:0,_create:function(){this._super();this._objs=[];f._cnt+=
1;this._cnt=f._cnt},addObj:function(b){0>this._objs.indexOf(b)&&this._objs.push(b)},removeObj:function(b){p.removeFromArray(this._objs,b)},getObjs:function(){return this._objs},destroy:function(){this._objs.forEach(function(b){b._isDestroyCalled||b.destroy()});this._objs=[];this._super()},toString:function(){return"LifeTimeScope "+this._cnt}},null,function(b){g.LifeTimeScope=b});g.PropWatcher=RIAPP.BaseObject.extend({_create:function(){this._super();this._objId="prw"+p.getNewID();this._objs=[]},addPropWatch:function(b,
c,e){b.addOnPropertyChange(c,function(b,c){e(c.property)},this.uniqueID);0>this._objs.indexOf(b)&&this._objs.push(b)},addWatch:function(b,c,e){b.addOnPropertyChange("*",function(b,n){-1<c.indexOf(n.property)&&e(n.property)},this.uniqueID);0>this._objs.indexOf(b)&&this._objs.push(b)},removeWatch:function(b){b.removeNSHandlers(this.uniqueID)},destroy:function(){var b=this;this._objs.forEach(function(c){b.removeWatch(c)});this._objs=[];this._super()},toString:function(){return"PropWatcher "+this._objId}},
{uniqueID:{get:function(){return this._objId}}},function(b){a.registerType("PropWatcher",b)});g.WaitQueue=RIAPP.BaseObject.extend({_create:function(b){this._super();this._objId="wq"+p.getNewID();this._owner=b;this._queue={}},_checkQueue:function(b,c){if(this._owner&&!this._owner._isDestroyCalled){var e=this,f=this._queue[b],n;if(f&&0!=f.length){var a,d,g=null,k=[],p=[],l=[];for(a=0;a<f.length;a+=1)if(n=f[a],n.predicate(c))if(!n.group&&0==k.length){d=n;break}else n.group&&(g||(g=n.group),g===n.group&&
k.push(n));if(d)p.push(d),l.push(d);else for(;0<k.length;)n=k.pop(),d||(d=n),d.lastWins?0==p.length&&p.push(n):p.push(n),l.push(n);try{if(0<p.length){for(a=f.length;0<a;)a-=1,-1<l.indexOf(f[a])&&f.splice(a,1);p.forEach(function(b){try{b.action.apply(e._owner,b.args)}catch(c){e._owner._onError(c,e)}})}}finally{0==f.length&&(delete this._queue[b],this._owner.removeOnPropertyChange(b,this.uniqueID))}}}},enQueue:function(b){b=p.extend(!1,{prop:"",groupName:null,predicate:null,action:null,actionArgs:[],
lastWins:!1,syncCheck:!1},b);var c=this;if(this._owner){var e=b.prop,f=this._queue[e];f||(f=[],this._queue[e]=f,this._owner.addOnPropertyChange(e,function(b,f){setTimeout(function(){c._isDestroyCalled||c._checkQueue(e,c._owner[e])},0)},c.uniqueID));f.push({predicate:b.predicate,action:b.action,group:b.groupName,lastWins:b.lastWins,args:!b.actionArgs?[]:b.actionArgs});b.syncCheck?c._checkQueue(e,c._owner[e]):setTimeout(function(){c._isDestroyCalled||c._checkQueue(e,c._owner[e])},0)}},destroy:function(){this._owner.removeOnPropertyChange(null,
this.uniqueID);this._queue={};this._owner=null;this._super()},toString:function(){return"WaitQueue "+this._objId}},{uniqueID:{get:function(){return this._objId}},owner:{get:function(){return this._owner}}},null);p.mergeObj(p,g);a.utils=g};
RIAPP.Global._coreModules.riapp=function(a){var g=this,d=a.utils,h=a.consts,k={},l={},p=RIAPP.BaseObject.extend({_DATA_BIND_SELECTOR:["*[",h.DATA_ATTR.DATA_BIND,"]"].join(""),_TEMPLATES_DATA_BIND_SELECTOR:["section.",RIAPP.css_riaTemplate," *[",h.DATA_ATTR.DATA_BIND,"]"].join(""),registerModule:function(f,b){if(l[f])throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_MODULE_ALREDY_REGISTERED,f));l[f]=b},_create:function(f){this._super();f=d.extend(!1,{app_name:"default",service_url:"",metadata:null,createDbContext:!0,
moduleNames:[]},f);var b=f.app_name;if(a.findApp(b))throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_APP_NAME_NOT_UNIQUE,b));Object.freeze(f);this._options=f;this._parser=null;this._converters={};this._lftmBind=this._dbContext=null;this._instanceNum=a._getNextAppNum();this._ELV_STORE_KEY=h.DATA_ATTR.EL_VIEW_KEY+this._instanceNum;this._bindingContentFactory=null;this._modInst={};this._exports={};this._elViews={};this._elViewStore={};this._global=a;this._nextElViewStoreKey=0;this._userCode={};this._viewModels=
{};var c,e;c=0;for(e=RIAPP._app_modules.length;c<e;c+=1)b={},k[RIAPP._app_modules[c]].apply(b,[this]),Object.freeze(b),this._modInst[RIAPP._app_modules[c]]=b;f=d.check_is.Array(f.moduleNames)&&0<f.moduleNames.length?f.moduleNames:[];c=0;for(e=f.length;c<e;c+=1){if(!l[f[c]])throw Error(String.format(RIAPP.ERRS.ERR_MODULE_UNDEFINED,f[c]));b={};l[f[c]].apply(b,[this]);Object.freeze(b);this._modInst[f[c]]=b}a._registerApp(this)},destroy:function(){this._isDestroyed||(a._unregisterApp(this),this._destroyBindings(),
this._dbContext&&(this._dbContext.destroy(),this._dbContext=null),this._elViews={},this._exports={},this._parser=this._options=this._global=null,this._converters={},this._elViewStore={},this._userCode={},this._viewModels={},this._modInst={},this._bindingContentFactory=null,this._super())},_getEventNames:function(){var f=this._super();return["define_calc"].concat(f)},_onError:function(f,b){if(a._checkIsDummy(f))return!0;var c=this._super(f,b);return!c?a._onError(f,b):c},_onGetCalcField:function(f){this.raiseEvent("define_calc",
f)},_getBindingOption:function(f,b,c){var e={mode:this.modules.binding.BINDING_MODE[1],converterParam:null,converter:null,targetPath:null,sourcePath:null,target:null,source:null,isSourceFixed:!1},a=f.source,n=f.target;!f.sourcePath&&f.to?e.sourcePath=f.to:f.sourcePath&&(e.sourcePath=f.sourcePath);f.targetPath&&(e.targetPath=f.targetPath);f.converterParam&&(e.converterParam=f.converterParam);f.mode&&(e.mode=f.mode);f.converter&&(d.check_is.String(f.converter)?e.converter=this.getConverter(f.converter):
e.converter=f.converter);n?d.check_is.String(n)?e.target="this"==n?b:this.parser.resolveBindingSource(this,this.parser._getPathParts(n)):e.target=n:e.target=b;a?(e.isSourceFixed=!0,d.check_is.String(a)?e.source="this"==a?b:this.parser.resolveBindingSource(this,this.parser._getPathParts(a)):e.source=a):e.source=c;return e},_getElViewType:function(f){return this._elViews[f]},_getElView:function(f){return(f=f.getAttribute(this._ELV_STORE_KEY))?this._elViewStore[f]:null},_setElView:function(f,b){var c=
f.getAttribute(this._ELV_STORE_KEY);c?b?this._elViewStore[c]=b:(f.removeAttribute(this._ELV_STORE_KEY),delete this._elViewStore[c]):b&&(c="s_"+this._nextElViewStoreKey,this._nextElViewStoreKey+=1,f.setAttribute(this._ELV_STORE_KEY,c),this._elViewStore[c]=b)},_isDataForm:function(f){if(!f)return!1;f=f.getAttribute(h.DATA_ATTR.DATA_VIEW);if(!f)return!1;f=this.parser.parseOptions(f);return 0<f.length&&f[0].name===h.ELVIEW_NM.DATAFORM},_isInsideDataForm:function(f){return!f?!1:(f=f.parentElement)?this._isDataForm(f)?
!0:this._isInsideDataForm(f):!1},_bindTemplateElements:function(f){var b=this,c=Array.fromList(f.querySelectorAll(b._DATA_BIND_SELECTOR)),e=d.LifeTimeScope.create();f.hasAttribute(h.DATA_ATTR.DATA_BIND)&&c.push(f);c.forEach(function(c){var n,f,a,d,g;if(!b._isInsideDataForm(c)){d=c.getAttribute(h.DATA_ATTR.DATA_BIND);c.removeAttribute(h.DATA_ATTR.DATA_BIND);d=b.parser.parseOptions(d);g=b.getElementView(c);e.addObj(g);n=0;for(f=d.length;n<f;n+=1)c=b._getBindingOption(d[n],g,null),a=b.bind(c),c.target=
null,e.addObj(a)}});return e},_bindElements:function(f,b,c){var e=this;f=f||a.document;f=Array.fromList(f.querySelectorAll(e._DATA_BIND_SELECTOR));var m=d.LifeTimeScope.create();f.forEach(function(n){var f,a;if(c||!e._isInsideDataForm(n)){if(!c&&(n.hasAttribute(h.DATA_ATTR.DATA_APP)&&(f=n.getAttribute(h.DATA_ATTR.DATA_APP)),f&&e.appName!==f||!f&&"default"!==e.appName))return;f=n.getAttribute(h.DATA_ATTR.DATA_BIND);n=e.getElementView(n);m.addObj(n);f=e.parser.parseOptions(f);for(var d=0,g=f.length;d<
g;d+=1)a=e._getBindingOption(f[d],n,b),a=e.bind(a),m.addObj(a)}});return m},_getContent:function(f,b,c,e,a){if(b.templateInfo)f=f.create(c,b.templateInfo,e,a);else if(b.bindingInfo)f=f.create(c,b,e,a);else throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_PARAM_INVALID,"options","bindingInfo"));return f},_getContentType:function(f){if(f.templateInfo)f=this.modules.baseContent.TemplateContent;else if(f.bindingInfo)f=this.bindingContentFactory.getContentType(f);else throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_PARAM_INVALID,
"options","bindingInfo"));return f},_parseContentAttr:function(f){var b={templateInfo:null,bindingInfo:null,displayInfo:null,fieldName:null};f=this.parser.parseOptions(f);if(0===f.length)return b;f=f[0];!f.template&&f.fieldName?(f.bindingInfo={target:null,source:null,targetPath:null,sourcePath:f.fieldName,mode:"OneWay",converter:null,converterParam:null},f.displayInfo=f.css):f.template&&(f.templateInfo=f.template,delete f.template);return d.extend(!1,b,f)},_destroyBindings:function(){this._lftmBind&&
(this._lftmBind.destroy(),this._lftmBind=null)},getNewObjectID:function(){return d.getNewID()},setUpBindings:function(){var f=a.document;this._destroyBindings();this._lftmBind=this._bindElements(f,this,!1)},registerElView:function(f,b){this._elViews[f]||(this._elViews[f]=b)},getElementView:function(f){var b,c,e;if(c=this._getElView(f))return c;if(f.hasAttribute(h.DATA_ATTR.DATA_VIEW)&&(c=f.getAttribute(h.DATA_ATTR.DATA_VIEW),(c=this.parser.parseOptions(c))&&0<c.length)){c=c[0];if(c.name&&"default"!==
c.name&&(b=this._getElViewType(c.name),!b))throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_ELVIEW_NOT_REGISTERED,c.name));c.options&&(e=c.options)}if(!b){c=f.nodeName.toLowerCase();switch(c){case "input":b=f.getAttribute("type");c=c+":"+b;b=this._getElViewType(c);break;default:b=this._getElViewType(c)}if(!b)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_ELVIEW_NOT_CREATED,c));}return c=b.create(f,e||{})},registerConverter:function(f,b){if(this._converters[f])throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_OBJ_ALREADY_REGISTERED,
f));this._converters[f]=b},getConverter:function(f){var b=this._converters[f];if(!b)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_CONVERTER_NOTREGISTERED,f));return b},registerType:function(f,b){return a._registerType(this,f,b)},getType:function(f){var b=a._getType(this,f);b||(b=a._getType(this.global,f));return b},bind:function(f){return this.getType("Binding").create(f)},startUp:function(f){var b=this,c=function(){f.apply(b,[b]);b.setUpBindings()};try{if(!d.check_is.Function(f))throw Error(RIAPP.ERRS.ERR_APP_SETUP_INVALID);
b.options.createDbContext?(b._dbContext=b.getType("DbContext").create(),b._dbContext.addHandler("define_calc",function(c,e){b._onGetCalcField(e)}),b._dbContext.initialize({serviceUrl:b.options.service_url,metadata:b.options.metadata}),a._waitForNotLoading(function(){b._dbContext.waitForInitialized(c,null)},null)):a._waitForNotLoading(c,null)}catch(e){a.reThrow(e,b._onError(e,b))}},loadTemplates:function(f){this.loadTemplatesAsync(function(){return a.utils.performAjaxGet(f)})},loadTemplatesAsync:function(f){a._loadTemplatesAsync(f,
this)},registerTemplateLoader:function(f,b){a._registerTemplateLoader(this.appName+"."+f,{fn_loader:b})},getTemplateLoader:function(f){var b=a._getTemplateLoader(this.appName+"."+f);b||(b=a._getTemplateLoader(f));return b},registerTemplateGroup:function(f,b){b=a.utils.extend(!1,{fn_loader:null,url:null,names:null,app:this},b);a._registerTemplateGroup(this.appName+"."+f,b)},toString:function(){return"Application"+this._instanceNum}},{_coreModules:{get:function(){return k}},bindingContentFactory:{get:function(){return this._bindingContentFactory},
set:function(f){this._bindingContentFactory=f}},options:{get:function(){return this._options}},modules:{get:function(){return this._modInst}},parser:{get:function(){return this._parser}},instanceNum:{get:function(){return this._instanceNum}},appName:{get:function(){return this.options.app_name}},global:{get:function(){return this._global}},dbContext:{get:function(){return this._dbContext}},UC:{get:function(){return this._userCode}},VM:{get:function(){return this._viewModels}},app:{get:function(){return this}},
localizable:{get:function(){return RIAPP.localizable}}},function(f){g.Application=f;a.registerType("Application",f)});RIAPP.Application=p};RIAPP.global=RIAPP.Global.create(window,jQuery,[]);
RIAPP.Application._coreModules.converter=function(a){var g=a.global,d=g.utils,h=d.str,k=RIAPP.BaseObject.extend({convertToSource:function(a,f,b){return a},convertToTarget:function(a,f,b){return d.check_is.nt(a)?null:a}},null,function(d){a.registerType("BaseConverter",d);a.registerConverter("BaseConverter",d)});k.extend({convertToSource:function(a,f,b){return!a?null:g.$.datepicker.parseDate(f,a)},convertToTarget:function(a,f,b){return d.check_is.nt(a)?"":g.$.datepicker.formatDate(f,a)},toString:function(){return"DateConverter"}},
null,function(d){a.registerConverter("dateConverter",d)});k.extend({convertToSource:function(a,f,b){if(!a)return null;f=Date.parseExact(a,f);if(!f)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_CONV_INVALID_DATE,a));return f},convertToTarget:function(a,f,b){return d.check_is.nt(a)?"":a.toString(f)},toString:function(){return"DateTimeConverter"}},null,function(d){a.registerConverter("dateTimeConverter",d)});var l=k.extend({convertToSource:function(a,f,b){if(d.check_is.nt(a))return null;b=g.defaults;
var c=b.decimalPoint,e=4,m=a.replace(b.thousandSep,""),m=m.replace(c,"."),m=h.stripNonNumeric(m);if(""===m)return null;c=null;switch(f){case 4:c=parseInt(m,10);break;case 1:c=parseInt(m,10);break;case 2:e=b.decPrecision;c=d.round(parseFloat(m),e);break;case 3:c=parseFloat(m);break;default:c=Number(m)}if(!d.check_is.Number(c))throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_CONV_INVALID_NUM,a));return c},convertToTarget:function(a,f,b){if(d.check_is.nt(a))return"";var c=g.defaults;b=c.decimalPoint;var e=
c.thousandSep;switch(f){case 1:return h.formatNumber(a,0,b,e);case 2:return f=c.decPrecision,h.formatNumber(a,f,b,e);case 4:return h.formatNumber(a,0,b,"");case 3:return h.formatNumber(a,null,b,e);default:return h.formatNumber(a,null,b,e)}},toString:function(){return"NumberConverter"}},null,function(d){a.registerConverter("numberConverter",d)});k.extend({convertToSource:function(a,f,b){return l.convertToSource(a,1,b)},convertToTarget:function(a,f,b){return l.convertToTarget(a,1,b)},toString:function(){return"IntegerConverter"}},
null,function(d){a.registerConverter("integerConverter",d)});k.extend({convertToSource:function(a,f,b){return l.convertToSource(a,4,b)},convertToTarget:function(a,f,b){return l.convertToTarget(a,4,b)},toString:function(){return"SmallIntConverter"}},null,function(d){a.registerConverter("smallIntConverter",d)});k.extend({convertToSource:function(a,f,b){return l.convertToSource(a,2,b)},convertToTarget:function(a,f,b){return l.convertToTarget(a,2,b)},toString:function(){return"DecimalConverter"}},null,
function(d){a.registerConverter("decimalConverter",d)});k.extend({convertToSource:function(a,f,b){return l.convertToSource(a,3,b)},convertToTarget:function(a,f,b){return l.convertToTarget(a,3,b)},toString:function(){return"FloatConverter"}},null,function(d){a.registerConverter("floatConverter",d)})};
RIAPP.Application._coreModules.parser=function(a){var g=a.global.utils,d=g.str,h=RIAPP.BaseObject.extend({__trimOuterBracesRX:/^([{]){0,1}|([}]){0,1}$/g,__trimQuotsRX:/^(['"])+|(['"])+$/g,__trimBracketsRX:/^(\[)+|(\])+$/g,__indexedPropRX:/(^\w+)\s*\[\s*['"]?\s*([^'"]+)\s*['",]?\s*\]/i,__valueDelimeter1:":",__valueDelimeter2:"=",__keyValDelimeter:",",_getPathParts:function(a){var d=this,g=[];(!a?[]:a.split(".")).forEach(function(f){var b;(b=f.match(d.__indexedPropRX))?(f=b[1],b=b[2],g.push(f),g.push("["+
b+"]")):g.push(f)});return g},_resolveProp:function(g,l){var h;return!l?g:d.startsWith(l,"[")?(h=a.modules.collection,l=this.trimQuotes(this.trimBrackets(l)),h.Dictionary.isPrototypeOf(g)?g.getItemByKey(l):h.Collection.isPrototypeOf(g)?g.getItemByPos(parseInt(l,10)):RIAPP.utils.isArray(g)?g[parseInt(l,10)]:g[l]):g[l]},_resolvePath:function(a,d){return!a?void 0:0===d.length?a:1===d.length?this._resolveProp(a,d[0]):this._resolvePath(this._resolveProp(a,d[0]),d.slice(1))},_setPropertyValue:function(a,
d,g){RIAPP.utils.startsWith(d,"[")?(d=this.trimQuotes(this.trimBrackets(d)),RIAPP.utils.isArray(a)?a[parseInt(d,10)]=g:a[d]=g):a[d]=g},_getKeyVals:function(a){var l,h,f,b=[],c={key:"",val:""},e=!0,m=this.__valueDelimeter1,n=this.__valueDelimeter2,t=this.__keyValDelimeter,v=function(c){c.val&&(g.check_is.Numeric(c.val)?c.val=Number(c.val):g.check_is.BoolString(c.val)&&(c.val=g.parseBool(c.val)));b.push(c)};for(l=0;l<a.length;l+=1){h=a.charAt(l);if("'"===h||'"'===h)f?f===h&&(f=null):f=h;!f&&"{"===h&&
!e?(h=a.substr(l),h=this.getBraceParts(h,!0)[0],c.val+=h,l+=h.length-1):!f&&h===t?c.key&&(v(c),c={key:"",val:""},e=!0):!f&&(h===m||h===n)?e=!1:e?c.key+=h:c.val+=h}c.key&&v(c);b.forEach(function(b){b.key=d.trim(b.key);g.check_is.String(b.val)&&(b.val=d.trim(b.val));""===b.val&&d.startsWith(b.key,"this.")&&(b.val=b.key.substr(5),b.key="targetPath")});return b=b.filter(function(b){return""!==b.val})},resolveBindingSource:function(a,d){if(a){if(0===d.length)return a;if(0<d.length)return this.resolveBindingSource(this._resolveProp(a,
d[0]),d.slice(1));throw Error("Invalid operation");}},resolvePath:function(a,d){if(!d)return a;var g=this._getPathParts(d);return this._resolvePath(a,g)},getBraceParts:function(a,d){var g,f="",b,c,e=0,m=[];for(g=0;g<a.length;g+=1){b=a.charAt(g);if("'"===b||'"'===b)c?c===b&&(c=null):c=b;if(!c&&"{"===b)e+=1,f+=b;else if(!c&&"}"===b){if(e-=1,f+=b,0===e&&(m.push(f),f="",d))break}else 0<e&&(f+=b)}return m},trimOuterBraces:function(a){return d.trim(a.replace(this.__trimOuterBracesRX,""))},trimQuotes:function(a){return d.trim(a.replace(this.__trimQuotsRX,
""))},trimBrackets:function(a){return d.trim(a.replace(this.__trimBracketsRX,""))},isWithOuterBraces:function(a){return d.startsWith(a,"{")&&d.endsWith(a,"}")},parseOption:function(a){var l={},h=this;a=d.trim(a);h.isWithOuterBraces(a)&&(a=h.trimOuterBraces(a));h._getKeyVals(a).forEach(function(a){var b=g.check_is.String(a.val);b&&h.isWithOuterBraces(a.val)?l[a.key]=h.parseOption(a.val):l[a.key]=b?h.trimQuotes(a.val):a.val});return l},parseOptions:function(a){var g=[],h=this;a=d.trim(a);var f=[a];
h.isWithOuterBraces(a)&&(f=h.getBraceParts(a,!1));f.forEach(function(b){g.push(h.parseOption(b))});return g},toString:function(){return"Parser"}},null);a._parser=h.create()};
RIAPP.Application._coreModules.baseElView=function(a){var g=this,d=a.global,h=d.utils,k=d.consts,l=RIAPP.localizable.VALIDATE,p=g.css={fieldError:"ria-field-error",errorTip:"ui-tooltip-red",commandLink:"ria-command-link"};Object.freeze(p);var f=RIAPP.BaseObject.extend({_app:a,_create:function(b,c){this._super();this._el=b;this._oldDisplay=this._$el=null;this._objId="elv"+this._app.getNewObjectID();this._propChangedCommand=null;this._app._setElView(this._el,this);this._errors=null;this._toolTip=c.tip;
this._css=c.css;this._init(c);this._applyToolTip()},_applyToolTip:function(){this._toolTip&&this._setToolTip(this.$el,this._toolTip)},_init:function(b){this._css&&this.$el.addClass(this._css)},_createElement:function(b){return d.$(d.document.createElement(b))},_setIsEnabled:function(b,c){b.prop("disabled",!c);c?b.removeClass("disabled"):b.addClass("disabled")},_getIsEnabled:function(b){return!b.prop("disabled")},destroy:function(){if(!this._isDestroyed){var b=this._$el,c=this._el;b&&b.off("."+this._objId);
try{this._$el=this._el=this.toolTip=this.validationErrors=this._propChangedCommand=null}finally{this._app._setElView(c,null)}this._super()}},invokePropChanged:function(b){b={property:b};this._propChangedCommand&&this._propChangedCommand.execute(this,b)},_getErrorTipInfo:function(b){var c=["<b>",l.errorInfo,"</b>","<br/>"];b.forEach(function(b){var a="";b.errors.forEach(function(b){a=a+" "+b});c.push(a);a=""});return c.join("")},_setFieldError:function(b){var c=this.$el;b?c.addClass(p.fieldError):
c.removeClass(p.fieldError)},_updateErrorUI:function(b,c){if(b){var e=this.$el;c&&0<c.length?(h.addToolTip(e,this._getErrorTipInfo(c),p.errorTip),this._setFieldError(!0)):(this._setToolTip(e,this.toolTip),this._setFieldError(!1))}},_onError:function(b,c){var e=this._super(b,c);return!e?this._app._onError(b,c):e},_setToolTip:function(b,c,e){h.addToolTip(b,c,e)},toString:function(){return"BaseElView"}},{app:{get:function(){return this._app}},$el:{get:function(){this._el&&!this._$el&&(this._$el=d.$(this._el));
...
b;a.registerType("TemplateElView",b);a.registerElView("template",b)});f.extend({_init:function(b){this._super(b);this._template=this._dataContext=null},_templateChanged:function(){this.raisePropertyChanged("templateID");this._template&&this.$el.empty().append(this._template.el)},updateTemplate:function(b){var c=this;try{if(!b&&this._template){this._template.destroy();this._template=null;c._templateChanged();return}}catch(e){this._onError(e,this),d._throwDummy(e)}try{this._template?this._template.templateID=
b:(this._template=this._app.getType("Template").create(b),this._template.dataContext=this._dataContext,this._template.addOnPropertyChange("templateID",function(b,e){c._templateChanged()},this._objId),c._templateChanged())}catch(a){this._onError(a,this),d._throwDummy(a)}},destroy:function(){this._template&&(this._template.destroy(),this._template=null);this._dataContext=null;this._super()}},{templateID:{set:function(b){this.updateTemplate(b)},get:function(){return!this._template?null:this._template.templateID}},
template:{get:function(){return this._template}},dataContext:{set:function(b){this._dataContext!==b&&(this._dataContext=b,this._template&&(this._template.dataContext=this._dataContext))},get:function(){return this._dataContext}}},function(b){g.DynaContentElView=b;a.registerType("DynaContentElView",b);a.registerElView(d.consts.ELVIEW_NM.DYNACONT,b)})};
RIAPP.Application._coreModules.binding=function(a){var g=this,d=a.global,h=d.utils,k=d.modules.errors,l=a.modules.baseElView.BaseElView,p=["OneTime","OneWay","TwoWay"];g.BINDING_MODE=p;g.ValidationError=k.BaseError.extend({_create:function(a,b){var c=RIAPP.ERRS.ERR_VALIDATION+"\r\n",e=0;a.forEach(function(b){0<e&&(c+="\r\n");c=b.fieldName?c+" "+RIAPP.localizable.TEXT.txtField+": "+b.fieldName+" -> "+b.errors.join(", "):c+b.errors.join(", ");e+=1});this._super(c);this._errors=a;this._item=b}},{item:{get:function(){return this._item}},
errors:{get:function(){return this._errors}}},function(f){a.registerType("ValidationError",f)});g.Binding=RIAPP.BaseObject.extend({_app:a,_create:function(a){this._super();a=h.extend(!1,{target:null,source:null,targetPath:null,sourcePath:null,mode:p[1],converter:null,converterParam:null,isSourceFixed:!1},a);if(!a.target)throw Error(RIAPP.ERRS.ERR_BIND_TARGET_EMPTY);if(!h.check_is.String(a.targetPath))throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_BIND_TGTPATH_INVALID,a.targetPath));if(0>p.indexOf(a.mode))throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_BIND_MODE_INVALID,
...
_getUpdTgtProxy:function(){var a=this;return function(){a._updateTarget()}},_getUpdSrcProxy:function(){var a=this;return function(){a._updateSource()}},_getSrcErrChangedProxy:function(){var a=this;return function(b,c){a._onSrcErrorsChanged()}},_onSrcErrorsChanged:function(){var a=[],b=this._targetObj,c=this._sourceObj,e=this._srcPath;b&&l.isPrototypeOf(b)&&(c&&0<e.length&&(a=c.getFieldErrors(e[e.length-1])),b.validationErrors=a)},_onError:function(a,b){var c=this._super(a,b);return!c?this._app._onError(a,
b):c},_getTgtChangedFn:function(a,b,c,e,d){return function(n,g){var k=a._app.parser._resolveProp(b,c);0<e.length&&a._checkBounded(null,"target",d,e);a._parseTgtPath(k,e,d)}},_getSrcChangedFn:function(a,b,c,e,d){return function(n,g){var k=a._app.parser._resolveProp(b,c);0<e.length&&a._checkBounded(null,"source",d,e);a._parseSrcPath(k,e,d)}},_parseSrcPath:function(a,b,c){this._sourceObj=null;0===b.length?this._sourceObj=a:this._parseSrcPath2(a,b,c);this._targetObj&&this._updateTarget()},_parseSrcPath2:function(a,
b,c){var e=RIAPP.BaseObject;if(e=!!a&&e.isPrototypeOf(a))a.addOnDestroyed(this._getOnSrcDestroyedProxy(),this._objId),this._checkBounded(a,"source",c,b);1<b.length?(e&&a.addOnPropertyChange(b[0],this._getSrcChangedFn(this,a,b[0],b.slice(1),c+1),this._objId),a&&(a=this._app.parser._resolveProp(a,b[0]))&&this._parseSrcPath2(a,b.slice(1),c+1)):a&&1===b.length&&((this._mode===p[1]||this._mode===p[2])&&e&&a.addOnPropertyChange(b[0],this._getUpdTgtProxy(),this._objId),a&&a.addOnItemErrorsChanged&&a.addOnItemErrorsChanged(this._getSrcErrChangedProxy(),
...
b[0]))&&this._parseTgtPath2(a,b.slice(1),c+1)):a&&1===b.length&&(this._mode===p[2]&&e&&a.addOnPropertyChange(b[0],this._getUpdSrcProxy(),this._objId),this._targetObj=a)},_checkBounded:function(a,b,c,e){var d,n;if("source"===b)n="s"+c;else if("target"===b)n="t"+c;else throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_PARAM_INVALID,"to",b));if(d=this._bounds[n])d.removeNSHandlers(this._objId),delete this._bounds[n];0<e.length&&this._checkBounded(null,b,c+1,e.slice(1));a&&(this._bounds[n]=a)},_onTgtDestroyed:function(a,
...
this._converterParam,this._sourceObj);void 0!==a&&(this.targetValue=a)}catch(b){d.reThrow(b,this._onError(b,this))}finally{this._ignoreTgtChange=!1}}},_updateSource:function(){if(!this._ignoreTgtChange){this._ignoreSrcChange=!0;try{var a=this._converter.convertToSource(this.targetValue,this._converterParam,this._sourceObj);void 0!==a&&(this.sourceValue=a)}catch(b){if(!g.ValidationError.isPrototypeOf(b)||!l.isPrototypeOf(this._targetObj))if(this._updateTarget(),!this._onError(b,this))throw b;}finally{this._ignoreSrcChange=
!1}}},destroy:function(){if(!this._isDestroyed){var a=this;h.forEachProp(this._bounds,function(b){a._bounds[b].removeNSHandlers(a._objId)});this._bounds={};this._target=this._source=this._targetObj=this._sourceObj=this._tgtPath=this._srcPath=this._converterParam=this._converter=this._state=this.target=this.source=null;this._super()}},toString:function(){return"Binding"}},{bindingID:{get:function(){return this._objId}},target:{set:function(a){if(this._state)this._state.target=a;else if(this._target!==
...
converterParam:{set:function(a){this._converterParam=a},get:function(){return this._converterParam}},isSourceFixed:{get:function(){return this._isSourceFixed}},isDisabled:{set:function(a){a=!!a;if(this.isDisabled!=a)if(a){a={source:this._source,target:this._target};try{this.source=this.target=null}finally{this._state=a}}else a=this._state,this._state=null,this.target=a.target,this.source=a.source},get:function(){return!!this._state}}},function(f){a.registerType("Binding",f)})};
RIAPP.Application._coreModules.template=function(a){var g=a.global,d=g.utils,h=g.consts,k=a.modules.binding.Binding,l=a.modules.baseElView.BaseElView,p=a.modules.baseElView.TemplateElView;this.Template=RIAPP.BaseObject.extend({_app:a,_create:function(a){this._super();this._el=this._dctxt=null;this._isDisabled=!1;this._lfTime=null;this._templateID=a;this._templElView=void 0;this._promise=null;this._templateID&&this._loadTemplate()},_getBindings:function(){if(!this._lfTime)return[];for(var a=this._lfTime.getObjs(),
b=[],c=0,e=a.length;c<e;c+=1)k.isPrototypeOf(a[c])&&b.push(a[c]);return b},_getElViews:function(){if(!this._lfTime)return[];for(var a=this._lfTime.getObjs(),b=[],c=0,e=a.length;c<e;c+=1)l.isPrototypeOf(a[c])&&b.push(a[c]);return b},_getTemplateElView:function(){if(!this._lfTime||null===this._templElView)return null;if(this._templElView)return this._templElView;for(var a=null,b=this._getElViews(),c=0,e=b.length;c<e;c+=1)if(p.isPrototypeOf(b[c])){a=b[c];break}return this._templElView=a},_loadTemplateElAsync:function(a){if(a=
this._app.getTemplateLoader(a))return a().then(function(b){var a=g.document.createElement("div");a.innerHTML=b;return a.firstElementChild});a=d.createDeferred();a.reject(Error(String.format(RIAPP.ERRS.ERR_TEMPLATE_ID_INVALID,this._templateID)));return a.promise()},_appendIsBusy:function(a){var b=this,c=this._app.getType("BusyElView").create(a,{img:"loader2.gif"}),e=setTimeout(function(){e=null;var c=b._app._getElView(a);c&&!c._isDestroyCalled&&(c.isBusy=!0)},250);c.addOnDestroyed(function(b,a){e&&
clearTimeout(e)},null)},_removeIsBusy:function(a){var b=this._app.getType("BusyElView");(a=this._app._getElView(a))&&b.isPrototypeOf(a)&&a.destroy()},_loadTemplate:function(){var a=this,b=a._templateID,c;a._unloadTemplate();b&&(b=a._loadTemplateElAsync(b),"pending"==b.state()&&(a._el=c=g.document.createElement("div"),a._appendIsBusy(c),a._promise=d.createDeferred(),b.then(function(){a._removeIsBusy(c);a._promise.resolve()}),b=g.$.when(b,a._promise)),b.then(function(b){if(!a._isDestroyCalled){var c=
!!a._promise;a._promise=null;b?(c&&a._el.appendChild(b),a._el=b,a._lfTime=a._app._bindTemplateElements(a._el),(b=a._getTemplateElView())&&b.templateLoaded(a),a._updateBindingSource()):a._unloadTemplate()}},function(b){a._isDestroyCalled||(a._promise=null,"cancel"!=b&&(b&&b.message?a._app._onError(b,a):a._app._onError(Error(String.format(RIAPP.ERRS.ERR_TEMPLATE_ID_INVALID,a._templateID)),a)))}))},_updateBindingSource:function(){var a,b,c,e=this._getBindings();a=0;for(b=e.length;a<b;a+=1)c=e[a],c.isDisabled=
this._isDisabled,c.isSourceFixed||(c.source=this._dctxt)},_updateIsDisabled:function(){var a,b,c,e=this._getBindings(),d=this._getElViews(),n=this._app._getElViewType(h.ELVIEW_NM.DATAFORM);a=0;for(b=e.length;a<b;a+=1)c=e[a],c.isDisabled=this._isDisabled;a=0;for(b=d.length;a<b;a+=1)c=d[a],n.isPrototypeOf(c)&&c.form&&(c.form.isDisabled=this._isDisabled)},_unloadTemplate:function(){try{if(this._el){var a=this._templElView;this._templElView=void 0;a&&a.templateUnloading(this)}}finally{this._lfTime&&(this._lfTime.destroy(),
this._lfTime=null),this._el&&g.$(this._el).remove(),this._el=null}},destroy:function(){this._isDestroyed||(this._promise&&(this._promise.reject("cancel"),this._promise=null),this._dctxt=null,this._unloadTemplate(),this._templateID=null,this._templElView=void 0,this._super())},findElByDataName:function(a){return g.$(this._el).find(["*[",h.DATA_ATTR.DATA_NAME,'="',a,'"]'].join("")).toArray()},findElViewsByDataName:function(a){var b=this,c=[];this.findElByDataName(a).forEach(function(a){(a=b._app._getElView(a))&&
c.push(a)});return c},toString:function(){return"Template"}},{dataContext:{set:function(a){this._dctxt!==a&&(this._dctxt=a,this.raisePropertyChanged("dataContext"),this._updateBindingSource())},get:function(){return this._dctxt}},templateID:{set:function(a){this._templateID!==a&&(this._promise&&(this._promise.reject("cancel"),this._promise=null),this._templateID=a,this._loadTemplate(),this.raisePropertyChanged("templateID"))},get:function(){return this._templateID}},el:{get:function(){return this._el}},
...
RIAPP.Application._coreModules.mvvm=function(a){this.Command=RIAPP.BaseObject.extend({_app:a,_create:function(a,d,h){this._super();this._action=a;this._thisObj=d;this._canExecute=h;this._isEnabled=!0;this._objId="cmd"+this._app.getNewObjectID()},_getEventNames:function(){var a=this._super();return["canExecute_changed"].concat(a)},canExecute:function(a,d){return!this._canExecute?!0:this._canExecute.apply(this._thisObj,[a,d])},execute:function(a,d){this._isEnabled&&this._action&&this._action.apply(this._thisObj,
[a,d])},destroy:function(){this._isDestroyed||(this._canExecute=this._thisObj=this._action=null,this._super())},raiseCanExecuteChanged:function(){this.raiseEvent("canExecute_changed",{})},toString:function(){return"Command"}},{app:{get:function(){return this._app}}},function(g){a.registerType("Command",g)});this.BaseViewModel=RIAPP.BaseObject.extend({_app:a,_create:function(){this._super();this._objId="vm"+this._app.getNewObjectID()},_onError:function(a,d){var h=this._super(a,d);return!h?this._app._onError(a,
d):h},toString:function(){return this._typeName?this._super():"BaseViewModel"}},{uniqueID:{get:function(){return this._objId}},app:{get:function(){return this._app}},$:{get:function(){return this._app.global.$}}},function(g){a.registerType("BaseViewModel",g)})};
RIAPP.Application._coreModules.baseContent=function(a){var g=a.global,d=a.modules.template.Template,h=a.modules.binding.Binding,k=this.css={content:"ria-content-field",required:"ria-required-field"};Object.freeze(k);this.BindingContent=RIAPP.BaseObject.extend({_app:a,_create:function(a,d,f,b){this._super();this._parentEl=a;this._el=null;this._options=d;this._isReadOnly=!!this._options.readOnly;this._isEditing=!!b;this._dctx=f;this._tgt=this._lfScope=null;g.$(this._parentEl).addClass(k.content);d.initContentFn&&
d.initContentFn(this);this._init();this.update()},_init:function(){},_updateCss:function(){var a=this._getDisplayInfo(),d=g.$(this._parentEl),f=this.getFieldInfo();this._isEditing&&this._canBeEdited()?(a&&(a.editCss&&d.addClass(a.editCss),a.displayCss&&d.removeClass(a.displayCss)),f&&!f.isNullable&&d.addClass(k.required)):a&&(a.displayCss&&d.addClass(a.displayCss),a.editCss&&d.removeClass(a.editCss),f&&!f.isNullable&&d.removeClass(k.required))},_canBeEdited:function(){if(this._isReadOnly)return!1;
...
RIAPP.Application._coreModules.collection=function(a){var g=this,d=a.global,h=d.utils,k,l,p,f=d.consts.DATA_TYPE,b={REMOVE:"0",ADDED:"1",RESET:"2",REMAP_KEY:"3"},c={};c.DATA_TYPE=f;c.SORT_ORDER={ASC:0,DESC:1};c.COLL_CHANGE_TYPE=b;c.DATE_CONVERSION={None:0,ServerLocalToClientLocal:1,UtcToClientLocal:2};g.consts=c;Object.freeze(c);var e=a.modules.binding.ValidationError,m={valueToDate:function(a,b,e){if(!a)return null;a=""+a;var d=a.split("&");if(7!=d.length)throw Error(base_utils.format(RIAPP.ERRS.ERR_PARAM_INVALID,
"val",a));a=new Date(parseInt(d[0],10),parseInt(d[1],10)-1,parseInt(d[2],10),parseInt(d[3],10),parseInt(d[4],10),parseInt(d[5],10),parseInt(d[6],10));var d=c.DATE_CONVERSION,f=h.get_timeZoneOffset();switch(b){case d.None:break;case d.ServerLocalToClientLocal:a.setMinutes(a.getMinutes()+e);a.setMinutes(a.getMinutes()-f);break;case d.UtcToClientLocal:a.setMinutes(a.getMinutes()-f);break;default:throw Error(base_utils.format(RIAPP.ERRS.ERR_PARAM_INVALID,"dtcnv",b));}return a},dateToValue:function(a,
b,e){if(null===a)return null;if(!h.check_is.Date(a))throw Error(base_utils.format(RIAPP.ERRS.ERR_PARAM_INVALID,"dt",a));var d=c.DATE_CONVERSION,f=h.get_timeZoneOffset();switch(b){case d.None:break;case d.ServerLocalToClientLocal:a.setMinutes(a.getMinutes()+f);a.setMinutes(a.getMinutes()-e);break;case d.UtcToClientLocal:a.setMinutes(a.getMinutes()+f);break;default:throw Error(h.format(RIAPP.ERRS.ERR_PARAM_INVALID,"dtcnv",b));}return""+a.getFullYear()+"&"+(a.getMonth()+1)+"&"+a.getDate()+"&"+a.getHours()+
"&"+a.getMinutes()+"&"+a.getSeconds()+"&"+a.getMilliseconds()},compareVals:function(a,b,c){if(null===a&&null!==b||null!==a&&null===b)return!1;switch(c){case f.DateTime:case f.Date:case f.Time:return h.check_is.Date(a)&&h.check_is.Date(b)?a.getTime()===b.getTime():!1;default:return a===b}},stringifyValue:function(a,b,c){return h.check_is.nt(a)?null:h.check_is.Date(a)?m.dateToValue(a,b,c):""+a},parseValue:function(a,b,c,e){var d=null;if(void 0===a||null===a)return d;switch(b){case f.None:d=a;break;
case f.String:d=a;break;case f.Bool:d=h.parseBool(a);break;case f.Integer:d=parseInt(a,10);break;case f.Decimal:case f.Float:d=parseFloat(a);break;case f.DateTime:case f.Date:case f.Time:d=m.valueToDate(a,c,e);break;case f.Guid:case f.Binary:d=a;break;default:throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_PARAM_INVALID,"dataType",b));}return d}};g.valueUtils=m;l=RIAPP.BaseObject.extend({_app:a,_create:function(){this._super();this._fkey=null;this._isEditing=!1;this._saveVals=null;this._vals={};this._notEdited=
!0},_getEventNames:function(){var a=this._super();return["errors_changed"].concat(a)},_onError:function(a,b){var c=this._super(a,b);return!c?this._collection._onError(a,b):c},_beginEdit:function(){var a=this._collection;if(a.isEditing){var b=a._EditingItem;if(b===this)return!1;try{b.endEdit(),b.getIsHasErrors()&&(this._onError(e.create(b.getAllErrors(),b),b),b.cancelEdit())}catch(c){a=this._onError(c,b),b.cancelEdit(),d.reThrow(c,a)}}this._isEditing=!0;this._saveVals=h.shallowCopy(this._vals);this._collection.currentItem=
...
c&&b.push(c);return b},_checkVal:function(a,b){var c=b,e=RIAPP.ERRS;if(this._skipValidate(a,b))return c;if(a.isReadOnly&&(!a.allowClientDefault||!this._isNew))throw Error(e.ERR_FIELD_READONLY);if((null===b||h.check_is.String(b)&&!b)&&!a.isNullable)throw Error(e.ERR_FIELD_ISNOT_NULLABLE);if(null===b)return b;switch(a.dataType){case f.None:break;case f.Guid:case f.Binary:case f.String:if(!h.check_is.String(b))throw Error(String.format(e.ERR_FIELD_WRONG_TYPE,b,"String"));if(0<a.maxLength&&b.length>a.maxLength)throw Error(String.format(e.ERR_FIELD_MAXLEN,
a.maxLength));a.isNullable&&""===b&&(c=null);if(a.regex&&!RegExp(a.regex,"i").test(b))throw Error(String.format(e.ERR_FIELD_REGEX,b));break;case f.Bool:if(!h.check_is.Boolean(b))throw Error(String.format(e.ERR_FIELD_WRONG_TYPE,b,"Boolean"));break;case f.Integer:case f.Decimal:case f.Float:if(!h.check_is.Number(b))throw Error(String.format(e.ERR_FIELD_WRONG_TYPE,b,"Number"));a.range&&h.validation.checkNumRange(Number(b),a.range);break;case f.DateTime:case f.Date:if(!h.check_is.Date(b))throw Error(String.format(e.ERR_FIELD_WRONG_TYPE,
b,"Date"));a.range&&h.validation.checkDateRange(b,a.range);break;case f.Time:if(!h.check_is.Date(b))throw Error(String.format(e.ERR_FIELD_WRONG_TYPE,b,"Time"));break;default:throw Error(String.format(e.ERR_PARAM_INVALID,"dataType",a.dataType));}return c},_onErrorsChanged:function(a){this.raiseEvent("errors_changed",a)},_resetIsNew:function(){},getFieldInfo:function(a){return this._collection.getFieldInfo(a)},getFieldNames:function(){return this._collection.getFieldNames()},addOnItemErrorsChanged:function(a,
b){this.addHandler("errors_changed",a,b)},getFieldErrors:function(a){var b=this._collection._getErrors(this);if(!b)return[];var c=a;a||(a="*");if(!b[a])return[];"*"===a&&(c=null);return[{fieldName:c,errors:b[a]}]},getAllErrors:function(){var a=this._collection._getErrors(this);if(!a)return[];var b=[];h.forEachProp(a,function(c){var e=null;"*"!==c&&(e=c);b.push({fieldName:e,errors:a[c]})});return b},getErrorString:function(){var a=this._collection._getErrors(this);if(!a)return"";var b=[];h.forEachProp(a,
...
e=h.get_timeZoneOffset();return m.stringifyValue(a,c,e)},_getPKFieldInfos:function(){if(this._pkInfo)return this._pkInfo;var a=this._fieldMap,b=[];h.forEachProp(a,function(c){0<a[c].isPrimaryKey&&b.push(a[c])});b.sort(function(a,b){return a.isPrimaryKey-b.isPrimaryKey});return this._pkInfo=b},_onError:function(a,b){var c=this._super(a,b);return!c?this._app._onError(a,b):c},_onCurrentChanging:function(a){try{this.endEdit()}catch(b){d.reThrow(b,this._onError(b,this))}this.raiseEvent("current_changing",
...
_onItemAdded:function(a){this.raiseEvent("item_added",{item:a,isAddNewHandled:!1})},_createNew:function(){throw Error("Not implemented");},_attach:function(a,c){if(this._itemsByKey[a._key])throw Error(RIAPP.ERRS.ERR_ITEM_IS_ATTACHED);try{this.endEdit()}catch(e){d.reThrow(e,this._onError(e,this))}var f;a._onAttaching();h.check_is.nt(c)?(f=this._items.length,this._items.push(a)):(f=c,h.insertIntoArray(this._items,a,f));this._itemsByKey[a._key]=a;this._onItemsChanged({change_type:b.ADDED,items:[a],pos:[f]});
a._onAttach();this.raisePropertyChanged("count");this._onCurrentChanging(a);this._currentPos=f;this._onCurrentChanged();return f},_onRemoved:function(a,c){try{this._onItemsChanged({change_type:b.REMOVE,items:[a],pos:[c]})}finally{this.raisePropertyChanged("count")}},_onPageSizeChanged:function(){},_onPageChanging:function(){var a={page:this.pageIndex,isCancel:!1};this._raiseEvent("page_changing",a);if(!a.isCancel)try{this.endEdit()}catch(b){d.reThrow(b,this._onError(b,this))}return!a.isCancel},_onPageChanged:function(){},
...
getFieldInfo:function(a){return this._fieldMap[a]},getFieldNames:function(){return h.getProps(this._fieldMap)},cancelEdit:function(){this.isEditing&&this._EditingItem.cancelEdit()},endEdit:function(){var a;this.isEditing&&(a=this._EditingItem,!a.endEdit()&&a.getIsHasErrors()&&(this._onError(e.create(a.getAllErrors(),a),a),this.cancelEdit()))},getItemsWithErrors:function(){var a=this,b=[];h.forEachProp(this._errors,function(c){c=a.getItemByKey(c);b.push(c)});return b},addNew:function(){var a,b;a=this._createNew();
...
isRowTimeStamp:!1,dataType:f.NONE,isNullable:!0,maxLength:-1,isReadOnly:!1,isAutoGenerated:!1,allowClientDefault:!1,dateConversion:c.DATE_CONVERSION.NONE,isClientOnly:!0,isCalculated:!1,isNeedOriginal:!1,dependentOn:null,range:null,regex:null,isNavigation:!1,fieldName:a}};p=l.extend({_create:function(a){this._super();this.__isNew=!a;a&&(this._vals=a);a||this._collection.getFieldNames().forEach(function(a){this._vals[a]=null},this)},_setProp:function(a,b){var c,d=this._collection;if(this._vals[a]!==
b)try{if(this._vals[a]=b,this.raisePropertyChanged(a),d._removeError(this,a),c=this._validateField(a))throw e.create([c],this);}catch(f){throw c=e.isPrototypeOf(f)?f:e.create([{fieldName:a,errors:[f.message]}],this),d._addError(this,a,c.errors[0].errors),c;}},_getProp:function(a){return this._vals[a]},_resetIsNew:function(){this.__isNew=!1},toString:function(){return"ListItem"}},{_isNew:{get:function(){return this.__isNew}},_collection:{get:function(){return this.__coll}}},function(a){g.ListItem=
a});k.extend({_create:function(a,b){this._super();this._type_name=a;if(RIAPP.utils.isArray(b)){this._props=b;if(0===this._props.length)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_PARAM_INVALID,"properties",b));this._initFieldMap(!1,b)}else if(l.isPrototypeOf(b))this._props=b.getFieldNames(),this._initFieldMap(!0,b);else if(b)this._props=Object.keys(b),this._initFieldMap(!1,b);else throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_PARAM_INVALID,"properties",b));this._itemType=null;this._createItemType()},
_initFieldMap:function(a,b){var c=this;a?this._props.forEach(function(a){c._fieldMap[a]=h.extend(!1,{},b.getFieldInfo(a))}):this._props.forEach(function(a){c._fieldMap[a]=k.getEmptyFieldInfo(a)})},_attach:function(a){try{this.endEdit()}catch(b){d.reThrow(b,this._onError(b,this))}return this._super(a)},_createNew:function(){var a=this._itemType.create(null);a._key=this._getNewKey(null);return a},_createItemType:function(){var a={};this.getFieldNames().forEach(function(b){a[b]={set:function(a){this._setProp(b,
a)},get:function(){return this._getProp(b)}}},this);a._collection={get:function(){return this.__coll}};var b=this._type_name;this._itemType=p.extend({__coll:this},a,function(a){a._typeName=b+"Item"})},_getNewKey:function(a){a="clkey_"+this._newKey;this._newKey+=1;return a},fillItems:function(a,c){var e=[],d=[],f=[];this._onFillStart({isBegin:!0,rowCount:a.length,time:new Date,isPageChanged:!1});try{c&&this.clear(),a.forEach(function(a){a=this._itemType.create(a);a._key=this._getNewKey(a);var b=this._itemsByKey[a._key];
b?f.push(b):(this._items.push(a),this._itemsByKey[a._key]=a,e.push(a),d.push(this._items.length-1),f.push(a))},this),0<e.length&&(this._onItemsChanged({change_type:b.ADDED,items:e,pos:d}),this.raisePropertyChanged("count"))}finally{this._onFillEnd({isBegin:!1,rowCount:f.length,time:new Date,resetUI:!!c,fetchedItems:f,newItems:e,isPageChanged:!1})}this.moveFirst()},getNewObjects:function(){return this._items.filter(function(a){return a._isNew})},resetNewObjects:function(){this._items.forEach(function(a){a._resetIsNew()})},
...
function(a){g.DataQuery=a});l=h.CollectionItem.extend({_create:function(a,b){this._super();this.__changeType=c.NONE;this._saveChangeType=this._origVals=this._srvRowKey=null;this.__isCached=this.__isRefreshing=!1;this.getFieldNames().forEach(function(a){this._vals[a]=null},this);this._initRowInfo(a,b)},_initRowInfo:function(a,b){if(a){var c=this,d=c._serverTimezone;this._key=this._srvRowKey=a.key;a.values.forEach(function(a,r){var f=b[r],m=c.getFieldInfo(f);if(!m)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_DBSET_INVALID_FIELDNAME,
c._dbSetName,f));f=e.parseValue(a,m.dataType,m.dateConversion,d);c._vals[m.fieldName]=f})}},_checkCanRefresh:function(){if(null===this._key||this._changeType===c.ADDED)throw Error(RIAPP.ERRS.ERR_OPER_REFRESH_INVALID);},_refreshValue:function(a,b,c){var d=this.getFieldInfo(b);if(!d)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_DBSET_INVALID_FIELDNAME,this._dbSetName,b));var f,q,m=d.dataType;a=e.parseValue(a,m,d.dateConversion,this._serverTimezone);f=this._vals[b];switch(c){case 3:e.compareVals(a,f,
m)||(this._vals[b]=a,this._onFieldChanged(d));break;case 1:this._origVals&&(this._origVals[b]=a);this._saveVals&&(this._saveVals[b]=a);e.compareVals(a,f,m)||(this._vals[b]=a,this._onFieldChanged(d));break;case 2:this._origVals&&(q=this._origVals[b],this._origVals[b]=a);if((void 0===q||e.compareVals(q,f,m))&&!e.compareVals(a,f,m))this._vals[b]=a,this._onFieldChanged(d);break;default:throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_PARAM_INVALID,"refreshMode",c));}},_refreshValues:function(a,b){var e=
...
_setFieldVal:function(a,b){var c,e=this._dbSetName,d=this._collection,q=RIAPP.ERRS,f=this._vals[a],m=b,g=this.getFieldInfo(a);if(!g)throw Error(String.format(q.ERR_DBSET_INVALID_FIELDNAME,e,a));!this._isEditing&&!this._isUpdating&&this.beginEdit();try{if(m=this._checkVal(g,m),f!=m&&this._fldChanging(g,f,m)&&(this._vals[a]=m,this._fldChanged(g,f,m)),d._removeError(this,a),c=this._validateField(a))throw v.create([c],this);}catch(n){throw c=v.isPrototypeOf(n)?n:v.create([{fieldName:a,errors:[n.message]}],
...
this.dbContext.getDbSet(b.parentDbSetName),a=c.slice(1).join("."),b.getFieldInfo(a);throw Error(String.format(RIAPP.ERRS.ERR_DBSET_INVALID_FIELDNAME,this.dbSetName,a));},_onError:function(a,b){return this.dbContext._onError(a,b)},_mapAssocFields:function(){for(var a=this._trackAssoc,b,c=Object.keys(a),e,d=this._trackAssocMap,q=0,f=c.length;q<f;q+=1){b=a[c[q]];for(var m=0,g=b.fieldRels.length;m<g;m+=1)e=b.fieldRels[m],d[e.childField]?d[e.childField].push(b.childToParentName):d[e.childField]=[b.childToParentName]}},
_getStrValue:function(a,b){return e.stringifyValue(a,b.dateConversion,this.dbContext.serverTimezone)},_createEntityType:function(a,b,c,e){var d=this,q={};if(!k.check_is.Array(b))throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_PARAM_INVALID_TYPE,"fldInfos","Array"));b.forEach(function(a){var b=k.extend(!1,{},a);b.dependents=[];d._fieldMap[a.fieldName]=b},this);var f=function(a){a.dependentOn.split(",").forEach(function(b){var c=d._fieldMap[b];if(!c)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_CALC_FIELD_DEFINE,
b));if(a.fieldName===b)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_CALC_FIELD_SELF_DEPEND,b));0>c.dependents.indexOf(a.fieldName)&&c.dependents.push(a.fieldName)})},m=function(a){var b=d._fieldMap[a.fieldName],r=!0,f=c.filter(function(b){return b.childToParentName==a.fieldName});0===f.length&&(f=e.filter(function(b){return b.parentToChildrenName==a.fieldName}),r=!1);if(1!=f.length)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_PARAM_INVALID_TYPE,"assocs","Array"));b.isClientOnly=!0;b.isReadOnly=
!0;var m=function(){throw Error("getFunc is not emplemented!");},g,z=f[0].name;r?(b.isReadOnly=!1,d._childAssocMap[f[0].childToParentName]=f[0],f[0].fieldRels.forEach(function(a){a=d._fieldMap[a.childField];!b.isReadOnly&&a.isReadOnly&&(b.isReadOnly=!0)}),m=function(){return d.dbContext.getAssociation(z).getParentItem(this)},b.isReadOnly||(d._trackAssoc[z]=f[0],g=function(b){var c,e,r=d.dbContext.getAssociation(z);if(b&&!r.parentDS.entityType.isPrototypeOf(b))throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_PARAM_INVALID_TYPE,
"value",r.parentDS.entityType._typeName));if(b&&b._isNew)this._setFieldVal(a.fieldName,b._key);else if(b){c=0;for(e=r.childFldInfos.length;c<e;c+=1)this[r.childFldInfos[c].fieldName]=b[r.parentFldInfos[c].fieldName]}else{this._getFieldVal(a.fieldName)&&this._setFieldVal(a.fieldName,null);c=0;for(e=r.childFldInfos.length;c<e;c+=1)this[r.childFldInfos[c].fieldName]=null}})):(d._parentAssocMap[f[0].parentToChildrenName]=f[0],m=function(){return d.dbContext.getAssociation(z).getChildItems(this)});q[a.fieldName]=
{set:g,get:m}},g=function(a){q[a.fieldName]={set:function(b){this._setFieldVal(a.fieldName,b)},get:function(){return this._getFieldVal(a.fieldName)}}};b.forEach(function(b){if(k.hasProp(l,b.fieldName))throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_ITEM_NAME_COLLISION,a,b.fieldName));if(b.isCalculated){var c=d.getFieldInfo(b.fieldName);c.isClientOnly=!0;c.isReadOnly=!0;c={dbSetName:a,fieldName:b.fieldName,getFunc:null};d.dbContext._onGetCalcField(c);k.check_is.Function(c.getFunc)&&(b.dependentOn&&f(b),
q[b.fieldName]={get:c.getFunc})}else b.isNavigation?m(b):g(b)});q._dbSet={get:function(){return this.__dbSet}};this._entityType=l.extend({__dbSet:d},q,function(b){b._typeName=a+"Entity"});this._mapAssocFields()},_fillFromService:function(a){a=k.extend(!1,{res:{names:[],rows:[],pageIndex:null,pageCount:null,dbSetName:this.dbSetName,totalCount:null},isPageChanged:!1,fn_beforeFillEnd:null},a);var b=this,c=a.res,e=c.names,d=c.rows||[],q=this._entityType,f=[],g=[],n=[],h=[],l=this.isPagingEnabled,u=this.query,
t=!0,p;this._onFillStart({isBegin:!0,rowCount:d.length,time:new Date,isPageChanged:a.isPageChanged});try{u&&(t=u.isClearPrevData,u.isClearCacheOnEveryLoad&&u._clearCache(),t&&this.clear(),u._reindexCache(),1<u.loadPageCount&&l&&(p=u._getCache(),u.isIncludeTotalCount&&!k.check_is.nt(c.totalCount)&&(p.totalCount=c.totalCount)));n=d.map(function(a){var c=a.key;if(!c)throw Error(RIAPP.ERRS.ERR_KEY_IS_EMPTY);var r=b._itemsByKey[c];r?a.values.forEach(function(a,b){r._refreshValue(a,e[b],1)}):(p&&(r=p.getItemByKey(c)),
r?a.values.forEach(function(a,b){r._refreshValue(a,e[b],1)}):r=q.create(a,e));return r});if(u&&(u.isIncludeTotalCount&&!k.check_is.nt(c.totalCount)&&(this.totalCount=c.totalCount),1<u.loadPageCount&&l)){p.fillCache(c.pageIndex,n);var v=p.getCachedPage(u.pageIndex),n=v?v.items:[]}n.forEach(function(a){var b=this._itemsByKey[a._key];b?h.push(b):(this._items.push(a),this._itemsByKey[a._key]=a,f.push(a),g.push(this._items.length-1),h.push(a))},this);0<f.length&&(this._onItemsChanged({change_type:m.ADDED,
items:f,pos:g}),this.raisePropertyChanged("count"));a.fn_beforeFillEnd&&a.fn_beforeFillEnd()}finally{this._onFillEnd({isBegin:!1,rowCount:h.length,time:new Date,resetUI:t,fetchedItems:h,newItems:f,isPageChanged:a.isPageChanged})}this.moveFirst();return{fetchedItems:h,newItems:f,isPageChanged:a.isPageChanged}},_fillFromCache:function(a){a=k.extend(!1,{isPageChanged:!1,fn_beforeFillEnd:null},a);var b=this,c=[],e=[],d=this.query;if(!d)throw Error(String.format(RIAPP.ERRS.ERR_ASSERTION_FAILED,"query is not null"));
d=d._getCache().getCachedPage(d.pageIndex);d=!d?[]:d.items;this._onFillStart({isBegin:!0,rowCount:d.length,time:new Date,isPageChanged:a.isPageChanged});try{this.clear(),this._items=d,d.forEach(function(a,r){b._itemsByKey[a._key]=a;c.push(r);e.push(a)}),a.fn_beforeFillEnd&&a.fn_beforeFillEnd(),0<e.length&&(this._onItemsChanged({change_type:m.ADDED,items:e,pos:c}),this.raisePropertyChanged("count"))}finally{this._onFillEnd({isBegin:!1,rowCount:e.length,time:new Date,resetUI:!0,fetchedItems:e,newItems:e,
isPageChanged:a.isPageChanged})}this.moveFirst();return{fetchedItems:e,newItems:e,isPageChanged:a.isPageChanged}},_commitChanges:function(a){var b=this;a.forEach(function(a){var e=a.clientKey,r=b._itemsByKey[e];if(!r)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_KEY_IS_NOTFOUND,e));var d=r._changeType;r.acceptChanges(a);d===c.ADDED&&(delete b._itemsByKey[e],r._srvRowKey=a.serverKey,r._key=r._srvRowKey,b._itemsByKey[r._key]=r,b._onItemsChanged({change_type:m.REMAP_KEY,items:[r],old_key:e,new_key:r._key}))})},
_setItemInvalid:function(a){var b=this._itemsByKey[a.clientKey],c={};a.invalid.forEach(function(a){a.fieldName||(a.fieldName="*");c[a.fieldName]?c[a.fieldName].push(a.message):c[a.fieldName]=[a.message]});var e=[];k.forEachProp(c,function(a){e.push({fieldName:a,errors:c[a]})});this._addErrors(b,e);return b},_getChanges:function(){var a=[],b=this._changeCache;k.forEachProp(b,function(c){a.push(b[c]._getRowInfo())});return a},_getTrackAssocInfo:function(){var a=this,b=[],c=this._changeCache,e=Object.keys(a._trackAssoc);
k.forEachProp(c,function(d){var q=c[d];e.forEach(function(c){var e=q._getFieldVal(a._trackAssoc[c].childToParentName),d=q._key;e&&d&&b.push({assocName:c,parentKey:e,childKey:d})})});return b},_getNewKey:function(a){a="clkey_"+this._newKey;this._newKey+=1;return a},_createNew:function(){var a=this._entityType.create(null,null);a._key=this._getNewKey(a);return a},_addToChanged:function(a){null!==a._key&&!this._changeCache[a._key]&&(this._changeCache[a._key]=a,this._changeCount+=1,1===this._changeCount&&
...
var b=this,c=this._dbSets;if(!k.check_is.Array(a.dbSets))throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_PARAM_INVALID_TYPE,"metadata.dbSets","Array"));this._serverTimezone=a.serverTimezone;a.dbSets.forEach(function(e){var d=e.dbSetName,q;q=a.associations.filter(function(a){return e.dbSetName==a.childDbSetName});var m=a.associations.filter(function(a){return e.dbSetName==a.parentDbSetName});q=f.create({dbContext:b,dbSetInfo:e,childAssoc:q,parentAssoc:m});b._arrDbSets.push(q);q.addOnPropertyChange("hasChanges",
...
this._assoc[a.name]=function(){var e=x.create(c);b._arrAssoc.push(e);b._assoc[a.name]=function(){return e};return e}},_initMethod:function(a){var b=this;this._svcMethods[a.methodName]=function(c){var e=k.createDeferred(),f=function(a){a.error?e.reject():e.resolve(a.result)};try{var q=b._getMethodParams(a,c);b._invokeMethod(a,q,f)}catch(m){d._checkIsDummy(m)||(b._onError(m,b),f({result:null,error:m}))}return e.promise()}},_getMethodParams:function(a,c){var d={methodName:a.methodName,paramInfo:{parameters:[]}},
f,m=a.parameters,q=m.length,g,n,h;c||(c={});for(f=0;f<q;f+=1){g=m[f];n=c[g.name];if(!g.isNullable&&!g.isArray&&g.dataType!==b.String&&k.check_is.nt(n))throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_SVC_METH_PARAM_INVALID,g.name,n,a.methodName));if(k.check_is.Function(n))throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_SVC_METH_PARAM_INVALID,g.name,n,a.methodName));g.isArray&&(!k.check_is.nt(n)&&!k.check_is.Array(n))&&(n=[n]);h=null;k.check_is.Array(n)?(h=[],n.forEach(function(a){h.push(e.stringifyValue(a,
g.dateConversion,self._serverTimezone))}),h=JSON.stringify(h)):h=e.stringifyValue(n,g.dateConversion,self._serverTimezone);d.paramInfo.parameters.push({name:g.name,value:h})}return d},_invokeMethod:function(a,b,c){var e=this,f,q;this.isBusy=!0;var m=function(a){try{if(!a)throw Error(k.format(RIAPP.ERRS.ERR_UNEXPECTED_SVC_ERROR,"operation result is undefined"));g.checkError(a.error,"invoke");c({result:a.result,error:null})}catch(b){d._checkIsDummy(b)||(e._onDataOperError(b,"invoke"),c({result:null,
error:b}))}};try{f=JSON.stringify(b),q=this._getUrl("InvokeMethod"),k.performAjaxCall(q,f,!0,function(a){m(JSON.parse(a));e.isBusy=!1},function(a){m({result:null,error:a});e.isBusy=!1},null)}catch(n){d._checkIsDummy(n)&&d._throwDummy(n),this.isBusy=!1,this._onDataOperError(n,"invoke"),c({result:null,error:n}),d._throwDummy(n)}},_getEventNames:function(){var a=this._super();return["submit_error","define_calc"].concat(a)},_loadFromCache:function(a,b){var c=a._dbSet,e;try{e=c._fillFromCache({isPageChanged:b,
fn_beforeFillEnd:null})}catch(f){d._checkIsDummy(f)&&d._throwDummy(f),this._onDataOperError(f,"load"),d._throwDummy(f)}return e},_loadIncluded:function(a){var b=this;a.included&&0<a.included.length&&a.included.forEach(function(a){b.getDbSet(a.dbSetName).fillItems(a,!0)})},_onLoaded:function(a,b){var c=this,e,f,q;try{if(!a)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_UNEXPECTED_SVC_ERROR,"null result"));e=a.dbSetName;f=this.getDbSet(e);if(!f)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_DBSET_NAME_INVALID,
e));g.checkError(a.error,"load");q=f._fillFromService({res:a,isPageChanged:b,fn_beforeFillEnd:function(){c._loadIncluded(a)}})}catch(m){d._checkIsDummy(m)&&d._throwDummy(m),this._onDataOperError(m,"load"),d._throwDummy(m)}return q},_dataSaved:function(a){var b=this,c=[],e=[];try{try{g.checkError(a.error,"submit")}catch(f){throw a.dbSets.forEach(function(a){var d=b._dbSets[a.dbSetName];a.rows.forEach(function(a){var b=d.getItemByKey(a.clientKey);if(!b)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_KEY_IS_NOTFOUND,
a.clientKey));c.push(b);a.invalid&&(d._setItemInvalid(a),e.push(b))})}),w.create(f,c,e);}a.dbSets.forEach(function(a){b._dbSets[a.dbSetName]._commitChanges(a.rows)})}catch(q){d._checkIsDummy(q)&&d._throwDummy(q),this._onSubmitError(q),d._throwDummy(q)}},_getChanges:function(){var a={dbSets:[],error:null,trackAssocs:[]};this._arrDbSets.forEach(function(b){b.endEdit();var c=b._getChanges();if(0!==c.length){var e=b._getTrackAssocInfo();a.dbSets.push({dbSetName:b.dbSetName,rows:c});a.trackAssocs=a.trackAssocs.concat(e)}});
return a},_getUrl:function(a){var b=this.service_url;k.str.endsWith(b,"/")||(b+="/");return b+=[a,""].join("/")},_onItemRefreshed:function(a,b){try{if(g.checkError(a.error,"refresh"),a.rowInfo)b._refreshValues(a.rowInfo,2);else throw b._dbSet.removeItem(b),b.destroy(),Error(RIAPP.ERRS.ERR_ITEM_DELETED_BY_ANOTHER_USER);}catch(c){d._checkIsDummy(c)&&d._throwDummy(c),this._onDataOperError(c,"refresh"),d._throwDummy(c)}},_refreshItem:function(a){var b=k.createDeferred(),c=function(c){c?b.resolve(a):b.reject()},
e=this._getUrl("RefreshItem"),d=a._dbSet;this.waitForNotSubmiting(function(){var b=this;d.waitForNotLoading(function(){var f,m=function(){b.isBusy=!1;d.isLoading=!1;a._isRefreshing=!1},g=function(a){m();b._onDataOperError(a,"refresh")};a._isRefreshing=!0;b.isBusy=!0;d.isLoading=!0;try{var n={dbSetName:a._dbSetName,rowInfo:a._getRowInfo(),error:null};a._checkCanRefresh();f=JSON.stringify(n);k.performAjaxCall(e,f,!0,function(e){try{var d=JSON.parse(e);b._onItemRefreshed(d,a);m();c(!0)}catch(f){g(f),
c(!1)}},function(a){m();b._onDataOperError(a,"refresh");c(!1)},null)}catch(y){g(y),c(!1)}},[],!0,null)},[],null);return b.promise()},_onError:function(a,b){var c=this._super(a,b);return!c?this.app?this.app._onError(a,b):d._onError(a,b):c},_onDataOperError:function(a,b){if(d._checkIsDummy(a))return!0;var c;c=t.isPrototypeOf(a)?a:t.create(a,b);return this._onError(c,this)},_onSubmitError:function(a){var b={error:a,isHandled:!1};this.raiseEvent("submit_error",b);b.isHandled||(this.rejectChanges(),this._onDataOperError(a,
"submit"))},_beforeLoad:function(a,b,c){a&&b!==a&&(c._query=a,c.pageIndex=0);b&&b!==a&&b.destroy();if(a.pageSize!==c.pageSize){c._ignorePageChanged=!0;try{c.pageIndex=0,c.pageSize=a.pageSize}finally{c._ignorePageChanged=!1}}if(a.pageIndex!==c.pageIndex){c._ignorePageChanged=!0;try{c.pageIndex=a.pageIndex}finally{c._ignorePageChanged=!1}}a.isCacheValid||a._clearCache()},_load:function(a,b){if(!a)throw Error(RIAPP.ERRS.ERR_DB_LOAD_NO_QUERY);var c=this,e=k.createDeferred(),f=a.loadPageCount,q=a.pageIndex,
m=a.isPagingEnabled,g=a.dbSetName,n=this.getDbSet(g);this.waitForNotSubmiting(function(){n.waitForNotLoading(function(){var h=n.query,l=c._getUrl("GetItems"),u,p,t=function(){n.isLoading=!1;c.isBusy=!1},v=function(a){t();e.resolve(a)},A=function(a){t();c._onDataOperError(a,"load");e.reject()},x;n.isLoading=!0;c.isBusy=!0;try{a.pageIndex=q;c._beforeLoad(a,h,n);var w,h=1;if(1<f&&m){if(a._isPageCached(q)){x=c._loadFromCache(a,b);x.outOfBandData=null;v(x);return}w=a._getCache().getNextRange(q);q=w.start;
h=w.cnt}u={dbSetName:g,pageIndex:q,pageSize:a.pageSize,pageCount:h,isIncludeTotalCount:a.isIncludeTotalCount,filterInfo:a.filterInfo,sortInfo:a.sortInfo,paramInfo:c._getMethodParams(a._queryInfo,a.params).paramInfo,queryName:a.queryName};p=JSON.stringify(u);k.performAjaxCall(l,p,!0,function(a){var e=[],q;try{q=a.indexOf(d.modules.consts.CHUNK_SEP),-1<q?(e.push(a.substr(0,q)),e.push(a.substr(q+d.modules.consts.CHUNK_SEP.length))):e.push(a),e=e.map(function(a){return JSON.parse(a)}),setTimeout(function(){var d,
q=e[0],f=!!q.included&&0<q.included.length;try{if(1<e.length&&(d=e[1])&&0<d.length)if(f&&q.included.forEach(function(a){a.rows=d.splice(0,a.rowCount);if(a.rowCount!=a.rows.length)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_ASSERTION_FAILED,"subset.rowCount == subset.rows.length"));}),q.rows=d,q.rowCount!=q.rows.length)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_ASSERTION_FAILED,"getDataResult.rowCount == getDataResult.rows.length"));x=c._onLoaded(q,b);x.outOfBandData=a.extraInfo;v(x)}catch(r){A(r)}},
0)}catch(f){A(f)}},function(a){t();c._onDataOperError(a,"load");e.reject()},null)}catch(D){A(D)}},[],!0,b?"paging":null)},[],b?"paging":null);return e.promise()},getDbSet:function(a){if(!this.isInitialized)throw Error(RIAPP.ERRS.ERR_DOMAIN_CONTEXT_NOT_INITIALIZED);var b=this._dbSets[a];if(!b)throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_DBSET_NAME_INVALID,a));return b},getAssociation:function(a){var b=this._assoc[a];if(!b)throw Error(RIAPP.utils.format(RIAPP.ERR_ASSOC_NAME_INVALID,a));return b()},
submitChanges:function(){if(this._pendingSubmit)return this._pendingSubmit.deferred.promise();var a=this,b={deferred:k.createDeferred()},c=function(a){a?b.deferred.resolve():b.deferred.reject()};this._pendingSubmit=b;this.waitForNotBusy(function(){var b,e,d,f=function(){a.isBusy=!1;a.isSubmiting=!1},m=function(b){f();a._onDataOperError(b,"submit");c(!1)};try{if(this.isSubmiting=this.isBusy=!0,this._pendingSubmit=null,b=this._getUrl("SaveChanges"),d=this._getChanges(),0===d.dbSets.length){f();c(!0);
return}}catch(g){m(g);return}try{e=JSON.stringify(d),k.performAjaxCall(b,e,!0,function(b){try{a._dataSaved(JSON.parse(b)),f(),c(!0)}catch(e){m(e)}},function(b){f();a._onSubmitError(b);c(!1)},null)}catch(n){m(n)}},[]);return b.deferred.promise()},load:function(a){return this._load(a,!1)},acceptChanges:function(){this._arrDbSets.forEach(function(a){a.acceptChanges()})},rejectChanges:function(){this._arrDbSets.forEach(function(a){a.rejectChanges()})},initialize:function(a){if(!this._isInitialized){var b=
this;a=k.extend(!1,{serviceUrl:null,metadata:null},a);this._serviceUrl=a.serviceUrl;if(a.metadata)this._initDbSets(a.metadata);else{a=this._getUrl("GetMetadata");try{this.isBusy=!0,k.performAjaxCall(a,void 0,!0,function(a){try{b._initDbSets(JSON.parse(a)),b.isBusy=!1}catch(c){b.isBusy=!1,b._onDataOperError(c,"initDbContext"),d._throwDummy(c)}},function(a){b.isBusy=!1;b._onDataOperError(a,"initDbContext")},null)}catch(c){this.isBusy=!1,this._onDataOperError(c,"initDbContext"),d._throwDummy(c)}}}},
...
return q},_onViewRefreshed:function(a){this.raiseEvent("view_refreshed",a)},_refresh:function(a){var b;if(b=this._dataSource)b=this._fn_itemsProvider?this._fn_itemsProvider(b):b.items,this._fn_filter&&(b=b.filter(this._fn_filter)),this._fn_sort&&(b=b.sort(this._fn_sort)),this._fillItems({items:b,isPageChanged:!!a,clear:!0,isAppend:!1}),this._onViewRefreshed({})},_fillItems:function(a){a=k.extend(!1,{items:[],isPageChanged:!1,clear:!0,isAppend:!1},a);var b,c=[],e=[],d=[];this._onFillStart({isBegin:!0,
rowCount:a.items.length,time:new Date,isPageChanged:a.isPageChanged});try{a.clear&&this.clear(),b=this.isPagingEnabled&&!a.isAppend?this._filterForPaging(a.items):a.items,b.forEach(function(a){var b=this._itemsByKey[a._key];b?d.push(b):(this._itemsByKey[a._key]=a,c.push(a),e.push(this._items.length-1),this._items.push(a),d.push(a))},this),0<c.length&&(this._onItemsChanged({change_type:m.ADDED,items:c,pos:e}),this.raisePropertyChanged("count"))}finally{this._onFillEnd({isBegin:!1,rowCount:d.length,
time:new Date,resetUI:!!a.clear,fetchedItems:d,newItems:c,isPageChanged:a.isPageChanged})}this.totalCount=a.clear?a.items.length:this.totalCount+c.length;this.moveFirst();return c},_onDSCollectionChanged:function(a){var b=this,c;c=a.items;switch(a.change_type){case m.RESET:this._isDSFilling||this._refresh(!1);break;case m.ADDED:!this._isAddingNew&&!this._isDSFilling&&(b._fn_filter&&(c=c.filter(b._fn_filter)),b.appendItems([c]));break;case m.REMOVE:c.forEach(function(a){(a=b._itemsByKey[a._key])&&
b.removeItem(a)});break;case m.REMAP_KEY:if(c=b._itemsByKey[a.old_key])delete b._itemsByKey[a.old_key],b._itemsByKey[a.new_key]=c,this._onItemsChanged(a);break;default:throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_COLLECTION_CHANGETYPE_INVALID,a.change_type));}},_onDSFill:function(a){var b=a.fetchedItems;a.isBegin?this._isDSFilling=!0:(this._isDSFilling=!1,a.resetUI?this._refresh(!1):(this._fn_filter&&(b=b.filter(this._fn_filter)),this.appendItems(b)))},_onDSStatusChanged:function(a){var b=a.item,
...
this,c;c=a.items;var e=[],d={};switch(a.change_type){case m.RESET:b._isParentFilling||(e=b.refreshParentMap());break;case m.ADDED:this._isParentFilling||(e=b._mapParentItems(c));break;case m.REMOVE:c.forEach(function(a){(a=b._unMapParentItem(a))&&(d[a]=null)});e=Object.keys(d);break;case m.REMAP_KEY:if(a.old_key&&(c=this._parentMap[a.old_key]))delete this._parentMap[a.old_key],e=this._mapParentItems([c]);break;default:throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_COLLECTION_CHANGETYPE_INVALID,a.change_type));
...
b){var e=this,d,f;if(a._changeType===c.DELETED){f=e.getChildItems(a);d=this._unMapParentItem(a);switch(e.onDeleteAction){case 1:f.forEach(function(a){a.deleteItem()});break;case 2:f.forEach(function(a){var b=a.isEditing;b||a.beginEdit();try{e._childFldInfos.forEach(function(b){a[b.fieldName]=null}),b||a.endEdit()}finally{b||a.cancelEdit()}})}d&&e._notifyParentChanged([d])}},_onChildCollChanged:function(a){var b=this,c=a.items,e=[],d={};switch(a.change_type){case m.RESET:b._isChildFilling||(e=b.refreshChildMap());
break;case m.ADDED:this._isChildFilling||(e=b._mapChildren(c));break;case m.REMOVE:c.forEach(function(a){(a=b._unMapChildItem(a))&&(d[a]=null)});e=Object.keys(d);break;case m.REMAP_KEY:if(a.old_key&&(a=c[0])){if(e=a._getFieldVal(this._childToParentName))delete this._childMap[e],a._clearFieldVal(this._childToParentName);e=this._mapChildren([a])}break;default:throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_COLLECTION_CHANGETYPE_INVALID,a.change_type));}b._notifyChildrenChanged(e)},_notifyChildrenChanged:function(a){this._notifyChanged([],
...
this._checkChildFKey(a)},_storeChildFKey:function(a){var b=this.getChildFKey(a),c;if(b&&(c=this._childMap[b])&&-1<c.indexOf(a))this._saveChildFKey=b},_checkChildFKey:function(a){var b=this._saveChildFKey,c,e;this._saveChildFKey=null;c=this.getChildFKey(a);c!==b&&(b&&(e=this._childMap[b],k.removeFromArray(e,a),0==e.length&&delete this._childMap[b],this._notifyParentChanged([b]),this._notifyChildrenChanged([b])),c&&(this._mapChildren([a]),this._notifyParentChanged([c]),this._notifyChildrenChanged([c])))},
_onChildStatusChanged:function(a,b){var e=c.DELETED,d=a._changeType,f=this.getChildFKey(a);f&&d===e&&(f=this._unMapChildItem(a))&&this._notifyChildrenChanged([f])},_getItemKey:function(a,b,c){for(var e=[],d,f=0,m=a.length;f<m;f+=1){d=c[a[f].fieldName];d=b._getStrValue(d,a[f]);if(null===d)return null;e.push(d)}return e.join(";")},_resetChildMap:function(){var a=Object.keys(this._childMap);this._childMap={};this._notifyChildrenChanged(a)},_resetParentMap:function(){var a=Object.keys(this._parentMap);
this._parentMap={};this._notifyParentChanged(a)},_unMapChildItem:function(a){var b,c,e=null;if(b=this.getChildFKey(a))if(c=this._childMap[b])a=k.removeFromArray(c,a),-1<a&&(0==c.length&&delete this._childMap[b],e=b);return e},_unMapParentItem:function(a){var b=null;if((a=this.getParentFKey(a))&&this._parentMap[a])delete this._parentMap[a],b=a;return b},_mapParentItems:function(a){for(var b,e,d=c.DELETED,f,q={},m=0,g=a.length;m<g;m+=1)if(b=a[m],e=b._changeType,e!==d&&(e=this.getParentFKey(b)))f=this._parentMap[e],
f!==b&&(this._parentMap[e]=b,q[e]=null);return Object.keys(q)},_onChildrenChanged:function(a){a&&this._parentToChildrenName&&(a=this._parentMap[a])&&a.raisePropertyChanged(this._parentToChildrenName)},_onParentChanged:function(a){var b=this;a&&this._childToParentName&&(a=this._childMap[a])&&a.forEach(function(a){a.raisePropertyChanged(b._childToParentName)})},_mapChildren:function(a){for(var b,e,d,f=c.DELETED,q={},m=0,g=a.length;m<g;m+=1)if(b=a[m],e=b._changeType,e!==f&&(e=this.getChildFKey(b)))d=
...
RIAPP.Application._coreModules.datadialog=function(a){var g=this,d=a.global,h=d.utils,k=RIAPP.localizable.TEXT,l=a.modules.db,p=a.modules.template.Template,f={DIALOG_ACTION:{Default:0,StayOpen:1}};Object.freeze(f.DIALOG_ACTION);Object.freeze(f);g.consts=f;RIAPP.BaseObject.extend({_app:a,DIALOG_ACTION:f.DIALOG_ACTION,_create:function(a){this._super();var c=this;this._objId="dlg"+this._app.getNewObjectID();a=h.extend(!1,{dataContext:null,dbContext:null,templateID:null,width:500,height:350,title:"data edit dialog",
...
this._$template=this._template=null;this._fn_submitOnOK=function(){var a=c._dbContext;if(!a)return h.createDeferred().resolve();a.addHandler("submit_error",function(a,b){l.SubmitError.isPrototypeOf(b.error)&&0<b.error.notValidated.length&&(b.isHandled=!0)},c._objId);var b=a.submitChanges();b.always(function(){a.removeHandler("submit_error",c._objId)});return b};this._updateIsEditable();this._options={width:a.width,height:a.height,title:a.title,autoOpen:!1,modal:!0,close:function(a,b){c._onClose()},
...
c.pop();return c},_getOkButton:function(){return $("#"+this._objId+"Ok")},_getCancelButton:function(){return $("#"+this._objId+"Cancel")},_getRefreshButton:function(){return $("#"+this._objId+"Refresh")},_getAllButtons:function(){return[this._getOkButton(),this._getCancelButton(),this._getRefreshButton()]},_disableButtons:function(a){this._getAllButtons().forEach(function(c){c.prop("disabled",!!a)})},_onOk:function(){var a=this,c;c=f.DIALOG_ACTION.Default;this._fn_OnOK&&(c=this._fn_OnOK(this));if(c!=
f.DIALOG_ACTION.StayOpen)if(this._dataContext){if(c=this._isEditable?this._dataContext.endEdit():!0)if(this._submitOnOK){this._disableButtons(!0);var e=this.title;this.title=k.txtSubmitting;c=this._fn_submitOnOK();c.always(function(){a._disableButtons(!1);a.title=e});c.done(function(){a._result="ok";a.hide()});c.fail(function(){a._isEditable&&a._dataContext.beginEdit()})}else a._result="ok",a.hide()}else a.hide()},_onCancel:function(){var a=f.DIALOG_ACTION.Default;this._fn_OnCancel&&(a=this._fn_OnCancel(this));
...
actionsCell:{get:function(){return this._actionsCell}},isDeleted:{set:function(a){this._el&&this._isDeleted!==a&&((this._isDeleted=a)?(this.isExpanded=!1,d.$(this._el).addClass(s.rowDeleted)):d.$(this._el).removeClass(s.rowDeleted))},get:function(){return!this._el?!0:this._isDeleted}},isEditing:{get:function(){return this._item._isEditing}}},function(a){g.Row=a});p=RIAPP.BaseObject.extend({_app:a,_create:function(a,b){this._super();this._grid=a;this._el=b.tr;this._parentRow=this._cell=this._item=
...
cell:{get:function(){return this._cell}},uniqueID:{get:function(){return this._objId}},itemKey:{get:function(){return!this._item?null:this._item._key}},parentRow:{set:function(a){var b=this;if(a!==this._parentRow){var c=d.$(this._cell._template.el);b._parentRow?c.slideUp("fast",function(){b._setParentRow(a)}):b._setParentRow(a)}},get:function(){return this._parentRow}}},function(a){g.DetailsRow=a});l=RIAPP.BaseObject.extend({_app:a,_create:function(a,c){this._super();var e=this;this._grid=a;this._el=
c.th;this._options=c.colinfo;this._isSelected=!1;this._objId="col"+this.app.getNewObjectID();var f=d.$("<div></div>");f.addClass(s.column);this._grid._headerDiv.append(f);this._extcol=f;var m=d.$("<div></div>");m.addClass(s.cellDiv).click(function(b){b.stopPropagation();d.currentSelectable=a;a._setCurrentColumn(e);e._onColumnClicked()});f.append(m);m.get(0).cell=this;this._div=m;d.$(this.grid._tableEl).on("click","div["+k.DATA_ATTR.DATA_EVENT_SCOPE+'="'+this.uniqueID+'"]',function(c){c.stopPropagation();
var f=this.cell;f&&(d.currentSelectable=a,a._setCurrentColumn(e),b.isPrototypeOf(f)?f._clickTimeOut?(clearTimeout(f._clickTimeOut),f._clickTimeOut=null,f._onDblClicked()):(f._onCellClicked(),f._clickTimeOut=setTimeout(function(){f._clickTimeOut=null},350)):f._onCellClicked())});this._options.width&&(this._el.style.width=this._options.width);this._init();this._options.colCellCss&&m.addClass(this._options.colCellCss)},_init:function(){this.title&&this._div.html(this.title)},destroy:function(){this._isDestroyed||
...
this.$div;b.removeClass(s.colSortable).removeClass(s.colSortAsc).removeClass(s.colSortDesc);switch(a){case "ASC":b.addClass(s.colSortAsc);break;case "DESC":b.addClass(s.colSortDesc);break;default:this.isSortable&&b.addClass(s.colSortable)}this._sortOrder=a},get:function(){return this._sortOrder}}},function(a){g.DataColumn=a});w=l.extend({_init:function(){this._super();this.$div.addClass(s.rowExpander)},toString:function(){return"ExpanderColumn"}},null,function(a){g.ExpanderColumn=a});u=l.extend({_init:function(){this._super();
...
this._super();return["row_expanded","row_selected","page_changed","row_state_changed","cell_dblclicked"].concat(a)},_setCurrentColumn:function(a){this._currentColumn&&(this._currentColumn.isSelected=!1);if(this._currentColumn=a)this._currentColumn.isSelected=!0},_parseColumnAttr:function(a,b){var c={type:"data",title:null,sortable:!1,sortMemberName:null,content:{}},e=this._app.parser.parseOptions(a),c=0<e.length?h.extend(!1,c,e[0]):c;b&&(c.content=this._app._parseContentAttr(b),!c.sortMemberName&&
...
this._columns.forEach(function(a){a.$extcol.width(a.el.offsetWidth);a.$extcol.position({my:"left top",at:"left top",of:b,offset:""+a.el.offsetLeft+" 0"})})},_wrapTable:function(){var a=this._$tableEl,b,c,e,f=this;a.wrap(d.$("<div></div>").addClass(s.wrapDiv));c=a.parent();c.wrap(d.$("<div></div>").addClass(s.container));e=c.parent();b=d.$("<div></div>").addClass(s.headerDiv).insertBefore(c);d.$(this._tHeadRow).addClass(s.columnInfo);this._wrapDiv=c;this._headerDiv=b;this._contaner=e;this._options.containerCss&&
e.addClass(this._options.containerCss);this._options.wrapCss&&c.addClass(this._options.wrapCss);this._options.headerCss&&b.addClass(this._options.headerCss);var m=a.width();this._chkWidthInterval=setInterval(function(){var b=a.width();m!==b&&(m=b,f._updateColsDim())},1E3)},_unWrapTable:function(){var a=this._$tableEl;this._headerDiv&&(clearInterval(this._chkWidthInterval),this._chkWidthInterval=null,this._headerDiv.remove(),this._headerDiv=null,a.unwrap(),this._wrapDiv=null,a.unwrap(),this._contaner=
null)},_createColumns:function(){for(var a=this,b=this._tHeadCells,c=b.length,e=[],d,f,m=0;m<c;m+=1)d=b[m],f=this._parseColumnAttr(d.getAttribute(k.DATA_ATTR.DATA_COLUMN),d.getAttribute(k.DATA_ATTR.DATA_CONTENT)),e.push({th:d,colinfo:f});e.forEach(function(b){(b=a._createColumn(b))&&a._columns.push(b)})},_createColumn:function(a){var b;switch(a.colinfo.type){case "row_expander":this._expanderCol||(this._expanderCol=b=w.create(this,a));break;case "row_actions":this._actionsCol||(this._actionsCol=b=
u.create(this,a));break;case "row_selector":this._rowSelectorCol||(this._rowSelectorCol=b=A.create(this,a));break;case "data":b=v.create(this,a);break;default:throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_GRID_COLTYPE_INVALID,a.colinfo.type));}return b},_appendItems:function(a){if(!this._isDestroyCalled)for(var b,c=this._tBodyEl,e=0,d=a.length;e<d;e+=1)b=a[e],this._rowMap[b._key]||this._createRowForItem(c,b)},_onKeyDown:function(a,b){var c=this._dataSource,e=k.KEYS;if(c)switch(a){case e.up:b.preventDefault();
...
RIAPP.Application._coreModules.pager=function(a){var g=this,d=a.global,h=d.utils,k=a.modules.collection,l=a.modules.baseElView.BaseElView,p={pager:"ria-data-pager",info:"pager-info",currentPage:"pager-current-page",otherPage:"pager-other-page"};Object.freeze(p);g.css=p;var f=RIAPP.localizable.PAGER,b=RIAPP.utils.format,c=RIAPP.BaseObject.extend({_app:a,_create:function(a,b,c){this._super();this._el=a;this._$el=d.$(this._el);this._objId="pgr"+this._app.getNewObjectID();if(b&&!k.Collection.isPrototypeOf(b))throw Error(RIAPP.ERRS.ERR_PAGER_DATASRC_INVALID);
...
this._$el,c,d;this._clearContent();if(0!==this.rowPerPage&&(c=this.rowCount,0!=c&&(c=this.currentPage,0!=c)))if(d=this.pageCount,this.hideOnSinglePage&&1==d)a.hide();else{a.show();if(this.showInfo){var g=this._createElement("span"),h=b(f.pageInfo,c,d);g.addClass(p.info).text(h).appendTo(a)}this.showFirstAndLast&&1!=c&&a.append(this._createFirst());this.showPreviousAndNext&&1!=c&&a.append(this._createPrevious());if(this.showNumbers){var g=1,h=d,k=this.sliderSize;this.useSlider&&0<k&&(g=Math.floor((k-
1)/2),h=c+g+(k-1)%2,g=c-g,1>g&&(h+=1-g,g=1),h>d&&(g-=h-d,1>g&&(g=1),h=d));for(;g<=h;g++)g===c?a.append(this._createCurrent()):a.append(this._createOther(g))}this.showPreviousAndNext&&c!=d&&a.append(this._createNext());this.showFirstAndLast&&c!=d&&a.append(this._createLast())}},_setDSPageIndex:function(a){this.dataSource.pageIndex=a-1},_onPageSizeChanged:function(a){this.rowPerPage=a.pageSize},_onPageIndexChanged:function(a){this.currentPage=a.pageIndex+1},_onTotalCountChanged:function(a){this.rowCount=
...
(b=f.firstPageTip);b=this._createLink(1,f.firstText,b);a.addClass(p.otherPage).append(b);return a},_createPrevious:function(){var a=this._createElement("span"),c=this.currentPage-1,d;this.showTip&&(d=b(f.prevPageTip,c));c=this._createLink(c,f.previousText,d);a.addClass(p.otherPage).append(c);return a},_createCurrent:function(){var a=this._createElement("span"),b=this.currentPage;a.text(""+b);this.showTip&&h.addToolTip(a,this._buildTip(b));a.addClass(p.currentPage);return a},_createOther:function(a){var b=
this._createElement("span"),c;this.showTip&&(c=this._buildTip(a));a=this._createLink(a,a,c);b.addClass(p.otherPage);b.append(a);return b},_createNext:function(){var a=this._createElement("span"),c=this.currentPage+1,d;this.showTip&&(d=b(f.nextPageTip,c));c=this._createLink(c,f.nextText,d);a.addClass(p.otherPage).append(c);return a},_createLast:function(){var a=this._createElement("span"),b;this.showTip&&(b=f.lastPageTip);b=this._createLink(this.pageCount,f.lastText,b);a.addClass(p.otherPage).append(b);
return a},_buildTip:function(a){var c=this.rowPerPage,d=this.rowCount,g=(a-1)*c+1,c=a==this.pageCount?d:a*c,h="";return h=a==this.currentPage?b(f.showingTip,g,c,d):b(f.showTip,g,c,d)},toString:function(){return"Pager"}},{el:{get:function(){return this._el}},app:{get:function(){return this._app}},dataSource:{set:function(a){a!==this._dataSource&&(null!==this._dataSource&&this._unbindDS(),this._dataSource=a,null!==this._dataSource&&this._bindDS(),this.raisePropertyChanged("dataSource"))},get:function(){return this._dataSource}},
...
RIAPP.Application._coreModules.stackpanel=function(a){var g=this,d=a.global,h=d.utils,k=d.consts,l=a.modules.collection,p=a.modules.template.Template,f=a.modules.baseElView.BaseElView,b={stackpanel:"ria-stackpanel",item:"stackpanel-item",currentItem:"current-item"};Object.freeze(b);g.css=b;var c=RIAPP.BaseObject.extend({_app:a,_create:function(a,c,f){this._super();this._el=a;this._$el=d.$(this._el);this._objId="pnl"+this._app.getNewObjectID();if(c&&!l.Collection.isPrototypeOf(c))throw Error(RIAPP.ERRS.ERR_STACKPNL_DATASRC_INVALID);
...
RIAPP.Application._coreModules.listbox=function(a){var g=this,d=a.global,h=d.utils,k=d.consts,l=a.modules.collection,p=a.modules.baseElView.EditableElView,f=RIAPP.BaseObject.extend({_app:a,_create:function(a,c,e){var f=this;this._super();this._el=a;this._$el=d.$(this._el);this._objId="lst"+this._app.getNewObjectID();if(c&&!l.Collection.isPrototypeOf(c))throw Error(RIAPP.ERRS.ERR_LISTBOX_DATASRC_INVALID);this._$el.on("change."+this._objId,function(a){a.stopPropagation();f._isRefreshing||f._onChanged()});
...
h.check_is.nt(a)?"":""+a):""+this._getValue(a)},_onDSCollectionChanged:function(a){var c=this,e=l.consts.COLL_CHANGE_TYPE;switch(a.change_type){case e.RESET:this._isDSFilling||this._refresh();break;case e.ADDED:this._isDSFilling||a.items.forEach(function(a){c._addOption(a,a._isNew)});break;case e.REMOVE:a.items.forEach(function(a){c._removeOption(a)});break;case e.REMAP_KEY:if(e=c._keyMap[a.old_key])delete c._keyMap[a.old_key],c._keyMap[a.new_key]=e,e.op.value=a.new_key}},_onDSFill:function(a){a.isBegin?
this._isDSFilling=!0:(this._isDSFilling=!1,this._refresh())},_onEdit:function(a,c,e){c?this._saveVal=this._getValue(a):(c=this._saveVal,this._saveVal=void 0,e||(e=a._key,(e=this._keyMap[e])?(e.op.text=this._getText(a),a=this._getValue(a),c!==a&&(""!==c&&delete this._valMap[c],""!==a&&(this._valMap[a]=e))):""!==c&&delete this._valMap[c]))},_onStatusChanged:function(a,c){a._changeType===k.CHANGE_TYPE.DELETED&&this._removeOption(a)},_onCommitChanges:function(a,c,e,d){var f=k.CHANGE_TYPE;if(c){if(!(e&&
...
RIAPP.Application._coreModules.dataform=function(a){var g=this,d=a.global,h=d.utils,k=d.consts,l=a.modules.binding.Binding,p=a.modules.baseElView.BaseElView,f={dataform:"ria-dataform"},b=RIAPP.localizable.VALIDATE;Object.freeze(f);g.css=f;var c=RIAPP.BaseObject.extend({_DATA_CONTENT_SELECTOR:"*["+k.DATA_ATTR.DATA_CONTENT+"]:not(["+k.DATA_ATTR.DATA_COLUMN+"])",_app:a,_create:function(b,c){var g=this,h;this._super();this._el=b;this._$el=d.$(this._el);this._objId="frm"+this._app.getNewObjectID();this._css=
c.css;this._dataContext=null;this._$el.addClass(f.dataform);this._css&&this._$el.addClass(this._css);this._isDisabled=this._isEditing=!1;this._content=[];this._lfTime=null;this._supportEdit=this._contentCreated=!1;this._errors=this._parentDataForm=this._collection=null;if(h=this._getParentDataForm(this._el))g._parentDataForm=a.getElementView(h),g._parentDataForm.addOnDestroyed(function(a,b){g.destroy()},g._objId)},_getBindings:function(){if(!this._lfTime)return[];for(var a=this._lfTime.getObjs(),
b=[],c=0,d=a.length;c<d;c+=1)l.isPrototypeOf(a[c])&&b.push(a[c]);return b},_getElViews:function(){if(!this._lfTime)return[];for(var a=this._lfTime.getObjs(),b=[],c=0,d=a.length;c<d;c+=1)p.isPrototypeOf(a[c])&&b.push(a[c]);return b},_updateIsDisabled:function(){var a,b,c,d=this._getBindings(),f=this._getElViews(),g=this._app._getElViewType(k.ELVIEW_NM.DATAFORM);a=0;for(b=d.length;a<b;a+=1)c=d[a],c.isDisabled=this._isDisabled;a=0;for(b=f.length;a<b;a+=1)c=f[a],g.isPrototypeOf(c)&&c.form&&(c.form.isDisabled=
this._isDisabled)},_updateContent:function(){var a=this._dataContext,b,c=this;if(this._contentCreated)this._content.forEach(function(b){b.dataContext=a;b.isEditing=this.isEditing},this),b=this._getBindings(),b.forEach(function(b){b.isSourceFixed||(b.source=a)});else if(a){b=Array.fromList(this._el.querySelectorAll(c._DATA_CONTENT_SELECTOR));var d=this.isEditing;b.forEach(function(b){if(c._getParentDataForm(b)===c._el){var f=b.getAttribute(k.DATA_ATTR.DATA_CONTENT),f=c._app._parseContentAttr(f);if(f.fieldName&&
...
null);this._contentCreated=!1},_onError:function(a,b){var c=this._super(a,b);return!c?this._app._onError(a,b):c},destroy:function(){if(!this._isDestroyed){this._clearContent();this._css&&this._$el.removeClass(this._css);this._$el.removeClass(f.dataform);this._$el=this._el=null;this._unbindDS();var a=this._parentDataForm;this._parentDataForm=null;a&&!a._isDestroyCalled&&a.removeNSHandlers(this._objId);this._dataContext=null;this._contentCreated=!1;this._super()}},toString:function(){return"DataForm"}},
...
_getEventNames:function(){var a=this._super();return["keypress"].concat(a)},toString:function(){return"TextBoxElView"}},{value:{set:function(a){if(this._el){var b=this._el,d=b.value;a=null===a?"":""+a;d!==a&&(b.value=a,this.raisePropertyChanged("value"))}},get:function(){var a=this._el;return!a?"":a.value}}},function(b){g.TextBoxElView=b;a.registerType("TextBoxElView",b);a.registerElView("input:text",b)});l.extend({toString:function(){return"HiddenElView"}},{value:{set:function(a){if(this._el){var b=
this._el,d=b.value;a=null===a?"":""+a;d!==a&&(b.value=a,this.raisePropertyChanged("value"))}},get:function(){var a=this._el;return!a?"":a.value}}},function(b){g.HiddenElView=b;a.registerType("HiddenElView",b);a.registerElView("input:hidden",b)});k.extend({_init:function(a){this._super(a);a.rows&&(this.rows=a.rows);a.cols&&(this.cols=a.cols);a.wrap&&(this.wrap=a.wrap)},toString:function(){return"TextAreaElView"}},{rows:{set:function(a){var b=this._el;if(b){var d=b.rows;a=!a?1:a;d!==a&&(b.rows=a,this.raisePropertyChanged("rows"))}},
...
"disabled")},destroy:function(){this._isDestroyed||(this._lfScope&&(this._lfScope.destroy(),this._lfScope=null),this._tgt&&(this._tgt.destroy(),this._tgt=null),this._super())},_cleanUp:function(){},update:function(){this._cleanUp();this._updateCss()},toString:function(){return"BoolContent"}},null,function(a){g.BoolContent=a});e.extend({_canBeEdited:function(){return!0},toString:function(){return"RowSelectContent"}},null,function(a){g.RowSelectContent=a});var m=b.extend({_getBindingOption:function(b,
c,e,f){b=this._super(b,c,e,f);b.converter=a.getConverter("dateTimeConverter");c=this.getFieldInfo();e=d.defaults;switch(c.dataType){case p.DateTime:b.converterParam=e.dateTimeFormat;break;case p.Time:b.converterParam=e.timeFormat;break;default:b.converterParam=e.dateTimeFormat}return b},toString:function(){return"DateTimeContent"}},null,function(a){g.DateTimeContent=a}),n=b.extend({_allowedKeys:[0,f.backspace,f.del,f.left,f.right,f.end,f.home,f.tab,f.esc,f.enter],_getBindingOption:function(b,c,d,
...
if(47===a)return!1;var c={32:" ",44:",",46:"."}[a],e=d.defaults;return c===e.decimalPoint?0===b.length?!1:0>b.indexOf(c):c&&c!==e.thousandSep?!1:!(!c&&(45>a||57<a))},toString:function(){return"NumberContent"}},null,function(a){g.NumberContent=a}),t=b.extend({_allowedKeys:[0,f.backspace,f.del,f.left,f.right,f.end,f.home,f.tab,f.esc,f.enter],update:function(){this._super();var a=this,b=a.getFieldInfo();l.TextBoxElView.isPrototypeOf(a._tgt)&&a._tgt.addHandler("keypress",function(c,d){d.isCancel=!a._previewKeyPress(b,
d.keyCode,d.value)})},_previewKeyPress:function(a,b,c){return!(0<a.maxLength&&c.length>=a.maxLength&&-1===this._allowedKeys.indexOf(b))},toString:function(){return"StringContent"}},null,function(a){g.StringContent=a}),v=b.extend({_allowedKeys:[0,f.backspace,f.del,f.left,f.right,f.end,f.home,f.tab,f.esc,f.enter],update:function(){this._super();var a=this,b=a.getFieldInfo();if(l.TextAreaElView.isPrototypeOf(a._tgt)){a._tgt.addHandler("keypress",function(c,d){d.isCancel=!a._previewKeyPress(b,d.keyCode,
...
get:function(){return this._value}}},function(a){g.LookupContent=a});g.BindingContentFactory=RIAPP.BaseObject.extend({_app:a,getContentType:function(a){var d=a.fieldInfo;if(a.lookup)return w;switch(d.dataType){case p.None:a=b;break;case p.String:a=a.multyline?v:t;break;case p.Bool:a=e;break;case p.Integer:a=n;break;case p.Decimal:case p.Float:a=n;break;case p.DateTime:case p.Time:a=m;break;case p.Date:a=c;break;case p.Guid:case p.Binary:a=b;break;default:throw Error(RIAPP.utils.format(RIAPP.ERRS.ERR_FIELD_DATATYPE,
d.dataType));}return a},createContent:function(a,b,c,d){return this.getContentType(b).create(a,b,c,d)},toString:function(){return"Default BindingContentFactory"}},null,null);a.bindingContentFactory=g.BindingContentFactory};
